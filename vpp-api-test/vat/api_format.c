...
static int api_sw_interface_set_dpdk_hqos_pipe (vat_main_t * vam)
{
    unformat_input_t * i = vam->input;
...
static int api_sw_interface_set_dpdk_hqos_subport (vat_main_t * vam)
{
    unformat_input_t * i = vam->input;
...
static int api_sw_interface_set_dpdk_hqos_tctbl (vat_main_t * vam)
{
    unformat_input_t * i = vam->input;
