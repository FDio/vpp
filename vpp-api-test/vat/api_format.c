...
static int api_sr_policy_add_del (vat_main_t * vam)
{
  ...
  int tunnel_set = 0;
  int j = 0;
  int tunnel_names_length = 0, tun_name_len = 0; // Different naming convention used as confusing these would be "bad" (TM)
  ...
  /* This WAS used for tunnel serialized length to pass to M2 */
