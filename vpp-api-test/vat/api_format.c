...
static void
vl_api_lisp_gpe_enable_disable_details_t_handler
(vl_api_lisp_gpe_enable_disable_details_t *mp)
{
    vat_main_t *vam = &vat_main;
...
static void
vl_api_lisp_gpe_enable_disable_details_t_handler_json
(vl_api_lisp_gpe_enable_disable_details_t *mp)
{
    vat_main_t *vam = &vat_main;
    vat_json_node_t *node = NULL;
...
_(LISP_GPE_ENABLE_DISABLE_DETAILS, lisp_gpe_enable_disable_details)
...
static int
api_lisp_gpe_enable_disable_dump(vat_main_t *vam)
{
    vl_api_lisp_gpe_enable_disable_dump_t *mp;
    f64 timeout = ~0;
    ...
    M(LISP_GPE_ENABLE_DISABLE_DUMP, lisp_GPE_ENABLE_DISABLE_dump);
    /* send it... */
    S;
...
_(lisp_gpe_enable_disable_dump, "")
