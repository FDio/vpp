...
_(SW_INTERFACE_SHOW_ERRORS_REPLY, sw_interface_show_errors_reply)
...
int api_sw_interface_show_errors (vat_main_t * vam)
{
    vl_api_sw_interface_show_errors_t *mp;
    f64 timeout;

    M(SW_INTERFACE_SHOW_ERRORS, sw_interface_show_errors);
    S;
...
int vl_api_sw_interface_show_errors_reply_t_handler (vl_api_sw_interface_show_errors_reply_t * mp)
{
    vat_main_t * vam = &vat_main;
...
int vl_api_sw_interface_show_errors_reply_t_handler_json (vl_api_sw_interface_show_errors_reply_t * mp)
{
    vat_main_t * vam = &vat_main;
    vat_json_node_t *node = NULL;
