...
static void
  vl_api_lisp_get_adjacencies_reply_t_handler
  (vl_api_lisp_get_adjacencies_reply_t * mp)
{
  vat_main_t *vam = &vat_main;
  u32 i, n;
...
static void
  vl_api_lisp_get_adjacencies_reply_t_handler_json
  (vl_api_lisp_get_adjacencies_reply_t * mp)
{
  u8 *s = 0;
  vat_main_t *vam = &vat_main;
...
#define vl_api_lisp_get_adjacencies_reply_t_endian vl_noop_handler
#define vl_api_lisp_get_adjacencies_reply_t_print vl_noop_handler
...
_(LISP_GET_ADJACENCIES_REPLY, lisp_get_adjacencies_reply)               \
...
static int
api_lisp_get_adjacencies (vat_main_t * vam)
{
  unformat_input_t *i = vam->input;
  vl_api_lisp_get_adjacencies_t *mp;
  f64 timeout = ~0;
  u8 vni_set = 0;
  u32 vni = ~0;
  ...
  M (LISP_GET_ADJACENCIES, lisp_get_adjacencies);
  mp->vni = clib_host_to_net_u32 (vni);
...
_(lisp_get_adjacencies, "vni <vni>")                                    \
_(show_lisp_status, "")                                                 \
