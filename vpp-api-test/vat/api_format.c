...
_(LI_ENABLE_DISABLE_REPLY, li_enable_disable_reply)                     \
_(LI_CREATE_REPLY, li_create_reply)                                     \
_(LI_DELETE_REPLY, li_delete_reply)                                     \
...
static int
api_li_enable_disable (vat_main_t * vam)
{
  unformat_input_t *i = vam->input;
  vl_api_li_enable_disable_t *mp;
  f64 timeout;
  ...
  M (LI_ENABLE_DISABLE, li_enable_disable);
...
static int
api_li_create (vat_main_t * vam)
{
  unformat_input_t *i = vam->input;
  vl_api_li_create_t *mp;
  f64 timeout;
  ip4_address_t collector;
  ip4_address_t src;
  u32 tmp;
...
static int
api_li_delete (vat_main_t * vam)
{
  unformat_input_t *i = vam->input;
  vl_api_li_delete_t *mp;
  f64 timeout;
  ip4_address_t collector;
  u32 tmp;
  u16 udp_port = 0;
...
_(li_enable_disable, "src <ip> collector <ip> port <port_num> [del]")   \
_(li_create, "src <ip> collector <ip> port <port_num>")                 \
_(li_delete, "collector <ip> port <port_num>")                          \
_(li_dump, "")                                                          \
