...
external_make_args = $(DPDK_MAKE_ARGS) DPDK_MAKE_EXTRA_ARGS="$(DPDK_MAKE_EXTRA_ARGS)" $(DPDK_CONFIG_ARGS) -C external ebuild-build

external_install =  make $(DPDK_MAKE_ARGS) DPDK_MAKE_EXTRA_ARGS="$(DPDK_MAKE_EXTRA_ARGS)" $(DPDK_CONFIG_ARGS) -C external ebuild-install
