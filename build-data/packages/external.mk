...
ifneq ($(strip $(VPP_PLATFORM)),)
  SUPPORTED_PLATFORMS := octeontx2 neoverse-n1 neoverse-n2 neoverse-v2
  ifneq ($(filter $(VPP_PLATFORM),$(SUPPORTED_PLATFORMS)),)
    ...
    $(warning [VPP WARNING] Currently supported: octeontx2, neoverse-n1, neoverse-n2, neoverse-v2.)
  endif
endif
endif
