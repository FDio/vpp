  ...
  if (mp->enable)
    {
      ...
      ci = vnet_config_add_feature (vm, &rx_cm4u->config_main,
				    ci,
				    vnet_feature_index_from_node_name (VNET_FEAT_IP4_UNICAST, "ip4-vpath-input"),
				    0, 0);
      ...
      ci = vnet_config_add_feature (vm, &rx_cm4m->config_main,
				    ci,
				    vnet_feature_index_from_node_name (VNET_FEAT_IP4_MULTICAST, "ip4-vpath-input"),
				    0, 0);
      ...
      ci = vnet_config_add_feature (vm, &rx_cm6u->config_main,
				    ci,
				    vnet_feature_index_from_node_name (VNET_FEAT_IP6_UNICAST, "ip6-vpath-input"),
				    0, 0);
      ...
      ci = vnet_config_add_feature (vm, &rx_cm6m->config_main,
				    ci,
				    vnet_feature_index_from_node_name (VNET_FEAT_IP6_MULTICAST, "ip6-vpath-input"),
				    0, 0);
