    ...
    vl_api_lisp_add_del_local_eid_t *mp)
{
    ...
    ip_address_set(ip_eid, mp->ip_address, mp->is_ipv6 ? IP6 : IP4);
    ...
    vl_api_lisp_add_del_remote_mapping_t *mp)
{
    ...
    ip_address_set (seid_addr, mp->seid, mp->eid_is_ip4 ? IP4 : IP6);
    ip_address_set (deid_addr, mp->deid, mp->eid_is_ip4 ? IP4 : IP6);
