...
vl_api_sw_interface_set_vpath_t_handler (vl_api_sw_interface_set_vpath_t * mp)
{
  ...
  ip_config_main_t *rx_cm4u = &ip4lm->feature_config_mains[VNET_UNICAST];
  ip_config_main_t *rx_cm4m = &ip4lm->feature_config_mains[VNET_MULTICAST];
  ip_config_main_t *rx_cm6u = &ip6lm->feature_config_mains[VNET_UNICAST];
  ip_config_main_t *rx_cm6m = &ip6lm->feature_config_mains[VNET_MULTICAST];
