...
static void *vl_api_errors_dump_t_print
(vl_api_errors_dump_t * mp, void *handle)
{
    u8 * s;

    s = format (0, "SCRIPT: errors_dump ");

    FINISH;
}

static void *vl_api_error_list_t_print
(vl_api_errors_dump_t * mp, void *handle)
{
    u8 * s;

    s = format (0, "SCRIPT: error_list ");
