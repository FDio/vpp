...
- Link Bonding
  ...
  - Add /if/lacp/<bond-sw_if_index>/<slave-sw_if_index>/partner-state (aa7257863)
...
- Plugins
  ...
  -  builtinurl
    - Initial working attempt (43765e2b4)
  -  DHCP
...
| ------- | ------- |
| [b'8e388390d'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'8e388390d') | vlib: use explicit types in api |
| [b'daa4bff16'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'daa4bff16') | api: memclnt api use string type. |
| [b'7adaa226e'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'7adaa226e') | api: revert use string type for strings in memclnt.api |
| [b'2959d42fe'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'2959d42fe') | api: use string type for strings in memclnt.api |
| [b'e71748291'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'e71748291') | vppapigen: remove support for legacy typedefs |

| @c src/examples/sample-plugin/sample/sample.api ||
| ------- | ------- |
| [b'33a58171e'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'33a58171e') | api: autogenerate api trace print/endian |
...
| ------- | ------- |
| [b'418ebb711'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'418ebb711') | papi: support default for type alias decaying to basetype |
| [b'9485d99bd'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'9485d99bd') | interface: Allow VLAN tag-rewrite on non-sub-interfaces too. |
| [b'c12eae73f'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'c12eae73f') | interface: shmemioerror while getting name_filter arg |
| [b'de312c2d5'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'de312c2d5') | interface: dump the interface device type |
| [b'e0792fdff'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'e0792fdff') | interface: callback to manage extra MAC addresses |
| [b'75761b933'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'75761b933') | api: split vl_api_prefix into two |
| [b'e5ff5a36d'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'e5ff5a36d') | api: enforce vla is last and fixed string type |
| [b'053204ab0'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'053204ab0') | api: Cleanup APIs interface.api |
...
| ------- | ------- |
| [b'c4c4cf506'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'c4c4cf506') | session: move add/del segment msg to mq |
| [b'79f89537c'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'79f89537c') | session: Add certificate store |
| [b'e5ff5a36d'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'e5ff5a36d') | api: enforce vla is last and fixed string type |
| [b'458089bba'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'458089bba') | session: move ctrl messages from bapi to mq |
...
| ------- | ------- |
| [b'692bfc85f'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'692bfc85f') | classify: API cleanup |

| @c src/vnet/l2tp/l2tp.api ||
| ------- | ------- |
| [b'3ae526271'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'3ae526271') | l2: l2tp API cleanup |

| @c src/vnet/gre/gre.api ||
| ------- | ------- |
| [b'5f8f61733'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'5f8f61733') | gre: Multi-point interfaces |
...
| ------- | ------- |
| [b'bf6c5c158'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'bf6c5c158') | feature: API cleanup |
...
| ------- | ------- |
| [b'4b76c58be'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'4b76c58be') | qos: api clenup |
...
| ------- | ------- |
| [b'dbf68c9aa'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'dbf68c9aa') | ipsec: Changes to make ipsec encoder/decoders reusable by the plugins |
| [b'12989b538'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'12989b538') | ipsec: remove dedicated IPSec tunnels |
...
| ------- | ------- |
| [b'2c504f89c'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'2c504f89c') | devices: virtio API cleanup |

| @c src/vnet/bonding/bond.api ||
| ------- | ------- |
| [b'3d1ef873d'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'3d1ef873d') | bonding: API cleanup |
| [b'a1876b84e'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'a1876b84e') | bonding: add weight support for active-backup mode |
...
| ------- | ------- |
| [b'956819afa'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'956819afa') | tcp: api clenup |

| @c src/vnet/cop/cop.api ||
| ------- | ------- |
| [b'aa4438a31'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'aa4438a31') | cop: API cleanup |

| @c src/vnet/ip-neighbor/ip_neighbor.api ||
| ------- | ------- |
| [b'cbe25aab3'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'cbe25aab3') | ip: Protocol Independent IP Neighbors |
...
| ------- | ------- |
| [b'fb27096ee'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'fb27096ee') | vxlan-gbp: api cleanup |
...
| ------- | ------- |
| [b'9534696b4'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'9534696b4') | ipip: Tunnel flags controlling copying data to/from payload/encap |
...
| ------- | ------- |
| [b'4682feb1f'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'4682feb1f') | bfd: API cleanup |
...
| ------- | ------- |
| [b'3eb8f207b'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'3eb8f207b') | mpls: api cleanup |
| [b'75761b933'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'75761b933') | api: split vl_api_prefix into two |
| [b'e71748291'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'e71748291') | vppapigen: remove support for legacy typedefs |
| [b'097fa66b9'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'097fa66b9') | fib: fib api updates |
...
| ------- | ------- |
| [b'f158944cc'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'f158944cc') | ip: trivial typos in docs |
| [b'f72ad93d6'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'f72ad93d6') | ip: punt API cleanup |
| [b'e5ff5a36d'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'e5ff5a36d') | api: enforce vla is last and fixed string type |
...
| ------- | ------- |
| [b'58989a37d'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'58989a37d') | ip: API cleanup |
| [b'cbe25aab3'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'cbe25aab3') | ip: Protocol Independent IP Neighbors |
| [b'668605fc8'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'668605fc8') | ip: use explicit types in api |
| [b'9db6ada77'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'9db6ada77') | fib: Table Replace |
| [b'de34c35fc'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'de34c35fc') | ip: add shallow virtual reassembly functionality |
| [b'75761b933'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'75761b933') | api: split vl_api_prefix into two |
| [b'e71748291'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'e71748291') | vppapigen: remove support for legacy typedefs |
| [b'097fa66b9'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'097fa66b9') | fib: fib api updates |
...
| ------- | ------- |
| [b'f1f5a8a1a'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'f1f5a8a1a') | bier: API cleanup |
| [b'e71748291'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'e71748291') | vppapigen: remove support for legacy typedefs |
| [b'097fa66b9'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'097fa66b9') | fib: fib api updates |
...
| ------- | ------- |
| [b'2f71a8889'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'2f71a8889') | ip: ipfix-export API update |
| [b'21b83e96d'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'21b83e96d') | api: implement ipfix_flush |

| @c src/vnet/gso/gso.api ||
| ------- | ------- |
| [b'29467b534'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'29467b534') | gso: Add gso feature arc |

| @c src/vnet/devices/af_packet/af_packet.api ||
| ------- | ------- |
| [b'97c998c28'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'97c998c28') | docs: devices-- add FEATURES.yaml |
| [b'3b2db9002'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'3b2db9002') | devices: af_packet API cleanup |

| @c src/vnet/devices/virtio/vhost_user.api ||
| ------- | ------- |
| [b'5d4c99f27'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'5d4c99f27') | devices: vhost API cleanup |
...
| ------- | ------- |
| [b'6d4af8918'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'6d4af8918') | virtio: split gso and checksum offload functionality |
| [b'2c504f89c'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'2c504f89c') | devices: virtio API cleanup |
| [b'97c998c28'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'97c998c28') | docs: devices-- add FEATURES.yaml |
...
| ------- | ------- |
| [b'97c998c28'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'97c998c28') | docs: devices-- add FEATURES.yaml |
| [b'df40cb5b5'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'df40cb5b5') | devices: pipe API cleanup |

| @c src/vnet/devices/tap/tapv2.api ||
| ------- | ------- |
| [b'ba0061feb'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'ba0061feb') | tap: split gso and checksum offload functionality |
| [b'5de4fb707'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'5de4fb707') | devices: tap API cleanup |
| [b'44d06916b'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'44d06916b') | tap: Move client registration check to top |
| [b'97c998c28'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'97c998c28') | docs: devices-- add FEATURES.yaml |
...
| ------- | ------- |
| [b'eeb5fb3a5'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'eeb5fb3a5') | sr: add "set sr encaps hop-limit" command |
| [b'e71748291'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'e71748291') | vppapigen: remove support for legacy typedefs |

| @c src/vnet/geneve/geneve.api ||
| ------- | ------- |
| [b'2d3282e17'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'2d3282e17') | geneve: API cleanup |

| @c src/plugins/marvell/pp2/pp2.api ||
| ------- | ------- |
| [b'4a65b910a'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'4a65b910a') | marvell: use explicit types in api |
| [b'859b59133'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'859b59133') | api: Add API support for marvell PP2 plugin |

| @c src/plugins/svs/svs.api ||
| ------- | ------- |
| [b'5e913f374'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'5e913f374') | svs: use explicit types in api |
...
| ------- | ------- |
| [b'b5076cbe1'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'b5076cbe1') | acl: add missing square brackets to vat_help option in acl api |
| [b'709dad304'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'709dad304') | acl: remove api boilerplate |
| [b'bb2e5221a'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'bb2e5221a') | api acl: breakout acl_types.api for reuse by others |
...
| ------- | ------- |
| [b'3ae9f5a90'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'3ae9f5a90') | memif: remove api boilerplate |
| [b'546f955b3'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'546f955b3') | memif: API cleanup |

| @c src/plugins/cdp/cdp.api ||
| ------- | ------- |
| [b'07e557a73'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'07e557a73') | cdp: use explicit types in api |

| @c src/plugins/dhcp/dhcp6_ia_na_client_cp.api ||
| ------- | ------- |
| [b'02bfd641b'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'02bfd641b') | dhcp: Move to plugin |

| @c src/plugins/dhcp/dhcp6_pd_client_cp.api ||
| ------- | ------- |
| [b'd5262831a'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'd5262831a') | dhcp: dhcp6_pd_client_cp API cleanup |
| [b'02bfd641b'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'02bfd641b') | dhcp: Move to plugin |

| @c src/plugins/dhcp/dhcp.api ||
| ------- | ------- |
| [b'6bcc6a455'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'6bcc6a455') | dhcp: fix crash on unicast renewal send |
| [b'02bfd641b'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'02bfd641b') | dhcp: Move to plugin |

| @c src/plugins/avf/avf.api ||
| ------- | ------- |
| [b'a0bf06d74'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'a0bf06d74') | avf: explicit types in api |
| [b'74af6f081'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'74af6f081') | avf: remote api boilerplate |

| @c src/plugins/dpdk/api/dpdk.api ||
| ------- | ------- |
| [b'6d75c20a6'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'6d75c20a6') | dpdk: use explicit types in api |
| [b'025166dc7'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'025166dc7') | dpdk: remove api boilerplate |

| @c src/plugins/builtinurl/builtinurl.api ||
| ------- | ------- |
| [b'43765e2b4'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'43765e2b4') | builtinurl: initial working attempt |

| @c src/plugins/mactime/mactime.api ||
| ------- | ------- |
| [b'7b22df06f'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'7b22df06f') | mactime: update api to use explicit types |
| [b'2c41a61d5'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'2c41a61d5') | mactime: add a "top" command to watch device stats |
| [b'7071952df'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'7071952df') | mactime: remove api boilerplate |
| [b'e71748291'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'e71748291') | vppapigen: remove support for legacy typedefs |
...
| ------- | ------- |
| [b'6aaee8c7c'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'6aaee8c7c') | ikev2: use explicit api types |
| [b'fc7b77db7'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'fc7b77db7') | ikev2: remove api boilerplate |
...
| ------- | ------- |
| [b'38277e407'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'38277e407') | gbp: use explicit types in api |
| [b'e71748291'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'e71748291') | vppapigen: remove support for legacy typedefs |
...
| ------- | ------- |
| [b'b2e463a10'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'b2e463a10') | l2e: use explicit api types |

| @c src/plugins/gtpu/gtpu.api ||
| ------- | ------- |
| [b'55636cb62'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'55636cb62') | gtpu: use explicit types in api |
| [b'49228efce'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'49228efce') | gtpu: remove api boilerplate |

| @c src/plugins/igmp/igmp.api ||
| ------- | ------- |
| [b'4a7fc4cf1'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'4a7fc4cf1') | igmp: use explicit types in api |
| [b'e71748291'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'e71748291') | vppapigen: remove support for legacy typedefs |
...
| ------- | ------- |
| [b'0fa66d618'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'0fa66d618') | ioam: use explicit api types |
...
| ------- | ------- |
| [b'7929f9f5c'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'7929f9f5c') | stn: use explicit types in api |

| @c src/plugins/map/map.api ||
| ------- | ------- |
| [b'be31c2a25'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'be31c2a25') | map: use explicit types in api |
| [b'7b2e9fb1a'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'7b2e9fb1a') | map: use ip6-full-reassembly instead of own code |
| [b'640edcd90'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'640edcd90') | map: use SVR for MAP-T |
| [b'e5ff5a36d'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'e5ff5a36d') | api: enforce vla is last and fixed string type |
| [b'ff47fb645'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'ff47fb645') | vppapigen map: raise ValueError when fieldname is python keyword |
...
| ------- | ------- |
| [b'7ff64fb97'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'7ff64fb97') | oddbuf: remove api boilerplate |
| [b'a287a30dd'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'a287a30dd') | misc: fix coverity warning in the oddbuf plugin |
| [b'c4abafd83'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'c4abafd83') | ip: fix udp/tcp checksum corner cases |

| @c src/plugins/l3xc/l3xc.api ||
| ------- | ------- |
| [b'60f5108a9'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'60f5108a9') | l3xc: use explicit types in api |
| [b'e71748291'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'e71748291') | vppapigen: remove support for legacy typedefs |
| [b'59fa121f8'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'59fa121f8') | L3 cross connect |

| @c src/plugins/pppoe/pppoe.api ||
| ------- | ------- |
| [b'04338e85a'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'04338e85a') | pppoe: use explicit types in api |
| [b'25fe57821'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'25fe57821') | pppoe: remove api boilerplate |

| @c src/plugins/mdata/mdata.api ||
| ------- | ------- |
| [b'd7b306657'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'd7b306657') | mdata: buffer metadata change tracker plugin |

| @c src/plugins/lb/lb.api ||
| ------- | ------- |
| [b'ae0724034'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'ae0724034') | lb: remove api boilerplate |
| [b'33538a150'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'33538a150') | lb: add APIs for set interface nat4 and nat6 |
| [b'75761b933'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'75761b933') | api: split vl_api_prefix into two |
...
| ------- | ------- |
| [b'e06e7c672'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'e06e7c672') | nsim: use explicit api types |
| [b'2e7a43ca4'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'2e7a43ca4') | nsim: remove api boilerplate |
...
| ------- | ------- |
| [b'277f03f06'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'277f03f06') | vmxnet3: use explicit types in api |
| [b'10bbfce02'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'10bbfce02') | vmxnet3: remove api boilerplate |
| [b'2985e0af6'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'2985e0af6') | vmxnet3: per interface gso support |
| [b'e71748291'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'e71748291') | vppapigen: remove support for legacy typedefs |

| @c src/plugins/tlsopenssl/tls_openssl.api ||
| ------- | ------- |
| [b'1e582206a'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'1e582206a') | tls: remove api boilerplate |
| [b'dd0cc9ec3'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'dd0cc9ec3') | tls: some rework based on TLS openssl C API |
| [b'be4d1aa2c'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'be4d1aa2c') | tls: Add C API for TLS openssl to set engine |

| @c src/plugins/abf/abf.api ||
| ------- | ------- |
| [b'bdde58534'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'bdde58534') | abf: use explicit types in api |
| [b'e71748291'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'e71748291') | vppapigen: remove support for legacy typedefs |
| [b'097fa66b9'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'097fa66b9') | fib: fib api updates |

| @c src/plugins/nat/nat.api ||
| ------- | ------- |
| [b'f126e746f'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'f126e746f') | nat: use SVR |
| [b'e5ff5a36d'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'e5ff5a36d') | api: enforce vla is last and fixed string type |
| [b'e71748291'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'e71748291') | vppapigen: remove support for legacy typedefs |
...
| ------- | ------- |
| [b'd8c1ef925'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'd8c1ef925') | rdma: api: prepare support for direct verb |
| [b'b644eb54f'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'b644eb54f') | rdma: add explicit types in api |
| [b'812afe712'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'812afe712') | rdma: add rdma API |
...
| ------- | ------- |
| [b'd4efce2e0'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'd4efce2e0') | ct6: use explicit type in api |
| [b'ee98904e0'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'ee98904e0') | ct6: remove api boilerplate |

| @c src/plugins/nsh/nsh.api ||
| ------- | ------- |
| [b'd3f0a4869'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'd3f0a4869') | nsh: use explicit api types |

| @c src/plugins/flowprobe/flowprobe.api ||
| ------- | ------- |
| [b'3013e6988'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'3013e6988') | flowprobe: use explicit types in api |
| [b'2a1ca787b'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'2a1ca787b') | api: split api generated files |

| @c src/plugins/lacp/lacp.api ||
| ------- | ------- |
| [b'ebef4a9e5'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'ebef4a9e5') | lacp: use explit api types |

| @c src/plugins/dns/dns.api ||
| ------- | ------- |
| [b'b922f16ba'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'b922f16ba') | dns: remove api boilerplate |
| [b'34af0ccf5'](https://gerrit.fd.io/r/gitweb?p=vpp.git;a=commit;h=b'34af0ccf5') | dns: make the dns name resolver a plugin |
