...
@page release_notes_19081 Release notes for VPP 19.04.1
...
The same does the client side C language binding, whiel other language bindings have their own encoder/decoders.
...
and not supported at all well in VAPI.
