...
- svm
  ...
  - support addition of chunks to fifos
- vppinfra
...
- vhost: GSO support
- virtio
  - Add GSO support for native virtio driver
...
- tcp
  ...
  - Nodes without full 6-tuple lookup for TCP proxy support
  - More connection statistics
...
- session
  - Ability to get endpoint in transport vft
