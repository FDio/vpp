...
{
  void
  handle_interface_stat (const interface &itf)
  {
  }
  void
  handle_interface_event (std::vector<VOM::interface::event> events)
  {
  }
};
...
public:
  ...
  is_empty ()
  {
    return ((0 == m_exp_queue.size ()) && (0 == m_act_queue.size ()));
  }
	...
	while (it_exp != m_exp_queue.end ())
	  {
		...
		if (typeid (*f_exp) ==
		    typeid (interface_cmds::af_packet_create_cmd))
		  {
		    rc = handle_derived<interface_cmds::af_packet_create_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (interface_cmds::loopback_create_cmd))
		  {
		    rc = handle_derived<interface_cmds::loopback_create_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (interface_cmds::bvi_create_cmd))
		  {
		    rc = handle_derived<interface_cmds::bvi_create_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (interface_cmds::vhost_create_cmd))
		  {
		    rc = handle_derived<interface_cmds::vhost_create_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (bond_interface_cmds::create_cmd))
		  {
		    rc = handle_derived<bond_interface_cmds::create_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (interface_cmds::loopback_delete_cmd))
		  {
		    rc = handle_derived<interface_cmds::loopback_delete_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (interface_cmds::bvi_delete_cmd))
		  {
		    rc = handle_derived<interface_cmds::bvi_delete_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (interface_cmds::af_packet_delete_cmd))
		  {
		    rc = handle_derived<interface_cmds::af_packet_delete_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (interface_cmds::vhost_delete_cmd))
		  {
		    rc = handle_derived<interface_cmds::vhost_delete_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (bond_interface_cmds::delete_cmd))
		  {
		    rc = handle_derived<bond_interface_cmds::delete_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (interface_cmds::state_change_cmd))
		  {
		    rc = handle_derived<interface_cmds::state_change_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (interface_cmds::set_table_cmd))
		  {
		    rc = handle_derived<interface_cmds::set_table_cmd> (f_exp,
									f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (interface_cmds::set_mac_cmd))
		  {
		    rc = handle_derived<interface_cmds::set_mac_cmd> (f_exp,
								      f_act);
		  }
		else if (typeid (*f_exp) == typeid (interface_cmds::set_tag))
		  {
		    rc =
		      handle_derived<interface_cmds::set_tag> (f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (bond_group_binding_cmds::bind_cmd))
		  {
		    rc = handle_derived<bond_group_binding_cmds::bind_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (bond_group_binding_cmds::unbind_cmd))
		  {
		    rc = handle_derived<bond_group_binding_cmds::unbind_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (route_domain_cmds::create_cmd))
		  {
		    rc = handle_derived<route_domain_cmds::create_cmd> (f_exp,
									f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (route_domain_cmds::delete_cmd))
		  {
		    rc = handle_derived<route_domain_cmds::delete_cmd> (f_exp,
									f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (route::ip_route_cmds::update_cmd))
		  {
		    rc = handle_derived<route::ip_route_cmds::update_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (route::ip_route_cmds::delete_cmd))
		  {
		    rc = handle_derived<route::ip_route_cmds::delete_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (route::ip_mroute_cmds::update_cmd))
		  {
		    rc = handle_derived<route::ip_mroute_cmds::update_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (route::ip_mroute_cmds::delete_cmd))
		  {
		    rc = handle_derived<route::ip_mroute_cmds::delete_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (neighbour_cmds::create_cmd))
		  {
		    rc = handle_derived<neighbour_cmds::create_cmd> (f_exp,
								     f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (neighbour_cmds::delete_cmd))
		  {
		    rc = handle_derived<neighbour_cmds::delete_cmd> (f_exp,
								     f_act);
		  }
		else if (typeid (*f_exp) == typeid (l3_binding_cmds::bind_cmd))
		  {
		    rc =
		      handle_derived<l3_binding_cmds::bind_cmd> (f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (l3_binding_cmds::unbind_cmd))
		  {
		    rc = handle_derived<l3_binding_cmds::unbind_cmd> (f_exp,
								      f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (bridge_domain_cmds::create_cmd))
		  {
		    rc = handle_derived<bridge_domain_cmds::create_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (bridge_domain_cmds::delete_cmd))
		  {
		    rc = handle_derived<bridge_domain_cmds::delete_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (bridge_domain_entry_cmds::create_cmd))
		  {
		    rc = handle_derived<bridge_domain_entry_cmds::create_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (bridge_domain_entry_cmds::delete_cmd))
		  {
		    rc = handle_derived<bridge_domain_entry_cmds::delete_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (bridge_domain_arp_entry_cmds::create_cmd))
		  {
		    rc = handle_derived<
		      bridge_domain_arp_entry_cmds::create_cmd> (f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (bridge_domain_arp_entry_cmds::delete_cmd))
		  {
		    rc = handle_derived<
		      bridge_domain_arp_entry_cmds::delete_cmd> (f_exp, f_act);
		  }
		else if (typeid (*f_exp) == typeid (l2_binding_cmds::bind_cmd))
		  {
		    rc =
		      handle_derived<l2_binding_cmds::bind_cmd> (f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (l2_binding_cmds::unbind_cmd))
		  {
		    rc = handle_derived<l2_binding_cmds::unbind_cmd> (f_exp,
								      f_act);
		  }
		else if (typeid (*f_exp) == typeid (l2_vtr_cmds::set_cmd))
		  {
		    rc = handle_derived<l2_vtr_cmds::set_cmd> (f_exp, f_act);
			 ...
			 typeid (l2_xconnect_cmds::bind_cmd))
		  {
		    rc = handle_derived<l2_xconnect_cmds::bind_cmd> (f_exp,
								     f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (l2_xconnect_cmds::unbind_cmd))
		  {
		    rc = handle_derived<l2_xconnect_cmds::unbind_cmd> (f_exp,
								       f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (vxlan_tunnel_cmds::create_cmd))
		  {
		    rc = handle_derived<vxlan_tunnel_cmds::create_cmd> (f_exp,
									f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (vxlan_tunnel_cmds::delete_cmd))
		  {
		    rc = handle_derived<vxlan_tunnel_cmds::delete_cmd> (f_exp,
									f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (sub_interface_cmds::create_cmd))
		  {
		    rc = handle_derived<sub_interface_cmds::create_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (sub_interface_cmds::delete_cmd))
		  {
		    rc = handle_derived<sub_interface_cmds::delete_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (ACL::acl_ethertype_cmds::bind_cmd))
		  {
		    rc = handle_derived<ACL::acl_ethertype_cmds::bind_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (ACL::acl_ethertype_cmds::unbind_cmd))
		  {
		    rc = handle_derived<ACL::acl_ethertype_cmds::unbind_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (ACL::list_cmds::l3_update_cmd))
		  {
		    rc = handle_derived<ACL::list_cmds::l3_update_cmd> (f_exp,
									f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (ACL::list_cmds::l3_delete_cmd))
		  {
		    rc = handle_derived<ACL::list_cmds::l3_delete_cmd> (f_exp,
									f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (ACL::binding_cmds::l3_bind_cmd))
		  {
		    rc = handle_derived<ACL::binding_cmds::l3_bind_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (ACL::binding_cmds::l3_unbind_cmd))
		  {
		    rc = handle_derived<ACL::binding_cmds::l3_unbind_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (ACL::list_cmds::l2_update_cmd))
		  {
		    rc = handle_derived<ACL::list_cmds::l2_update_cmd> (f_exp,
									f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (ACL::list_cmds::l2_delete_cmd))
		  {
		    rc = handle_derived<ACL::list_cmds::l2_delete_cmd> (f_exp,
									f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (ACL::binding_cmds::l2_bind_cmd))
		  {
		    rc = handle_derived<ACL::binding_cmds::l2_bind_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (ACL::binding_cmds::l2_unbind_cmd))
		  {
		    rc = handle_derived<ACL::binding_cmds::l2_unbind_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (arp_proxy_binding_cmds::bind_cmd))
		  {
		    rc = handle_derived<arp_proxy_binding_cmds::bind_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (arp_proxy_binding_cmds::unbind_cmd))
		  {
		    rc = handle_derived<arp_proxy_binding_cmds::unbind_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (arp_proxy_config_cmds::config_cmd))
		  {
		    rc = handle_derived<arp_proxy_config_cmds::config_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (arp_proxy_config_cmds::unconfig_cmd))
		  {
		    rc = handle_derived<arp_proxy_config_cmds::unconfig_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (igmp_binding_cmds::bind_cmd))
		  {
		    rc = handle_derived<igmp_binding_cmds::bind_cmd> (f_exp,
								      f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (igmp_binding_cmds::unbind_cmd))
		  {
		    rc = handle_derived<igmp_binding_cmds::unbind_cmd> (f_exp,
									f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (igmp_listen_cmds::listen_cmd))
		  {
		    rc = handle_derived<igmp_listen_cmds::listen_cmd> (f_exp,
								       f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (igmp_listen_cmds::unlisten_cmd))
		  {
		    rc = handle_derived<igmp_listen_cmds::unlisten_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (ip_punt_redirect_cmds::config_cmd))
		  {
		    rc = handle_derived<ip_punt_redirect_cmds::config_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (ip_punt_redirect_cmds::unconfig_cmd))
		  {
		    rc = handle_derived<ip_punt_redirect_cmds::unconfig_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (ip_unnumbered_cmds::config_cmd))
		  {
		    rc = handle_derived<ip_unnumbered_cmds::config_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (ip_unnumbered_cmds::unconfig_cmd))
		  {
		    rc = handle_derived<ip_unnumbered_cmds::unconfig_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (ip6nd_ra_config::config_cmd))
		  {
		    rc = handle_derived<ip6nd_ra_config::config_cmd> (f_exp,
								      f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (ip6nd_ra_config::unconfig_cmd))
		  {
		    rc = handle_derived<ip6nd_ra_config::unconfig_cmd> (f_exp,
									f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (ip6nd_ra_prefix::config_cmd))
		  {
		    rc = handle_derived<ip6nd_ra_prefix::config_cmd> (f_exp,
								      f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (ip6nd_ra_prefix::unconfig_cmd))
		  {
		    rc = handle_derived<ip6nd_ra_prefix::unconfig_cmd> (f_exp,
									f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (interface_span_cmds::config_cmd))
		  {
		    rc = handle_derived<interface_span_cmds::config_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (interface_span_cmds::unconfig_cmd))
		  {
		    rc = handle_derived<interface_span_cmds::unconfig_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (nat_static_cmds::create_44_cmd))
		  {
		    rc = handle_derived<nat_static_cmds::create_44_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (nat_static_cmds::delete_44_cmd))
		  {
		    rc = handle_derived<nat_static_cmds::delete_44_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (nat_binding_cmds::bind_44_input_cmd))
		  {
		    rc = handle_derived<nat_binding_cmds::bind_44_input_cmd> (
		      f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (nat_binding_cmds::unbind_44_input_cmd))
		  {
		    rc =
		      handle_derived<nat_binding_cmds::unbind_44_input_cmd> (
			f_exp, f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (interface_cmds::events_cmd))
		  {
		    rc = handle_derived<interface_cmds::events_cmd> (f_exp,
								     f_act);
		  }
		...
		else if (typeid (*f_exp) == typeid (pipe_cmds::delete_cmd))
		  {
		    rc = handle_derived<pipe_cmds::delete_cmd> (f_exp, f_act);
			 ...
			 typeid (QoS::mark_cmds::create_cmd))
		  {
		    rc = handle_derived<QoS::mark_cmds::create_cmd> (f_exp,
								     f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (QoS::mark_cmds::delete_cmd))
		  {
		    rc = handle_derived<QoS::mark_cmds::delete_cmd> (f_exp,
								     f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (QoS::record_cmds::create_cmd))
		  {
		    rc = handle_derived<QoS::record_cmds::create_cmd> (f_exp,
								       f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (QoS::record_cmds::delete_cmd))
		  {
		    rc = handle_derived<QoS::record_cmds::delete_cmd> (f_exp,
								       f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (QoS::store_cmds::create_cmd))
		  {
		    rc = handle_derived<QoS::store_cmds::create_cmd> (f_exp,
								      f_act);
		  }
		else if (typeid (*f_exp) ==
			 typeid (QoS::store_cmds::delete_cmd))
		  {
		    rc = handle_derived<QoS::store_cmds::delete_cmd> (f_exp,
								      f_act);
		  }
		else if (typeid (*f_exp) == typeid (QoS::map_cmds::create_cmd))
		  {
		    rc =
		      handle_derived<QoS::map_cmds::create_cmd> (f_exp, f_act);
		  }
		else if (typeid (*f_exp) == typeid (QoS::map_cmds::delete_cmd))
		  {
		    rc =
		      handle_derived<QoS::map_cmds::delete_cmd> (f_exp, f_act);
		  }
		else
		  {
...
private:
  template <typename T>
  rc_t
  handle_derived (const cmd *f_exp, cmd *f_act)
  {
    const T *i_exp;
    T *i_act;
...
public:
  ...
  VppInit () : name ("vpp-ut"), f (new MockCmdQ ())
  {
    HW::init (f);
    OM::init ();
...
#define ADD_EXPECT(stmt) vi.f->expect (new stmt)

#define STRICT_ORDER_OFF() vi.f->strict_order (false)
...
BOOST_AUTO_TEST_CASE (test_interface)
{
  ...
  interface itf1 (itf1_name, interface::type_t::AFPACKET,
  ...
  HW::item<interface::admin_state_t> hw_as_down (
    interface::admin_state_t::DOWN, rc_t::OK);
   ...
   */
  interface itf1b (itf1_name, interface::type_t::AFPACKET,
  ...
  interface itf2 (itf2_name, interface::type_t::AFPACKET,
		  interface::admin_state_t::UP, itf2_tag);
  ...
  interface itf3 (itf3_name, interface::type_t::VHOST,
		  interface::admin_state_t::UP, itf3_tag);
...
BOOST_AUTO_TEST_CASE (test_bvi)
{
  ...
  interface itf (bvi_name, interface::type_t::BVI,
		 interface::admin_state_t::UP);
  ...
  interface itf_new_mac (bvi_name, interface::type_t::BVI,
			 interface::admin_state_t::UP);
  ...
  interface itf_new_mac2 (bvi_name, interface::type_t::BVI,
			  interface::admin_state_t::UP);
  ...
  delete l3;
  ADD_EXPECT (
    l3_binding_cmds::unbind_cmd (hw_l3_unbind, hw_ifh.data (), pfx_10));
  ADD_EXPECT (interface_cmds::state_change_cmd (hw_as_down, hw_ifh));
  ...
  ADD_EXPECT (
    route_domain_cmds::create_cmd (hw_rd4_create, l3_proto_t::IPV4, 1));
  ADD_EXPECT (
    route_domain_cmds::create_cmd (hw_rd6_create, l3_proto_t::IPV6, 1));
  TRY_CHECK_RC (OM::write (graham, rd));

  const std::string bvi2_name = "bvi2";
  interface *itf2 = new interface (bvi2_name, interface::type_t::BVI,
  ...
  ADD_EXPECT (interface_cmds::state_change_cmd (hw_as_up, hw_ifh2));
  ADD_EXPECT (
    interface_cmds::set_table_cmd (hw_rd4_bind, l3_proto_t::IPV4, hw_ifh2));
  ADD_EXPECT (
    interface_cmds::set_table_cmd (hw_rd6_bind, l3_proto_t::IPV6, hw_ifh2));
  ...
  ADD_EXPECT (
    l3_binding_cmds::unbind_cmd (hw_l3_unbind, hw_ifh2.data (), pfx_10));
  ADD_EXPECT (
    interface_cmds::set_table_cmd (hw_rd4_unbind, l3_proto_t::IPV4, hw_ifh2));
  ADD_EXPECT (
    interface_cmds::set_table_cmd (hw_rd6_unbind, l3_proto_t::IPV6, hw_ifh2));
  ADD_EXPECT (interface_cmds::state_change_cmd (hw_as_down, hw_ifh2));
  ADD_EXPECT (interface_cmds::bvi_delete_cmd (hw_ifh2));
  ADD_EXPECT (
    route_domain_cmds::delete_cmd (hw_rd4_delete, l3_proto_t::IPV4, 1));
  ADD_EXPECT (
    route_domain_cmds::delete_cmd (hw_rd6_delete, l3_proto_t::IPV6, 1));
...
BOOST_AUTO_TEST_CASE (test_bond)
{
  ...
  ADD_EXPECT (bond_interface_cmds::create_cmd (
    hw_ifh3, bond_name, bond_interface::mode_t::LACP, bond_interface::lb_t::L2,
    l2_address_t::ZERO));
  ADD_EXPECT (interface_cmds::state_change_cmd (hw_as_up, hw_ifh3));
  ...
  ADD_EXPECT (
    bond_group_binding_cmds::bind_cmd (bond_hw_bind, hw_ifh3.data (), *bm1));
  ADD_EXPECT (
    bond_group_binding_cmds::bind_cmd (bond_hw_bind, hw_ifh3.data (), *bm2));
  ...
  HW::item<interface::admin_state_t> hw_as_down (
    interface::admin_state_t::DOWN, rc_t::OK);
  ADD_EXPECT (
    bond_group_binding_cmds::unbind_cmd (bond_hw_bind, hw_ifh.data ()));
  ADD_EXPECT (
    bond_group_binding_cmds::unbind_cmd (bond_hw_bind, hw_ifh2.data ()));
  ADD_EXPECT (interface_cmds::state_change_cmd (hw_as_down, hw_ifh2));
  ADD_EXPECT (interface_cmds::af_packet_delete_cmd (hw_ifh2, itf2_name));
  ADD_EXPECT (interface_cmds::state_change_cmd (hw_as_down, hw_ifh3));
...
BOOST_AUTO_TEST_CASE (test_bridge)
{
  ...
  ADD_EXPECT (bridge_domain_cmds::create_cmd (
    hw_bd, bridge_domain::learning_mode_t::ON,
    bridge_domain::arp_term_mode_t::ON, bridge_domain::arp_ufwd_mode_t::ON,
    bridge_domain::flood_mode_t::ON, bridge_domain::uu_flood_mode_t::ON,
  ...
  ADD_EXPECT (l2_binding_cmds::bind_cmd (
    hw_l2_bind, hw_ifh.data (), hw_bd.data (),
  ...
  ADD_EXPECT (l2_binding_cmds::bind_cmd (
    hw_l2_bind, hw_ifh2.data (), hw_bd.data (),
    l2_binding::l2_port_type_t::L2_PORT_TYPE_NORMAL));
  ...
  ADD_EXPECT (bridge_domain_entry_cmds::create_cmd (hw_be1, mac1, bd1.id (),
						    hw_ifh2.data (), false));
  ...
  boost::asio::ip::address ip1 =
    boost::asio::ip::address::from_string ("10.10.10.10");

  bridge_domain_arp_entry *bea1 = new bridge_domain_arp_entry (bd1, ip1, mac1);
  ADD_EXPECT (
    bridge_domain_arp_entry_cmds::create_cmd (hw_be1, bd1.id (), mac1, ip1));
  ...
  HW::item<interface::admin_state_t> hw_as_down (
    interface::admin_state_t::DOWN, rc_t::OK);
  ADD_EXPECT (l2_binding_cmds::unbind_cmd (
    hw_l2_bind, hw_ifh.data (), hw_bd.data (),
    l2_binding::l2_port_type_t::L2_PORT_TYPE_NORMAL));
  ADD_EXPECT (interface_cmds::state_change_cmd (hw_as_down, hw_ifh));
  ADD_EXPECT (interface_cmds::af_packet_delete_cmd (hw_ifh, itf1_name));
  ...
  STRICT_ORDER_OFF ();
  ADD_EXPECT (
    bridge_domain_arp_entry_cmds::delete_cmd (hw_be1, bd1.id (), mac1, ip1));
  ADD_EXPECT (
    bridge_domain_entry_cmds::delete_cmd (hw_be1, mac1, bd1.id (), false));
  ADD_EXPECT (l2_binding_cmds::unbind_cmd (
    hw_l2_bind, hw_ifh2.data (), hw_bd.data (),
    l2_binding::l2_port_type_t::L2_PORT_TYPE_NORMAL));
  ...
  ADD_EXPECT (bridge_domain_cmds::create_cmd (
    hw_bd2, bridge_domain::learning_mode_t::ON,
    bridge_domain::arp_term_mode_t::ON, bridge_domain::arp_ufwd_mode_t::ON,
    bridge_domain::flood_mode_t::ON, bridge_domain::uu_flood_mode_t::ON,
    bridge_domain::mac_age_mode_t::OFF));
  ...
  interface itf3 (itf3_name, interface::type_t::BVI,
		  interface::admin_state_t::UP);
  ...
  ADD_EXPECT (
    l2_binding_cmds::bind_cmd (hw_l2_bind, hw_ifh3.data (), hw_bd2.data (),
  ...
  ADD_EXPECT (bridge_domain_entry_cmds::create_cmd (hw_be2, mac2, bd2.id (),
						    hw_ifh3.data (), true));
  ...
  STRICT_ORDER_OFF ();
  ADD_EXPECT (l2_binding_cmds::unbind_cmd (
    hw_l2_bind, hw_ifh3.data (), hw_bd2.data (),
    l2_binding::l2_port_type_t::L2_PORT_TYPE_BVI));
  ADD_EXPECT (
    bridge_domain_entry_cmds::delete_cmd (hw_be2, mac2, bd2.id (), true));
  ADD_EXPECT (interface_cmds::state_change_cmd (hw_as_down, hw_ifh3));
...
BOOST_AUTO_TEST_CASE (test_l2_xconnect)
{
  ...
  ADD_EXPECT (l2_xconnect_cmds::bind_cmd (xconnect_east, hw_ifh.data (),
					  hw_ifh2.data ()));
  ADD_EXPECT (l2_xconnect_cmds::bind_cmd (xconnect_west, hw_ifh2.data (),
					  hw_ifh.data ()));
  ...
  HW::item<interface::admin_state_t> hw_as_down (
    interface::admin_state_t::DOWN, rc_t::OK);
  STRICT_ORDER_OFF ();
  ADD_EXPECT (l2_xconnect_cmds::unbind_cmd (xconnect_east_unbind,
					    hw_ifh.data (), hw_ifh2.data ()));
  ADD_EXPECT (l2_xconnect_cmds::unbind_cmd (xconnect_west_unbind,
					    hw_ifh2.data (), hw_ifh.data ()));
  ADD_EXPECT (interface_cmds::state_change_cmd (hw_as_down, hw_ifh2));
  ADD_EXPECT (interface_cmds::af_packet_delete_cmd (hw_ifh2, itf2_name));
  ADD_EXPECT (interface_cmds::state_change_cmd (hw_as_down, hw_ifh));
  ADD_EXPECT (interface_cmds::af_packet_delete_cmd (hw_ifh, itf1_name));
...
BOOST_AUTO_TEST_CASE (test_vxlan)
{
  ...
  // VXLAN create
  vxlan_tunnel::endpoint_t ep (
    boost::asio::ip::address::from_string ("10.10.10.10"),
    boost::asio::ip::address::from_string ("10.10.10.11"), 322);
  ...
  // bridge-domain create
  bridge_domain bd1 (
    33, bridge_domain::learning_mode_t::OFF,
    bridge_domain::arp_term_mode_t::OFF, bridge_domain::arp_ufwd_mode_t::OFF,
    bridge_domain::flood_mode_t::OFF, bridge_domain::uu_flood_mode_t::OFF,
    bridge_domain::mac_age_mode_t::ON);

  HW::item<uint32_t> hw_bd (33, rc_t::OK);
  ADD_EXPECT (bridge_domain_cmds::create_cmd (
    hw_bd, bridge_domain::learning_mode_t::OFF,
    bridge_domain::arp_term_mode_t::OFF, bridge_domain::arp_ufwd_mode_t::OFF,
    bridge_domain::flood_mode_t::OFF, bridge_domain::uu_flood_mode_t::OFF,
    bridge_domain::mac_age_mode_t::ON));
  ...
  ADD_EXPECT (l2_binding_cmds::bind_cmd (
    hw_l2_bind, hw_vxt.data (), hw_bd.data (),
    l2_binding::l2_port_type_t::L2_PORT_TYPE_NORMAL));
  TRY_CHECK_RC (OM::write (franz, *l2itf));
...
BOOST_AUTO_TEST_CASE (test_vlan)
{
  ...
  sub_interface *vl33 =
    new sub_interface (itf1, interface::admin_state_t::UP, 33);

  HW::item<handle_t> hw_vl33 (3, rc_t::OK);
  ADD_EXPECT (sub_interface_cmds::create_cmd (hw_vl33, itf1_name + ".33",
					      hw_ifh.data (), 33));
...
BOOST_AUTO_TEST_CASE (test_acl)
{
  ...
  ADD_EXPECT (
    ACL::acl_ethertype_cmds::bind_cmd (ae_binding, hw_ifh.data (), l_e));
  ...
  ACL::l3_rule r2 (20, ACL::action_t::DENY, route::prefix_t::ZERO,
		   route::prefix_t::ZERO);
  ...
  ACL::l3_rule r3 (30, ACL::action_t::PERMIT, route::prefix_t::ZERO,
		   route::prefix_t::ZERO);
  ...
  ADD_EXPECT (
    ACL::list_cmds::l2_update_cmd (l2_hw_acl, l2_acl_name, l2_rules));
  TRY_CHECK_RC (OM::write (leo, l2_acl));

  ACL::l2_binding *l2b =
    new ACL::l2_binding (direction_t::OUTPUT, itf1, l2_acl);
  HW::item<bool> l2_hw_binding (true, rc_t::OK);
  ADD_EXPECT (ACL::binding_cmds::l2_bind_cmd (
    l2_hw_binding, direction_t::OUTPUT, hw_ifh.data (), l2_hw_acl.data ()));
  TRY_CHECK_RC (OM::write (leo, *l2b));

  delete l2b;
  ADD_EXPECT (ACL::binding_cmds::l2_unbind_cmd (
    l2_hw_binding, direction_t::OUTPUT, hw_ifh.data (), l2_hw_acl.data ()));
  ...
  HW::item<interface::admin_state_t> hw_as_down (
    interface::admin_state_t::DOWN, rc_t::OK);
  STRICT_ORDER_OFF ();
  ADD_EXPECT (ACL::binding_cmds::l3_unbind_cmd (
    hw_binding, direction_t::INPUT, hw_ifh.data (), hw_acl.data ()));
  ADD_EXPECT (ACL::list_cmds::l3_delete_cmd (hw_acl));
  ADD_EXPECT (
    ACL::acl_ethertype_cmds::unbind_cmd (ae_binding, hw_ifh.data ()));
  ADD_EXPECT (interface_cmds::state_change_cmd (hw_as_down, hw_ifh));
  ADD_EXPECT (interface_cmds::af_packet_delete_cmd (hw_ifh, itf1_name));
...
BOOST_AUTO_TEST_CASE (test_igmp)
{
  ...
  boost::asio::ip::address_v4 gaddr =
    boost::asio::ip::address_v4::from_string ("232.0.0.1");
  boost::asio::ip::address_v4 saddr1 =
    boost::asio::ip::address_v4::from_string ("192.168.0.20");
  boost::asio::ip::address_v4 saddr2 =
    boost::asio::ip::address_v4::from_string ("192.168.0.30");

  std::string itf3_name = "host3";
  interface itf3 (itf3_name, interface::type_t::AFPACKET,
		  interface::admin_state_t::UP);
  HW::item<handle_t> hw_ifh (2, rc_t::OK);
  HW::item<interface::admin_state_t> hw_as_up (interface::admin_state_t::UP,
					       rc_t::OK);
  ...
  ADD_EXPECT (igmp_listen_cmds::listen_cmd (hw_as_listen, hw_ifh.data (),
					    gaddr, saddrs));
  ...
  STRICT_ORDER_OFF ();
  ADD_EXPECT (
    igmp_listen_cmds::unlisten_cmd (hw_as_listen, hw_ifh.data (), gaddr));
...
BOOST_AUTO_TEST_CASE (test_ip_punt_redirect)
{
  ...
  boost::asio::ip::address addr =
    boost::asio::ip::address::from_string ("192.168.0.20");
  ...
  ADD_EXPECT (ip_punt_redirect_cmds::config_cmd (hw_ip_cfg, hw_ifh2.data (),
						 hw_ifh.data (), addr));
  ...
  HW::item<interface::admin_state_t> hw_as_down (
    interface::admin_state_t::DOWN, rc_t::OK);
  STRICT_ORDER_OFF ();
  ADD_EXPECT (ip_punt_redirect_cmds::unconfig_cmd (
    hw_ip_uncfg, hw_ifh2.data (), hw_ifh.data (), addr));
  ADD_EXPECT (interface_cmds::state_change_cmd (hw_as_down, hw_ifh));
  ADD_EXPECT (interface_cmds::af_packet_delete_cmd (hw_ifh, itf1_name));
  ADD_EXPECT (interface_cmds::state_change_cmd (hw_as_down, hw_ifh2));
  ADD_EXPECT (interface_cmds::af_packet_delete_cmd (hw_ifh2, itf2_name));
...
BOOST_AUTO_TEST_CASE (test_ip_unnumbered)
{
  ...
  HW::item<bool> hw_ip_cfg (true, rc_t::OK);
  HW::item<bool> hw_ip_uncfg (false, rc_t::OK);
  ADD_EXPECT (ip_unnumbered_cmds::config_cmd (hw_ip_cfg, hw_ifh2.data (),
					      hw_ifh.data ()));
  ...
  HW::item<interface::admin_state_t> hw_as_down (
    interface::admin_state_t::DOWN, rc_t::OK);
  STRICT_ORDER_OFF ();
  ADD_EXPECT (ip_unnumbered_cmds::unconfig_cmd (hw_ip_uncfg, hw_ifh2.data (),
						hw_ifh.data ()));
  ADD_EXPECT (
    l3_binding_cmds::unbind_cmd (hw_l3_unbind, hw_ifh.data (), pfx_10));
  ADD_EXPECT (interface_cmds::state_change_cmd (hw_as_down, hw_ifh2));
...
BOOST_AUTO_TEST_CASE (test_ip6nd)
{
  ...
  interface itf (itf_name, interface::type_t::AFPACKET,
		 interface::admin_state_t::UP);
  HW::item<handle_t> hw_ifh (3, rc_t::OK);
  HW::item<interface::admin_state_t> hw_as_up (interface::admin_state_t::UP,
					       rc_t::OK);
  ...
  ADD_EXPECT (ip6nd_ra_config::config_cmd (hw_ip6nd_ra_config_config,
					   hw_ifh.data (), ra));
  ...
  ADD_EXPECT (ip6nd_ra_prefix::config_cmd (hw_ip6nd_ra_prefix_config,
					   hw_ifh.data (), ra_pfx));
  TRY_CHECK_RC (OM::write (paulo, *ip6pfx));

  delete ip6pfx;

  ADD_EXPECT (ip6nd_ra_prefix::unconfig_cmd (hw_ip6nd_ra_prefix_unconfig,
					     hw_ifh.data (), ra_pfx));
  ...
  STRICT_ORDER_OFF ();
  ADD_EXPECT (ip6nd_ra_config::unconfig_cmd (hw_ip6nd_ra_config_unconfig,
					     hw_ifh.data (), ra));
  ADD_EXPECT (
    l3_binding_cmds::unbind_cmd (hw_l3_unbind, hw_ifh.data (), pfx_10));
  ADD_EXPECT (interface_cmds::state_change_cmd (hw_as_down, hw_ifh));
...
BOOST_AUTO_TEST_CASE (test_interface_span)
{
  ...
  HW::item<handle_t> hw_ifh2 (4, rc_t::OK);
  HW::item<interface::admin_state_t> hw_as_up2 (interface::admin_state_t::UP,
						rc_t::OK);
  ...
  interface_span *itf_span =
    new interface_span (itf1, itf2, interface_span::state_t::TX_RX_ENABLED);
  HW::item<bool> hw_is_cfg (true, rc_t::OK);
  HW::item<bool> hw_is_uncfg (true, rc_t::OK);
  ADD_EXPECT (interface_span_cmds::config_cmd (
    hw_is_cfg, hw_ifh.data (), hw_ifh2.data (),
    interface_span::state_t::TX_RX_ENABLED));
  TRY_CHECK_RC (OM::write (elif, *itf_span));

  HW::item<interface::admin_state_t> hw_as_down (
    interface::admin_state_t::DOWN, rc_t::OK);
  HW::item<interface::admin_state_t> hw_as_down2 (
    interface::admin_state_t::DOWN, rc_t::OK);

  delete itf_span;
  STRICT_ORDER_OFF ();
  ADD_EXPECT (interface_span_cmds::unconfig_cmd (hw_is_uncfg, hw_ifh.data (),
						 hw_ifh2.data ()));
  ADD_EXPECT (interface_cmds::state_change_cmd (hw_as_down, hw_ifh));
  ADD_EXPECT (interface_cmds::af_packet_delete_cmd (hw_ifh, itf1_name));
...
BOOST_AUTO_TEST_CASE (test_routing)
{
  ...
  interface *itf2 = new interface (itf2_name, interface::type_t::AFPACKET,
				   interface::admin_state_t::UP, rd4);
  ...
  ADD_EXPECT (
    l3_binding_cmds::bind_cmd (hw_l3_10_bind, hw_ifh.data (), pfx_10));
  ...
  ADD_EXPECT (
    l3_binding_cmds::bind_cmd (hw_l3_11_bind, hw_ifh2.data (), pfx_11));
  ...
  boost::asio::ip::address nh_9 =
    boost::asio::ip::address::from_string ("10.10.10.9");
  route::path *path_9 = new route::path (nh_9, itf1);
  boost::asio::ip::address nh_10 =
  ...
  ADD_EXPECT (
    route::ip_route_cmds::update_cmd (hw_route_5, 0, pfx_5, pl_9_10));
   ...
   */
  boost::asio::ip::address nh_11 =
    boost::asio::ip::address::from_string ("11.11.11.10");
  route::path *path_11 = new route::path (nh_11, *itf2);
  boost::asio::ip::address nh_12 =
    boost::asio::ip::address::from_string ("11.11.11.12");
  ...
  ADD_EXPECT (
    route::ip_route_cmds::update_cmd (hw_route_5_2, 1, pfx_5, pl_11));
  TRY_CHECK_RC (OM::write (ian, *route_5_2));

  route::path_list_t pl_11_12 = { *path_11, *path_12 };
  route_5_2->add (*path_12);
  ADD_EXPECT (
    route::ip_route_cmds::update_cmd (hw_route_5_2, 1, pfx_5, pl_11_12));
  TRY_CHECK_RC (OM::write (ian, *route_5_2));
  ...
  ADD_EXPECT (neighbour_cmds::create_cmd (hw_neighbour, hw_ifh.data (), mac_n,
					  nh_10, neighbour::flags_t::STATIC));
  ...
  ADD_EXPECT (
    route::ip_route_cmds::update_cmd (hw_route_dvr, 0, pfx_6, pl_13));
  TRY_CHECK_RC (OM::write (ian, *route_dvr));

  /*
   * a multicast route
   */
  route::mprefix_t mpfx_4 (boost::asio::ip::address::from_string ("232.1.1.1"),
			   32);
  ...
  ADD_EXPECT (route::ip_mroute_cmds::update_cmd (hw_mroute_4, 0, mpfx_4, *mp1,
						 route::itf_flags_t::FORWARD));
  ADD_EXPECT (route::ip_mroute_cmds::update_cmd (hw_mroute_4, 0, mpfx_4, *mp2,
						 route::itf_flags_t::FORWARD));
  ADD_EXPECT (route::ip_mroute_cmds::update_cmd (hw_mroute_4, 0, mpfx_4, *mp1,
						 route::itf_flags_t::ACCEPT));
  ...
  ADD_EXPECT (route::ip_mroute_cmds::delete_cmd (hw_mroute_4, 0, mpfx_4, *mp1,
						 route::itf_flags_t::FORWARD));
  ADD_EXPECT (route::ip_mroute_cmds::delete_cmd (hw_mroute_4, 0, mpfx_4, *mp2,
						 route::itf_flags_t::FORWARD));
  ADD_EXPECT (route::ip_mroute_cmds::delete_cmd (hw_mroute_4, 0, mpfx_4, *mp1,
						 route::itf_flags_t::ACCEPT));
  ...
  ADD_EXPECT (neighbour_cmds::delete_cmd (hw_neighbour, hw_ifh.data (), mac_n,
					  nh_10, neighbour::flags_t::STATIC));
  ...
  ADD_EXPECT (
    l3_binding_cmds::unbind_cmd (hw_l3_10_unbind, hw_ifh.data (), pfx_10));
  ADD_EXPECT (
    l3_binding_cmds::unbind_cmd (hw_l3_11_unbind, hw_ifh2.data (), pfx_11));
  ADD_EXPECT (interface_cmds::state_change_cmd (hw_as_down, hw_ifh));
  ADD_EXPECT (interface_cmds::af_packet_delete_cmd (hw_ifh, itf1_name));
  ADD_EXPECT (
    interface_cmds::set_table_cmd (hw_rd4_unbind, l3_proto_t::IPV4, hw_ifh2));
  ADD_EXPECT (
    interface_cmds::set_table_cmd (hw_rd4_unbind, l3_proto_t::IPV6, hw_ifh2));
  ADD_EXPECT (interface_cmds::state_change_cmd (hw_as_down2, hw_ifh2));
  ADD_EXPECT (interface_cmds::af_packet_delete_cmd (hw_ifh2, itf2_name));
  ADD_EXPECT (
    route_domain_cmds::delete_cmd (hw_rd4_delete, l3_proto_t::IPV4, 1));
...
BOOST_AUTO_TEST_CASE (test_nat)
{
  ...
  interface itf_in (itf_in_name, interface::type_t::AFPACKET,
		    interface::admin_state_t::UP);
  HW::item<handle_t> hw_ifh (2, rc_t::OK);
  HW::item<interface::admin_state_t> hw_as_up (interface::admin_state_t::UP,
					       rc_t::OK);
  ...
  interface itf_out (itf_out_name, interface::type_t::AFPACKET,
		     interface::admin_state_t::UP);
   ...
   */
  boost::asio::ip::address in_addr =
    boost::asio::ip::address::from_string ("10.0.0.1");
  boost::asio::ip::address_v4 out_addr =
    boost::asio::ip::address_v4::from_string ("1.1.1.1");

  nat_static ns (in_addr, out_addr);
  HW::item<bool> hw_ns (true, rc_t::OK);

  ADD_EXPECT (
    nat_static_cmds::create_44_cmd (hw_ns, 0, in_addr.to_v4 (), out_addr));
  TRY_CHECK_RC (OM::write (gs, ns));

  /*
   * bind nat inside and out
   */
  nat_binding *nb_in = new nat_binding (
    itf_in, direction_t::INPUT, l3_proto_t::IPV4, nat_binding::zone_t::INSIDE);
  HW::item<bool> hw_nb_in (true, rc_t::OK);

  ADD_EXPECT (nat_binding_cmds::bind_44_input_cmd (
    hw_nb_in, hw_ifh.data ().value (), nat_binding::zone_t::INSIDE));
  TRY_CHECK_RC (OM::write (gs, *nb_in));

  nat_binding *nb_out =
    new nat_binding (itf_out, direction_t::INPUT, l3_proto_t::IPV4,
		     nat_binding::zone_t::OUTSIDE);
  HW::item<bool> hw_nb_out (true, rc_t::OK);

  ADD_EXPECT (nat_binding_cmds::bind_44_input_cmd (
    hw_nb_out, hw_ifh2.data ().value (), nat_binding::zone_t::OUTSIDE));
  TRY_CHECK_RC (OM::write (gs, *nb_out));

  STRICT_ORDER_OFF ();
  delete nb_in;
  delete nb_out;
  ADD_EXPECT (nat_binding_cmds::unbind_44_input_cmd (
    hw_nb_in, hw_ifh.data ().value (), nat_binding::zone_t::INSIDE));
  ADD_EXPECT (nat_binding_cmds::unbind_44_input_cmd (
    hw_nb_out, hw_ifh2.data ().value (), nat_binding::zone_t::OUTSIDE));
  ADD_EXPECT (
    nat_static_cmds::delete_44_cmd (hw_ns, 0, in_addr.to_v4 (), out_addr));
  ADD_EXPECT (interface_cmds::state_change_cmd (hw_as_down, hw_ifh));
...
BOOST_AUTO_TEST_CASE (test_interface_route_domain_change)
{
  ...
  ADD_EXPECT (
    l3_binding_cmds::bind_cmd (hw_l3_bind1, hw_ifh1.data (), pfx_10));
  ...
  ADD_EXPECT (
    l3_binding_cmds::bind_cmd (hw_l3_bind2, hw_ifh1.data (), pfx_11));
  ...
  ADD_EXPECT (
    route_domain_cmds::create_cmd (hw_rd_create, l3_proto_t::IPV4, 1));
  ADD_EXPECT (
    route_domain_cmds::create_cmd (hw_rd_create, l3_proto_t::IPV6, 1));
   ...
   */
  interface *itf2 = new interface (itf1_name, interface::type_t::AFPACKET,
				   interface::admin_state_t::UP, rd);
  ADD_EXPECT (
    l3_binding_cmds::unbind_cmd (hw_l3_unbind1, hw_ifh1.data (), pfx_10));
  ADD_EXPECT (
    l3_binding_cmds::unbind_cmd (hw_l3_unbind2, hw_ifh1.data (), pfx_11));
  ADD_EXPECT (
    interface_cmds::set_table_cmd (hw_rd_bind, l3_proto_t::IPV4, hw_ifh1));
  ADD_EXPECT (
    interface_cmds::set_table_cmd (hw_rd_bind, l3_proto_t::IPV6, hw_ifh1));
  ADD_EXPECT (
    l3_binding_cmds::bind_cmd (hw_l3_bind1, hw_ifh1.data (), pfx_10));
  ADD_EXPECT (
    l3_binding_cmds::bind_cmd (hw_l3_bind2, hw_ifh1.data (), pfx_11));
   ...
   */
  interface itf3 (itf1_name, interface::type_t::AFPACKET,
		  interface::admin_state_t::UP);
  ADD_EXPECT (
    l3_binding_cmds::unbind_cmd (hw_l3_unbind1, hw_ifh1.data (), pfx_10));
  ADD_EXPECT (
    l3_binding_cmds::unbind_cmd (hw_l3_unbind2, hw_ifh1.data (), pfx_11));
  ADD_EXPECT (
    interface_cmds::set_table_cmd (hw_rd_unbind, l3_proto_t::IPV4, hw_ifh1));
  ADD_EXPECT (
    interface_cmds::set_table_cmd (hw_rd_unbind, l3_proto_t::IPV6, hw_ifh1));
  ADD_EXPECT (
    l3_binding_cmds::bind_cmd (hw_l3_bind1, hw_ifh1.data (), pfx_10));
  ADD_EXPECT (
    l3_binding_cmds::bind_cmd (hw_l3_bind2, hw_ifh1.data (), pfx_11));
  ...
  ADD_EXPECT (
    route_domain_cmds::delete_cmd (hw_rd_delete, l3_proto_t::IPV4, 1));
  ADD_EXPECT (
    route_domain_cmds::delete_cmd (hw_rd_delete, l3_proto_t::IPV6, 1));
...
{
  route::prefix_t p6_s_16 (boost::asio::ip::address::from_string ("2001::"),
			   16);

  BOOST_CHECK (p6_s_16.mask () ==
	       boost::asio::ip::address::from_string ("ffff::"));

  route::prefix_t p6_s_17 (
    boost::asio::ip::address::from_string ("2001:ff00::"), 17);

  BOOST_CHECK (p6_s_17.mask () ==
	       boost::asio::ip::address::from_string ("ffff:8000::"));
  BOOST_CHECK (p6_s_17.low ().address () ==
	       boost::asio::ip::address::from_string ("2001:8000::"));

  route::prefix_t p6_s_15 (
    boost::asio::ip::address::from_string ("2001:ff00::"), 15);
  BOOST_CHECK (p6_s_15.mask () ==
	       boost::asio::ip::address::from_string ("fffe::"));
  BOOST_CHECK (p6_s_15.low ().address () ==
	       boost::asio::ip::address::from_string ("2000::"));

  route::prefix_t p4_s_16 (
    boost::asio::ip::address::from_string ("192.168.0.0"), 16);

  BOOST_CHECK (p4_s_16.mask () ==
	       boost::asio::ip::address::from_string ("255.255.0.0"));

  route::prefix_t p4_s_17 (
    boost::asio::ip::address::from_string ("192.168.127.0"), 17);

  BOOST_CHECK (p4_s_17.mask () ==
	       boost::asio::ip::address::from_string ("255.255.128.0"));
  BOOST_CHECK (p4_s_17.low ().address () ==
	       boost::asio::ip::address::from_string ("192.168.0.0"));
  BOOST_CHECK (p4_s_17.high ().address () ==
	       boost::asio::ip::address::from_string ("192.168.127.255"));

  route::prefix_t p4_s_15 (
    boost::asio::ip::address::from_string ("192.168.255.255"), 15);

  BOOST_CHECK (p4_s_15.mask () ==
	       boost::asio::ip::address::from_string ("255.254.0.0"));
  BOOST_CHECK (p4_s_15.low ().address () ==
	       boost::asio::ip::address::from_string ("192.168.0.0"));
  BOOST_CHECK (p4_s_15.high ().address () ==
	       boost::asio::ip::address::from_string ("192.169.255.255"));

  route::prefix_t p4_s_32 (
    boost::asio::ip::address::from_string ("192.168.1.1"), 32);

  BOOST_CHECK (p4_s_32.mask () ==
	       boost::asio::ip::address::from_string ("255.255.255.255"));
  BOOST_CHECK (p4_s_32.low ().address () ==
	       boost::asio::ip::address::from_string ("192.168.1.1"));
  BOOST_CHECK (p4_s_32.high ().address () ==
	       boost::asio::ip::address::from_string ("192.168.1.1"));
}
...
BOOST_AUTO_TEST_CASE (test_pipes)
{
  ...
  bridge_domain bd1 (
    33, bridge_domain::learning_mode_t::OFF,
    bridge_domain::arp_term_mode_t::OFF, bridge_domain::arp_ufwd_mode_t::ON,
    bridge_domain::flood_mode_t::OFF, bridge_domain::uu_flood_mode_t::ON,
    bridge_domain::mac_age_mode_t::ON);
  ...
  ADD_EXPECT (l2_binding_cmds::bind_cmd (
    hw_l2_1_bind, pipe1.east ()->handle (), hw_bd.data (),
    l2_binding::l2_port_type_t::L2_PORT_TYPE_NORMAL));
  ...
  ADD_EXPECT (l2_binding_cmds::bind_cmd (
    hw_l2_2_bind, pipe1.west ()->handle (), hw_bd.data (),
    l2_binding::l2_port_type_t::L2_PORT_TYPE_NORMAL));
  ...
  ADD_EXPECT (l2_binding_cmds::unbind_cmd (
    ...
    l2_binding::l2_port_type_t::L2_PORT_TYPE_NORMAL));
  ADD_EXPECT (l2_binding_cmds::unbind_cmd (
    hw_l2_1_bind, pipe1.west ()->handle (), hw_bd.data (),
    l2_binding::l2_port_type_t::L2_PORT_TYPE_NORMAL));
...
BOOST_AUTO_TEST_CASE (test_qos)
{
  ...
  ADD_EXPECT (
    QoS::record_cmds::create_cmd (hw_qr, hw_ifh.data (), QoS::source_t::IP));
  TRY_CHECK_RC (OM::write (albert, *qr));

  QoS::store *qs = new QoS::store (itf, QoS::source_t::IP, 55);
  HW::item<bool> hw_qs (true, rc_t::OK);
  ADD_EXPECT (QoS::store_cmds::create_cmd (hw_qs, hw_ifh.data (),
					   QoS::source_t::IP, 55));
  ...
  ADD_EXPECT (
    QoS::mark_cmds::create_cmd (hw_qm, hw_ifh.data (), 1, QoS::source_t::IP));
  ...
  delete qs;
  ADD_EXPECT (
    QoS::mark_cmds::delete_cmd (hw_qm, hw_ifh.data (), QoS::source_t::IP));
  ADD_EXPECT (QoS::map_cmds::delete_cmd (hw_qem, 1));
  ADD_EXPECT (
    QoS::record_cmds::delete_cmd (hw_qr, hw_ifh.data (), QoS::source_t::IP));
  ADD_EXPECT (
    QoS::store_cmds::delete_cmd (hw_qs, hw_ifh.data (), QoS::source_t::IP));
  ADD_EXPECT (interface_cmds::state_change_cmd (hw_as_down, hw_ifh));
  ADD_EXPECT (interface_cmds::af_packet_delete_cmd (hw_ifh, itf_name));
