...
typedef struct private_kernel_libipsec_vpp_plugin_t
  private_kernel_libipsec_vpp_plugin_t;

/**
 * private data of "kernel" libipsec plugin
 */
struct private_kernel_libipsec_vpp_plugin_t
{

  /**
   * implements plugin interface
   */
  kernel_libipsec_vpp_plugin_t public;

  vac_t *vac;
};

METHOD (plugin_t, get_name, char *, private_kernel_libipsec_vpp_plugin_t *this)
{
  return "kernel-libipsec-vpp";
}

METHOD (plugin_t, get_features, int,
	private_kernel_libipsec_vpp_plugin_t *this,
	plugin_feature_t *features[])
{
  static plugin_feature_t f[] = {
    PLUGIN_CALLBACK (kernel_ipsec_register, kernel_libipsec_vpp_ipsec_create),
...
METHOD (plugin_t, destroy, void, private_kernel_libipsec_vpp_plugin_t *this)
{
  if (this->vac)
    {
 ...
 */
plugin_t *
kernel_libipsec_vpp_plugin_create ()
{
  private_kernel_libipsec_vpp_plugin_t *this;

  DBG1 (DBG_KNL, "kernel-libipsec-vpp HELLO WORLD!");
  ...
  DBG1 (DBG_KNL, "vac_create successfull");
