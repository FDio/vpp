...
/** \brief Memif per thread initialization
    ...
    \return memif_err_t
*/
int memif_per_thread_init (memif_per_thread_main_handle_t *pt_main, void *private_ctx,
...
*/
int memif_per_thread_control_fd_handler (memif_per_thread_main_handle_t pt_main, int fd,
					 uint8_t events);
