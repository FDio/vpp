 ...
 * 
 * Memif controll channel represents one end of communication between two memif endpoints.
 * The controll channel is responsible for receiving and transmitting memif control messages
