...
print_help_args ()
{
  ...
  printf ("	ip=<ip4>                   : Ip of interface.\n");
  printf
    ("	role=<master|slave>        : Role in which interface operates.\n");
  printf ("	soscket=<filename>         : name of socket connection.\n");
  printf
...
print_help_cmds ()
{
  ...
  printf ("\tfilters:\n");
  printf ("\t	DBG - debug messages\n");
  printf ("\t	INFO - info messages\n");
...
/*in bridge mode are receive packets transmit into next interfaces of
