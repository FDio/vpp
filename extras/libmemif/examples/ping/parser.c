...
#define PARSER_ERROR_QUEUES            "<Number for parameter 'qpairs' beyond of range <1,255>.>"
#define PARSER_ERROR_RSIZE             "<Number for parameter 'rsize' beyond of range <1,14>.>"
