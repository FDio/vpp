...
int resolve_packet_zero_copy (void *pck, uint32_t * size, uint8_t ip_addr[4], uint8_t hw_addr[6]);

/* resolve packet in place and add eth encap */
int resolve_packet_zero_copy_add_encap (void **pck, uint32_t * size, uint8_t ip_addr[4]);
