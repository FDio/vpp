...
func RedisBenchmarkTest(s *VethsSuite) {
	...
	s.Log("attaching server to vpp")
	// LDP and VCL_DEBUG=1 generate a 450+ MB log file
	envVarsCln["LDP_DEBUG"] = "0"
	envVarsCln["VCL_DEBUG"] = "0"
