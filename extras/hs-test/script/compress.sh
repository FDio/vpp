...
export WORKSPACE="/w/workspace/daw-docker-vpp-verify-hst-master-ubuntu2204-x86_64/extras/hs-test"
export HS_SUMMARY="${WORKSPACE}/summary"
export COMPRESS_FAILED_TEST_LOGS="yes"
