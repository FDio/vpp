...
func (s *KindSuite) CreateDynamicJob(ctx context.Context, namespace, jobName, testType, nodeName string, finalizers ...string) error {
...
func (s *KindSuite) DeleteDynamicJob(ctx context.Context, namespace, jobName string) error {
...
func (s *KindSuite) ListJobsInNamespace(ctx context.Context, namespace string) ([]string, error) {
...
func (s *KindSuite) CleanupJobsWithFinalizers(ctx context.Context, namespace string) error {
