...
func (vpp *VppInstance) start() error {
	...
	vpp.container.exec("mkdir --mode=0700 -p " + vpp.getRunDir(), nil)
	vpp.container.exec("mkdir --mode=0700 -p " + vpp.getLogDir(), nil)
	vpp.container.exec("mkdir --mode=0700 -p " + vpp.getEtcDir(), nil)
	...
	// Start VPP
	if err := vpp.container.execServer("vpp -c "+startupFileName, nil); err != nil {
		return err
	}
