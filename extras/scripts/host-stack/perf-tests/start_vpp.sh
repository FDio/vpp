...
#  PLUGIN_PATH="/scratch/fcoras/vpp/build-root/install-vpp_debug-native/vpp/lib64/vpp_plugins"
#  PLUGIN_VAT_PATH="/scratch/fcoras/vpp/build-root/install-vpp_debug-native/vpp/lib64/vpp_api_test_plugins"
#fi
