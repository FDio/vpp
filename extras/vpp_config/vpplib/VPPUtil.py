...
class VPPUtil(object):
    ...
    def _install_vpp_ubuntu(self, node, fdio_release='1707',
    ...
    def _install_vpp_centos(self, node, fdio_release='1707',
    ...
    def _uninstall_vpp_centos(self, node):
        ...
        if len(pkgs) > 0:
            if 'version' in pkgs[0]:
                ...
                self._uninstall_vpp_pkg_centos(node, 'vpp-nsh-plugin-dbg')
                self._uninstall_vpp_pkg_centos(node, 'vpp-nsh-plugin-dev')
                self._uninstall_vpp_pkg_centos(node, 'vpp-nsh-plugin')
                self._uninstall_vpp_pkg_centos(node, 'vpp-plugins')
                self._uninstall_vpp_pkg_centos(node, 'vpp-dpdk-dev')
                self._uninstall_vpp_pkg_centos(node, 'vpp-dpdk-dkms')
                self._uninstall_vpp_pkg_centos(node, 'vpp-dev')
                self._uninstall_vpp_pkg_centos(node, 'vpp-dbg')
