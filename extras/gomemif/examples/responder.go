...
func Disconnected(e *memif.Endpoint) error {
        ...
        data, ok := e.GetPrivateData().(*endpointData)
        if !ok {
...
func interractiveHelp() {
        ...
        fmt.Println("show - print endpoint details")
...
func main () {
        ...
        name := flag.String("name", "gomemif", "endpoint name")
