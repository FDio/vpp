...
func (m *MockChannel) CheckCompatiblity(arg0 ...api.Message) error {
	varargs := []interface{}{}
	for _, a := range arg0 {
...
func (mr *MockChannelMockRecorder) CheckCompatiblity(arg0 ...interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckCompatiblity", reflect.TypeOf((*MockChannel)(nil).CheckCompatiblity), arg0...)
}
