...
create_cmd::issue(connection& con)
{
  ...
  if (gbp_bridge_domain::flags_t::DO_NOT_LEARN & m_flags)
    flags = static_cast<vapi_enum_gbp_bridge_domain_flags>(flags |GBP_BD_API_FLAG_DO_NOT_LEARN);
  if (gbp_bridge_domain::flags_t::UU_FWD_DROP & m_flags)
    flags = static_cast<vapi_enum_gbp_bridge_domain_flags>(flags |GBP_BD_API_FLAG_UU_FWD_DROP);
  if (gbp_bridge_domain::flags_t::MCAST_DROP & m_flags)
    flags = static_cast<vapi_enum_gbp_bridge_domain_flags>(flags |GBP_BD_API_FLAG_MCAST_DROP);
  if (gbp_bridge_domain::flags_t::UCAST_ARP & m_flags)
    flags = static_cast<vapi_enum_gbp_bridge_domain_flags>(flags |GBP_BD_API_FLAG_UCAST_ARP);
