...
install -p -m 644 %{_mu_build_dir}/../src/tools/vppapigen/C_OUTPUT.py %{buildroot}/usr/share/vpp
install -p -m 644 %{_mu_build_dir}/../src/tools/vppapigen/JSON_OUTPUT.py %{buildroot}/usr/share/vpp
