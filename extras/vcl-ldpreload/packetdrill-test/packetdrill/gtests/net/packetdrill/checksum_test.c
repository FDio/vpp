...
static void
test_tcp_udp_v4_checksum (void)
{
  u8 data[] = {
    0x45, 0x00, 0x00, 0x3c, 0x00, 0x00, 0x00, 0x00, 0xff, 0x06, 0xf9, 0x10,
    0x01, 0x01, 0x01, 0x01, 0xc0, 0xa8, 0x00, 0x01, 0x04, 0xd2, 0xeb, 0x35,
    0x00, 0x00, 0x00, 0x00, 0xc6, 0xf0, 0x56, 0x00, 0xa0, 0x12, 0x16, 0xa0,
    0x54, 0x12, 0x00, 0x00, 0x02, 0x04, 0x05, 0xb4, 0x04, 0x02, 0x08, 0x0a,
    0x00, 0x00, 0x02, 0xbc, 0x00, 0x06, 0x0a, 0xd8, 0x01, 0x03, 0x03, 0x07,
  };
...
test_tcp_udp_v6_checksum (void)
{
  ...
  checksum = ntohs (
    tcp_udp_v6_checksum (&ipv6->src_ip, &ipv6->dst_ip, IPPROTO_TCP, tcp, len));
  assert (checksum == 0);
...
static void
test_ipv4_checksum (void)
{
  u8 data[] = {
    0x45, 0x00, 0x00, 0x3c, 0x00, 0x00, 0x00, 0x00, 0xff, 0x06,
    0xf9, 0x10, 0x01, 0x01, 0x01, 0x01, 0xc0, 0xa8, 0x00, 0x01,
  };
...
static void
test_sctp_crc32c (void)
{
  u8 data[] = {
    0x07, 0xd0, 0xd6, 0x61, 0x11, 0x0c, 0xc5, 0x6c, 0xda, 0xd7,
    0x37, 0x74, 0x06, 0x00, 0x00, 0x0f, 0x00, 0x0c, 0x00, 0x0b,
    0x47, 0x6f, 0x6f, 0x64, 0x62, 0x79, 0x65, 0x00,
  };
