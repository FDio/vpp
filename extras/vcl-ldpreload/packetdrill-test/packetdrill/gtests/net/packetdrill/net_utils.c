...
static void
verbose_system (const char *command)
{
  int result;
...
static void
net_add_ipv4_address (const char *dev_name, const struct ip_address *ip,
		      int prefix_len)
{
  char *command = NULL;
...
static void
net_add_ipv6_address (const char *dev_name, const struct ip_address *ip,
		      int prefix_len)
{
  char *command = NULL;
  char ip_string[ADDR_STR_LEN];
...
void
net_add_dev_address (const char *dev_name, const struct ip_address *ip,
		     int prefix_len)
{
...
void
net_del_dev_address (const char *dev_name, const struct ip_address *ip,
		     int prefix_len)
{
  char *command = NULL;
  char ip_string[ADDR_STR_LEN];
 ...
 */
void
net_setup_dev_address (const char *dev_name, const struct ip_address *ip,
		       int prefix_len)
{
