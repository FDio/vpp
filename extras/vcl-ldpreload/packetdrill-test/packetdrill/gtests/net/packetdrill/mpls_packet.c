...
int
new_mpls_stack_entry (s64 label, s64 traffic_class, bool is_stack_bottom,
		      s64 ttl, struct mpls *mpls, char **error)
{
...
int
mpls_header_append (struct packet *packet, struct mpls_stack *mpls_stack,
		    char **error)
{
...
int
mpls_header_finish (struct packet *packet, struct header *header,
