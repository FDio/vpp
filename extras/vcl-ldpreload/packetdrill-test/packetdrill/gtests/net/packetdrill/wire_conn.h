...
/* Blocking connect. */
void wire_conn_connect (struct wire_conn *conn, const struct ip_address *ip,
...
int wire_conn_write (struct wire_conn *conn, enum wire_op_t op,
 ...
 * wire_conn_read().
 */
int wire_conn_read (struct wire_conn *conn, enum wire_op_t *op, void **buf,
		    int *buf_len);
