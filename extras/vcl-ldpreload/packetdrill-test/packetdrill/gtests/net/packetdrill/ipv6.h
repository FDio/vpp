...
struct ipv6
{
  ...
  __u8 traffic_class_hi : 4, version : 4;
  __u8 flow_label_hi : 4, traffic_class_lo : 4;
  __u16 flow_label_lo;
#elif __BYTE_ORDER == __BIG_ENDIAN
  __u8 version : 4, traffic_class_hi : 4;
  __u8 traffic_class_lo : 4, flow_label_hi : 4;
  __u16 flow_label_lo;
#else
...
static inline u8
ipv6_tos_byte (const struct ipv6 *ipv6)
{
  return (ipv6->traffic_class_hi << 4) | ipv6->traffic_class_lo;
}

static inline u32
ipv6_flow_label (const struct ipv6 *ipv6)
{
  return (ntohs (ipv6->flow_label_lo)) | (ipv6->flow_label_hi << 16);
}

static inline u8
ipv6_hoplimit_byte (const struct ipv6 *ipv6)
{
