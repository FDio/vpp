...
static inline u32
mpls_entry_label (const struct mpls *mpls)
{
...
static inline u8
mpls_entry_tc (const struct mpls *mpls)
{
...
static inline bool
mpls_entry_stack (const struct mpls *mpls)
{
...
static inline u8
mpls_entry_ttl (const struct mpls *mpls)
{
...
static inline void
mpls_entry_set (u32 label, u8 traffic_class, bool is_stack_bottom, u8 ttl,
		struct mpls *mpls)
{
  mpls->entry =
    htonl ((label << MPLS_LABEL_SHIFT) | (traffic_class << MPLS_TC_SHIFT) |
	   (is_stack_bottom << MPLS_STACK_SHIFT) | (ttl << MPLS_TTL_SHIFT));
}
...
static inline struct mpls_stack *
mpls_stack_new (void)
{
 ...
 */
static inline int
mpls_stack_append (struct mpls_stack *stack, struct mpls mpls)
{
