...
struct gre
{
  union
  {
    ...
    struct
    {
      ...
      __u16 recursion_control : 3, strict_route : 1, has_seq : 1, has_key : 1,
	has_routing : 1, has_checksum : 1, version : 3, reserved : 4, ack : 1;
#elif __BYTE_ORDER == __BIG_ENDIAN
      __u16 has_checksum : 1, has_routing : 1, has_key : 1, has_seq : 1,
	strict_route : 1, recursion_control : 3, ack : 1, reserved : 4,
	version : 3;
#else
