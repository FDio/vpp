...
extern void copy_script (const char *script_buffer, struct script *script);

/* Read the script file into a single linear buffer. */
extern void read_script (const char *script_path, struct script *script);
 ...
 * parser.y.
 */
extern int parse_script (struct config *config, struct script *script,
