...
next:
  ...
  while (1)
    {
      test (ver3_icx_gcc, b, a);
      test (ver3_icx_clang, b, a);

      tsc_mark ("new trm gcc");
      test (ver1_trm_gcc, b, a);
      tsc_mark ("old trm gcc");
      test (ver2_trm_gcc, b, a);
      tsc_mark ("new trm clang");
      test (ver1_trm_clang, b, a);
      tsc_mark ("old trm clang");
      test (ver2_trm_clang, b, a);

      tsc_mark ("new hsw gcc");
      test (ver1_hsw_gcc, b, a);
      tsc_mark ("old hsw gcc");
      test (ver2_hsw_gcc, b, a);
      tsc_mark ("new hsw clang");
      test (ver1_hsw_clang, b, a);
      tsc_mark ("old hsw clang");
      test (ver2_hsw_clang, b, a);

      tsc_mark ("new skx gcc");
      test (ver1_skx_gcc, b, a);
      tsc_mark ("old skx gcc");
      test (ver2_skx_gcc, b, a);
      tsc_mark ("new skx clang");
      test (ver1_skx_clang, b, a);
      tsc_mark ("old skx clang");
      test (ver2_skx_clang, b, a);

#if 0
      tsc_mark ("new icx gcc");
      test (ver1_icx_gcc, b, a);
      tsc_mark ("old icx gcc");
      test (ver2_icx_gcc, b, a);
      tsc_mark ("new icx clang");
      test (ver1_icx_clang, b, a);
      tsc_mark ("old icx clang");
      test (ver2_icx_clang, b, a);
      tsc_mark ("rep movsb icx gcc");
      test (ver3_icx_gcc, b, a);
      tsc_mark ("rep movsb icx clang");
      test (ver3_icx_clang, b, a);
#endif
