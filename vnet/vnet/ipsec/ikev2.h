...
typedef CLIB_PACKED (struct
		     ...
		     u8 exchange;
		     u8 flags;
		     u32 msgid; u32 length; u8 payload[0];}) ike_header_t;
...
typedef CLIB_PACKED (struct
		     ...
		     u8 nextpayload;
		     u8 flags;
		     u16 length; u8 payload[0];}) ike_payload_header_t;
...
typedef CLIB_PACKED (struct
		     ...
		     u8 auth_method;
		     u8 reserved[3];
		     u8 payload[0];}) ike_auth_payload_header_t;
...
typedef CLIB_PACKED (struct
		     ...
		     u16 length;
		     u8 id_type;
		     u8 reserved[3]; u8 payload[0];}) ike_id_payload_header_t;
