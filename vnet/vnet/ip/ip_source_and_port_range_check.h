...
typedef enum {
  IP_SOURCE_AND_PORT_RANGE_CHECK_PROTOCOL_TCP,
  IP_SOURCE_AND_PORT_RANGE_CHECK_PROTOCOL_UDP,
  IP_SOURCE_AND_PORT_RANGE_CHECK_PROTOCOL_ICMP,
  IP_SOURCE_AND_PORT_RANGE_CHECK_PROTOCOLS,
