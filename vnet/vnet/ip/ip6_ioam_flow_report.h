...
_(ioamPpcRxPackets, 5280, u64)                    \
_(ioamPpcLostPackets, 5281, u64)                  \
_(ioamPpcReorderedPackets, 5282, u64)             \
_(ioamPpcDupPackets, 5283, u64)                    
...
_(ipfix->ppc_rx.rx_packets, 0xffffffffffffffff, ioamPpcRxPackets, 8)       \
_(ipfix->ppc_rx.lost_packets, 0xffffffffffffffff, ioamPpcLostPackets, 8)   \
_(ipfix->ppc_rx.reordered_packets,0xffffffffffffffff,ioamPpcReorderedPackets,8)\
_(ipfix->ppc_rx.dup_packets, 0xffffffffffffffff, ioamPpcDupPackets, 8)       
