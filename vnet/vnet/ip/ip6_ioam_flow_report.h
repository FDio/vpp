...
_(ifix->my_node_id, 0xffffffff, ioamMyNodeId, 4)                          \
_(ifix->pkt_counter, 0xffffffff, ioamPacketCount, 4)                      \
_(ifix->bytes_counter, 0xffffffff, ioamByteCount, 4)                      \
_(ifix->sfc_id, 0xffffffff, ioamSfcId, 4)                                 \
_(ifix->sfc_validated_count, 0xffffffff, ioamSfcValidatedCount, 4)        \
_(ifix->sfc_invalidated_count, 0xffffffff, ioamSfcInValidatedCount, 4)    \
_(ifix->start_timestamp, 0xffffffff, ioamStartTimeStamp, 4)               \
_(ifix->end_timestamp, 0xffffffff, ioamEndTimeStamp, 4)                   \
_(ifix->src_port, 0xffff, sourceTransportPort, 2)                         \
_(ifix->dst_port, 0xffff, destinationTransportPort, 2)                    \
_(ifix->protocol, 0xffff, ioamProtocol, 2)                                \
_(ifix->num_nodes, 0xffff, ioamNumberOfNodes, 2)        
