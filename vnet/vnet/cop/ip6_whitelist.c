...
{
  .function = ip6_cop_whitelist_node_fn,.name =
    "ip6-cop-whitelist",.vector_size = sizeof (u32),.format_trace =
    format_ip6_cop_whitelist_trace,.type = VLIB_NODE_TYPE_INTERNAL,.n_errors =
    ARRAY_LEN (ip6_cop_whitelist_error_strings),.error_strings =
    ip6_cop_whitelist_error_strings,.n_next_nodes = COP_RX_N_FEATURES,
...
VLIB_NODE_FUNCTION_MULTIARCH (ip6_cop_whitelist_node,
			      ip6_cop_whitelist_node_fn)
