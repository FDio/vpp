...
int
cop_interface_enable_disable (u32 sw_if_index, int enable_disable)
{
  cop_main_t *cm = &cop_main;
...
{
.path = "cop interface",.short_help =
    "cop interface <interface-name> [disable]",.function =
    cop_enable_disable_command_fn,};


int
cop_whitelist_enable_disable (cop_whitelist_enable_disable_args_t * a)
{
  cop_main_t *cm = &cop_main;
  vlib_main_t *vm = cm->vlib_main;
...
{
.path = "cop whitelist",.short_help =
    "cop whitelist <interface-name> [ip4][ip6][default][fib-id <NN>][disable]",.function
    = cop_whitelist_enable_disable_command_fn,};
