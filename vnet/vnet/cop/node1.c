...
{
  .function = cop_input_node_fn,.name = "cop-input",.vector_size =
    sizeof (u32),.format_trace = format_cop_input_trace,.type =
    VLIB_NODE_TYPE_INTERNAL,.n_errors =
    ARRAY_LEN (cop_input_error_strings),.error_strings =
    cop_input_error_strings,.n_next_nodes = COP_RX_N_FEATURES,
  ...
  [IP4_RX_COP_WHITELIST] = "ip4-cop-whitelist",
      ...
      [DEFAULT_RX_COP_INPUT] = "ethernet-input",[RX_COP_DROP] = "error-drop",}
,};
