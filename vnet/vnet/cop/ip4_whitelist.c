...
{
  .function = ip4_cop_whitelist_node_fn,.name =
    "ip4-cop-whitelist",.vector_size = sizeof (u32),.format_trace =
    format_ip4_cop_whitelist_trace,.type = VLIB_NODE_TYPE_INTERNAL,.n_errors =
    ARRAY_LEN (ip4_cop_whitelist_error_strings),.error_strings =
    ip4_cop_whitelist_error_strings,.n_next_nodes = COP_RX_N_FEATURES,
...
VLIB_NODE_FUNCTION_MULTIARCH (ip4_cop_whitelist_node,
