 ...
 *  CLASSIFY_ACTION_REWRITE_IP4_VRF_ID:
 *   - Classified IP packets will be looked up
 *     from the specified ipv4 fib table
 *  CLASSIFY_ACTION_REWRITE_IP6_VRF_ID:
 *   - Classified IP packets will be looked up
 *     from the specified ipv6 fib table
 */
#define CLASSIFY_ACTION_REWRITE_IP4_VRF_ID       1
#define CLASSIFY_ACTION_REWRITE_IP6_VRF_ID       2
