...
span_node_inline_fn (vlib_main_t * vm, vlib_node_runtime_t * node, vlib_frame_t * frame, int is_input)
{
...
static uword
span_input_node_fn (vlib_main_t * vm, vlib_node_runtime_t * node, vlib_frame_t * frame)
{
  return span_node_inline_fn (vm, node, frame, 1);
}

static uword
span_output_node_fn (vlib_main_t * vm, vlib_node_runtime_t * node, vlib_frame_t * frame)
{
