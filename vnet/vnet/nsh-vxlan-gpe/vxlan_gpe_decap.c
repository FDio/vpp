...
// alagalah Copy from either normal vxlan or gre
  ...
  while (n_left_from > 0)
      ...
      while (n_left_from >= 4 && n_left_to_next >= 2)
	{
	  ...
	  b1 = vlib_get_buffer (vm, bi1);
          ...
          key0.local = iuvn0->ip4.src_address.as_u32;
          key0.remote = iuvn0->ip4.dst_address.as_u32;
	  ...
	  /* alagalah move to NSH This should all go away */
          if (next0 == VXLAN_GPE_INPUT_NEXT_NSH_INPUT)
            {
              ...
              next_key0.local = iuvn0->ip4.dst_address.as_u32;
	      next_key0.remote = iuvn0->ip4.dst_address.as_u32;
        ...
        trace0:
          ...
          key1.local = iuvn1->ip4.src_address.as_u32;
          ...
          if (next1 == VXLAN_GPE_INPUT_NEXT_NSH_INPUT)
            {
              ...
              next_key1.local = iuvn1->ip4.dst_address.as_u32;
               ...
               vlib_frame_t * from_frame)
{
  ...
  while (n_left_from > 0)
      ...
      while (n_left_from > 0 && n_left_to_next > 0)
	{
	  u32 bi0;
	  vlib_buffer_t * b0;
	  u32 next0 = 0; // alagalah WRONG but not sorted yet -> NSH_INPUT_NEXT_REENCAP;
...
VLIB_REGISTER_NODE (nsh_input_node) = {
  ...
  .next_nodes = {
        [NSH_INPUT_NEXT_DECAP_ETHERNET_LOOKUP] = "ethernet-input",
        [NSH_INPUT_NEXT_DECAP_IP4_LOOKUP] = "ip4-lookup",
        [NSH_INPUT_NEXT_DECAP_IP6_LOOKUP] = "ip6-lookup",
	[NSH_INPUT_NEXT_ENCAP_GRE] = "gre-encap",
	[NSH_INPUT_NEXT_ENCAP_VXLANGPE] = "vxlan-gpe-encap",
	[NSH_INPUT_NEXT_ENCAP_ETHERNET] = "error-drop",
