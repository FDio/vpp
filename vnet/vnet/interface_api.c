...
/* 
 * So we can publish this patch without wasting
 * verify job executor cycles.
 * $$$ Remove prior to attempting Actual Verification...
 */
void deliberate_checkstyle_fail(void)
{
  if (1) {
    deliberate_checkstyle_fail();
  }
}
