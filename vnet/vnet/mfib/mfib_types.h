...
typedef enum mfib_itf_attribute_t_
{
    ...
    MFIB_ITF_INTERNAL_COPY,
    MFIB_ITF_ATTRIBUTE_LAST = MFIB_ITF_INTERNAL_COPY,
...
#define MFIB_ITF_NAMES_LONG  {                    \
    ...
    [MFIB_ITF_INTERNAL_COPY] = "Internal-Copy",   \
}
...
typedef enum mfib_itf_flags_t_
{
    ...
    MFIB_ITF_FLAG_INTERNAL_COPY = (1 << MFIB_ITF_INTERNAL_COPY),
} mfib_itf_flags_t;
