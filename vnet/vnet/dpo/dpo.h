 ...
 * When programming a DPO's next node arc from parent to child it is thus required
...
/**
 * @brief Types of data-path objects
 */
...
/**
 * The identity of a DPO is a combination of its type and its instance number/index
...
extern void dpo_stack(dpo_type_t type,
                      dpo_proto_t proto,
                      dpo_id_t *parent,
                      const dpo_id_t *child);
extern void dpo_stack_from_node(u32 parent_node,
                                dpo_proto_t proto,
                                dpo_id_t *parent,
                                const dpo_id_t *child);
