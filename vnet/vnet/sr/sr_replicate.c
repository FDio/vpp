		  ...
		  vlib_frame_t * frame)
{
  ...
  while (n_left_from > 0)
      ...
      while (n_left_from > 0 && n_left_to_next > 0)
	{
	  ...
	  int i;
	  struct rte_mbuf *orig_mb0 = 0;
	  ip6_sr_header_t * hdr_sr0 = 0;
	  ip6_header_t * ip0 = 0, * hdr_ip0;
          struct rte_mbuf * clone0;
	  ...
	  for (i=0; i < vec_len (pol0->tunnel_indices); i++)
	    {
	      ...
	      t0 = vec_elt_at_index (sm->tunnels, pol0->tunnel_indices[i]);
              ...
              // alagalah: check hdr_mb0 != 0, do something sane
	      ...
	      if (i != (vec_len (pol0->tunnel_indices) - 1))
		{
	      ...
	      /* alagalah TODO: Rollback/fixup when this occurs */
		  ASSERT (clone0);
		}
	      else
		{
