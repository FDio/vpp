		    ...
		    u8 * error0, ip4_mapt_next_t * next0)
{
  if (PREDICT_FALSE (ip4_get_fragment_offset (ip40)))
	...
	*dst_port0 = 0;
	       ...
	       code == ICMP4_echo_reply
	       || ((icmp46_header_t *) u8_ptr_add (ip40, sizeof (*ip40)))->
	       code == ICMP4_echo_request)
