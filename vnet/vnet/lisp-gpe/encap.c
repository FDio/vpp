/*
 * encap.c: lisp-gpe encap processing
 *
...
always_inline void
ip4_encap_one (vlib_main_t * vm, lisp_gpe_tunnel_t * t0, vlib_buffer_t * b0)
{
...
always_inline void
ip4_encap_two (vlib_main_t * vm, lisp_gpe_tunnel_t * t0, lisp_gpe_tunnel_t * t1,
