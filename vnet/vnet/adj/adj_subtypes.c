 ...
 *
 * A rewirte sub-type has the rewrite string provided, but no key
 */
adj_index_t
...
adj_index_t
adj_map_add_or_lock (fib_protocol_t proto,
		     u32 next_index,
		     u32 map_index)
{
    ip_adjacency_t * adj;
    ...
    adj->lookup_next_index = next_index;
    adj->ia_nh_proto = proto;
    adj->sub_type.map.domain_index = map_index;
...
adj_index_t
adj_sr_add_or_lock (fib_protocol_t proto,
		    u32 next_index,
		    u32 sr_index)
{
    ip_adjacency_t * adj;
    ...
    adj->lookup_next_index = next_index;
    adj->ia_nh_proto = proto;
    adj->sub_type.sr.sr_index = sr_index;
    adj->rewrite_header.data_bytes = 0;
...
void
adj_map_update (adj_index_t adj_index,
		u32 map_index)
{
    ip_adjacency_t *adj;
