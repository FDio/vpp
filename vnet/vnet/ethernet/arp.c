			     ...
			     ip_interface_address_t ** result_ia)
{
  ...
  foreach_ip_interface_address (lm, ia, sw_if_index,	/* *INDENT-OFF* */
				1 /* honor unnumbered */ ,
				(
				  {
				  ip4_address_t * a =
		...
		ethernet_header_t * eth0, ip_interface_address_t * ifa0)
{
  ...
  p				/* *INDENT-OFF* */
    ool_foreach (si, vim->sw_interfaces, (
					   {
					   if (si->
					       flags &
						   ...
						   unnum_src_sw_if_index))
					   {
					   vec_add1 (broadcast_swifs,
						     si->sw_if_index);}
					   }
		 ));
  /* *INDENT-ON* */
...
V				/* *INDENT-OFF* */
LIB_REGISTER_NODE (arp_input_node, static) =
{
  .function = arp_input,.name = "arp-input",.vector_size =
    sizeof (u32),.n_errors = ETHERNET_ARP_N_ERROR,.error_strings =
    ethernet_arp_error_strings,.n_next_nodes = ARP_INPUT_N_NEXT,.next_nodes =
  {
	      ...
	      unformat_input_t * input, vlib_cli_command_t * cmd)
{
  ...
  es = 0;
  p				/* *INDENT-OFF* */
    ool_foreach (e, am->ip4_entry_pool, (
					  {
					  vec_add1 (es, e[0]);
					  }));
  /* *INDENT-ON* */
...
VLI				/* *INDENT-OFF* */
B_CLI_COMMAND (show_ip4_arp_command, static) =
{
.path = "show ip arp",.function = show_ip4_arp,.short_help =
    "Show ARP table",};
/* *INDENT-ON* */
...
V				/* *INDENT-OFF* */
LIB_CLI_COMMAND (ip_arp_add_del_command, static) =
{
.path = "set ip arp",.short_help =
...
V				/* *INDENT-OFF* */
LIB_CLI_COMMAND (set_int_proxy_enable_command, static) =
{
.path = "set interface proxy-arp",.short_help =
    "set interface proxy-arp <intfc> [enable|disable]",.function =
...
V				/* *INDENT-OFF* */
LIB_REGISTER_NODE (arp_term_l2bd_node, static) =
{
  .function = arp_term_l2bd,.name = "arp-term-l2bd",.vector_size =
    sizeof (u32),.n_errors = ETHERNET_ARP_N_ERROR,.error_strings =
    ethernet_arp_error_strings,.n_next_nodes = ARP_TERM_N_NEXT,.next_nodes =
  {
