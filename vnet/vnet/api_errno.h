...
_(NOT_RUNNING_AS_ROOT, -82, "Not running as root") \
_(ALREADY_CONNECTED, -83, "Connection to the data plane already exists") \
_(UNSUPPORTED_JNI_VERSION, -84, "Unsupported JNI version") \
_(FAILED_TO_ATTACH_TO_JAVA_THREAD, -84, "Failed to attach to Java thread")
