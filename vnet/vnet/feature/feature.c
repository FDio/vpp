...
static clib_error_t *
show_interface_features_command_fn (vlib_main_t * vm,
...
VLIB_CLI_COMMAND (show_features_inteface_command, static) = {
  .path = "show interface features",
  .short_help = "show interface features <intfc>",
  .function = show_interface_features_command_fn,
};
/* *INDENT-ON* */
