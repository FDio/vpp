...
static void
foreach_sfib4_entry (BVT (clib_bihash_kv) * kvp, void * arg)
{
  foreach_sfib_entry_arg_t *a = arg;
                            ...
                            void *arg)
{
  ...
  BV (clib_bihash_foreach_key_value_pair) (&sfib4->ip4_lookup_table,
                                           foreach_sfib4_entry, &a);
}

static void
foreach_sfib6_entry (BVT (clib_bihash_kv) * kvp, void * arg)
{
  foreach_sfib_entry_arg_t *a = arg;
  ip6_address_t ip;
  ip6_address_t *mask;
