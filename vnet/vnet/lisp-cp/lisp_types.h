...
#define lcaf_len(_a) (_a)->len
#define lcaf_gid_address(_a) (_a)->gid_addr
#define lcaf_vni(_a) (_a)->vni
...
#define gid_address_lcaf_type(_a) lcaf_type(&gid_address_lcaf(_a))
#define gid_address_lcaf_gid_addr(_a) (gid_address_lcaf(_a)).gid_addr
