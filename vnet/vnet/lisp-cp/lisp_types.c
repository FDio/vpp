...
static u16 gid_simple_addr_size_to_write (simple_address_t * a);
...
{
  simple_address_t * a = va_arg(*args, simple_address_t *);
...
static u16
gid_simple_addr_parse (u8 * p, simple_address_t * a)
{
...
sd_parse (u8 * p, void * a)
{
  ...
  gid_address_t * g = a;
  u16 size = 0;
  simple_address_t * src = &gid_address_sd_src (g);
  simple_address_t * dst = &gid_address_sd_dst (g);
...
static u16
gid_simple_addr_write (u8 * p, simple_address_t * a)
{
  switch (gid_simple_type (a))
    {
    case GID_SIMPLE_ADDR_IP_PREF:
...
static u8
gid_simple_address_length (simple_address_t * a)
{
  switch (gid_simple_type (a))
    {
    case GID_SIMPLE_ADDR_IP_PREF:
...
static u16
gid_simple_addr_size_to_write (simple_address_t * a)
{
  switch (gid_simple_type (a))
    {
    case GID_SIMPLE_ADDR_IP_PREF:
...
static int
gid_simple_cmp (simple_address_t * a1,
                simple_address_t * a2)
{
