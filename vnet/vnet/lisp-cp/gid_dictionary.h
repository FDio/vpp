...
void
gid_dict_foreach_ip4_entry (gid_dictionary_t *db, u32 vni, ip_prefix_t *src,
                            ip_prefix_t *dst, foreach_subprefix_match_cb_t cb,
                            void *arg);

void
gid_dict_foreach_ip6_entry (gid_dictionary_t *db, u32 vni, ip_prefix_t *src,
                            ip_prefix_t *dst, foreach_subprefix_match_cb_t cb,
                            void *arg);
