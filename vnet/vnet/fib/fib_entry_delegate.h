...
typedef enum fib_entry_delegate_type_t_ {
    FIB_ENTRY_DELEGATE_CHAIN_IP4_UNICAST = FIB_FORW_CHAIN_TYPE_UNICAST_IP4,
    FIB_ENTRY_DELEGATE_CHAIN_IP6_UNICAST = FIB_FORW_CHAIN_TYPE_UNICAST_IP6,
...
{                                                             \
    for (_fdt = FIB_ENTRY_DELEGATE_CHAIN_IP4_UNICAST;         \
