...
func (s *BaseSuite) execInPod(namespace, podName, containerName string, command ...string) ([]byte, error) {
...
func (s *BaseSuite) ExecInKindNodeContainer(kindNodeName, containerName string, command ...string) ([]byte, error) {
...
func (s *BaseSuite) ExecVppctlInKindNode(kindNodeName string, vppctlArgs ...string) ([]byte, error) {
