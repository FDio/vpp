...
func (s *KubeSuite) createAndLogPolicy(ctx context.Context, policy *networkingv1.NetworkPolicy) error {
...
func (s *KubeSuite) CreateDefaultNetworkPolicies(ctx context.Context, namespace, appLabel string) error {
...
func (s *KubeSuite) CreateNetworkPolicy(ctx context.Context, namespace, appLabel string, port int32) error {
...
func (s *KubeSuite) GetNetworkPolicies(ctx context.Context, namespace, appLabel string) (*networkingv1.NetworkPolicyList, error) {
...
func (s *KubeSuite) DeleteNetworkPolicy(ctx context.Context, namespace, policyName string) error {
...
func (s *KubeSuite) CleanupNetworkPolicies(namespace, appLabel string) {
...
func (s *KubeSuite) VerifyDefaultNetworkPolicies(output, nodeName string) (bool, []string) {
...
func (s *KubeSuite) VerifyDynamicNetworkPolicies(output, nodeName string, createdPolicies []string) (bool, []string) {
