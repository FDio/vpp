...
func (s *KubeSuite) CreateDynamicJob(ctx context.Context, namespace, jobName, appLabel, nodeName string) error {
...
func (s *KubeSuite) DeleteDynamicJob(ctx context.Context, namespace, jobName string) error {
...
func (s *KubeSuite) ListJobsInNamespace(ctx context.Context, namespace string) ([]string, error) {
...
func (s *KubeSuite) CleanupJobsWithFinalizers(ctx context.Context, namespace string) error {
