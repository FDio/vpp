...
func (s *KubeSuite) CleanupJobFinalizers(ctx context.Context, namespace string, jobName string) {
...
func (s *KubeSuite) CreateTestJob(ctx context.Context, namespace, jobName string, jobFinalizers, podFinalizers []string, jobSuccess bool) (*batchv1.Job, error) {
	job := &batchv1.Job{
...
func (s *KubeSuite) CreatePodTemplateSpec(finalizers []string, jobName string, jobSuccess bool) corev1.PodTemplateSpec {
...
func (s *KubeSuite) RunFinalizerTest(ctx context.Context, testName string, jobFinalizers, podFinalizers []string, jobSuccess bool) {
