...
var _ = Describe("NginxProxySuite", Ordered, ContinueOnFailure, Label("Nginx", "Proxy"), func() {
...
var _ = Describe("NginxProxySuiteSolo", Ordered, ContinueOnFailure, Serial, Label("Nginx", "Proxy"), func() {
	var s NginxProxySuite
	BeforeAll(func() {
		s.SetupSuite()
	})
