  ...
  while (n_left_from > 0)
  {
    ...
    while (n_left_from > 0 && n_left_to_next > 0)
    {
      ...
      if (is_input_v4) {
        ...
        key0[2] = ((udp_header_t *)(ip40 + 1))->src_port |
            ((udp_header_t *)(ip40 + 1))->dst_port << 16 |
            ((vip0 - lbm->vips) << 32);
      } else {
        ip6_header_t *ip60;
        ...
        key0[2] = ((udp_header_t *)(ip60 + 1))->src_port |
            (ip60->dst_address.as_u16[7] << 16) |
            ((vip0 - lbm->vips) << 32);
      }
      ...
      gre0->protocol = (is_input_v4)?0x0800:0x86DD;
...
VNET_IP4_REGISTER_ADJACENCY(lb6_gre4) = {
  .node_name = "lb6-gre4",
  .fn = lb_format_adjacency,
...
VNET_IP6_REGISTER_ADJACENCY(lb4_gre6) = {
  .node_name = "lb4-gre6",
  .fn = lb_format_adjacency,
