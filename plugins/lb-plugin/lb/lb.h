...
typedef struct {
  ...
  /**
   * Hash table for existing flows
   */
  clib_bihash_24_8_t sticky_flows_table;
  ...
  /**
   * Number of buckets in the sticky flows table
   */
  u32 sticky_nbuckets;

  /**
   * Size of the sticky flows table
   */
  u32 sticky_size;
