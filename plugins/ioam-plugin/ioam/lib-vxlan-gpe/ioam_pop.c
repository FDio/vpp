			     ...
			     vlib_buffer_t * b0)
{
  ...
  /* Pop the iOAM data */
  vlib_buffer_advance (b0, gpe_ioam0->length);

  gpe_hdr0->protocol = gpe_ioam0->protocol;
  copy_src0 = (u64 *) ((u8 *) ip0 - 4);
  copy_dst0 = (u64 *) ((u8 *) copy_src0 + gpe_ioam0->length);
				  ...
				  u32 * next0)
{
  ...
  if (gpe_ioam0->length > clib_net_to_host_u16 (ip0->length))
    {
      next0[0] = VXLAN_GPE_POP_IOAM_V4_NEXT_DROP;
      goto trace00;
    }
  ...
  next0[0] = VXLAN_GPE_POP_IOAM_V4_NEXT_ETHER;
				    ...
				    u32 * next1)
{
  ...
  next0[0] = next1[0] = VXLAN_GPE_POP_IOAM_V4_NEXT_ETHER;
}
		      ...
		      vlib_frame_t * from_frame, u8 is_ipv6)
{
  ...
  while (n_left_from > 0)
      ...
      while (n_left_from >= 4 && n_left_to_next >= 2)
	{
	  ...
	  next0 = next1 = VXLAN_GPE_POP_IOAM_V4_NEXT_ETHER;
      ...
      while (n_left_from > 0 && n_left_to_next > 0)
	{
	  u32 bi0;
	  vlib_buffer_t *b0;
	  u32 next0 = VXLAN_GPE_POP_IOAM_V4_NEXT_ETHER;
...
VLIB_REGISTER_NODE (vxlan_gpe_pop_ioam_v4_node) = {
  ...
  .n_next_nodes = VXLAN_GPE_POP_IOAM_V4_N_NEXT,

  .next_nodes = {
    [VXLAN_GPE_POP_IOAM_V4_NEXT_ETHER] = "ethernet-input",
    [VXLAN_GPE_POP_IOAM_V4_NEXT_DROP] = "error-drop",
  },
};
/* *INDENT-ON* */
