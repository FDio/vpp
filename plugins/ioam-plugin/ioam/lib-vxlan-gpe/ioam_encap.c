				    ...
				    u32 * next1)
{
  ...
  vxlan_gpe_encap_decap_ioam_v4_one_inline (vm, node, ngm, b0, t0, next0,
					    VXLAN_GPE_ENCAP_IOAM_V4_NEXT_DROP);
  vxlan_gpe_encap_decap_ioam_v4_one_inline (vm, node, ngm, b1, t1, next1,
					    VXLAN_GPE_ENCAP_IOAM_V4_NEXT_DROP);
}
			 ...
			 vlib_frame_t * from_frame)
{
  ...
  while (n_left_from > 0)
      ...
      while (n_left_from >= 4 && n_left_to_next >= 2)
	{
	  ...
	  vxlan_gpe_encap_ioam_v4_two_inline (vm, node, ngm, b0, b1, t0, t1,
					      &next0, &next1);
