...
int
ipfix_collector_reg_flow (vlib_main_t * vm, ipfix_client_add_del_t * info)
{
  ...
  strncpy ((char *) client->client_name, (char *) info->client_name,
	   IPFIX_COLLECTOR_CLIENT_NAME_MAX - 1);
