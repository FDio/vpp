...
def plugin_map_plugins():
    for p in plugins:
        ...
        msg_id_base_set(r.first_msg_id)
        plugins[p]['base'] = r.first_msg_id
...
#
# The language binding itself depends on a couple of API calls. Set these up.
#
VL_API_RX_THREAD_EXIT = plugin_name_to_id('memclnt', 'VL_API_RX_THREAD_EXIT')
VL_API_CONTROL_PING_REPLY = plugin_name_to_id('vpe', 'VL_API_CONTROL_PING_REPLY')
