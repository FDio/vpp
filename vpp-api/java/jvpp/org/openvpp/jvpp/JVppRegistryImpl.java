...
public final class JVppRegistryImpl implements JVppRegistry {
    ...
    public JVppRegistryImpl() throws IOException {
        connection = new VppJNIConnection("CallbackApiWithRegistryTest"); // TODO reduce visibility of VppJNIConnection
        connection.connect();
        map = new ConcurrentHashMap<>(); // TODO do we need the map?
    }
