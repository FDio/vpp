...
public class FutureApiTest {
    ...
    private static void testShowVersion(final FutureJVppFacade jvpp) {
        ...
        try {
            final Future<ShowVersionReply> replyFuture = jvpp.showVersion(new ShowVersion());
    ...
    private static void testGetNodeIndex(final FutureJVppFacade jvpp) {
        ...
        try {
            ...
            final Future<GetNodeIndexReply> replyFuture = jvpp.getNodeIndex(request);
    ...
    private static void testSwInterfaceDump(final FutureJVppFacade jvpp) {
        ...
        try {
            ...
            final Future<SwInterfaceDetailsReplyDump> replyFuture = jvpp.swInterfaceDump(request);
