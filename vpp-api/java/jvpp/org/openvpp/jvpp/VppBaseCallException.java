...
/**
 * Basic Exception representing failed operation of JVpp request call
 */
public class VppBaseCallException extends Exception {
    private final String methodName;    // method name causing failer
    private final int ctxId;            // request context identifier
    private final int errorCode;        // result of the request operation

    /**
     * Constructs an VppBaseCallException with the specified api method name and error code.
     *
