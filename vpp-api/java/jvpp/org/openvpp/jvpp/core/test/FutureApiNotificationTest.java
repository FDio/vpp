...
//
//        jvppFacade.wantInterfaceEvents(NotificationUtils.getEnableInterfaceNotificationsReq()).toCompletableFuture().get();
//        System.out.println("Interface events started");
//
//        System.out.println("Changing interface configuration");
//        jvppFacade.swInterfaceSetFlags(NotificationUtils.getChangeInterfaceState()).toCompletableFuture().get();
//
//        Thread.sleep(1000);
//
//        jvppFacade.wantInterfaceEvents(NotificationUtils.getDisableInterfaceNotificationsReq()).toCompletableFuture().get();
