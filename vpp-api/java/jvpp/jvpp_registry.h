...
// FIXME (vale should be either shared between plugins or constructed in a way that prevents collisions)
...
static inline int vppjni_sanity_check (jvpp_main_t * jm)
{
    if (!jm->is_connected)
