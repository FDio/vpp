...
def generate_jvpp(func_list, base_package, dto_package, callback_package, future_facade_package):
    ...
    jvpp_file.write(future_jvpp_template.substitute(base_package=base_package,
    ...
    jvpp_file.write(future_jvpp_facade_template.substitute(base_package=base_package,
                                                           dto_package=dto_package,
 ...
 * Preventing casts on client side when using Invoker APIs
 */
...
future_jvpp_method_template = Template('''
    java.util.concurrent.Future<$base_package.$dto_package.$reply_name> $method_name($base_package.$dto_package.$request_name request);
''')
...
future_jvpp_method_impl_template = Template('''
    @Override
    public java.util.concurrent.Future<$base_package.$dto_package.$reply_name> $method_name($base_package.$dto_package.$request_name request) {
        return send(request);
    }
''')
