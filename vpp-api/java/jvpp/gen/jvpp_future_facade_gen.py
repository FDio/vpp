...
future_jvpp_method_impl_template = Template('''
    ...
    public java.util.concurrent.CompletionStage<$base_package.$dto_package.$reply_name> $method_name($base_package.$dto_package.$request_name request) {
        try {
            return send(request);
        } catch(org.openvpp.jvpp.VppInvocationException ex) {
            final java.util.concurrent.CompletableFuture<$base_package.$dto_package.$reply_name> replyCompletableFuture = new java.util.concurrent.CompletableFuture<$base_package.$dto_package.$reply_name>();
