...
public final class NotificationRegistryImpl implements NotificationRegistry, GlobalNotificationCallback {
    ...
    private final java.util.concurrent.ConcurrentMap<Class<? extends $base_package.$dto_package.JVppNotification>, $base_package.$callback_package.JVppCallback> registeredCallbacks =
...
handler_impl_template = Template("""
    ...
    public void on$notification(
        ...
        final $base_package.$callback_package.JVppCallback jVppCallback = registeredCallbacks.get($base_package.$dto_package.$notification.class);
