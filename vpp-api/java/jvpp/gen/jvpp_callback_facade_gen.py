 ...
 * <br>(python representation of vpe.api generated by vppapigen).
 */
public final class CallbackJVppFacade extends $base_package.$notification_package.NotificationRegistryProvider implements $base_package.$callback_facade_package.CallbackJVpp {
