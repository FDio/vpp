...
def generate_jni_impl(func_list):
    ...
    for f in func_list:
        ...
        if is_manually_generated(camel_case_function_name) or util.is_reply(camel_case_function_name) \
                or util.is_ignored(camel_case_function_name) or util.is_notification(camel_case_function_name):
            continue
...
def generate_msg_handlers(func_list):
    ...
    for f in func_list:
        ...
        if is_manually_generated(handler_name) or not util.is_reply(dto_name) or util.is_ignored(dto_name) or util.is_notification(dto_name):
