...
parser.add_argument('--plugin_package', action="store", dest="plugin_package", default='org.openvpp.jvpp')
...
callback_gen.generate_callbacks(func_list, base_package, plugin_package, callback_package, dto_package, args.inputfile)
