...
def is_supported(f_name):
    return f_name not in {'vnet_ip4_fib_counters', 'vnet_ip6_fib_counters', # FIXME: functions unsupported due to problems with vpe.api
                          'l2_fib_table_entry' # FIXME: either add client_index or make C code generator smarter
                          }
...
dto_gen.generate_dtos(func_list, base_package, dto_package)
jvpp_impl_gen.generate_jvpp(func_list, base_package, dto_package)
callback_gen.generate_callbacks(func_list, base_package, callback_package, dto_package)
jvpp_c_gen.generate_jvpp(func_list)
jvpp_future_facade_gen.generate_jvpp(func_list, base_package, dto_package, callback_package, future_package)
jvpp_callback_facade_gen.generate_jvpp(func_list, base_package, dto_package, callback_package, callback_facade_package)
