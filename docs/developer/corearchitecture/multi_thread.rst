...
into consideration that the VPP process might be limited to a subset of logical
cores on the host machine (e.g. using control groups or in a container environment),
and automatically remaps the user requested pinning configuration.
