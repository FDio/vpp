...
`session_stats.h <../base/session_stats/session_stats.h>`_
and per-packet processing logic is in
`node.c <../base/session_stats/node.c>`_.
...
- **Entry size**: curently set to 384 bytes, to fit on 6 cache lines.
...
`setup.pg <../../../src/plugins/sfdp_services/base/session_stats/setup.pg>`_.
