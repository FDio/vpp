...
Now, you need to bind the NICs (Network Card Interface) to VPP. Firstly you have the retrieve the PCIs of the NICs you want to bind:
...
The PCIs have a format similar to this: 0000:00:0X.0. Once you retrieve them, you should copy them inside the startup file of VPP:
