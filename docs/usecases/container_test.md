...
Create /etc/netplan/50-cloud-init.yaml:
...
Set up /etc/apt/sources.list via cut-'n-paste from a recently update
"focal" host. Something like so:
...
Suggest "apt-get install make gitk".
