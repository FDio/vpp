...
delta_clock_in_seconds are identical modulo one system-call time. On
the other hand, a _deus ex machina_ is perfectly capable of yanking
the system reference time - in either direction - by an hour or a day.
