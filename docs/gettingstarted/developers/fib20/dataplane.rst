...
- write custom DPOs/nodes for combinds functions, e.g. pop MPLS label
  and lookup in v4 table. This has the disadvantage that the nuber of
...
In either case a disadvantgae to collapsing the graph is that it
