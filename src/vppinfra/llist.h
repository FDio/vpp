...
#define clib_llist_remove(LP, name, E)                                        \
  do                                                                          \
    {                                                                         \
      ASSERT ((E) !=                                                          \
	      clib_llist_next (LP, name, E)); /* don't remove sentinel */     \
...
#define clib_llist_splice(LP, name, P, H)                                     \
  do                                                                          \
	...
	{                                                                     \
	  ...
	  _lnext (_ll_var (le), name) =                                       \
	    clib_llist_entry_index (LP, _ll_var (ne));                        \
	  _lnext (P, name) = clib_llist_entry_index (LP, _ll_var (fe));       \
	  _lprev (_ll_var (ne), name) =                                       \
	    clib_llist_entry_index (LP, _ll_var (le));                        \
