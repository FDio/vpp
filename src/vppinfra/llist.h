 ...
 */
#define llist_next(LP,name,E) llist_pool_entry((LP),_lnext((E),name))
/**
 ...
 */
#define llist_prev(LP,name,E) llist_pool_entry((LP),_lprev((E),name))
/**
...
do {								\
  _lprev ((E),name) = llist_entry_index ((LP), (E));		\
...
do {									\
  ...
  _lprev ((N),name) = llist_entry_index ((LP),(E));			\
  _lnext ((P),name) = llist_entry_index ((LP),(E));			\
} while (0)
/**
...
do {									\
  ...
  _lnext (llist_prev (LP,name,E),name) = _lnext (E,name);		\
  _lprev (llist_next (LP,name,E),name) = _lprev (E,name);		\
  _lnext (E,name) = _lprev (E,name) = LLIST_INVALID_INDEX;		\
}while (0)
...
do {									\
  ...
  if (_ll_var (fe) != (H))						\
    {									\
      ...
      _lprev (_ll_var (fe),name) = llist_entry_index(LP,P);		\
      _lnext (_ll_var (le),name) = llist_entry_index(LP,_ll_var (ne));	\
      _lnext (P,name) = llist_entry_index (LP,_ll_var (fe));		\
      _lprev (_ll_var (ne),name) = llist_entry_index(LP,_ll_var (le));	\
      _lnext (H,name) = llist_entry_index(LP,H);			\
