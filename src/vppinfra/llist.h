 ...
 */
#define llist_next(LP,name,E) pool_elt_at_index((LP),_lnext((E),name))
/**
 ...
 */
#define llist_prev(LP,name,E) pool_elt_at_index((LP),_lprev((E),name))
/**
...
do {									\
  ...
  ASSERT (_lnext (E,name) != LLIST_INVALID_INDEX);			\
  ASSERT (_lprev (E,name) != LLIST_INVALID_INDEX);			\
