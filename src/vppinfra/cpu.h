...
#define AARCH64_CPU_PART_NEOVERSEV1 0xd40
...
static inline int
clib_cpu_march_priority_neoversev1 ()
{
  const clib_cpu_info_t *info = clib_get_cpu_info ();
  ...
  if (info->aarch64.part_num == AARCH64_CPU_PART_NEOVERSEV1)
    return 10;
