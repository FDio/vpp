...
#define _CLIB_MARCH_FN_REGISTRATION(fn)                                       \
  static clib_march_fn_registration CLIB_MARCH_SFX (                          \
    fn##_march_fn_registration) = { .name = CLIB_MARCH_VARIANT_STR };         \
                                                                              \
...
#define CLIB_MARCH_FN_CONSTRUCTOR(fn)                                         \
  static void __clib_constructor CLIB_MARCH_SFX (fn##_march_constructor) (    \
    void)                                                                     \
  {                                                                           \
