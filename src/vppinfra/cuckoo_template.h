...
typedef struct
{
  ...
  /** snapshost pointers no longer in use (per cpu) */
                                                  ...
                                                  u8 reduced_hash)
{
  ...
  clib_cuckoo_bucket_foreach_idx_unrolled (i, {
    ...
    if (
      ...
      {
        CVT (clib_cuckoo_kv) value_copy;
        value_copy.value = b->elts[i].value;
