...
\
static_always_inline t##s##x##c \
t##s##x##c##_splat_zero (boolxn pg, t##s x) \
...
\
static_always_inline t##s##x##c \
t##s##x##c##_add_n (boolxn pg, t##s##x##c a, t##s b) \
...
\
static_always_inline t##s##x##c \
t##s##x##c##_sub_n (boolxn pg, t##s##x##c a, t##s b) \
...
t##s##x##c##_elt_mask (i64 a, i64 b) \
{ return svwhilelt_b##s (a, b); } \
\
static_always_inline boolxn \
t##s##x##c##_eltall_mask () \
{ return svptrue_b##s (); } \
\
static_always_inline t##s##x##c \
t##s##x##c##_and (boolxn pg, t##s##x##c a, t##s##x##c b) \
{ return (t##s##x##c) svand_##i##_z (pg, a, b); } \
\
static_always_inline t##s##x##c \
t##s##x##c##_or (boolxn pg, t##s##x##c a, t##s##x##c b) \
{ return (t##s##x##c) svorr_##i##_z (pg, a, b); } \
\
static_always_inline t##s##x##c \
t##s##x##c##_or_n (boolxn pg, t##s##x##c a, t##s b) \
{ return (t##s##x##c) svorr_n_##i##_z (pg, a, b); } \
\
static_always_inline boolxn \
t##s##x##c##_equal (boolxn pg, t##s##x##c a, t##s##x##c b) \
{ return svcmpeq_##i (pg, a, b); } \
\
static_always_inline boolxn \
t##s##x##c##_unequal (boolxn pg, t##s##x##c a, t##s##x##c b) \
{ return svcmpne_##i (pg, a, b); } \
\
static_always_inline t##s \
t##s##x##c##_reduction_or (boolxn pg, t##s##x##c a) \
{ return svorv_##i (pg, a); } \
\
static_always_inline t##s##x##c \
t##s##x##c##_from_u8xn (u8xn a) \
{ return svreinterpret_##i (a); } \
\
static_always_inline t##s##x##c \
t##s##x##c##_from_u16xn (u16xn a) \
{ return svreinterpret_##i (a); } \
\
static_always_inline t##s##x##c \
t##s##x##c##_from_u32xn (u32xn a) \
{ return svreinterpret_##i (a); } \
\
static_always_inline t##s##x##c \
t##s##x##c##_from_u64xn (u64xn a) \
{ return svreinterpret_##i (a); } \
\
static_always_inline t##s##x##c \
t##s##x##c##_from_i8xn (i8xn a) \
{ return svreinterpret_##i (a); } \
\
static_always_inline t##s##x##c \
t##s##x##c##_from_i16xn (i16xn a) \
{ return svreinterpret_##i (a); } \
\
static_always_inline t##s##x##c \
t##s##x##c##_from_i32xn (i32xn a) \
{ return svreinterpret_##i (a); } \
\
static_always_inline t##s##x##c \
t##s##x##c##_from_i64xn (i64xn a) \
{ return svreinterpret_##i (a); } \
\
static_always_inline t##s##x##c \
t##s##x##c##_create_indexes (t##s base, t##s step) \
{ return svindex_##i (base, step); } \
\
static_always_inline t##s \
t##s##x##c##_eltmin (boolxn pg, t##s##x##c a) \
...
#define foreach_sve_vec_i \
    _(i,8,n,s8,b) _(i,16,n,s16,h) _(i,32,n,s32,w) _(i,64,n,s64,d)
#define foreach_sve_vec_u \
    _(u,8,n,u8,b) _(u,16,n,u16,h) _(u,32,n,u32,w) _(u,64,n,u64,d)
...
\
static_always_inline i32 \
t##s##x##c##_active_eno (boolxn pg, boolxn a) \
{ return (i32) svcntp_b##s (pg, a); } \
\
static_always_inline void \
t##s##x##c##_prefetch_vector (boolxn pg, u64xn bases) \
