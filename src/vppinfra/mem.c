...
static int
clib_mem_vm_maps_sort (void *a1, void *a2)
{
  clib_mem_map_t *m1 = a1;
  clib_mem_map_t *m2 = a2;
...
{
  clib_mem_main_t *mm = &clib_mem_main;
  clib_mem_map_t *m, *list = 0;

  pool_foreach (m, mm->vm_maps,
		{
		vec_add (list, m, 1);
		}
  );

  vec_sort_with_function (list, clib_mem_vm_maps_sort);
