...
clib_bihash_key_compare_48_8 (u64 * a, u64 * b)
{
  ...
  u64x4 v1, zero = { 0 };
  u64x2 v2;
  v1 = u64x4_load_unaligned (a) ^ u64x4_load_unaligned (b);
  v2 = u64x2_load_unaligned (a + 4) ^ u64x2_load_unaligned (b + 4);
  return u64x4_is_all_zero (v1 | u64x4_insert_lo (zero, v2));
