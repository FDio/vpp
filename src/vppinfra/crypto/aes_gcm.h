...
static_always_inline void
clib_aes128_gcm_enc (aes_gcm_key_data_t *kd, const u8 *in, u8 *out,
		     u32 data_bytes, const u8 *aad, u32 aad_bytes,
		     const u8 *iv, const u8 *tag, u32 tag_bytes)
{
  aes_gcm ((u8x16u *) in, (u8x16u *) out, (u8x16u *) aad, (u8 *) iv,
	   (u8x16u *) tag, data_bytes, aad_bytes, tag_bytes, kd,
	   AES_KEY_ROUNDS (AES_KEY_128), /* is_encrypt */ 1);
}

static_always_inline void
clib_aes256_gcm_enc (aes_gcm_key_data_t *kd, const u8 *in, u8 *out,
		     u32 data_bytes, const u8 *aad, u32 aad_bytes,
		     const u8 *iv, const u8 *tag, u32 tag_bytes)
{
  aes_gcm ((u8x16u *) in, (u8x16u *) out, (u8x16u *) aad, (u8 *) iv,
...
static_always_inline int
clib_aes128_gcm_dec (aes_gcm_key_data_t *kd, const u8 *in, u8 *out,
		     u32 data_bytes, const u8 *aad, u32 aad_bytes,
		     const u8 *iv, const u8 *tag, u32 tag_bytes)
{
  return aes_gcm ((u8x16u *) in, (u8x16u *) out, (u8x16u *) aad, (u8 *) iv,
		  (u8x16u *) tag, data_bytes, aad_bytes, tag_bytes, kd,
		  AES_KEY_ROUNDS (AES_KEY_128), /* is_encrypt */ 0);
}

static_always_inline int
clib_aes256_gcm_dec (aes_gcm_key_data_t *kd, const u8 *in, u8 *out,
		     u32 data_bytes, const u8 *aad, u32 aad_bytes,
		     const u8 *iv, const u8 *tag, u32 tag_bytes)
{
  return aes_gcm ((u8x16u *) in, (u8x16u *) out, (u8x16u *) aad, (u8 *) iv,
