...
#define _(b)                                                                  \
  ...
  {                                                                           \
    ...
    clib_aes##b##_cbc_encrypt (data, plaintext, &k, iv, sizeof (plaintext));  \
  ...
  {                                                                           \
    ...
    clib_aes##b##_cbc_encrypt (dst, src, kd, iv, n);                          \
...
#define _(b)                                                                  \
  ...
  {                                                                           \
    ...
    u8 data[512];                                                             \
    clib_aes##b##_cbc_key_expand (&k, key##b);                                \
    clib_aes##b##_cbc_decrypt (data, ciphertext##b, &k, iv,                   \
			       sizeof (ciphertext##b));                       \
  ...
  {                                                                           \
    ...
    clib_aes##b##_cbc_key_expand (kd, key##b);                                \
                                                                              \
    test_perf_event_enable (tp);                                              \
    clib_aes##b##_cbc_decrypt (dst, src, kd, iv, n);                          \
    test_perf_event_disable (tp);                                             \
                                                                              \
    test_mem_free (dst);                                                      \
    test_mem_free (src);                                                      \
