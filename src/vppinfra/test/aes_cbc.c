...
#define _(b)                                                                  \
  ...
  {                                                                           \
    ...
    clib_aes##b##_cbc_encrypt (&k, data, plaintext, sizeof (plaintext), iv);  \
  ...
  {                                                                           \
    ...
    clib_aes##b##_cbc_encrypt (kd, dst, src, n, iv);                          \
...
#define _(b)                                                                  \
  ...
  {                                                                           \
    ...
    u8 data[512];                                                             \
    clib_aes##b##_cbc_key_expand (&k, key##b);                                \
    clib_aes##b##_cbc_decrypt (&k, data, ciphertext##b, iv,                   \
			       sizeof (ciphertext##b));                       \
  ...
  {                                                                           \
    ...
    clib_aes##b##_cbc_key_expand (kd, key##b);                                \
                                                                              \
    test_perf_event_enable (tp);                                              \
    clib_aes##b##_cbc_decrypt (kd, dst, src, iv, n);                          \
    test_perf_event_disable (tp);                                             \
                                                                              \
    test_mem_free (dst);                                                      \
    test_mem_free (src);                                                      \
