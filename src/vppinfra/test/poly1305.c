...
const static struct
{
...
} test_cases[] = {
  {
    .name = "test1",
    .len = 34,
    .tag = { 0xa8, 0x06, 0x1d, 0xc1, 0x30, 0x51, 0x36, 0xc6, 0xc2, 0x2b, 0x8b,
  ...
  },
  {
    .name = "RFC8439 A3 TV2",
    .len = sizeof (text1),
    .tag = { 0x36, 0xe5, 0xf6, 0xb5, 0xc5, 0xe0, 0x60, 0x70, 0xf0, 0xef, 0xca,
  ...
  },
  {
    ...
    .tag = { 0x45, 0x41, 0x66, 0x9a, 0x7e, 0xaa, 0xee, 0x61, 0xe7, 0x08, 0xdc,
  ...
  },
  {
    ...
    .msg = (u8[16]){ 0xFD, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
		     0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF },
    .tag = { 0xFa, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
  ...
  },
  {
    ...
    .msg =
      (u8[64]){ 0xE3, 0x35, 0x94, 0xD7, 0x50, 0x5E, 0x43, 0xB9, 0x00, 0x00,
		...
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00 },
    .tag = { 0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x55, 0x00, 0x00,
...
test_clib_poly1305 (clib_error_t *err)
{
  ...
  FOREACH_ARRAY_ELT (tc, test_cases)
    {
      clib_poly1305 (tc->key, tc->msg, tc->len, tag);
      if (memcmp (tag, tc->tag, 16) != 0)
	err = clib_error_return (
	  ...
	  tc->len, format_hexdump, tc->tag, 16, format_hexdump, tag, 16);
    }
  return err;
}
