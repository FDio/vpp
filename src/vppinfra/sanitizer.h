...
#define CLIB_MEM_OVERFLOW_LOAD(f, src)                                        \
  ({                                                                          \
    ...
    typeof (f (clib_mem_overflow_load_src__)) clib_mem_overflow_load_ret__;   \
    CLIB_MEM_OVERFLOW_PUSH (clib_mem_overflow_load_src__,                     \
			    sizeof (clib_mem_overflow_load_ret__));           \
    clib_mem_overflow_load_ret__ = f (clib_mem_overflow_load_src__);          \
