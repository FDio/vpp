...
void clib_sanitizer_unpoison_push__ (u64 *shadow, u64 **shadow_ptr,
				     const void *ptr, size_t len);
void clib_sanitizer_unpoison_pop__ (u64 shadow, u64 *shadow_ptr);
...
#define CLIB_MEM_OVERFLOW_PUSH(src, n)                                        \
  do                                                                          \
    {                                                                         \
      ...
      clib_sanitizer_unpoison_push__ (&clib_mem_overflow_shadow__,            \
				      &clib_mem_overflow_shadow_ptr__, (src), \
				      (n))
