...
clib_memcpy16 (void *d, void *s)
{
  ...
  __builtin_ia32_storedqu (d, __builtin_ia32_loaddqu (s));
#else
  *(u8x16u *) d = *(u8x16u *) s;
#endif
}
...
clib_memcpy_x86_64 (void *restrict dst, const void *restrict src, size_t n)
{
  ...
  if (n <= 32)
    ...
    more:
      // printf("more n %lu nr %lu off %lu x %u\n", n, nr, off, x);
      v0 = *(u8x32u *) (s + off);
      v1 = *(u8x32u *) (s + off + 32);
      v2 = *(u8x32u *) (s + off + 64);
      v3 = *(u8x32u *) (s + off + 96);
  ...
  asm volatile(
    ...
    "vmovdqu	(%[src]), %%xmm15		\n\t"
    "vmovdqu	%%xmm15, (%[dst])		\n\t"
    "vmovdqu	-0x10(%[src],%[n]), %%xmm15	\n\t"
    "vmovdqu	%%xmm15, -0x10(%[dst],%[n])	\n\t"
#else
    "vmovdqu	(%[src]), %x[ymm0]		\n\t"
    "vmovdqu	%x[ymm0], (%[dst])		\n\t"
    "vmovdqu	-0x10(%[src],%[n]), %x[ymm0]	\n\t"
    "vmovdqu	%x[ymm0], -0x10(%[dst],%[n])	\n\t"
#endif
#endif
    "jmp	.L_done_%=			\n\t"
    /* copy first 32 bytes */
    ...
    ".L_more_%=:				\n\t"
    "vmovdqu	-0x200(%[src],%%r11), %[ymm0]	\n\t"
    "vmovdqu	-0x1e0(%[src],%%r11), %[ymm1]	\n\t"
    "vmovdqu	-0x1c0(%[src],%%r11), %[ymm2]	\n\t"
    "vmovdqu	-0x1a0(%[src],%%r11), %[ymm3]	\n\t"
    "vmovdqa	%[ymm0], -0x200(%[dst],%%r11)	\n\t"
    "vmovdqa	%[ymm1], -0x1e0(%[dst],%%r11)	\n\t"
    "vmovdqa	%[ymm2], -0x1c0(%[dst],%%r11)	\n\t"
    "vmovdqa	%[ymm3], -0x1a0(%[dst],%%r11)	\n\t"
    "vmovdqu	-0x180(%[src],%%r11), %[ymm0]	\n\t"
    "vmovdqu	-0x160(%[src],%%r11), %[ymm1]	\n\t"
    "vmovdqu	-0x140(%[src],%%r11), %[ymm2]	\n\t"
    "vmovdqu	-0x120(%[src],%%r11), %[ymm3]	\n\t"
    "vmovdqa	%[ymm0], -0x180(%[dst],%%r11)	\n\t"
    "vmovdqa	%[ymm1], -0x160(%[dst],%%r11)	\n\t"
    "vmovdqa	%[ymm2], -0x140(%[dst],%%r11)	\n\t"
    "vmovdqa	%[ymm3], -0x120(%[dst],%%r11)	\n\t"
    "add	$0x100, %%r11			\n\t"
    "cmp	%[tmp], %%r11			\n\t"
    "jne	.L_more_%=			\n\t"
    ...
    "vmovdqu	-0x140(%[src],%%r11), %[ymm0]	\n\t"
    "vmovdqu	%[ymm0], -0x140(%[dst],%%r11)	\n\t"
    "vmovdqu	-0x160(%[src],%%r11), %[ymm0]	\n\t"
    "vmovdqu	%[ymm0], -0x160(%[dst],%%r11)	\n\t"
    "vmovdqu	-0x180(%[src],%%r11), %[ymm0]	\n\t"
    "vmovdqu	%[ymm0], -0x180(%[dst],%%r11)	\n\t"
    "vmovdqu	-0x1a0(%[src],%%r11), %[ymm0]	\n\t"
    "vmovdqu	%[ymm0], -0x1a0(%[dst],%%r11)	\n\t"
    "vmovdqu	-0x1c0(%[src],%%r11), %[ymm0]	\n\t"
    "vmovdqu	%[ymm0], -0x1c0(%[dst],%%r11)	\n\t"
    "vmovdqu	-0x1e0(%[src],%%r11), %[ymm0]	\n\t"
    "vmovdqu	%[ymm0], -0x1e0(%[dst],%%r11)	\n\t"
    ".L_only_one_%=:				\n\t"
    "vmovdqu	-0x200(%[src],%%r11), %[ymm0]	\n\t"
    "vmovdqu	%[ymm0], -0x200(%[dst],%%r11)	\n\t"
    ".L_last_%=:				\n\t"
    /* copy last 32 bytes */
  ...
  asm volatile(
    ...
    /* main 256-byte copy loop */
    ".L_more_%=:				\n\t"
    "movdqu	-0x200(%[src],%%r11), %[xmm0]	\n\t"
    "movdqu	-0x1f0(%[src],%%r11), %[xmm1]	\n\t"
    "movdqu	-0x1e0(%[src],%%r11), %[xmm2]	\n\t"
    "movdqu	-0x1d0(%[src],%%r11), %[xmm3]	\n\t"
    "movdqa	%[xmm0], -0x200(%[dst],%%r11)	\n\t"
    "movdqa	%[xmm1], -0x1f0(%[dst],%%r11)	\n\t"
    "movdqa	%[xmm2], -0x1e0(%[dst],%%r11)	\n\t"
    "movdqa	%[xmm3], -0x1d0(%[dst],%%r11)	\n\t"
    "movdqu	-0x1c0(%[src],%%r11), %[xmm0]	\n\t"
    "movdqu	-0x1b0(%[src],%%r11), %[xmm1]	\n\t"
    "movdqu	-0x1a0(%[src],%%r11), %[xmm2]	\n\t"
    "movdqu	-0x190(%[src],%%r11), %[xmm3]	\n\t"
    "movdqa	%[xmm0], -0x1c0(%[dst],%%r11)	\n\t"
    "movdqa	%[xmm1], -0x1b0(%[dst],%%r11)	\n\t"
    "movdqa	%[xmm2], -0x1a0(%[dst],%%r11)	\n\t"
    "movdqa	%[xmm3], -0x190(%[dst],%%r11)	\n\t"
    "movdqu	-0x180(%[src],%%r11), %[xmm0]	\n\t"
    "movdqu	-0x170(%[src],%%r11), %[xmm1]	\n\t"
    "movdqu	-0x160(%[src],%%r11), %[xmm2]	\n\t"
    "movdqu	-0x150(%[src],%%r11), %[xmm3]	\n\t"
    "movdqa	%[xmm0], -0x180(%[dst],%%r11)	\n\t"
    "movdqa	%[xmm1], -0x170(%[dst],%%r11)	\n\t"
    "movdqa	%[xmm2], -0x160(%[dst],%%r11)	\n\t"
    "movdqa	%[xmm3], -0x150(%[dst],%%r11)	\n\t"
    "movdqu	-0x140(%[src],%%r11), %[xmm0]	\n\t"
    "movdqu	-0x130(%[src],%%r11), %[xmm1]	\n\t"
    "movdqu	-0x120(%[src],%%r11), %[xmm2]	\n\t"
    "movdqu	-0x110(%[src],%%r11), %[xmm3]	\n\t"
    "movdqa	%[xmm0], -0x140(%[dst],%%r11)	\n\t"
    "movdqa	%[xmm1], -0x130(%[dst],%%r11)	\n\t"
    "movdqa	%[xmm2], -0x120(%[dst],%%r11)	\n\t"
    "movdqa	%[xmm3], -0x110(%[dst],%%r11)	\n\t"
    "add	$0x100, %%r11			\n\t"
    "cmp	%[tmp], %%r11			\n\t"
    "jne	.L_more_%=			\n\t"
    ...
    "movdqu	-0x120(%[src],%%r11), %[xmm0]	\n\t"
    "movdqu	%[xmm0], -0x120(%[dst],%%r11)	\n\t"
    "movdqu	-0x130(%[src],%%r11), %[xmm0]	\n\t"
    "movdqu	%[xmm0], -0x130(%[dst],%%r11)	\n\t"
    "movdqu	-0x140(%[src],%%r11), %[xmm0]	\n\t"
    "movdqu	%[xmm0], -0x140(%[dst],%%r11)	\n\t"
    "movdqu	-0x150(%[src],%%r11), %[xmm0]	\n\t"
    "movdqu	%[xmm0], -0x150(%[dst],%%r11)	\n\t"
    "movdqu	-0x160(%[src],%%r11), %[xmm0]	\n\t"
    "movdqu	%[xmm0], -0x160(%[dst],%%r11)	\n\t"
    "movdqu	-0x170(%[src],%%r11), %[xmm0]	\n\t"
    "movdqu	%[xmm0], -0x170(%[dst],%%r11)	\n\t"
    "movdqu	-0x180(%[src],%%r11), %[xmm0]	\n\t"
    "movdqu	%[xmm0], -0x180(%[dst],%%r11)	\n\t"
    "movdqu	-0x190(%[src],%%r11), %[xmm0]	\n\t"
    "movdqu	%[xmm0], -0x190(%[dst],%%r11)	\n\t"
    "movdqu	-0x1a0(%[src],%%r11), %[xmm0]	\n\t"
    "movdqu	%[xmm0], -0x1a0(%[dst],%%r11)	\n\t"
    "movdqu	-0x1b0(%[src],%%r11), %[xmm0]	\n\t"
    "movdqu	%[xmm0], -0x1b0(%[dst],%%r11)	\n\t"
    "movdqu	-0x1c0(%[src],%%r11), %[xmm0]	\n\t"
    "movdqu	%[xmm0], -0x1c0(%[dst],%%r11)	\n\t"
    "movdqu	-0x1d0(%[src],%%r11), %[xmm0]	\n\t"
    "movdqu	%[xmm0], -0x1d0(%[dst],%%r11)	\n\t"
    "movdqu	-0x1e0(%[src],%%r11), %[xmm0]	\n\t"
    "movdqu	%[xmm0], -0x1e0(%[dst],%%r11)	\n\t"
    ".L_only_two_%=:				\n\t"
    "movdqu	-0x1f0(%[src],%%r11), %[xmm0]	\n\t"
    "movdqu	%[xmm0], -0x1f0(%[dst],%%r11)	\n\t"
    ".L_only_one_%=:				\n\t"
    "movdqu	-0x200(%[src],%%r11), %[xmm0]	\n\t"
    "movdqu	%[xmm0], -0x200(%[dst],%%r11)	\n\t"
    ".L_last_%=:				\n\t"
    /* copy last 32 bytes */
    ...
    :
    /* clobbers */
    "memory", "r11" /* force use r11 for offset so REX encoding is used */);
