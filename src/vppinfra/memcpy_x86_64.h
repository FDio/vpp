...
last:
  ...
  if (PREDICT_TRUE (n))
	...
	"1:\n"
	"vmovdqu8 0x80(%[src]), %%zmm15;\n"
	"vmovdqu8 %%zmm15, 0x80(%[dst]);\n"
	"vmovdqu8 0x40(%[src]), %%zmm15;\n"
	"vmovdqu8 %%zmm15, 0x40(%[dst]);\n"
	"%{disp8%} vmovdqu8 0x00(%[src]), %%zmm15;\n"
	"%{disp8%} vmovdqu8 %%zmm15, 0x00(%[dst]);\n"
