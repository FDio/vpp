...
*/
always_inline int clib_cuckoo_kv_is_free_8_8 (const clib_cuckoo_kv_8_8_t *v)
{
...
always_inline void clib_cuckoo_kv_set_free_8_8 (clib_cuckoo_kv_8_8_t *v)
{
...
*/
always_inline u8 *format_cuckoo_kvp_8_8 (u8 *s, va_list *args)
{
...
always_inline u64 clib_cuckoo_hash_8_8 (clib_cuckoo_kv_8_8_t *v)
{
...
/** Compare two clib_cuckoo_kv_8_8_t instances
    ...
    @param b - second key
*/
always_inline int clib_cuckoo_key_compare_8_8 (u64 a, u64 b) { return a == b; }
