...
#ifndef BIHASH_32_64_SVM
#define BIHASH_32_64_SVM 1
#endif

#ifdef BIHASH_32_64_SVM
#include </usr/include/linux/memfd.h>
...
/* Max page size 2**20 */
#define BIHASH_FREELIST_LENGTH 20
#endif
...
typedef CLIB_PACKED (struct
		     ...
		     volatile u32 ready; u64 pad;
		     }) BVT (clib_bihash_shared_header);

STATIC_ASSERT_SIZEOF (BVT (clib_bihash_shared_header), CLIB_CACHE_LINE_BYTES);
