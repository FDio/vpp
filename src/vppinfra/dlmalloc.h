 ...
 *
 * Above this threshold the sys_alloc() calls mmap_alloc() to directly mmap the
 * memory. However, the interaction of this path with the rest of the vpp infra
 * results in vpp infra considering directly mmap-allocated pieces to not be
 * part of the heap, with predictable consequence.
 *
...
#define dlbulk_free		     bulk_free
  ...
  */
  ...
  DLMALLOC_EXPORT void mspace_get_address_and_size (mspace msp, char **addrp,
						    size_t *sizep);
