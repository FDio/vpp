...
clib_mask_compare_u16 (u16 v, u16 *a, u64 *bitmap, u32 n_elts)
{
  while (n_elts >= 64)
    {
      bitmap++[0] = clib_mask_compare_u16_x64 (v, a, 64);
      n_elts -= 64;
      a += 64;
    }
  ...
  bitmap[0] = clib_mask_compare_u16_x64 (v, a, n_elts) & pow2_mask (n_elts);
}
...
clib_mask_compare_u32_x64 (u32 v, u32 *a, u32 n_elts)
{
  ...
  c = i16x16_pack (i16x16_pack (v8 == av[0], v8 == av[1]),
		   i16x16_pack (v8 == av[2], v8 == av[3]));
  mask = i8x32_msb_mask ((i8x32) u32x8_permute (c, m));

  c = i16x16_pack (i16x16_pack (v8 == av[4], v8 == av[5]),
		   i16x16_pack (v8 == av[6], v8 == av[7]));
