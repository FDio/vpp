...
#define clib_atomic_cmp_and_swap(addr,old,_new) __sync_val_compare_and_swap(addr, old, _new)
#define clib_atomic_bool_cmp_and_swap(addr,old,_new) __sync_bool_compare_and_swap(addr, old, _new)

#define clib_atomic_cmp_and_swap_acq_relax_n(addr,exp,_new,weak) __atomic_compare_exchange_n ((addr), (exp), (_new), (weak), __ATOMIC_ACQUIRE, __ATOMIC_RELAXED)
