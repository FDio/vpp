...
api_ip_add_del_route (vat_main_t * vam)
{
  ...
  bool is_ipv6 = 0;
  bool is_local = 0, is_drop = 0;
  bool is_unreach = 0, is_prohibit = 0;
  bool is_add = 1;
...
api_ipsec_spd_entry_add_del (vat_main_t * vam)
{
  ...
  bool is_add = 1, is_outbound = 0, is_ipv6 = 0, is_ip_any = 1;
...
api_one_eid_table_add_del_map (vat_main_t * vam)
{
  ...
  bool is_add = 1, vni_set = 0, vrf_set = 0, bd_index_set = 0;
...
api_one_add_del_remote_mapping (vat_main_t * vam)
{
  ...
  bool is_add = 1, del_all = 0, eid_set = 0, seid_set = 0;
...
api_one_locator_dump (vat_main_t * vam)
{
  ...
  vl_api_control_ping_t *mp_ping;
  bool is_index_set = 0, is_name_set = 0;
  u8 *ls_name = 0;
  u32 ls_index = ~0;
  int ret;
...
api_gpe_add_del_native_fwd_rpath (vat_main_t * vam)
{
  ...
  int ret = 0;
  bool is_add = 1, ip_set = 0, is_ip4 = 1;
  struct in_addr ip4;
  struct in6_addr ip6;
