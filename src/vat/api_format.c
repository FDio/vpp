...
static void
vl_api_tapv2_create_reply_t_handler (vl_api_tapv2_create_reply_t * mp)
{
  vat_main_t *vam = &vat_main;
  i32 retval = ntohl (mp->retval);
  if (vam->async_mode)
...
static void vl_api_tapv2_create_reply_t_handler_json
  (vl_api_tapv2_create_reply_t * mp)
{
  vat_main_t *vam = &vat_main;
  vat_json_node_t node;
...
static void
vl_api_tapv2_delete_reply_t_handler (vl_api_tapv2_delete_reply_t * mp)
{
  vat_main_t *vam = &vat_main;
  i32 retval = ntohl (mp->retval);
  if (vam->async_mode)
...
static void vl_api_tapv2_delete_reply_t_handler_json
  (vl_api_tapv2_delete_reply_t * mp)
{
  vat_main_t *vam = &vat_main;
  vat_json_node_t node;
...
_(TAPV2_CREATE_REPLY, tapv2_create_reply)				\
_(TAPV2_DELETE_REPLY, tapv2_delete_reply)				\
_(SW_INTERFACE_TAPV2_DETAILS, sw_interface_tapv2_details)               \
...
static int
api_tapv2_create (vat_main_t * vam)
{
  unformat_input_t *i = vam->input;
  vl_api_tapv2_create_t *mp;
  u8 mac_address[6];
  u8 random_mac = 1;
  u8 name_set = 0;
  u8 *tap_name;
...
static int
api_tapv2_delete (vat_main_t * vam)
{
  unformat_input_t *i = vam->input;
  vl_api_tapv2_delete_t *mp;
  u32 sw_if_index = ~0;
  u8 sw_if_index_set = 0;
  int ret;
...
static void vl_api_sw_interface_tapv2_details_t_handler
  (vl_api_sw_interface_tapv2_details_t * mp)
{
  vat_main_t *vam = &vat_main;
...
static void vl_api_sw_interface_tapv2_details_t_handler_json
  (vl_api_sw_interface_tapv2_details_t * mp)
{
  vat_main_t *vam = &vat_main;
  vat_json_node_t *node = NULL;
...
static int
api_sw_interface_tapv2_dump (vat_main_t * vam)
{
  vl_api_sw_interface_tapv2_dump_t *mp;
  vl_api_control_ping_t *mp_ping;
  int ret;

  print (vam->ofp, "\n%-16s %s", "dev_name", "sw_if_index");
  /* Get list of tap interfaces */
  M (SW_INTERFACE_TAPV2_DUMP, mp);
  S (mp);
