...
class FromJSON():
    ...
    def print_string(self, o, toplevel=False):
        ...
        if o.modern_vla:
            ...
            write('    {msgvar} = clib_mem_realloc({msgvar}, {msgsize} + plen, {msgsize});\n'
...
'''
    ...
    {{
        ...
        int size = cJSON_GetArraySize(array);
        {lfield} = size;
        {realloc} = clib_mem_realloc({realloc}, {msgsize} + sizeof({t}) * size, {msgsize});
...
'''
        ...
        if o.fieldtype == 'u8':
            if o.lengthfield:
                ...
                write('    {realloc} = clib_mem_realloc({realloc}, {msgsize} + '
    ...
    def print_define(self, o):
        ...
        write('    vl_api_{}_t *a = clib_mem_alloc(l);\n'.format(o.name))
        write('\n')
