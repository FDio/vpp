...
int
bad_section (cpel_section_header_t *sh, int verbose, FILE *ofp)
{
...
int
noop_pass (cpel_section_header_t *sh, int verbose, FILE *ofp)
{
  return (0);
}

int
strtab_pass1 (cpel_section_header_t *sh, int verbose, FILE *ofp)
{
  uword *p;
...
int
evtdef_pass1 (cpel_section_header_t *sh, int verbose, FILE *ofp)
{
  int i, nevents;
...
int
trackdef_pass1 (cpel_section_header_t *sh, int verbose, FILE *ofp)
{
  int i, nevents;
...
int
unsupported_pass (cpel_section_header_t *sh, int verbose, FILE *ofp)
{
  if (verbose)
    {
...
int
event_pass2 (cpel_section_header_t *sh, int verbose, FILE *ofp)
{
...
int
process_section (cpel_section_header_t *sh, int verbose, FILE *ofp,
		 pass_t pass)
{
  u32 type;
...
int
cpel_dump_file_header (cpel_file_header_t *fh, int verbose, FILE *ofp)
{
  time_t file_time;
  ...
  if (verbose)
    {
      fprintf (
	stderr, "CPEL file: %s-endian, version %d\n",
...
int
cpel_dump (u8 *cpel, int verbose, FILE *ofp)
{
