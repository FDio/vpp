...
void *
vl_msg_push_heap_w_vrp (svm_region_t * vlib_rp)
{
...
{
  return vl_msg_push_heap_w_vrp (api_main.vlib_rp);
}

void
vl_msg_pop_heap_w_vrp (svm_region_t * vlib_rp, void *oldheap)
{
...
{
  vl_msg_pop_heap_w_vrp (api_main.vlib_rp, oldheap);
}
