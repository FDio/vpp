...
void vl_api_pop_heap (void *oldheap);
void *vl_msg_push_heap_no_rplock (void);
void vl_api_pop_heap_no_rplock (void *oldheap);
...
typedef struct
{
  ...
  /** Lock on current binary api segment descriptor */
  pthread_mutex_t vlib_rp_mutex;
