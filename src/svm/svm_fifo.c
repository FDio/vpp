...
svm_fifo_dequeue_internal (svm_fifo_t * f,
			   int pid, u32 max_bytes, u8 * copy_here, int nowait)
{
...
int
svm_fifo_dequeue (svm_fifo_t * f, int pid, u32 max_bytes, u8 * copy_here)
{
...
svm_fifo_enqueue_internal (svm_fifo_t * f,
			   int pid,
			   u32 max_bytes, u8 * copy_from_here, int nowait)
{
  u32 total_copy_bytes, first_copy_bytes, second_copy_bytes;
...
int
svm_fifo_enqueue (svm_fifo_t * f, int pid, u32 max_bytes, u8 * copy_from_here)
{
...
static int
svm_fifo_enqueue_internal2 (svm_fifo_t * f,
			    int pid, u32 max_bytes, u8 * copy_from_here)
{
  u32 total_copy_bytes, first_copy_bytes, second_copy_bytes;
  u32 cursize, nitems;
...
int
svm_fifo_enqueue_nowait2 (svm_fifo_t * f,
			  int pid, u32 max_bytes, u8 * copy_from_here)
{
...
int
svm_fifo_enqueue_with_offset2 (svm_fifo_t * f,
			       int pid,
			       u32 offset,
...
int
svm_fifo_dequeue_nowait2 (svm_fifo_t * f,
			  int pid, u32 max_bytes, u8 * copy_here)
{
