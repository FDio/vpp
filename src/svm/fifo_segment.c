...
fifo_segment_init (fifo_segment_t * fs)
{
  ...
  max_fifo = (fs_free_space (fs) - 4096) / 2;
...
//  if (!fs_chunk_size_is_valid (fsh, data_bytes))
//    {
//      clib_warning ("fifo size out of range %u max %u", data_bytes,
//                    (1 << fsh->max_log2_chunk_size));
//      return 0;
//    }
