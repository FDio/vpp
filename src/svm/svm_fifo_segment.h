...
#define FIFO_SEGMENT_F_IS_SSVM		1 << 3	/* Segment is ssvm */
#define FIFO_SEGMENT_F_IS_MEMFD		1 << 4	/* Segment is memfd */
...
int svm_fifo_segment_create_memfd (svm_fifo_segment_create_args_t * a);
