...
svm_fifo_t *fifo_segment_alloc_fifo_w_slice (fifo_segment_t *fs,
					     u32 slice_index, u32 data_bytes,
 ...
 */
void fifo_segment_preallocate_fifo_pairs (fifo_segment_t *fs, u32 rx_fifo_size,
 ...
 */
svm_fifo_chunk_t *fsh_alloc_chunk (fifo_segment_header_t *fsh, u32 slice_index,
				   u32 chunk_size);
