...
typedef struct _svm_fifo
{
  ...
  union
  {
    struct
    {
      ...
      u32 client_thread_index; /**< app worker index */
    };
    u64 app_sh_as_u64;
  };
...
#define svm_fifo_chunks_at_attach(f) *((svm_fifo_chunk_t **) &f->ooo_deq)
#define svm_fifo_hdr_at_attach(f)    *((svm_fifo_shared_t **) &f->ooo_enq)
