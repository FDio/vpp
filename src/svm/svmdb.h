...
void svmdb_local_set_string_variable (svmdb_client_t *client, char *var,
				      char *val);
...
void svmdb_local_set_vec_variable (svmdb_client_t *client, char *var,
				   void *val, u32 elsize);
...
void *svmdb_local_find_or_add_vec_variable (svmdb_client_t *client, char *var,
					    u32 nbytes);
