...
behavior by using VPP plugins with the appropiate API calls to the
existing SR code.
...
Upon recival of a packet, this plugin will enforce the next IP6 lookup
...
-  unformat_srv6_localsid_sample: This function parses the CLI command
   when initialising a new SR LocalSID using this behavior. It parses
