...
static_always_inline void
iavf_rx_validate_l4_cksum (vlib_buffer_t *b, u64 qw1, iavf_rx_tail_t *t, u32 flags,
			   int maybe_multiseg)
{
		       ...
		       int maybe_multiseg)
{
  ...
  while (n_left >= 4)
      ...
      if (maybe_multiseg)
	{
      ...
      iavf_rx_validate_l4_cksum (b[0], qw1[0], tail + 0, flags, maybe_multiseg);
      iavf_rx_validate_l4_cksum (b[1], qw1[1], tail + 1, flags, maybe_multiseg);
      iavf_rx_validate_l4_cksum (b[2], qw1[2], tail + 2, flags, maybe_multiseg);
      iavf_rx_validate_l4_cksum (b[3], qw1[3], tail + 3, flags, maybe_multiseg);
