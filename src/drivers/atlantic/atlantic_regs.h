...
#define atl_reg_hw_revision_t_fields                                                               \
  __ (4, rev_id)                                                                                   \
...
ATL_REG_STRUCT (atl_reg_hw_revision_t);
...
#define atl_reg_aq2_fw_interface_in_request_policy_t_fields                                        \
  __ (1, promisc_all)                                                                              \
  __ (1, promisc_mcast)                                                                            \
  __ (5, promisc_rx_queue_tx_index)                                                                \
...
#define foreach_atl_reg                                                                            \
  ...
  _ (0x13630, AQ2_FW_INTERFACE_OUT_CABLE_DIAG_STATUS, )                                            \
...
typedef union
{
  ...
  atl_reg_hw_revision_t hw_revision;
