...
typedef struct
{
  ...
  mvpp2_buff_release_entry_t bre[MRVL_PP2_BUFF_BATCH_SZ];
  u16 n_bpool_refill;
  u32 hw_id;
  u32 desc_total;
  uintptr_t desc_phys_arr;
...
vnet_dev_rv_t mvpp2_bpool_get_buff (vlib_main_t *, vnet_dev_t *, mvpp2_bpool_t *,
				    mvpp2_buff_info_t *);
vnet_dev_rv_t mvpp2_bpool_put_buffs (vlib_main_t *, vnet_dev_t *, mvpp2_buff_release_entry_t[],
				     u16 *);
...
void mvpp2_hif_release_descs (vlib_main_t *, vnet_dev_t *, u16, struct pp2_ppio_desc[]);
...
#define foreach_mvpp2_rx_node_counter                                                              \
  ...
  _ (BPOOL_PUT_BUFFS, bpool_put_buffs, ERROR, "mvpp2_bpool_put_buffs error")                       \
