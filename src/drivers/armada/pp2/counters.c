...
#define foreach_mvpp2_port_counter                                                                 \
  ...
  _ (RX_DROP_FULLQ, VENDOR (0, RX, PACKETS, "drop fullQ"))                                         \
  _ (RX_DROP_EARLY, VENDOR (0, RX, PACKETS, "drop early"))                                         \
  _ (RX_DROP_BM, VENDOR (0, RX, PACKETS, "drop BM"))                                               \
  _ (RX_CLS_LKP_HIT, VENDOR (0, RX, PACKETS, "cls lkp hit"))                                       \
  _ (RX_CLS_FLOW_HIT, VENDOR (0, RX, PACKETS, "cls flow hit"))                                     \
  _ (RX_CLS4_HIT, VENDOR (0, RX, PACKETS, "cls4 hit"))                                             \
  _ (RX_MC_OVF_DROP, VENDOR (0, RX, PACKETS, "drop MC overflow"))                                  \
  _ (TX_DROP_FULLQ, VENDOR (0, TX, PACKETS, "drop fullQ"))                                         \
  _ (TX_DROP_EARLY, VENDOR (0, TX, PACKETS, "drop early"))                                         \
  _ (TX_DROP_BM, VENDOR (0, TX, PACKETS, "drop BM"))                                               \
  _ (TX_DROP_BM_MC, VENDOR (0, TX, PACKETS, "drop BM MC"))
...
static vnet_dev_counter_t mvpp2_rxq_counters[] = {
  [MVPP2_RXQ_CTR_ENQ_DESC] = VNET_DEV_CTR_VENDOR (0, RX, DESCRIPTORS, "enqueued"),
  [MVPP2_RXQ_CTR_DROP_FULLQ] = VNET_DEV_CTR_VENDOR (0, RX, PACKETS, "drop fullQ"),
  [MVPP2_RXQ_CTR_DROP_EARLY] = VNET_DEV_CTR_VENDOR (0, RX, PACKETS, "drop early"),
  [MVPP2_RXQ_CTR_DROP_BM] = VNET_DEV_CTR_VENDOR (0, RX, PACKETS, "drop BM"),
  [MVPP2_RXQ_CTR_CLS_LKP_HIT] = VNET_DEV_CTR_VENDOR (0, RX, PACKETS, "cls lkp hit"),
  [MVPP2_RXQ_CTR_CLS_FLOW_HIT] = VNET_DEV_CTR_VENDOR (0, RX, PACKETS, "cls flow hit"),
  [MVPP2_RXQ_CTR_CLS4_HIT] = VNET_DEV_CTR_VENDOR (0, RX, PACKETS, "cls4 hit"),
  [MVPP2_RXQ_CTR_MC_OVF_DROP] = VNET_DEV_CTR_VENDOR (0, RX, PACKETS, "drop MC overflow"),
};

static vnet_dev_counter_t mvpp2_txq_counters[] = {
  [MVPP2_TXQ_CTR_ENQ_DESC] = VNET_DEV_CTR_VENDOR (0, TX, DESCRIPTORS, "enqueued"),
  [MVPP2_TXQ_CTR_ENQ_DEC_TO_DDR] = VNET_DEV_CTR_VENDOR (0, TX, DESCRIPTORS, "enq to DDR"),
  [MVPP2_TXQ_CTR_ENQ_BUF_TO_DDR] = VNET_DEV_CTR_VENDOR (0, TX, BUFFERS, "enq to DDR"),
  [MVPP2_TXQ_CTR_DEQ_DESC] = VNET_DEV_CTR_VENDOR (0, TX, PACKETS, "dequeued"),
  [MVPP2_TXQ_CTR_DROP_FULLQ] = VNET_DEV_CTR_VENDOR (0, TX, PACKETS, "drop fullQ"),
  [MVPP2_TXQ_CTR_DROP_EARLY] = VNET_DEV_CTR_VENDOR (0, TX, PACKETS, "drop early"),
  [MVPP2_TXQ_CTR_DROP_BM] = VNET_DEV_CTR_VENDOR (0, TX, PACKETS, "drop BM"),
  [MVPP2_TXQ_CTR_DROP_BM_MC] = VNET_DEV_CTR_VENDOR (0, TX, PACKETS, "drop BM MC"),
};
