...
static int
mvpp2_prs_eth_start_hdr_set (vnet_dev_port_t *port, enum pp2_ppio_eth_start_hdr eth_start_hdr)
{
...
static int
mvpp2_prs_eth_start_header_set (vnet_dev_port_t *port, enum pp2_ppio_eth_start_hdr mode)
{
  u32 type;
  int rc;
  u32 nri = 0, ri_mask = 0;
...
int
mvpp2_parser_eth_start_header_set (vnet_dev_port_t *port, enum pp2_ppio_eth_start_hdr eth_start_hdr)
{
  vnet_dev_t *dev = port->dev;
  int rc;
