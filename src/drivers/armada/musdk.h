...
int pp2_ppio_get_statistics (vnet_dev_port_t *port, struct pp2_ppio_statistics *stats, int reset);
int pp2_ppio_inq_get_statistics (vnet_dev_port_t *port, u8 tc, u8 qid,
				 struct pp2_ppio_inq_statistics *stats, int reset);
int pp2_ppio_outq_get_statistics (vnet_dev_port_t *port, u8 qid,
				  struct pp2_ppio_outq_statistics *stats, int reset);
int pp2_ppio_recv (vnet_dev_port_t *port, u8 tc, u8 qid, struct pp2_ppio_desc *descs, u16 *num);
int pp2_ppio_get_num_outq_done (vnet_dev_port_t *port, struct pp2_hif *hif, u8 qid, u16 *num);
int pp2_ppio_send (vnet_dev_port_t *port, struct pp2_hif *hif, u8 qid, struct pp2_ppio_desc *descs,
		   u16 *num);
