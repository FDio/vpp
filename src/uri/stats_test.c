...
static void
vl_api_vnet_interface_simple_counters_reply_t_handler(vl_api_vnet_interface_simple_counters_reply_t *mp) {
...
static void
vl_api_vnet_interface_combined_counters_reply_t_handler(vl_api_vnet_interface_combined_counters_reply_t *mp) {
  fformat (stdout,
           "Got stats message %d\n",mp->_vl_msg_id);
}

static void
vl_api_vnet_ip4_fib_counters_reply_t_handler(vl_api_vnet_ip4_fib_counters_reply_t *mp) {
  fformat (stdout,
           "Got stats message %d\n",mp->_vl_msg_id);
...
static void
vl_api_vnet_ip6_fib_counters_reply_t_handler(vl_api_vnet_ip6_fib_counters_reply_t *mp) {
  fformat (stdout,
           "Got stats message %d\n",mp->_vl_msg_id);
}

static void
vl_api_vnet_ip4_nbr_counters_reply_t_handler(vl_api_vnet_ip4_nbr_counters_reply_t *mp) {
  fformat (stdout,
           "Got stats message %d\n",mp->_vl_msg_id);
}
...
static void
vl_api_vnet_ip6_nbr_counters_reply_t_handler(vl_api_vnet_ip6_nbr_counters_reply_t *mp) {
  fformat (stdout,
           "Got stats message %d\n",mp->_vl_msg_id);
}
...
#define foreach_stats_msg                                               \
  ...
  _(VNET_INTERFACE_SIMPLE_COUNTERS_REPLY, vnet_interface_simple_counters_reply)     \
  _(VNET_INTERFACE_COMBINED_COUNTERS_REPLY, vnet_interface_combined_counters_reply)	\
  _(VNET_IP4_FIB_COUNTERS_REPLY, vnet_ip4_fib_counters_reply)                       \
  _(VNET_IP6_FIB_COUNTERS_REPLY, vnet_ip6_fib_counters_reply)                       \
  _(VNET_IP4_NBR_COUNTERS_REPLY, vnet_ip4_nbr_counters_reply)                       \
  _(VNET_IP6_NBR_COUNTERS_REPLY, vnet_ip6_nbr_counters_reply)
