...
static void
vl_api_connect_reply_t_handler (vl_api_connect_reply_t * mp)
{
  vppcom_main_t *vcm = &vppcom_main;
  session_t *session;
  u32 session_index;
...
send_reply:
  ...
  rmp->_vl_msg_id = ntohs (VL_API_CONNECT_REPLY);
