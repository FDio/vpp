...
{
  VAPI_OK = 0,		     /**< success */
  VAPI_EINVAL,		     /**< invalid value enctountered */
 ...
 * @return VAPI_OK on success, other error code on error
 */
vapi_error_e vapi_send (vapi_ctx_t ctx, void *msg, uword size);
 ...
 * @param size1 size of the first message to send
 * @param msg2 second message to send
 * @param size2 size of the second message to send
 *
 * @return VAPI_OK on success, other error code on error
 */
vapi_error_e vapi_send2 (vapi_ctx_t ctx, void *msg1, uword size1, void *msg2,
			 uword size2);
...
typedef vapi_error_e (*vapi_event_cb) (vapi_ctx_t ctx,
				       void *callback_ctx, void *payload);
