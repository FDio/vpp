...
public class CallbackInvokeCounterTest {

    private static final Logger LOG = Logger.getLogger(CallbackInvokeCounterTest.class.getName());
    ...
    private static void testInvokeCounter(boolean setCount, int count) throws Exception {
        ...
        try (final JVppRegistry registry = new JVppRegistryImpl("CallbackInvokeCounterTest");
