...
public class CallbackInvokeCounterExample {

    private static final Logger LOG = Logger.getLogger(CallbackInvokeCounterExample.class.getName());
    private static ShowVersion request = new ShowVersion();
    ...
    private static void testInvokeCounter(boolean setCount, int count) throws Exception {
        ...
        try (final JVppRegistry registry = new JVppRegistryImpl("CallbackInvokeCounterExample");
