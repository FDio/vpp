...
InvokeCounterExample - test provide two ways to count invocations:
1) maximum number of invocations and received replyies within 1 sec
sudo java -cp build-vpp-native/vpp/vpp-api/java/jvpp-registry-18.01.jar:build-vpp-native/vpp/vpp-api/java/jvpp-core-18.01.jar io.fd.vpp.jvpp.core.examples.CallbackInvokeCounterExample
2) measure time in ns from first request to receiving last reply over set amount of requests
sudo java -cp build-vpp-native/vpp/vpp-api/java/jvpp-registry-18.01.jar:build-vpp-native/vpp/vpp-api/java/jvpp-core-18.01.jar io.fd.vpp.jvpp.core.examples.CallbackInvokeCounterExample [number of request to send]

FutureCounterExample - test provide two ways to count invocations:
1) maximum number of invocations and received replyies within 1 sec
sudo java -cp build-vpp-native/vpp/vpp-api/java/jvpp-registry-18.01.jar:build-vpp-native/vpp/vpp-api/java/jvpp-core-18.01.jar io.fd.vpp.jvpp.core.examples.FutureInvokeCounterExample
2) measure time in ns from first request to receiving last reply over set amount of requests
sudo java -cp build-vpp-native/vpp/vpp-api/java/jvpp-registry-18.01.jar:build-vpp-native/vpp/vpp-api/java/jvpp-core-18.01.jar io.fd.vpp.jvpp.core.examples.FutureInvokeCounterExample [number of request to send] [maximum diff between send and received messages]
