...
- From VPP's build-root/ folder execute:
  - sudo java -cp build-vpp-native/vpp-api/java/jvpp-registry-17.10.jar:build-vpp-native/vpp-api/java/jvpp-core-17.01.jar io.fd.vpp.jvpp.core.examples.[test name]
