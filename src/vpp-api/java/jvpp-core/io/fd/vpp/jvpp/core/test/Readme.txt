...
- From VPP's build-root/ folder execute:
  - sudo java -cp build-vpp-native/vpp-api/java/jvpp-registry-17.04.jar:build-vpp-native/vpp-api/java/jvpp-core-17.04.jar io.fd.vpp.jvpp.core.test.[test name]
