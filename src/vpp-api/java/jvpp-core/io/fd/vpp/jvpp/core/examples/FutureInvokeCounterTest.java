...
public class FutureInvokeCounterTest {

    private static final Logger LOG = Logger.getLogger(FutureInvokeCounterTest.class.getName());
    ...
    private static void testInvokeCounter(boolean setCount) throws Exception {
        ...
        try (final JVppRegistry registry = new JVppRegistryImpl("FutureInvokeCounterTest");
