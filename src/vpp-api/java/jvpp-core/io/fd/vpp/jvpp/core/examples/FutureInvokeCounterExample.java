...
public class FutureInvokeCounterExample {
    ...
    /**
     *
     * @param args - for running for one sec requires one parameter, allowed difference between send requests and
     *             received replies
     *             - for running for set amount of request requires two parameters, desired request amount and
     *             allowed difference between send requests and received replies
     ...
     * @param diff allowed difference between send requests and received replies, in case this difference is exceeded
     *             there's active wait until the difference decrease
     * @throws Exception
     */
