...
from generate import ParserContext, Struct, Parameter, Message, Type
...
#
class PluginModel:
    def __init__(self, name: str, context: ParserContext) -> None:
        context.validate_json_data()
        self._name = name

        self._types = [TypeClass(name, t) for t in context.types.values()]
        self._replies = [ ]
        self._requests = [ ]
