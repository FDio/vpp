...
(JNIEnv * env, jclass clazz${arguments}) {
    ...
    jclass requestClass = (*env)->FindClass(env, "io/fd/vpp/jvpp/${plugin_name}/dto/${java_class_name}");
...
def generate_jni_impl(model):
    ...
    for msg in model.messages:
        ...
        jni_impl.append(_JNI_IMPL_TEMPLATE.substitute(
            ...
            java_class_name=msg.java_name_upper,
...
_REQUEST_FIELD_IDENTIFIER_TEMPLATE = Template("""
    ...
    ${jni_type} ${field_reference_name} = (*env)->Get${jni_getter}(env, request, ${field_reference_name}FieldId);
    """)
...
def _generate_jni_identifiers(msg):
    ...
    for field in msg.fields:
        ...
        identifiers.append(_REQUEST_FIELD_IDENTIFIER_TEMPLATE.substitute(
            ...
            field_name=name,
            jni_signature=type.jni_signature,
            jni_type=type.jni_signature,
            jni_getter=type.jni_getter,
        ))
