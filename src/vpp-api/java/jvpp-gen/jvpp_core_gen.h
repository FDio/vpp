 ...
 *     {   u'crc': u'0x98cbb7f1'}]
 */
static inline void _host_to_net_custom_type(jobject _host, vl_api_custom_type_t * _net)
{
    jclass _custom_type_class = (*env)->FindClass(env, "io/fd/vpp/jvpp/core/types/CustomType");

    jfieldID valFieldId = (*env)->GetFieldID(env, _custom_type_class, "val", "I");
    jint val = (*env)->GetIntField(env, _host, valFieldId);

    jfieldID array1FieldId = (*env)->GetFieldID(env, _custom_type_class, "array1", "[B");
    jbyteArray array1 = (*env)->GetObjectField(env, _host, array1FieldId);

    jfieldID array2SizeFieldId = (*env)->GetFieldID(env, _custom_type_class, "array2Size", "B");
    jbyte array2Size = (*env)->GetByteField(env, _host, array2SizeFieldId);

    jfieldID array2FieldId = (*env)->GetFieldID(env, _custom_type_class, "array2", "[S");
...
(JNIEnv * env, jclass clazz, jobject request) {
    ...
    _host_to_net_custom_type(val, &(mp->val));
...
(JNIEnv * env, jclass clazz, jobject request) {
    ...
    {
        jclass valArrayElementClass = (*env)->FindClass(env, "io/fd/vpp/jvpp/core/types/CustomType");
        if (val) {
            size_t _i;
        ...
        if (cnt > max_size) cnt = max_size;
            for (_i = 0; _i < cnt; _i++) {
                ...
                _host_to_net_custom_type(valArrayElement, &(mp->val[_i]))
            }
        }
    }
...
(JNIEnv * env, jclass clazz, jobject request) {
    ...
    // create message:
    const size_t _size = sizeof(*mp) + vlaSize*sizeof(custom_type);
    mp = vl_msg_api_alloc(_size);
    memset (mp, 0, _size);
...
static void vl_api_request_with_custom_type_reply_t_handler (vl_api_request_with_custom_type_reply_t * mp)
{
    ...
    (*env)->SetObjectField(env, dto, valFieldId, _net_to_host_custom_type(mp->val));
