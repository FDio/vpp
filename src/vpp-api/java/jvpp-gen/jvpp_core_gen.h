...
jclass requestWithCustomTypeClass;
jclass requestWithCustomTypeReplyClass;
jclass requestWithCustomTypeArrayClass;
jclass requestWithCustomTypeArrayReplyClass;
jclass requestWithCustomTypeVlaClass;
jclass requestWithCustomTypeVlaReplyClass;
jclass fooEventClass;
...
static int cache_class_references(JNIEnv* env) {
    ...
    requestWithCustomTypeClass = (jclass)(*env)->NewGlobalRef(env, (*env)->FindClass(env, "io/fd/vpp/jvpp/core/dto/RequestWithCustomType"));
    if ((*env)->ExceptionCheck(env)) {
        (*env)->ExceptionDescribe(env);
        return JNI_ERR;
    }
    requestWithCustomTypeReplyClass = (jclass)(*env)->NewGlobalRef(env, (*env)->FindClass(env, "io/fd/vpp/jvpp/core/dto/RequestWithCustomTypeReply"));
    if ((*env)->ExceptionCheck(env)) {
        (*env)->ExceptionDescribe(env);
        return JNI_ERR;
    }
    requestWithCustomTypeArrayClass = (jclass)(*env)->NewGlobalRef(env, (*env)->FindClass(env, "io/fd/vpp/jvpp/core/dto/RequestWithCustomTypeArray"));
    if ((*env)->ExceptionCheck(env)) {
        (*env)->ExceptionDescribe(env);
        return JNI_ERR;
    }
    requestWithCustomTypeArrayReplyClass = (jclass)(*env)->NewGlobalRef(env, (*env)->FindClass(env, "io/fd/vpp/jvpp/core/dto/RequestWithCustomTypeArrayReply"));
    if ((*env)->ExceptionCheck(env)) {
        (*env)->ExceptionDescribe(env);
        return JNI_ERR;
    }
    requestWithCustomTypeVlaClass = (jclass)(*env)->NewGlobalRef(env, (*env)->FindClass(env, "io/fd/vpp/jvpp/core/dto/RequestWithCustomTypeVla"));
    if ((*env)->ExceptionCheck(env)) {
        (*env)->ExceptionDescribe(env);
        return JNI_ERR;
    }
    requestWithCustomTypeVlaReplyClass = (jclass)(*env)->NewGlobalRef(env, (*env)->FindClass(env, "io/fd/vpp/jvpp/core/dto/RequestWithCustomTypeVlaReply"));
    if ((*env)->ExceptionCheck(env)) {
        (*env)->ExceptionDescribe(env);
        return JNI_ERR;
    }
    fooEventClass = (jclass)(*env)->NewGlobalRef(env, (*env)->FindClass(env, "io/fd/vpp/jvpp/core/dto/FooEvent"));
    if ((*env)->ExceptionCheck(env)) {
        (*env)->ExceptionDescribe(env);
        return JNI_ERR;
    }
...
static void delete_class_references(JNIEnv* env) {
    ...
    if (requestWithCustomTypeClass) {
        (*env)->DeleteGlobalRef(env, requestWithCustomTypeClass);
    }
    if (requestWithCustomTypeReplyClass) {
        (*env)->DeleteGlobalRef(env, requestWithCustomTypeReplyClass);
    }
    if (requestWithCustomTypeArrayClass) {
        (*env)->DeleteGlobalRef(env, requestWithCustomTypeArrayClass);
    }
    if (requestWithCustomTypeArrayReplyClass) {
        (*env)->DeleteGlobalRef(env, requestWithCustomTypeArrayReplyClass);
    }
    if (requestWithCustomTypeVlaClass) {
        (*env)->DeleteGlobalRef(env, requestWithCustomTypeVlaClass);
    }
    if (requestWithCustomTypeVlaReplyClass) {
        (*env)->DeleteGlobalRef(env, requestWithCustomTypeVlaReplyClass);
    }
    if (fooEventClass) {
        (*env)->DeleteGlobalRef(env, fooEventClass);
    }
...
_(request_with_custom_type_47d351da) \
_(request_with_custom_type_reply_a105fcf1) \
_(request_with_custom_type_array_5793d854) \
_(request_with_custom_type_array_reply_55c7a97e) \
_(request_with_custom_type_vla_039ab679) \
_(request_with_custom_type_vla_reply_0329a4f5) \
_(foo_event_8d8025a8) \


// Type handlers

/**
 * Host to network byte order conversion for custom_type type.
 ...
 *     {   u'crc': u'0x98cbb7f1'}]
 */
static inline void _host_to_net_custom_type(JNIEnv * env, jobject _host, vl_api_custom_type_t * _net)
{
    jclass customTypeClass = (*env)->FindClass(env, "io/fd/vpp/jvpp/core/types/CustomType");

    jfieldID valFieldId = (*env)->GetFieldID(env, customTypeClass, "val", "I");
    jint val = (*env)->GetIntField(env, _host, valFieldId);

    jfieldID array1FieldId = (*env)->GetFieldID(env, customTypeClass, "array1", "[B");
    jbyteArray array1 = (*env)->GetObjectField(env, _host, array1FieldId);

    jfieldID array2SizeFieldId = (*env)->GetFieldID(env, customTypeClass, "array2Size", "B");
    jbyte array2Size = (*env)->GetByteField(env, _host, array2SizeFieldId);

    jfieldID array2FieldId = (*env)->GetFieldID(env, customTypeClass, "array2", "[S");
    jshortArray array2 = (*env)->GetObjectField(env, _host, array2FieldId);

    _net->val = clib_host_to_net_u32(val);
    ...
    if (array1) {
        ...
        (*env)->GetByteArrayRegion(env, array1, 0, cnt, (jbyte *)_net->array1);
    }

    _net->array2_size = array2Size;

    if (array2) {
        jshort * array2ArrayElements = (*env)->GetShortArrayElements(env, array2, NULL);
        size_t _i;
        jsize cnt = (*env)->GetArrayLength(env, array2);
        
        size_t max_size = array2Size;
        if (cnt > max_size) cnt = max_size;
        for (_i = 0; _i < cnt; _i++) {
            _net->array2[_i] = clib_host_to_net_u16(array2ArrayElements[_i]);
        }
        (*env)->ReleaseShortArrayElements (env, array2, array2ArrayElements, 0);
    }
    
}

/**
 * Network to host byte order conversion for custom_type type.
 * Generated based on ['test.api.json']:
 * [   [u'u32', u'val'],
 *     [u'u8', u'array1', 6],
 *     [u'u8', u'array2_size'],
 ...
 *     {   u'crc': u'0x98cbb7f1'}]
 */
static inline void _net_to_host_custom_type(JNIEnv * env, vl_api_custom_type_t * _net, jobject _host)
{
    jclass customTypeClass = (*env)->FindClass(env, "io/fd/vpp/jvpp/core/types/CustomType");

    jfieldID valFieldId = (*env)->GetFieldID(env, customTypeClass, "val", "I");
    (*env)->SetIntField(env, _host, valFieldId, clib_net_to_host_u32(_net->val));

    jfieldID array1FieldId = (*env)->GetFieldID(env, customTypeClass, "array1", "[B");
    jbyteArray array1 = (*env)->NewByteArray(env, 6);
    (*env)->SetByteArrayRegion(env, array1, 0, 6, (const jbyte*)_net->array1);
    (*env)->SetObjectField(env, _host, array1FieldId, array1);
    (*env)->DeleteLocalRef(env, array1);

    jfieldID array2SizeFieldId = (*env)->GetFieldID(env, customTypeClass, "array2Size", "B");
    (*env)->SetByteField(env, _host, array2SizeFieldId, _net->array2_size);

    jfieldID array2FieldId = (*env)->GetFieldID(env, customTypeClass, "array2", "[S");
    {
        jshortArray array2 = (*env)->NewShortArray(env, _net->array2_size);
        jshort * array2ArrayElements = (*env)->GetShortArrayElements(env, array2, NULL);
        unsigned int _i;
        for (_i = 0; _i < _net->array2_size; _i++) {
            array2ArrayElements[_i] = clib_net_to_host_u16(_net->array2[_i]);
        }

        (*env)->ReleaseShortArrayElements(env,  array2, array2ArrayElements, 0);
        (*env)->SetObjectField(env, _host, array2FieldId, array2);
...
/**
 * JNI binding for sending request_with_custom_type message.
 * Generated based on ['test.api.json']:
 * [   [u'u16', u'_vl_msg_id'],
 *     [u'u32', u'client_index'],
 *     [u'u32', u'context'],
 ...
 *     {   u'crc': u'0x47d351da'}]
 */
JNIEXPORT jint JNICALL Java_io_fd_vpp_jvpp_core_JVppCoreImpl_requestWithCustomType0
(JNIEnv * env, jclass clazz, jobject request) {
    core_main_t *plugin_main = &core_main;
    vl_api_request_with_custom_type_t * mp;
    u32 my_context_id = vppjni_get_context_id (&jvpp_main);
    jclass requestClass = (*env)->FindClass(env, "io/fd/vpp/jvpp/core/dto/RequestWithCustomType");


    jfieldID valFieldId = (*env)->GetFieldID(env, requestClass, "val", "Lio/fd/vpp/jvpp/core/types/CustomType;");
    jobject val = (*env)->GetObjectField(env, request, valFieldId);
    ...
    mp = vl_msg_api_alloc(_size);
    memset (mp, 0, _size);
    mp->_vl_msg_id = ntohs (get_message_id(env, "request_with_custom_type_47d351da"));
    mp->client_index = plugin_main->my_client_index;
    mp->context = clib_host_to_net_u32 (my_context_id);

    _host_to_net_custom_type(env, val, &(mp->val));

    // send message:
    if (CLIB_DEBUG > 1)
        clib_warning ("Sending request_with_custom_type message");
    vl_msg_api_send_shmem (plugin_main->vl_input_queue, (u8 *)&mp);
    if ((*env)->ExceptionCheck(env)) {
        return JNI_ERR;
    }
...
/**
 * JNI binding for sending request_with_custom_type_array message.
 * Generated based on ['test.api.json']:
 * [   [u'u16', u'_vl_msg_id'],
 *     [u'u32', u'client_index'],
 *     [u'u32', u'context'],
 ...
 *     {   u'crc': u'0x5793d854'}]
 */
JNIEXPORT jint JNICALL Java_io_fd_vpp_jvpp_core_JVppCoreImpl_requestWithCustomTypeArray0
(JNIEnv * env, jclass clazz, jobject request) {
    core_main_t *plugin_main = &core_main;
    vl_api_request_with_custom_type_array_t * mp;
    u32 my_context_id = vppjni_get_context_id (&jvpp_main);
    jclass requestClass = (*env)->FindClass(env, "io/fd/vpp/jvpp/core/dto/RequestWithCustomTypeArray");


    jfieldID valFieldId = (*env)->GetFieldID(env, requestClass, "val", "[Lio/fd/vpp/jvpp/core/types/CustomType;");
    jobjectArray val = (*env)->GetObjectField(env, request, valFieldId);
    ...
    mp = vl_msg_api_alloc(_size);
    memset (mp, 0, _size);
    mp->_vl_msg_id = ntohs (get_message_id(env, "request_with_custom_type_array_5793d854"));
    mp->client_index = plugin_main->my_client_index;
    mp->context = clib_host_to_net_u32 (my_context_id);
...

    {
        if (val) {
            size_t _i;
            jsize cnt = (*env)->GetArrayLength (env, val);
            
        size_t max_size = 16;
        if (cnt > max_size) cnt = max_size;
            for (_i = 0; _i < cnt; _i++) {
                jobject valArrayElement = (*env)->GetObjectArrayElement(env, val, _i);
                _host_to_net_custom_type(env, valArrayElement, &(mp->val[_i]));
            }
        }
    }
    ...
    // send message:
    if (CLIB_DEBUG > 1)
        clib_warning ("Sending request_with_custom_type_array message");
    vl_msg_api_send_shmem (plugin_main->vl_input_queue, (u8 *)&mp);
    if ((*env)->ExceptionCheck(env)) {
        return JNI_ERR;
    }
...
/**
 * JNI binding for sending request_with_custom_type_vla message.
 * Generated based on ['test.api.json']:
 * [   [u'u16', u'_vl_msg_id'],
 *     [u'u32', u'client_index'],
 *     [u'u32', u'context'],
 ...
 *     {   u'crc': u'0x039ab679'}]
 */
JNIEXPORT jint JNICALL Java_io_fd_vpp_jvpp_core_JVppCoreImpl_requestWithCustomTypeVla0
(JNIEnv * env, jclass clazz, jobject request) {
    core_main_t *plugin_main = &core_main;
    vl_api_request_with_custom_type_vla_t * mp;
    u32 my_context_id = vppjni_get_context_id (&jvpp_main);
    jclass requestClass = (*env)->FindClass(env, "io/fd/vpp/jvpp/core/dto/RequestWithCustomTypeVla");


    jfieldID vlaSizeFieldId = (*env)->GetFieldID(env, requestClass, "vlaSize", "B");
    jbyte vlaSize = (*env)->GetByteField(env, request, vlaSizeFieldId);
    ...
    // create message:
    const size_t _size = sizeof(*mp) + vlaSize*sizeof(vl_api_custom_type_t);
    mp = vl_msg_api_alloc(_size);
    memset (mp, 0, _size);
    mp->_vl_msg_id = ntohs (get_message_id(env, "request_with_custom_type_vla_039ab679"));
    mp->client_index = plugin_main->my_client_index;
    mp->context = clib_host_to_net_u32 (my_context_id);
    ...
    // send message:
    if (CLIB_DEBUG > 1)
        clib_warning ("Sending request_with_custom_type_vla message");
    vl_msg_api_send_shmem (plugin_main->vl_input_queue, (u8 *)&mp);
    if ((*env)->ExceptionCheck(env)) {
        return JNI_ERR;
    }
...
/**
 * Handler for request_with_custom_type_reply message.
 * Generated based on ['test.api.json']:
 * [   [u'u16', u'_vl_msg_id'],
 *     [u'u32', u'context'],
 *     [u'i32', u'retval'],
 ...
 *     {   u'crc': u'0xa105fcf1'}]
 */
static void vl_api_request_with_custom_type_reply_t_handler (vl_api_request_with_custom_type_reply_t * mp)
{
    core_main_t *plugin_main = &core_main;
    JNIEnv *env = jvpp_main.jenv;
    jthrowable exc;
    ...
    // for negative result don't send callback message but send error callback
    if (mp->retval<0) {
        call_on_error("request_with_custom_type_reply", mp->context, mp->retval, plugin_main->callbackClass, plugin_main->callbackObject, callbackExceptionClass);
        return;
    }
    if (mp->retval == VNET_API_ERROR_IN_PROGRESS) {
        clib_warning("Result in progress");
    ...
    if (CLIB_DEBUG > 1)
        clib_warning ("Received request_with_custom_type_reply event message");

    jmethodID constructor = (*env)->GetMethodID(env, requestWithCustomTypeReplyClass, "<init>", "()V");

    // User does not have to provide callbacks for all VPP messages.
    // We are ignoring messages that are not supported by user.
    (*env)->ExceptionClear(env); // just in case exception occurred in different place and was not properly cleared
    jmethodID callbackMethod = (*env)->GetMethodID(env, plugin_main->callbackClass, "onRequestWithCustomTypeReply", "(Lio/fd/vpp/jvpp/core/dto/RequestWithCustomTypeReply;)V");
    exc = (*env)->ExceptionOccurred(env);
    if (exc) {
        clib_warning("Unable to extract onRequestWithCustomTypeReply method reference from core plugin's callbackClass. Ignoring message.\n");
        (*env)->ExceptionDescribe(env);
        (*env)->ExceptionClear(env);
        return;
    }

    jobject dto = (*env)->NewObject(env, requestWithCustomTypeReplyClass, constructor);

    jfieldID contextFieldId = (*env)->GetFieldID(env, requestWithCustomTypeReplyClass, "context", "I");
    (*env)->SetIntField(env, dto, contextFieldId, clib_net_to_host_u32(mp->context));

    jfieldID valFieldId = (*env)->GetFieldID(env, requestWithCustomTypeReplyClass, "val", "Lio/fd/vpp/jvpp/core/types/CustomType;");
    jclass valClass = (*env)->FindClass(env, "io/fd/vpp/jvpp/core/types/CustomType");
    jmethodID valConstructor = (*env)->GetMethodID(env, valClass, "<init>", "()V");
    jobject val = (*env)->NewObject(env, valClass,  valConstructor);
    _net_to_host_custom_type(env, &(mp->val), val);
    (*env)->SetObjectField(env, dto, valFieldId, val);
...
/**
 * Handler for request_with_custom_type_array_reply message.
 * Generated based on ['test.api.json']:
 * [   [u'u16', u'_vl_msg_id'],
 *     [u'u32', u'context'],
 *     [u'i32', u'retval'],
 ...
 *     {   u'crc': u'0x55c7a97e'}]
 */
static void vl_api_request_with_custom_type_array_reply_t_handler (vl_api_request_with_custom_type_array_reply_t * mp)
{
    core_main_t *plugin_main = &core_main;
    JNIEnv *env = jvpp_main.jenv;
    jthrowable exc;
    ...
    // for negative result don't send callback message but send error callback
    if (mp->retval<0) {
        call_on_error("request_with_custom_type_array_reply", mp->context, mp->retval, plugin_main->callbackClass, plugin_main->callbackObject, callbackExceptionClass);
        return;
    }
    if (mp->retval == VNET_API_ERROR_IN_PROGRESS) {
        clib_warning("Result in progress");
    ...
    if (CLIB_DEBUG > 1)
        clib_warning ("Received request_with_custom_type_array_reply event message");

    jmethodID constructor = (*env)->GetMethodID(env, requestWithCustomTypeArrayReplyClass, "<init>", "()V");

    // User does not have to provide callbacks for all VPP messages.
    // We are ignoring messages that are not supported by user.
    (*env)->ExceptionClear(env); // just in case exception occurred in different place and was not properly cleared
    jmethodID callbackMethod = (*env)->GetMethodID(env, plugin_main->callbackClass, "onRequestWithCustomTypeArrayReply", "(Lio/fd/vpp/jvpp/core/dto/RequestWithCustomTypeArrayReply;)V");
    exc = (*env)->ExceptionOccurred(env);
    if (exc) {
        clib_warning("Unable to extract onRequestWithCustomTypeArrayReply method reference from core plugin's callbackClass. Ignoring message.\n");
        (*env)->ExceptionDescribe(env);
        (*env)->ExceptionClear(env);
        return;
    }

    jobject dto = (*env)->NewObject(env, requestWithCustomTypeArrayReplyClass, constructor);

    jfieldID contextFieldId = (*env)->GetFieldID(env, requestWithCustomTypeArrayReplyClass, "context", "I");
    (*env)->SetIntField(env, dto, contextFieldId, clib_net_to_host_u32(mp->context));

    jfieldID valFieldId = (*env)->GetFieldID(env, requestWithCustomTypeArrayReplyClass, "val", "[Lio/fd/vpp/jvpp/core/types/CustomType;");
    {
        jclass valClass = (*env)->FindClass(env, "io/fd/vpp/jvpp/core/types/CustomType");
        jobjectArray val = (*env)->NewObjectArray(env, 16, valClass, 0);
        jmethodID valConstructor = (*env)->GetMethodID(env, valClass, "<init>", "()V");
        unsigned int _i;
        for (_i = 0; _i < 16; _i++) {
            jobject valArrayElement = (*env)->NewObject(env, valClass,  valConstructor);
            _net_to_host_custom_type(env, &(mp->val[_i]), valArrayElement);
            (*env)->SetObjectArrayElement(env, val, _i, valArrayElement);
            (*env)->DeleteLocalRef(env, valArrayElement);
        }
        (*env)->SetObjectField(env, dto, valFieldId, val);
        (*env)->DeleteLocalRef(env, val);
    }
...
/**
 * Handler for request_with_custom_type_vla_reply message.
 * Generated based on ['test.api.json']:
 * [   [u'u16', u'_vl_msg_id'],
 *     [u'u32', u'context'],
 *     [u'i32', u'retval'],
 ...
 *     {   u'crc': u'0x0329a4f5'}]
 */
static void vl_api_request_with_custom_type_vla_reply_t_handler (vl_api_request_with_custom_type_vla_reply_t * mp)
{
    core_main_t *plugin_main = &core_main;
    JNIEnv *env = jvpp_main.jenv;
    jthrowable exc;
    ...
    // for negative result don't send callback message but send error callback
    if (mp->retval<0) {
        call_on_error("request_with_custom_type_vla_reply", mp->context, mp->retval, plugin_main->callbackClass, plugin_main->callbackObject, callbackExceptionClass);
        return;
    }
    if (mp->retval == VNET_API_ERROR_IN_PROGRESS) {
        clib_warning("Result in progress");
    ...
    if (CLIB_DEBUG > 1)
        clib_warning ("Received request_with_custom_type_vla_reply event message");

    jmethodID constructor = (*env)->GetMethodID(env, requestWithCustomTypeVlaReplyClass, "<init>", "()V");

    // User does not have to provide callbacks for all VPP messages.
    // We are ignoring messages that are not supported by user.
    (*env)->ExceptionClear(env); // just in case exception occurred in different place and was not properly cleared
    jmethodID callbackMethod = (*env)->GetMethodID(env, plugin_main->callbackClass, "onRequestWithCustomTypeVlaReply", "(Lio/fd/vpp/jvpp/core/dto/RequestWithCustomTypeVlaReply;)V");
    exc = (*env)->ExceptionOccurred(env);
    if (exc) {
        clib_warning("Unable to extract onRequestWithCustomTypeVlaReply method reference from core plugin's callbackClass. Ignoring message.\n");
        (*env)->ExceptionDescribe(env);
        (*env)->ExceptionClear(env);
        return;
    }

    jobject dto = (*env)->NewObject(env, requestWithCustomTypeVlaReplyClass, constructor);

    jfieldID contextFieldId = (*env)->GetFieldID(env, requestWithCustomTypeVlaReplyClass, "context", "I");
    (*env)->SetIntField(env, dto, contextFieldId, clib_net_to_host_u32(mp->context));

    jfieldID vlaSizeFieldId = (*env)->GetFieldID(env, requestWithCustomTypeVlaReplyClass, "vlaSize", "B");
    (*env)->SetByteField(env, dto, vlaSizeFieldId, mp->vla_size);

    jfieldID valFieldId = (*env)->GetFieldID(env, requestWithCustomTypeVlaReplyClass, "val", "[Lio/fd/vpp/jvpp/core/types/CustomType;");
    {
        jclass valClass = (*env)->FindClass(env, "io/fd/vpp/jvpp/core/types/CustomType");
        jobjectArray val = (*env)->NewObjectArray(env, mp->vla_size, valClass, 0);
        jmethodID valConstructor = (*env)->GetMethodID(env, valClass, "<init>", "()V");
        unsigned int _i;
        for (_i = 0; _i < mp->vla_size; _i++) {
            jobject valArrayElement = (*env)->NewObject(env, valClass,  valConstructor);
            _net_to_host_custom_type(env, &(mp->val[_i]), valArrayElement);
            (*env)->SetObjectArrayElement(env, val, _i, valArrayElement);
            (*env)->DeleteLocalRef(env, valArrayElement);
...
/**
 * Handler for foo_event message.
 * Generated based on ['test.api.json']:
 * [[u'u16', u'_vl_msg_id'], [u'u32', u'client_index'], [u'u32', u'val1'], [u'u8', u'val2'], {   u'crc': u'0x8d8025a8'}]
 */
static void vl_api_foo_event_t_handler (vl_api_foo_event_t * mp)
{
    core_main_t *plugin_main = &core_main;
    JNIEnv *env = jvpp_main.jenv;
    jthrowable exc;
    ...
    if (CLIB_DEBUG > 1)
        clib_warning ("Received foo_event event message");

    jmethodID constructor = (*env)->GetMethodID(env, fooEventClass, "<init>", "()V");

    // User does not have to provide callbacks for all VPP messages.
    // We are ignoring messages that are not supported by user.
    (*env)->ExceptionClear(env); // just in case exception occurred in different place and was not properly cleared
    jmethodID callbackMethod = (*env)->GetMethodID(env, plugin_main->callbackClass, "onFooEvent", "(Lio/fd/vpp/jvpp/core/dto/FooEvent;)V");
    exc = (*env)->ExceptionOccurred(env);
    if (exc) {
        clib_warning("Unable to extract onFooEvent method reference from core plugin's callbackClass. Ignoring message.\n");
        (*env)->ExceptionDescribe(env);
        (*env)->ExceptionClear(env);
        return;
    }

    jobject dto = (*env)->NewObject(env, fooEventClass, constructor);

    jfieldID val1FieldId = (*env)->GetFieldID(env, fooEventClass, "val1", "I");
    (*env)->SetIntField(env, dto, val1FieldId, clib_net_to_host_u32(mp->val1));

    jfieldID val2FieldId = (*env)->GetFieldID(env, fooEventClass, "val2", "B");
    (*env)->SetByteField(env, dto, val2FieldId, mp->val2);
...
_(request_with_custom_type_reply_a105fcf1, request_with_custom_type_reply) \
_(request_with_custom_type_array_reply_55c7a97e, request_with_custom_type_array_reply) \
_(request_with_custom_type_vla_reply_0329a4f5, request_with_custom_type_vla_reply) \
_(foo_event_8d8025a8, foo_event) \
