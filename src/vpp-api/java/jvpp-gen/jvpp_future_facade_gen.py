...
from jvpp_json_parser import is_control_ping, is_control_ping_reply, is_dump, is_request, is_details, is_reply
...
public final class FutureJVpp${plugin_name}FacadeCallback implements $plugin_package.callback.JVpp${plugin_name}GlobalCallback {
    ...
    // FIXME private final $plugin_package.notification.Global${plugin_name}EventCallback notificationCallback;
...
def _generate_future_jvpp_callback_methods(model):
    ...
    for msg in model.messages:
        ...
        if is_details(msg):
            ...
            raise TypeError("Unknown mesage type %s", msg)
