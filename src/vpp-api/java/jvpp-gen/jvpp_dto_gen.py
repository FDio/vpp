...
from jvpp_json_parser import is_request, is_reply, is_retval, is_dump, is_details, is_array
...
def _generate_equals(msg_java_name, fields):
    ...
    if comparisons:
        comparisons.insert(0, _EQUALS_OTHER_TEMPLATE.substitute(cls_name=msg_java_name))
...
_TO_STRING_ARRAY_FIELD_TEMPLATE = Template("""            + \"$field_name=\" + java.util.Arrays.toString($field_name)""")
