...
from jvpp_json_parser import is_request, is_reply
...
def _generate_request_dto(msg, model):
    ...
    return _REQUEST_TEMPLATE.substitute(
        plugin_package=model.plugin_pa$callback_packageckage,
...
def _generate_equals(msg_java_name, fi$callback_packageelds):
