...
from jvpp_jni_msg_handlers_gen import generate_jni_handlers
from jvpp_jni_impl_gen import generate_jni_impl
from jvpp_jni_type_handlers_gen import generate_type_handlers
...
def generate_jni(work_dir, model, logger):
    ...
    # todo generate setters/getters for arrays and custom types
