...
from jvpp_jni_common_gen import generate_j2c_swap, generate_j2c_identifiers, generate_c2j_swap
    ...
    for t in model.types:
        if isinstance(t, Class):
            ...
            type_handlers.append(_TYPE_HOST_TO_NET_TEMPLATE.substitute(
                ...
                class_FQN=t.jni_name,
                jni_identifiers=jni_identifiers,
                type_swap=generate_c2j_swap(t, object_ref_name="_host", struct_ref_name="_net") #, struct_ref_name="_net")
            ))
