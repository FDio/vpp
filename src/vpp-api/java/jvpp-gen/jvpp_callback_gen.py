...
from jvpp_json_parser import is_request, is_dump, is_control_ping, is_control_ping_reply
...
def generate_callbacks(model, logger):
    json_filename = model.json_api_files
    logger.debug("Generating Callback interfaces for %s" % json_filename)
