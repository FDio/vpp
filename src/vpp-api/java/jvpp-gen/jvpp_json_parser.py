...
class JsonParser(object):
    ...
    def _parse_types(self):
        # vpp_type java_type jni_signature jni_type
        self.types = {
    ...
    def _parse_message(self, name, definition):
        ...
        if self.is_service(name):
            ...
            if _is_stream(service):
                return Dump(name, service['reply'], crc, fields, definition)
            ...
            return Details(name, self._dumps_by_details[name], crc, fields, definition)
