...
class Message(object):
    ...
    def __str__(self):
        return "Message{name:%s, java_name:%s, crc:%s, fields:%s}" % (self.name, self.java_name_upper, self.crc, self.fields)
...
class JsonParser(object):
    ...
    def _parse_types(self):
        ...
        self.types = {
            ...
            'u16': SimpleType('u16', 'short', 'S', 'jshort', 'ShortField', 'clib_host_to_net_u16'),
            'i16': SimpleType('i16', 'short', 'S', 'jshort', 'ShortField', 'clib_host_to_net_i16'),
            'u32': SimpleType('u32', 'int', 'I', 'jint', 'IntField', 'clib_host_to_net_u32'),
            'i32': SimpleType('i32', 'int', 'I', 'jint', 'IntField', 'clib_host_to_net_i32'),
            'u64': SimpleType('u64', 'long', 'J', 'jlong', 'LongField', 'clib_host_to_net_u64'),
            'i64': SimpleType('i64', 'long', 'J', 'jlong', 'LongField', 'clib_host_to_net_i64'),
