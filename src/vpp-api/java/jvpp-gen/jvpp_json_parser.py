...
class Class(Type):
    def __init__(self, name, crc, fields, definition, plugin_name):
        ...
        _java_name = underscore_to_camelcase_upper(name)
        self.java_name = "io.fd.vpp.jvpp.%s.types.%s" % (plugin_name, _java_name)
        self.crc = crc
        self.fields = fields
        ...
        self.jni_signature = "Lio/fd/vpp/jvpp/%s/types/%s;" % (plugin_name, _java_name)
