...
class JsonParser(object):
    ...
    def _parse_types(self):
        ...
        self._types_by_name = OrderedDict({
            ...
            'u8[]': Array('u8[]', 'byte[]', '[B', 'jbyteArray', 'ObjectField', is_swap_needed=False),
            'u16[]': Array('u16[]', 'short[]', '[S', 'jshortArray', 'ObjectField'),
            'u32[]': Array('u32[]', 'int[]', '[I', 'jintArray', 'ObjectField'),
            'u64[]': Array('u64[]', 'long[]', '[J', 'jlongArray', 'ObjectField')
