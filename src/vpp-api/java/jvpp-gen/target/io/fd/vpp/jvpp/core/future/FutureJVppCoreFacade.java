 ...
 */
public class FutureJVppCoreFacade extends io.fd.vpp.jvpp.future.AbstractFutureJVppInvoker implements
    io.fd.vpp.jvpp.core.future.FutureJVppCore {

    // FIXME private final io.fd.vpp.jvpp.core.notification.CoreEventRegistryImpl eventRegistry = new io.fd.vpp.jvpp.core.notification.CoreEventRegistryImpl();
    ...
    public FutureJVppCoreFacade(final io.fd.vpp.jvpp.JVppRegistry registry, final io.fd.vpp.jvpp.JVpp jvpp) throws java.io.IOException {
        ...
        registry.register(jvpp, new FutureJVppCoreFacadeCallback(getRequests(), null /*FIXME eventRegistry*/));
    }
