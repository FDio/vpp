...
from jvpp_callback_facade_gen import generate_callback_facade
...
from notification_gen import generate_notifications
...
- update future facade (done)
- uncomment tests and run them (done)
...
./jvpp-core/target/io/fd/vpp/jvpp/core/future/FutureJVppCoreFacadeCallback.java (done)
./jvpp-core/target/io/fd/vpp/jvpp/core/callback/JVppCoreGlobalCallback.java (done)
./jvpp-core/target/io/fd/vpp/jvpp/core/callback/SwInterfaceEventCallback.java (done)
./jvpp-core/target/io/fd/vpp/jvpp/core/notification/CoreEventRegistryImpl.java (done)
./jvpp-core/target/io/fd/vpp/jvpp/core/notification/CoreEventRegistry.java (done)
./jvpp-core/target/io/fd/vpp/jvpp/core/notification/GlobalCoreEventCallback.java (done)
./jvpp-core/target/io/fd/vpp/jvpp/core/JVppCoreImpl.java (done)

11) (100) Callback facade (done)
- 
- events in 
./jvpp-core/target/io/fd/vpp/jvpp/core/callfacade/CallbackJVppCoreFacadeCallback.java (done)
...
do not change file names if possible
