...
- usage in messages: c part (50%)
-- message size computation
- arrays (there is no GetObjectArrayElements, just GetObjectArrayElement, so template for custom type arrays needs to be revisited!)
- nested structures
