...
9) (90) Future facade (in progress)
- future jvpp (done)
- future facade (done)
- future callbacks (done)
- dump_reply dtos (in progress)
- uncomment tests/examples
...
13) nested structures (fixme)
-- message size computation (jni_impl_gen)
-- VPP-586

14) make it commitable (python packaging,...)

15) Improve generated formatting (optional)
