...
./jvpp-core/target/io/fd/vpp/jvpp/core/notification/CoreEventRegistryImpl.java (todo!!!)
...
- 
- events in 
./jvpp-core/target/io/fd/vpp/jvpp/core/callfacade/CallbackJVppCoreFacadeCallback.java (todo!!!!!!!)
