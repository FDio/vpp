...
class Profile(VppObject):
    ...
    def remove_vpp_config(self):
        self._vclient.ikev2_profile_add_del(
            name=self.profile_name, is_add=False)

    def add_vpp_config(self):
        self._vclient.ikev2_profile_add_del(
            name=self.profile_name, is_add=True)
        ...
        if hasattr(self, 'ipsec_udp_port'):
            self._vclient.ikev2_profile_set_ipsec_udp_port(
