...
class VPPUnserialize(object):
    ...
    lists where each sublists describes a class property that data is
    unserialized into.
    """

    """The description of attributes in thie class to unserialize into.
    ...
    * 'type' is a description of the serialized type. This can be one of the
      values of @ref _base_types, one of the special VPP types 'suint' or
    ...
    * 'object_klass' is a class reference that is instantiates for each element
      in the list.
    """
    struct = None
    ...
    def __init__(self, buf=None):
        ...
        :param buf: If provided, this @ref VPPUnserializeBuffer is used to
