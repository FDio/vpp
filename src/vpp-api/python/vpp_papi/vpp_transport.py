...
class VppTransportCallbackMixin(metaclass=abc.ABCMeta):

    @abc.abstractmethod
    def msg_handler_sync(self, buffer):
        pass

    @abc.abstractmethod
    def msg_handler_async(self, buffer):
        pass

    @abc.abstractmethod
    def msg_error_handler(self, buffer):
        pass


class BaseVppTransport(MessageTableMixin, metaclass=abc.ABCMeta):
    @abc.abstractmethod
    def __init__(self, *, parent: typing.Optional[VppTransportCallbackMixin], ctx: typing.Dict) -> None:
    ...
    @abc.abstractmethod
    def get_callback(self, do_async: bool) -> typing.Callable:
        pass
