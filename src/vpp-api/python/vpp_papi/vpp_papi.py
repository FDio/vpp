...
class VPPApiClient(object):
    ...
    def process_json_file(self, apidef_file):
        ...
        for m in api['messages']:
            ...
            except vpp_exceptions.VPPApiClientNotImplementedError:
        ...
        if not apifiles:
            ...
            try:
                ...
                if testmode:
                    ...
                    raise vpp_exceptions.VPPApiClientRuntimeError
    ...
    def find_api_files(cls, api_dir=None, patterns='*'):
        ...
        if api_dir is None:
            ...
            if api_dir is None:
                raise vpp_exceptions.VPPApiClientError(
    ...
    def api(self):
        if not hasattr(self, "_api"):
            ...
            raise vpp_exceptions.VPPApiClientError(msg)
        return self._api
    ...
    def connect_internal(self, name, msg_handler, chroot_prefix, rx_qlen,
        ...
        rv = self.transport.connect(name.encode('utf-8'), pfx,
                                    msg_handler, rx_qlen)
        if rv != 0:
            raise vpp_exceptions.VPPApiClientIOError(2, 'Connect failed')
    ...
    def msg_handler_sync(self, msg):
        ...
        if context == 0:
            ...
            raise vpp_exceptions.VPPApiClientIOError(2, msg)
