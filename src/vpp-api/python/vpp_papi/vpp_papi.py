...
__all__ = ('FuncWrapper', 'VPP', 'VppApiDynamicMethodHolder',
           ...
           'VPPApiClient', 'VPPApiShmClient', 'VPPApiSocketClient')
...
class VPPApiClient:
    ...
    def __init__(self, *, apifiles=None, testmode=False, transport=transport, async_thread=True,
...
from .vpp_transport_shmem import VppTransport as transport_shmem
from .vpp_transport_socket import VppTransport as transport_socket


class VPPApiShmClient(VPPApiClient):
    transport = transport_shmem


class VPPApiSocketClient(VPPApiClient):
    transport = transport_socket

# vim: tabstop=8 expandtab shiftwidth=4 s