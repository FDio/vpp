...
class VPP():
    ...
    from provides .api.json files and makes functions accordingly.
    These functions are documented in the VPP .api files, as they
    are dynamically created.

    Additiionally, VPP can send callback messages; this class
    ...
    def _call_vpp(self, i, msgdef, multipart, **kwargs):
        ...
        supplied.
        The remainder of the kwargs are the message content.

        The return value is the message or message array containing
        the response.  It can be None if there was no response
