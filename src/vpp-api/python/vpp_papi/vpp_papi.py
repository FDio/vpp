...
def vpp_atexit(vpp_weakref):
    ...
    if vpp_instance.transport.connected:
...
class VPP():
    ...
    def connect(self, name, chroot_prefix=None, async=False, rx_qlen=32):
        ...
        client and server.
        """
        msg_handler = self.transport.get_callback(async)
    ...
    def connect_sync(self, name, chroot_prefix=None, rx_qlen=32):
        ...
        return self.connect_internal(name, None, chroot_prefix, rx_qlen, async=False)
