...
public:
   ...
   */
  typedef std::set<bond_member_interface> enslaved_itf_t;

  /**
   * Construct a new object matching the desried state
   */
  bond_interface_binding(const bond_interface& itf, const enslaved_itf_t& mem);
...
private:
   ...
   */
  friend class singular_db<key_t, bond_interface_binding>;
   ...
   * "binding".
   */
  static singular_db<key_t, bond_interface_binding> m_db;
};
};
