...
nat_binding::nat_binding(const interface &itf,
                         ...
                         const zone_t &zone)
  : m_binding(false), m_itf(itf.singular()), m_dir(dir), m_proto(proto), m_zone(zone)
{
}

nat_binding::nat_binding(const nat_binding &o)
  : m_binding(o.m_binding), m_itf(o.m_itf), m_dir(o.m_dir), m_proto(o.m_proto), m_zone(o.m_zone)
{
}
