...
namespace VOM
{
    ...
    nat_binding::zone_t::zone_t(int v, const std::string s) : enum_base(v, s)
    {
    }
    ...
    void nat_binding::sweep()
    {
        if (m_binding)
        {
            ...
            {
                HW::enqueue(new unbind_44_input_cmd(m_binding, m_itf->handle(),
                                                    m_zone));
            }
            else
            {
    ...
    void nat_binding::replay()
    {
        if (m_binding)
        {
            ...
            {
                HW::enqueue(
                    new bind_44_input_cmd(m_binding, m_itf->handle(), m_zone));
            }
            else
            {
                assert(!"Unimplemented");
