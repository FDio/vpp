...
namespace VOM
{
    ...
    bool nat_binding::bind_44_input_cmd::
    operator==(const bind_44_input_cmd &other) const
    {
    ...
    bool nat_binding::unbind_44_input_cmd::
    operator==(const unbind_44_input_cmd &other) const
    {
        return ((m_itf == other.m_itf) && (m_zone == other.m_zone));
    }
