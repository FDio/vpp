 ...
 * Constructor
 */
    bind_cmd(HW::item<bool>& item, const handle_t& itf, uint32_t bd,
             bool is_bvi);
 ...
 * Constructor
 */
    unbind_cmd(HW::item<bool>& item, const handle_t& itf, uint32_t bd,
               bool is_bvi);
 ...
 * Constructor
 */
    set_vtr_op_cmd(HW::item<l2_vtr_op_t>& item, const handle_t& itf,
                   uint16_t tag);
