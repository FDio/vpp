...
namespace VOM
{
    ...
    class l2_binding : public object_base
    {
      public:
         ...
         */
        class bind_cmd : public rpc_cmd<HW::item<bool>, rc_t, vapi::Sw_interface_set_l2_bridge>
        {
          public:
            /**
             * Constructor
         ...
         */
        class unbind_cmd : public rpc_cmd<HW::item<bool>, rc_t, vapi::Sw_interface_set_l2_bridge>
        {
          public:
            /**
             * Constructor
         ...
         */
        class set_vtr_op_cmd : public rpc_cmd<HW::item<l2_vtr_op_t>, rc_t, vapi::L2_interface_vlan_tag_rewrite>
        {
          public:
            /**
             * Constructor
