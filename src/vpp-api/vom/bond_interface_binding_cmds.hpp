...
#ifndef __VOM_BOND_INTERFACE_BINDING_CMDS_H__
#define __VOM_BOND_INTERFACE_BINDING_CMDS_H__
...
namespace VOM {
namespace bond_interface_binding_cmds {
/**
...
public:
  ...
  bind_cmd(HW::item<bool>& item,
           ...
           const bond_member_interface& itf);
...
private:
   ...
   */
  const bond_member_interface& m_itf;
};
 ...
 */
class dump_cmd : public VOM::dump_cmd<vapi::Sw_interface_lacp_dump>
{
public:
  /**
   * Default Constructor
