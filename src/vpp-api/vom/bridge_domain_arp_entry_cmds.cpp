...
namespace VOM
{
    ...
    bool bridge_domain_arp_entry::create_cmd::
    operator==(const create_cmd &other) const
    {
    ...
    bool bridge_domain_arp_entry::delete_cmd::
    operator==(const delete_cmd &other) const
    {
        return ((m_mac == other.m_mac) && (m_ip_addr == other.m_ip_addr) &&
                (m_bd == other.m_bd));
    }
