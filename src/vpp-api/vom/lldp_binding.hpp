...
namespace VOM
{
    ...
    class lldp_binding : public object_base
    {
      public:
         ...
         */
        class bind_cmd : public rpc_cmd<HW::item<bool>, rc_t, vapi::Sw_interface_set_lldp>
        {
          public:
            /**
             * Constructor
         ...
         */
        class unbind_cmd : public rpc_cmd<HW::item<bool>, rc_t, vapi::Sw_interface_set_lldp>
        {
          public:
            /**
             * Constructor
