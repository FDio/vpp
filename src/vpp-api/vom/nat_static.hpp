 ...
 */
  nat_static(const route_domain& rd, const boost::asio::ip::address& inside,
             const boost::asio::ip::address_v4& outside);
 ...
 * Constructor
 */
    create_44_cmd(HW::item<bool>& item, route::table_id_t id,
 ...
 * Constructor
 */
    delete_44_cmd(HW::item<bool>& item, route::table_id_t id,
                  const boost::asio::ip::address_v4& inside,
                  const boost::asio::ip::address_v4& outside);
