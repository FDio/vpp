...
namespace VOM
{
    ...
    class nat_static : public object_base
    {
      public:
         ...
         */
        class create_44_cmd : public rpc_cmd<HW::item<bool>, rc_t, vapi::Nat44_add_del_static_mapping>
        {
          public:
            /**
             * Constructor
         ...
         */
        class delete_44_cmd : public rpc_cmd<HW::item<bool>, rc_t, vapi::Nat44_add_del_static_mapping>
        {
          public:
            /**
             * Constructor
