...
{
  if (0x0806 == numeric) {
    return (ethertype_t::ETHERTYPE_ARP);
  }
  if (0x8906 == numeric) {
    return (ethertype_t::ETHERTYPE_FCOE);
  }
  if (0x0800 == numeric) {
    return (ethertype_t::ETHERTYPE_IPV4);
  }
  if (0x86DD == numeric) {
    return (ethertype_t::ETHERTYPE_IPV6);
  }
  if (0x88E5 == numeric) {
    return (ethertype_t::ETHERTYPE_MAC_SECURITY);
  }
  if (0x8847 == numeric) {
    return (ethertype_t::ETHERTYPE_MPLS_UNICAST);
  }
  if (0x22F3 == numeric) {
    return (ethertype_t::ETHERTYPE_TRILL);
  }

  return (ethertype_t::ETHERTYPE_UNSPECIFIED);
}
