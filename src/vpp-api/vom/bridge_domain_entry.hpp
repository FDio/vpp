...
namespace VOM
{
    ...
    class bridge_domain_entry : public object_base
    {
      public:
         ...
         */
        static std::shared_ptr<bridge_domain_entry>
        find(const bridge_domain_entry &temp);
         ...
         */
        class create_cmd
            : public rpc_cmd<HW::item<bool>, rc_t, vapi::L2fib_add_del>
        {
          public:
            /**
             * Constructor
      ...
      private:
         ...
         */
        static std::shared_ptr<bridge_domain_entry>
        find_or_add(const bridge_domain_entry &temp);
