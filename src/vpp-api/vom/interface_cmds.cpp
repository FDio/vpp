...
namespace VOM
{
    interface::loopback_create_cmd::loopback_create_cmd(
    ...
    interface::af_packet_create_cmd::af_packet_create_cmd(
        HW::item<handle_t> &item,
        const std::string &name)
      : create_cmd(item, name)
    {
    ...
    interface::loopback_delete_cmd::loopback_delete_cmd(
        HW::item<handle_t> &item)
      : delete_cmd(item)
    {
    }
    ...
    interface::af_packet_delete_cmd::af_packet_delete_cmd(
        HW::item<handle_t> &item,
        const std::string &name)
    ...
    interface::state_change_cmd::state_change_cmd(
      ...
      : rpc_cmd(state), m_hdl(hdl)
    {
    }

    bool interface::state_change_cmd::
    operator==(const state_change_cmd &other) const
    {
    ...
    interface::set_table_cmd::set_table_cmd(HW::item<route::table_id_t> &table,
                                            ...
                                            const HW::item<handle_t> &hdl)
      : rpc_cmd(table), m_hdl(hdl), m_proto(proto)
    {
    }
    ...
    interface::events_cmd::events_cmd(event_listener &el)
      : event_cmd(el.status()), m_listener(el)
    {
    }
    ...
    rc_t interface::events_cmd::issue(connection &con)
    {
         ...
         */
        m_reg.reset(
            new reg_t(con.ctx(), std::ref(*(static_cast<event_cmd *>(this)))));
    ...
    interface::stats_cmd::stats_cmd(stat_listener &el,
      ...
      : event_cmd(el.status()), m_listener(el), m_swifindex(interfaces)
    {
    }
