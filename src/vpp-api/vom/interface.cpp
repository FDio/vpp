...
interface::interface(const std::string &name,
  ...
  : m_hdl(handle_t::INVALID), m_name(name), m_type(itf_type), m_state(itf_state), m_table_id(route::DEFAULT_TABLE), m_l2_address(l2_address_t::ZERO, rc_t::UNSET), m_oper(oper_state_t::DOWN)
{
}
...
interface::interface(const handle_t &handle,
  ...
  : m_hdl(handle), m_name(name), m_type(type), m_state(state), m_table_id(route::DEFAULT_TABLE), m_l2_address(l2_address), m_oper(oper_state_t::DOWN)
{
}
...
interface::interface(const std::string &name,
  ...
  : m_hdl(handle_t::INVALID), m_name(name), m_type(itf_type), m_rd(rd.singular()), m_state(itf_state), m_table_id(m_rd->table_id()), m_l2_address(l2_address_t::ZERO, rc_t::UNSET), m_oper(oper_state_t::DOWN)
{
}

interface::interface(const interface &o)
  : m_hdl(o.m_hdl), m_name(o.m_name), m_type(o.m_type), m_rd(o.m_rd), m_state(o.m_state), m_table_id(o.m_table_id), m_l2_address(o.m_l2_address), m_oper(o.m_oper)
{
}
