 ...
 */
interface::interface(const std::string& name, interface::type_t itf_type,
...
interface::interface(const handle_t& handle, const l2_address_t& l2_address,
                     const std::string& name, interface::type_t type,
...
interface::interface(const std::string& name, interface::type_t itf_type,
                     interface::admin_state_t itf_state, const route_domain& rd)
  : m_hdl(handle_t::INVALID)
  , m_name(name)
  , m_type(itf_type)
  , m_rd(rd.singular())
