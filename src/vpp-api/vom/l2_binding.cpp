...
namespace VOM
{
     ...
     */
    const l2_binding::l2_vtr_op_t
        l2_binding::l2_vtr_op_t::L2_VTR_DISABLED(0, "disabled");
    const l2_binding::l2_vtr_op_t
        l2_binding::l2_vtr_op_t::L2_VTR_PUSH_1(1, "push-1");
    const l2_binding::l2_vtr_op_t
        l2_binding::l2_vtr_op_t::L2_VTR_PUSH_2(2, "push-2");
    const l2_binding::l2_vtr_op_t
        l2_binding::l2_vtr_op_t::L2_VTR_POP_1(3, "pop-1");
    const l2_binding::l2_vtr_op_t
        l2_binding::l2_vtr_op_t::L2_VTR_POP_2(4, "pop-2");
    const l2_binding::l2_vtr_op_t
        l2_binding::l2_vtr_op_t::L2_VTR_TRANSLATE_1_1(5, "translate-1-1");
    const l2_binding::l2_vtr_op_t
        l2_binding::l2_vtr_op_t::L2_VTR_TRANSLATE_1_2(6, "translate-1-2");
    const l2_binding::l2_vtr_op_t
        l2_binding::l2_vtr_op_t::L2_VTR_TRANSLATE_2_1(7, "translate-2-1");
    const l2_binding::l2_vtr_op_t
        l2_binding::l2_vtr_op_t::L2_VTR_TRANSLATE_2_2(5, "translate-2-2");
    ...
    void l2_binding::sweep()
    {
        ...
        {
            HW::enqueue(
                new unbind_cmd(m_binding, m_itf->handle(), m_bd->id(),
    ...
    void l2_binding::replay()
    {
        ...
        {
            HW::enqueue(
                new set_vtr_op_cmd(m_vtr_op, m_itf->handle(), m_vtr_op_tag));
        }
    }
