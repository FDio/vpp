 ...
 */
  typedef std::tuple<interface::key_type, mac_address_t,
 ...
 */
  neighbour(const interface& itf, const mac_address_t& mac,
 ...
 * Constructor
 */
    create_cmd(HW::item<bool>& item, handle_t itf, const mac_address_t& mac,
               const boost::asio::ip::address& ip_addr);
 ...
 * Constructor
 */
    delete_cmd(HW::item<bool>& item, handle_t itf, const mac_address_t& mac,
               const boost::asio::ip::address& ip_addr);
