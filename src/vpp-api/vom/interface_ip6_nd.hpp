    ...
    class interface_ip6_nd : public object_base
    {
      public:
        ...
        interface_ip6_nd(const interface &itf, const class_t cls)
          : m_itf(itf.singular()), m_cls(cls), m_config(true)
        {
        }
        ...
        interface_ip6_nd(const interface_ip6_nd &o)
          : m_itf(o.m_itf), m_cls(o.m_cls), m_config(o.m_config)
        {
        }
        ...
        class config_cmd : public rpc_cmd<HW::item<bool>, rc_t, CMD>
        {
          public:
            ...
            config_cmd(HW::item<bool> &item,
                       const handle_t &itf,
                       const class_t &cls)
              : rpc_cmd<HW::item<bool>, rc_t, CMD>(item), m_itf(itf), m_cls(cls)
            {
            }
      ...
      private:
                              ...
                              public inspect::command_handler
        {
          public:
            event_handler()
            {
                ...
                inspect::register_handler({"ip6_nd "}, "interface ip6 nd",
                                          this);
            }
         ...
         */
        static std::shared_ptr<interface_ip6_nd>
        find_or_add(const interface_ip6_nd &temp)
        {
