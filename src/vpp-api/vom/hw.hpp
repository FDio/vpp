      ...
      public:
        ...
        template <typename T> class item
        {
          public:
             ...
             * Constructor
             */
            item(const T &data) : item_data(data), item_rc(rc_t::NOOP)
            {
            }
            /**
             * Constructor
             */
            item() : item_rc(rc_t::UNSET)
            {
            }
             ...
             * Constructor
             */
            item(const T &data, rc_t rc) : item_data(data), item_rc(rc)
            {
            }
            ...
            bool update(const item &desired)
            {
                 ...
                 */
                need_hw_update =
                    (item_data != desired.data() || rc_t::OK != rc());
