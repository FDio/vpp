...
namespace VOM {
l2_binding::bind_cmd::bind_cmd(HW::item<bool>& item, const handle_t& itf,
                               uint32_t bd, bool is_bvi)
  : rpc_cmd(item)
  , m_itf(itf)
  , m_bd(bd)
  , m_is_bvi(is_bvi)
...
l2_binding::unbind_cmd::unbind_cmd(HW::item<bool>& item, const handle_t& itf,
                                   uint32_t bd, bool is_bvi)
  : rpc_cmd(item)
  , m_itf(itf)
  , m_bd(bd)
...
l2_binding::set_vtr_op_cmd::set_vtr_op_cmd(HW::item<l2_vtr_op_t>& item,
                                           const handle_t& itf, uint16_t tag)
  : rpc_cmd(item)
  , m_itf(itf)
  , m_tag(tag)
{
