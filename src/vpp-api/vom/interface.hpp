...
namespace VOM
{
    ...
    class interface : public object_base
    {
      public:
        ...
        class create_cmd : public rpc_cmd<HW::item<handle_t>,
                                          HW::item<handle_t>,
                                          MSG>
        {
          public:
            create_cmd(HW::item<handle_t> &item,
              ...
              : rpc_cmd<HW::item<handle_t>, HW::item<handle_t>, MSG>(item), m_name(name)
            {
            }
        ...
        class loopback_create_cmd : public create_cmd<vapi::Create_loopback>
        {
          public:
             ...
             */
            loopback_create_cmd(HW::item<handle_t> &item,
                                const std::string &name);
        ...
        class af_packet_create_cmd : public create_cmd<vapi::Af_packet_create>
        {
          public:
             ...
             * and the name of the interface to create
             */
            af_packet_create_cmd(HW::item<handle_t> &item,
                                 const std::string &name);
                                          ...
                                          MSG>
        {
          public:
            ...
            delete_cmd(HW::item<handle_t> &item)
              : rpc_cmd<HW::item<handle_t>, HW::item<handle_t>, MSG>(item), m_name()
            {
            }
        ...
        class af_packet_delete_cmd : public delete_cmd<vapi::Af_packet_delete>
        {
          public:
             ...
             */
            af_packet_delete_cmd(HW::item<handle_t> &item,
                                 const std::string &name);
         ...
         * A command class to delete TAP interfaces in VPP
         */
        class set_tag : public rpc_cmd<HW::item<handle_t>,
                                       rc_t,
                                                ...
                                                vapi::Sw_interface_set_flags>
        {
          public:
             ...
             */
            state_change_cmd(HW::item<admin_state_t> &s,
        ...
        /**
         * The the singular instance of the interface in the object_base-Model by handle
         */
        static std::shared_ptr<interface> find(const handle_t &h);

        /**
         * The the singular instance of the interface in the object_base-Model by name
         */
