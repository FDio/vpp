 ...
 */
  class state_change_cmd : public rpc_cmd<HW::item<admin_state_t>, rc_t,
 ...
 */
  class set_table_cmd : public rpc_cmd<HW::item<route::table_id_t>, rc_t,
 ...
 */
    set_table_cmd(HW::item<route::table_id_t>& item, const l3_proto_t& proto,
 ...
 * A command class that binds an interface to an L3 table
 */
  class set_mac_cmd : public rpc_cmd<HW::item<l2_address_t>, rc_t,
 ...
 */
  interface(const handle_t& handle, const l2_address_t& l2_address,
            const std::string& name, type_t type, admin_state_t state);
