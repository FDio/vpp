...
namespace VOM
{
    ...
    class interface : public object_base
    {
      public:
        ...
        class create_cmd
            : public rpc_cmd<HW::item<handle_t>, HW::item<handle_t>, MSG>
        {
          public:
            ...
            void succeeded()
            {
                rpc_cmd<HW::item<handle_t>, HW::item<handle_t>,
                        MSG>::succeeded();
            ...
            {
                int sw_if_index =
                    reply.get_response().get_payload().sw_if_index;
         ...
         */
        class events_cmd
            : public rpc_cmd<HW::item<bool>, rc_t, vapi::Want_interface_events>,
      ...
      private:
         ...
         * handle store.
         */
        template <typename MSG> friend class create_cmd;

        /**
         * Create commands are firends so they can remove interfaces from the
         * handle store.
         */
        template <typename MSG> friend class delete_cmd;
    };
};
/*
