...
namespace VOM {
   ...
   */
        class af_packet_create_cmd : public interface::create_cmd<vapi::Af_packet_create>
  {
  public:
    /**
     * Constructor taking the HW::item to update
   ...
   */
    class af_packet_delete_cmd : public interface::delete_cmd<vapi::Af_packet_delete>
  {
  public:
    /**
     * Constructor taking the HW::item to update
