 ...
 */
  interface_span(const interface& itf_from, const interface& itf_to,
                 state_t state);
 ...
 * Constructor
 */
    config_cmd(HW::item<bool>& item, const handle_t& itf_from,
               const handle_t& itf_to, const state_t& state);
 ...
 * Constructor
 */
    unconfig_cmd(HW::item<bool>& item, const handle_t& itf_from,
