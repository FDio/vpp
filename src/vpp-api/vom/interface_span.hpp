...
namespace VOM
{
    ...
    class interface_span : public object_base
    {
      public:
         ...
         */
        class config_cmd : public rpc_cmd<HW::item<bool>, rc_t, vapi::Sw_interface_span_enable_disable>
        {
          public:
            /**
             * Constructor
         ...
         */
        class unconfig_cmd : public rpc_cmd<HW::item<bool>, rc_t, vapi::Sw_interface_span_enable_disable>
        {
          public:
            /**
             * Constructor
      ...
      private:
         ...
         */
        static std::shared_ptr<interface_span> find_or_add(const interface_span &temp);
        ...
        */
        ...
        /**
         * A reference counting pointer the interface where the traffic is mirrored
         */
