...
namespace VOM
{
    ...
    class ip_unnumbered : public object_base
    {
      public:
         ...
         */
        class config_cmd : public rpc_cmd<HW::item<bool>, rc_t, vapi::Sw_interface_set_unnumbered>
        {
          public:
            /**
             * Constructor
         ...
         */
        class unconfig_cmd : public rpc_cmd<HW::item<bool>, rc_t, vapi::Sw_interface_set_unnumbered>
        {
          public:
            /**
             * Constructor
