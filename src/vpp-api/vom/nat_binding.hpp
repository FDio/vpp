 ...
 */
  nat_binding(const interface& itf, const direction_t& dir,
              const l3_proto_t& proto, const zone_t& zone);
 ...
 */
  class bind_44_input_cmd
    : public rpc_cmd<HW::item<bool>, rc_t,
 ...
 * Constructor
 */
    bind_44_input_cmd(HW::item<bool>& item, const handle_t& itf,
                      const zone_t& zone);
 ...
 * Constructor
 */
    unbind_44_input_cmd(HW::item<bool>& item, const handle_t& itf,
                        const zone_t& zone);
