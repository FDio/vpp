...
namespace VOM
{
    ...
    class nat_binding : public object_base
    {
      public:
         ...
         */
        class bind_44_input_cmd : public rpc_cmd<HW::item<bool>, rc_t, vapi::Nat44_interface_add_del_feature>
        {
          public:
            /**
             * Constructor
         ...
         */
        class unbind_44_input_cmd : public rpc_cmd<HW::item<bool>, rc_t, vapi::Nat44_interface_add_del_feature>
        {
          public:
            /**
             * Constructor
