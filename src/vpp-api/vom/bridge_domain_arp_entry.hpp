...
namespace VOM
{
    ...
    class bridge_domain_arp_entry : public object_base
    {
      public:
         ...
         */
        typedef std::tuple<uint32_t, mac_address_t, boost::asio::ip::address>
            key_t;
         ...
         */
        static std::shared_ptr<bridge_domain_arp_entry>
        find(const bridge_domain_arp_entry &temp);
      ...
      private:
         ...
         */
        static std::shared_ptr<bridge_domain_arp_entry>
        find_or_add(const bridge_domain_arp_entry &temp);
