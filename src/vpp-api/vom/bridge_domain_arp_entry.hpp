 ...
 */
  bridge_domain_arp_entry(const bridge_domain& bd, const mac_address_t& mac,
 ...
 * Constructor
 */
    create_cmd(HW::item<bool>& item, uint32_t id, const mac_address_t& mac,
               const boost::asio::ip::address& ip_addr);
 ...
 * Constructor
 */
    delete_cmd(HW::item<bool>& item, uint32_t id, const mac_address_t& mac,
               const boost::asio::ip::address& ip_addr);
