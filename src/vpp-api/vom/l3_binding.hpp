...
namespace VOM
{
    ...
    class l3_binding : public object_base
    {
      public:
         ...
         */
        class bind_cmd : public rpc_cmd<HW::item<bool>, rc_t, vapi::Sw_interface_add_del_address>
        {
          public:
            /**
             * Constructor
         ...
         */
        class unbind_cmd : public rpc_cmd<HW::item<bool>, rc_t, vapi::Sw_interface_add_del_address>
        {
          public:
            /**
             * Constructor
