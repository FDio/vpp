...
namespace VOM
{
     ...
     */
    bridge_domain::bridge_domain(uint32_t id) : m_id(id)
    {
    }

    bridge_domain::bridge_domain(const bridge_domain &o) : m_id(o.m_id)
    {
    }
    ...
    bridge_domain::event_handler::handle_populate(const client_db::key_t &key)
    {
         ...
         */
        std::shared_ptr<bridge_domain::dump_cmd> cmd(
            new bridge_domain::dump_cmd());
