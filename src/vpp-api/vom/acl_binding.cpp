...
namespace VOM
{
    namespace ACL
    {
        ...
        l2_binding::event_handler::handle_populate(const client_db::key_t &key)
        {
             ...
             */
            std::shared_ptr<l2_binding::dump_cmd> cmd(
                new l2_binding::dump_cmd());
        ...
        {
            std::shared_ptr<l3_binding::dump_cmd> cmd(
                new l3_binding::dump_cmd());
