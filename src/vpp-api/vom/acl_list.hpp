    ...
    namespace ACL
    {
        ...
        class list : public object_base
        {
          public:
             ...
             */
            class update_cmd : public rpc_cmd<HW::item<handle_t>,
                                              HW::item<handle_t>,
                                              UPDATE>
            {
              public:
          ...
          private:
             ...
             */
            friend class VOM::singular_db<key_t, list>;
        ...
        template <typename RULE, typename UPDATE, typename DELETE, typename DUMP>
        typename ACL::list<RULE, UPDATE, DELETE, DUMP>::event_handler list<RULE, UPDATE, DELETE, DUMP>::m_evh;
    };
};
