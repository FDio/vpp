...
const bond_interface::mode_t bond_interface::mode_t::ROUND_ROBIN(0,
                                                                 "round-robin");
const bond_interface::mode_t bond_interface::mode_t::ACTIVE_BACKUP(
  1,
  "active-backup");
const bond_interface::mode_t bond_interface::mode_t::XOR(2, "xor");
const bond_interface::mode_t bond_interface::mode_t::BROADCAST(3, "broadcast");
const bond_interface::mode_t bond_interface::mode_t::LACP(4, "lacp");
const bond_interface::mode_t bond_interface::mode_t::UNSPECIFIED(~0,
                                                                 "unspecified");

const bond_interface::mode_t
bond_interface::mode_t::from_nemuric_val(const uint8_t numeric)
{
  if (0 == numeric) {
...
bond_interface::lb_t::from_numeric_val(const uint8_t numeric)
{
  if (0 == numeric) {
...
bond_member_interface::mode_t::from_numeric_val(const uint8_t numeric)
{
  if (0 == numeric)
...
bond_member_interface::rate_t::from_numeric_val(const uint8_t numeric)
{
  if (0 == numeric)
