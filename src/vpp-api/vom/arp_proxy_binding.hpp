...
namespace VOM
{
    ...
    class arp_proxy_binding : public object_base
    {
      public:
         ...
         */
        class bind_cmd : public rpc_cmd<HW::item<bool>, rc_t, vapi::Proxy_arp_intfc_enable_disable>
        {
          public:
            /**
             * Constructor
         ...
         */
        class unbind_cmd : public rpc_cmd<HW::item<bool>, rc_t, vapi::Proxy_arp_intfc_enable_disable>
        {
          public:
            /**
             * Constructor
