...
namespace VOM
{
     ...
     */
    singular_db<arp_proxy_config::key_t, arp_proxy_config>
        arp_proxy_config::m_db;
    ...
    {
        return (
            m_db.find_or_add(std::make_pair(temp.m_low, temp.m_high), temp));
    }
    ...
    arp_proxy_config::event_handler::event_handler()
    {
        ...
        inspect::register_handler({"arp-proxy"}, "ARP Proxy configurations",
                                  this);
    }
    ...
    void arp_proxy_config::event_handler::handle_populate(
