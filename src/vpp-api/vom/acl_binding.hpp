        ...
        class binding : public object_base
        {
          public:
            ...
            binding(const direction_t &direction,
                    const interface &itf,
                    const LIST &acl)
              : m_direction(direction), m_itf(itf.singular()), m_acl(acl.singular()), m_binding(0)
            {
                m_evh.order();
            }
            ...
            binding(const binding &o)
              : m_direction(o.m_direction), m_itf(o.m_itf), m_acl(o.m_acl), m_binding(0)
            {
            }
            ...
            class bind_cmd : public rpc_cmd<HW::item<bool>, rc_t, BIND>
            {
              public:
                ...
                bind_cmd(HW::item<bool> &item,
                         ...
                         const handle_t &itf,
                         const handle_t &acl)
                  : rpc_cmd<HW::item<bool>, rc_t, BIND>(item), m_direction(direction), m_itf(itf), m_acl(acl)
                {
                }
