...
{
  clib_aes_gcm_key_expand ((aes_gcm_key_data_t *) key_data, key->data, ks);
}
...
static_always_inline void
aes_gcm_key_add_inline (vnet_crypto_key_t *key, vnet_crypto_key_data_t *key_data, aes_key_size_t ks)
{
