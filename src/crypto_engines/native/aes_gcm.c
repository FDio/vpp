...
aes_ops_enc_aes_gcm (vnet_crypto_op_t *ops[], u32 n_ops, aes_key_size_t ks, i32 aad_len,
		     u32 auth_len, clib_thread_index_t thread_index)
{
...
#define _(x)                                                                                       \
  ...
  {                                                                                                \
    return aes_ops_dec_aes_gcm (ops, n_ops, AES_KEY_##x, -1, 0, thread_index);                     \
  }                                                                                                \
  static u32 aes_ops_enc_aes_gcm_##x (vnet_crypto_op_t *ops[], u32 n_ops,                          \
				      clib_thread_index_t thread_index)                            \
  {                                                                                                \
    return aes_ops_enc_aes_gcm (ops, n_ops, AES_KEY_##x, -1, 0, thread_index);                     \
  }                                                                                                \
  static u32 aes_ops_dec_aes_gcm_##x##_tag16_aad8 (vnet_crypto_op_t *ops[], u32 n_ops,             \
						   clib_thread_index_t thread_index)               \
  {                                                                                                \
    return aes_ops_dec_aes_gcm (ops, n_ops, AES_KEY_##x, 8, 16, thread_index);                     \
  }                                                                                                \
  static u32 aes_ops_enc_aes_gcm_##x##_tag16_aad8 (vnet_crypto_op_t *ops[], u32 n_ops,             \
						   clib_thread_index_t thread_index)               \
  {                                                                                                \
    return aes_ops_enc_aes_gcm (ops, n_ops, AES_KEY_##x, 8, 16, thread_index);                     \
  }                                                                                                \
  static u32 aes_ops_dec_aes_gcm_##x##_tag16_aad12 (vnet_crypto_op_t *ops[], u32 n_ops,            \
						    clib_thread_index_t thread_index)              \
  {                                                                                                \
    return aes_ops_dec_aes_gcm (ops, n_ops, AES_KEY_##x, 12, 16, thread_index);                    \
  }                                                                                                \
  static u32 aes_ops_enc_aes_gcm_##x##_tag16_aad12 (vnet_crypto_op_t *ops[], u32 n_ops,            \
						    clib_thread_index_t thread_index)              \
  {                                                                                                \
    return aes_ops_enc_aes_gcm (ops, n_ops, AES_KEY_##x, 12, 16, thread_index);                    \
  }
...
VNET_CRYPTO_REG_ALG_GROUP (native_gcm128_group) = {
...
VNET_CRYPTO_REG_ALG_GROUP (native_gcm192_group) = {
...
VNET_CRYPTO_REG_ALG_GROUP (native_gcm256_group) = {
...
#define _(b)                                                                                         \
  VNET_CRYPTO_REG_ALG (aes_##b##_gcm) = {                                                          \
    ...
    .simple = {                                                                                    \
      ...
      .dec_fn = aes_ops_dec_aes_gcm_##b,                                                           \
                                                                                                     ...
                                                                                                     \
  VNET_CRYPTO_REG_ALG (aes_##b##_gcm_tag16_aad8) = {                                               \
    .group = &native_gcm##b##_group,                                                               \
    .alg_id = VNET_CRYPTO_ALG_AES_##b##_GCM_TAG16_AAD8,                                            \
    .simple = {                                                                                    \
      ...
      .dec_fn = aes_ops_dec_aes_gcm_##b##_tag16_aad8,                                              \
                                                                                                     ...
                                                                                                     \
  VNET_CRYPTO_REG_ALG (aes_##b##_gcm_tag16_aad12) = {                                              \
    .group = &native_gcm##b##_group,                                                               \
    .alg_id = VNET_CRYPTO_ALG_AES_##b##_GCM_TAG16_AAD12,                                           \
    .simple = {                                                                                    \
