...
VNET_CRYPTO_REG_ALG_GROUP (native_ctr128_group) = {
  .probe_fn = probe,
  .max_key_data_sz = sizeof (aes_ctr_key_data_t),
  .key_change_fn = aes_ctr_128_key_change_handler,
};

VNET_CRYPTO_REG_ALG_GROUP (native_ctr192_group) = {
  .probe_fn = probe,
  .max_key_data_sz = sizeof (aes_ctr_key_data_t),
  .key_change_fn = aes_ctr_192_key_change_handler,
};

VNET_CRYPTO_REG_ALG_GROUP (native_ctr256_group) = {
  .probe_fn = probe,
  .max_key_data_sz = sizeof (aes_ctr_key_data_t),
  .key_change_fn = aes_ctr_256_key_change_handler,
};

VNET_CRYPTO_REG_ALG_GROUP (native_ctr128_sha2_group) = {
...
VNET_CRYPTO_REG_ALG_GROUP (native_ctr192_sha2_group) = {
  .probe_fn = aes_ctr_sha2_probe,
  .max_key_data_sz = sizeof (aes_ctr_hmac_key_data_t),
  .key_change_fn = aes_ctr_sha2_192_key_change_handler,
};

VNET_CRYPTO_REG_ALG_GROUP (native_ctr256_sha2_group) = {
  .probe_fn = aes_ctr_sha2_probe,
  .max_key_data_sz = sizeof (aes_ctr_hmac_key_data_t),
...
#define _(b)                                                                                       \
  VNET_CRYPTO_REG_ALG (aes_##b##_ctr) = {                                                          \
...
#define _(a, n, b, c)                                                                                \
  ...
  VNET_CRYPTO_REG_ALG (aes_##a##_ctr_hmac_sha##b) = {                                              \
    ...
    .chained = {                                                                                   \
      ...
      .dec_fn = crypto_native_ops_dec_aes_ctr_##a##_hmac_sha##b##_chained,                         \
                                                                                                     ...
                                                                                                     \
  VNET_CRYPTO_REG_ALG (aes_##a##_ctr_hmac_sha##b##_tag##c) = {                                     \
    .group = &native_ctr##a##_sha2_group,                                                          \
...
_ (128, SHA_256, 256, 16)
_ (192, SHA_256, 256, 16)
_ (256, SHA_256, 256, 16)
  ...
  {                                                                                                \
    return aes_ops_dec_aes_ctr_hmac_chained (ops, chunks, n_ops, AES_KEY_##a, CLIB_SHA2_256, c,    \
					     thread_index);                                        \
                                                                                                   ...
                                                                                                   \
  VNET_CRYPTO_REG_ALG (aes_##a##_ctr_hmac_sha256_tag##c##_extra) = {                              \
    .group = &native_ctr##a##_sha2_group,                                                          \
    .alg_id = VNET_CRYPTO_ALG_AES_##a##_CTR_SHA_256_ICV##c,                                         \
    .simple = {                                                                                    \
