...
#define _(a, b, c, d)                                                                              \
  ...
  {                                                                                                \
    return openssl_ops_hmac_dec_cbc_chained (ops, chunks, n_ops);                                  \
                                                                                                   ...
                                                                                                   \
  static void openssl_ctx_aes_hmac_##a (vnet_crypto_key_op_t kop, void *key_data,                  \
					vnet_crypto_alg_t alg, const u8 *data, u16 length)         \
  {                                                                                                \
    openssl_ctx_cipher (kop, key_data, data, c, b (), 0);                                          \
    openssl_ctx_hmac (kop, key_data, data + c, length, d ());                                      \
  }
