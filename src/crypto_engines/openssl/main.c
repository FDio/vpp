...
#define _(n, c, m, t)                                                                 \
static u32 openssl_ops_enc_##n (vlib_main_t *vm, vnet_crypto_op_t *ops[], u32 n_ops) \
{                                                                                    \
...
static u32 openssl_ops_dec_##n (vlib_main_t *vm, vnet_crypto_op_t *ops[], u32 n_ops) \
{                                                                                    \
  for (u32 i = 0; i < n_ops; i++)                                                    \
    ops[i]->digest_len = t;                                                          \
...
static u32 openssl_ops_enc_chained_##n (vlib_main_t *vm,                             \
...
static u32 openssl_ops_dec_chained_##n (vlib_main_t *vm,                             \
        vnet_crypto_op_t *ops[], vnet_crypto_op_chunk_t *chunks, u32 n_ops)         \
{                                                                                    \
  for (u32 i = 0; i < n_ops; i++)                                                    \
    ops[i]->digest_len = t;                                                          \
