...
#define foreach_openssl_combined_evp_op                                                            \
  ...
  _ (3DES_CBC_SHA2_224, EVP_des_ede3_cbc, EVP_sha224, 24, 0)                                       \
  _ (AES_128_CBC_SHA2_224, EVP_aes_128_cbc, EVP_sha224, 16, 0)                                     \
  _ (AES_192_CBC_SHA2_224, EVP_aes_192_cbc, EVP_sha224, 24, 0)                                     \
  _ (AES_256_CBC_SHA2_224, EVP_aes_256_cbc, EVP_sha224, 32, 0)                                     \
  _ (3DES_CBC_SHA2_256, EVP_des_ede3_cbc, EVP_sha256, 24, 0)                                       \
  _ (AES_128_CBC_SHA2_256, EVP_aes_128_cbc, EVP_sha256, 16, 0)                                     \
  _ (AES_192_CBC_SHA2_256, EVP_aes_192_cbc, EVP_sha256, 24, 0)                                     \
  _ (AES_256_CBC_SHA2_256, EVP_aes_256_cbc, EVP_sha256, 32, 0)                                     \
  _ (3DES_CBC_SHA2_384, EVP_des_ede3_cbc, EVP_sha384, 24, 0)                                       \
  _ (AES_128_CBC_SHA2_384, EVP_aes_128_cbc, EVP_sha384, 16, 0)                                     \
  _ (AES_192_CBC_SHA2_384, EVP_aes_192_cbc, EVP_sha384, 24, 0)                                     \
  _ (AES_256_CBC_SHA2_384, EVP_aes_256_cbc, EVP_sha384, 32, 0)                                     \
  _ (3DES_CBC_SHA2_512, EVP_des_ede3_cbc, EVP_sha512, 24, 0)                                       \
  _ (AES_128_CBC_SHA2_512, EVP_aes_128_cbc, EVP_sha512, 16, 0)                                     \
  _ (AES_192_CBC_SHA2_512, EVP_aes_192_cbc, EVP_sha512, 24, 0)                                     \
  _ (AES_256_CBC_SHA2_512, EVP_aes_256_cbc, EVP_sha512, 32, 0)                                     \
  ...
  _ (AES_128_CTR_SHA2_256, EVP_aes_128_ctr, EVP_sha256, 16, 0)                                     \
  _ (AES_192_CTR_SHA2_256, EVP_aes_192_ctr, EVP_sha256, 24, 0)                                     \
  _ (AES_256_CTR_SHA2_256, EVP_aes_256_ctr, EVP_sha256, 32, 0)                                     \
  _ (AES_128_CTR_SHA2_384, EVP_aes_128_ctr, EVP_sha384, 16, 0)                                     \
  _ (AES_192_CTR_SHA2_384, EVP_aes_192_ctr, EVP_sha384, 24, 0)                                     \
  _ (AES_256_CTR_SHA2_384, EVP_aes_256_ctr, EVP_sha384, 32, 0)                                     \
  _ (AES_128_CTR_SHA2_512, EVP_aes_128_ctr, EVP_sha512, 16, 0)                                     \
  _ (AES_192_CTR_SHA2_512, EVP_aes_192_ctr, EVP_sha512, 24, 0)                                     \
  _ (AES_256_CTR_SHA2_512, EVP_aes_256_ctr, EVP_sha512, 32, 0)                                     \
  _ (3DES_CBC_SHA1_160_ICV12, EVP_des_ede3_cbc, EVP_sha1, 24, 12)                                  \
  _ (3DES_CBC_SHA2_224_ICV14, EVP_des_ede3_cbc, EVP_sha224, 24, 14)                                \
  _ (3DES_CBC_SHA2_256_ICV12, EVP_des_ede3_cbc, EVP_sha256, 24, 12)                                \
  _ (3DES_CBC_SHA2_256_ICV16, EVP_des_ede3_cbc, EVP_sha256, 24, 16)                                \
  _ (3DES_CBC_SHA2_384_ICV24, EVP_des_ede3_cbc, EVP_sha384, 24, 24)                                \
  _ (3DES_CBC_SHA2_512_ICV32, EVP_des_ede3_cbc, EVP_sha512, 24, 32)                                \
  ...
  _ (AES_128_CBC_SHA2_224_ICV14, EVP_aes_128_cbc, EVP_sha224, 16, 14)                              \
  _ (AES_192_CBC_SHA2_224_ICV14, EVP_aes_192_cbc, EVP_sha224, 24, 14)                              \
  _ (AES_256_CBC_SHA2_224_ICV14, EVP_aes_256_cbc, EVP_sha224, 32, 14)                              \
  _ (AES_128_CBC_SHA2_256_ICV12, EVP_aes_128_cbc, EVP_sha256, 16, 12)                              \
  _ (AES_192_CBC_SHA2_256_ICV12, EVP_aes_192_cbc, EVP_sha256, 24, 12)                              \
  _ (AES_256_CBC_SHA2_256_ICV12, EVP_aes_256_cbc, EVP_sha256, 32, 12)                              \
  _ (AES_128_CBC_SHA2_256_ICV16, EVP_aes_128_cbc, EVP_sha256, 16, 16)                              \
  _ (AES_192_CBC_SHA2_256_ICV16, EVP_aes_192_cbc, EVP_sha256, 24, 16)                              \
  _ (AES_256_CBC_SHA2_256_ICV16, EVP_aes_256_cbc, EVP_sha256, 32, 16)                              \
  _ (AES_128_CBC_SHA2_384_ICV24, EVP_aes_128_cbc, EVP_sha384, 16, 24)                              \
  _ (AES_192_CBC_SHA2_384_ICV24, EVP_aes_192_cbc, EVP_sha384, 24, 24)                              \
  _ (AES_256_CBC_SHA2_384_ICV24, EVP_aes_256_cbc, EVP_sha384, 32, 24)                              \
  _ (AES_128_CBC_SHA2_512_ICV32, EVP_aes_128_cbc, EVP_sha512, 16, 32)                              \
  _ (AES_192_CBC_SHA2_512_ICV32, EVP_aes_192_cbc, EVP_sha512, 24, 32)                              \
  _ (AES_256_CBC_SHA2_512_ICV32, EVP_aes_256_cbc, EVP_sha512, 32, 32)                              \
  ...
  _ (AES_128_CTR_SHA2_256_ICV12, EVP_aes_128_ctr, EVP_sha256, 16, 12)                              \
  _ (AES_192_CTR_SHA2_256_ICV12, EVP_aes_192_ctr, EVP_sha256, 24, 12)                              \
  _ (AES_256_CTR_SHA2_256_ICV12, EVP_aes_256_ctr, EVP_sha256, 32, 12)                              \
  _ (AES_128_CTR_SHA2_256_ICV16, EVP_aes_128_ctr, EVP_sha256, 16, 16)                              \
  _ (AES_192_CTR_SHA2_256_ICV16, EVP_aes_192_ctr, EVP_sha256, 24, 16)                              \
  _ (AES_256_CTR_SHA2_256_ICV16, EVP_aes_256_ctr, EVP_sha256, 32, 16)                              \
  _ (AES_128_CTR_SHA2_384_ICV24, EVP_aes_128_ctr, EVP_sha384, 16, 24)                              \
  _ (AES_192_CTR_SHA2_384_ICV24, EVP_aes_192_ctr, EVP_sha384, 24, 24)                              \
  _ (AES_256_CTR_SHA2_384_ICV24, EVP_aes_256_ctr, EVP_sha384, 32, 24)                              \
  _ (AES_128_CTR_SHA2_512_ICV32, EVP_aes_128_ctr, EVP_sha512, 16, 32)                              \
  _ (AES_192_CTR_SHA2_512_ICV32, EVP_aes_192_ctr, EVP_sha512, 24, 32)                              \
  _ (AES_256_CTR_SHA2_512_ICV32, EVP_aes_256_ctr, EVP_sha512, 32, 32)
...
openssl_ops_dec_aead (vnet_crypto_op_t *ops[], vnet_crypto_op_chunk_t *chunks, u32 n_ops,
		      int is_gmac, i32 aadlen, u32 taglen, clib_thread_index_t thread_index)
{
  EVP_CIPHER_CTX *ctx;
  vnet_crypto_op_chunk_t *chp;
  u32 i, j, n_fail = 0;
...
openssl_ops_dec_null_gmac (vnet_crypto_op_t *ops[], vnet_crypto_op_chunk_t *chunks, u32 n_ops,
			   i32 aad_len, u32 taglen, clib_thread_index_t thread_index)
{
  return openssl_ops_dec_aead (ops, chunks, n_ops, /* is_gmac */ 1, aad_len, taglen, thread_index);
}
...
openssl_ops_dec_gcm (vnet_crypto_op_t *ops[], vnet_crypto_op_chunk_t *chunks, u32 n_ops,
		     i32 aad_len, u32 taglen, clib_thread_index_t thread_index)
{
  return openssl_ops_dec_aead (ops, chunks, n_ops, /* is_gmac */ 0, aad_len, taglen, thread_index);
}

static_always_inline __clib_unused u32
openssl_ops_dec_chacha20_poly1305 (vnet_crypto_op_t *ops[], vnet_crypto_op_chunk_t *chunks,
				   u32 n_ops, i32 aad_len, u32 taglen,
				   clib_thread_index_t thread_index)
{
  return openssl_ops_dec_aead (ops, chunks, n_ops, /* is_gmac */ 0, aad_len, taglen, thread_index);
}
		  ...
		  const EVP_MD *md, u32 digest_len)
{
  ...
  for (i = 0; i < n_ops; i++)
    {
      vnet_crypto_hash_op_t *op = ops[i];
...
openssl_ctx_cipher_add (const u8 *key_bytes, u8 *key_data, const EVP_CIPHER *cipher, int is_gcm)
{
  ...
  if (kd->evp_cipher_dec_ctx)
	...
	clib_panic ("openssl EVP_DecryptInit_ex (cipher) failed");
      if (is_gcm &&
	  PREDICT_FALSE (EVP_CIPHER_CTX_ctrl (ctx, EVP_CTRL_GCM_SET_IVLEN, 12, 0) != 1))
	clib_panic ("openssl EVP_CTRL_GCM_SET_IVLEN failed");
...
#undef _
  ...
  [VNET_CRYPTO_ALG_SHA2_256_ICV12] = EVP_sha256,
  [VNET_CRYPTO_ALG_SHA2_256_ICV16] = EVP_sha256,
  [VNET_CRYPTO_ALG_SHA2_384_ICV24] = EVP_sha384,
  [VNET_CRYPTO_ALG_SHA2_512_ICV32] = EVP_sha512,
};
...
#define _(m, a, b, f, l)                                                                           \
  static u32 openssl_ops_enc_##a (vnet_crypto_op_t *ops[],                                         \
				  ...
				  clib_thread_index_t thread_index)                                \
  {                                                                                                \
    return openssl_ops_enc_cbc (ops, 0, n_ops, thread_index);                                      \
  }                                                                                                \
                                                                                                   \
...
#define _(m, a, b, f, l)                                                                           \
  ...
  u32 openssl_ops_dec_##a (vnet_crypto_op_t *ops[], vnet_crypto_op_chunk_t *chunks __clib_unused,  \
			   u32 n_ops, clib_thread_index_t thread_index)                            \
  {                                                                                                \
    return openssl_ops_dec_##m (ops, 0, n_ops, f ? l : -1, f ? 16 : 0, thread_index);              \
  }                                                                                                \
                                                                                                   \
  static u32 openssl_ops_enc_chained_##a (vnet_crypto_op_t *ops[], vnet_crypto_op_chunk_t *chunks, \
					  u32 n_ops, clib_thread_index_t thread_index)             \
  ...
  static u32 openssl_ops_dec_chained_##a (vnet_crypto_op_t *ops[], vnet_crypto_op_chunk_t *chunks, \
					  u32 n_ops, clib_thread_index_t thread_index)             \
  {                                                                                                \
    return openssl_ops_dec_##m (ops, chunks, n_ops, f ? l : -1, f ? 16 : 0, thread_index);         \
  }
...
#define _(a, b)                                                                                    \
  VNET_CRYPTO_REGISTER_ALG (openssl_hmac_##a) = {                                                       \
...
#define _(a, b, d)                                                                                 \
  VNET_CRYPTO_REGISTER_HASH_ALG (openssl_hash_##a) = {                                             \
    ...
    .simple_fn = openssl_ops_hash_##a,                                                             \
    .chained_fn = openssl_ops_hash_chained_##a,                                                    \
  };
foreach_openssl_hash_op;
#undef _
