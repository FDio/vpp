...
#define foreach_openssl_combined_evp_op                                                            \
  ...
  _ (3DES_CBC_SHA1, EVP_des_ede3_cbc, EVP_sha1, 24, 0)                                             \
  _ (AES_128_CBC_SHA1, EVP_aes_128_cbc, EVP_sha1, 16, 0)                                           \
  _ (AES_192_CBC_SHA1, EVP_aes_192_cbc, EVP_sha1, 24, 0)                                           \
  _ (AES_256_CBC_SHA1, EVP_aes_256_cbc, EVP_sha1, 32, 0)                                           \
  _ (3DES_CBC_SHA224, EVP_des_ede3_cbc, EVP_sha224, 24, 0)                                         \
  _ (AES_128_CBC_SHA224, EVP_aes_128_cbc, EVP_sha224, 16, 0)                                       \
  _ (AES_192_CBC_SHA224, EVP_aes_192_cbc, EVP_sha224, 24, 0)                                       \
  _ (AES_256_CBC_SHA224, EVP_aes_256_cbc, EVP_sha224, 32, 0)                                       \
  _ (3DES_CBC_SHA256, EVP_des_ede3_cbc, EVP_sha256, 24, 0)                                         \
  _ (AES_128_CBC_SHA256, EVP_aes_128_cbc, EVP_sha256, 16, 0)                                       \
  _ (AES_192_CBC_SHA256, EVP_aes_192_cbc, EVP_sha256, 24, 0)                                       \
  _ (AES_256_CBC_SHA256, EVP_aes_256_cbc, EVP_sha256, 32, 0)                                       \
  _ (3DES_CBC_SHA384, EVP_des_ede3_cbc, EVP_sha384, 24, 0)                                         \
  _ (AES_128_CBC_SHA384, EVP_aes_128_cbc, EVP_sha384, 16, 0)                                       \
  _ (AES_192_CBC_SHA384, EVP_aes_192_cbc, EVP_sha384, 24, 0)                                       \
  _ (AES_256_CBC_SHA384, EVP_aes_256_cbc, EVP_sha384, 32, 0)                                       \
  _ (3DES_CBC_SHA512, EVP_des_ede3_cbc, EVP_sha512, 24, 0)                                         \
  _ (AES_128_CBC_SHA512, EVP_aes_128_cbc, EVP_sha512, 16, 0)                                       \
  _ (AES_192_CBC_SHA512, EVP_aes_192_cbc, EVP_sha512, 24, 0)                                       \
  _ (AES_256_CBC_SHA512, EVP_aes_256_cbc, EVP_sha512, 32, 0)                                       \
  _ (AES_128_CTR_SHA1, EVP_aes_128_ctr, EVP_sha1, 16, 0)                                           \
  _ (AES_192_CTR_SHA1, EVP_aes_192_ctr, EVP_sha1, 24, 0)                                           \
  _ (AES_256_CTR_SHA1, EVP_aes_256_ctr, EVP_sha1, 32, 0)                                           \
  _ (AES_128_CTR_SHA256, EVP_aes_128_ctr, EVP_sha256, 16, 0)                                       \
  _ (AES_192_CTR_SHA256, EVP_aes_192_ctr, EVP_sha256, 24, 0)                                       \
  _ (AES_256_CTR_SHA256, EVP_aes_256_ctr, EVP_sha256, 32, 0)                                       \
  _ (AES_128_CTR_SHA384, EVP_aes_128_ctr, EVP_sha384, 16, 0)                                       \
  _ (AES_192_CTR_SHA384, EVP_aes_192_ctr, EVP_sha384, 24, 0)                                       \
  _ (AES_256_CTR_SHA384, EVP_aes_256_ctr, EVP_sha384, 32, 0)                                       \
  _ (AES_128_CTR_SHA512, EVP_aes_128_ctr, EVP_sha512, 16, 0)                                       \
  _ (AES_192_CTR_SHA512, EVP_aes_192_ctr, EVP_sha512, 24, 0)                                       \
  _ (AES_256_CTR_SHA512, EVP_aes_256_ctr, EVP_sha512, 32, 0)                                       \
...
openssl_ctx_add_hmac_key_data (vnet_crypto_ctx_t *ctx, u8 *key_data, void *arg __clib_unused)
{
  ...
  openssl_ctx_hmac_add (vnet_crypto_get_cipher_key (ctx), ctx->cipher_key_sz + ctx->auth_key_sz,
			key_data, f ());
}
