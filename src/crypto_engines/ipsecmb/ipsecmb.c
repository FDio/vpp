...
#define foreach_ipsecmb_hmac_op                                                                    \
  ...
  _ (SHA_224, SHA_224, sha224, 64, 32, 28)                                                         \
  _ (SHA_256, SHA_256, sha256, 64, 32, 32)                                                         \
  _ (SHA_384, SHA_384, sha384, 128, 64, 48)                                                        \
  _ (SHA_512, SHA_512, sha512, 128, 64, 64)
...
#define foreach_ipsecmb_combined_cipher_op                                                         \
  ...
  _ (AES_128_CBC_SHA_224, 128, CBC, CBC, SHA_224, SHA_224, 64, 32, 28, 14)                         \
  _ (AES_192_CBC_SHA_224, 192, CBC, CBC, SHA_224, SHA_224, 64, 32, 28, 14)                         \
  _ (AES_256_CBC_SHA_224, 256, CBC, CBC, SHA_224, SHA_224, 64, 32, 28, 14)                         \
  _ (AES_128_CBC_SHA_256, 128, CBC, CBC, SHA_256, SHA_256, 64, 32, 32, 16)                         \
  _ (AES_192_CBC_SHA_256, 192, CBC, CBC, SHA_256, SHA_256, 64, 32, 32, 16)                         \
  _ (AES_256_CBC_SHA_256, 256, CBC, CBC, SHA_256, SHA_256, 64, 32, 32, 16)                         \
  _ (AES_128_CBC_SHA_384, 128, CBC, CBC, SHA_384, SHA_384, 128, 64, 48, 24)                        \
  _ (AES_192_CBC_SHA_384, 192, CBC, CBC, SHA_384, SHA_384, 128, 64, 48, 24)                        \
  _ (AES_256_CBC_SHA_384, 256, CBC, CBC, SHA_384, SHA_384, 128, 64, 48, 24)                        \
  _ (AES_128_CBC_SHA_512, 128, CBC, CBC, SHA_512, SHA_512, 128, 64, 64, 32)                        \
  _ (AES_192_CBC_SHA_512, 192, CBC, CBC, SHA_512, SHA_512, 128, 64, 64, 32)                        \
  _ (AES_256_CBC_SHA_512, 256, CBC, CBC, SHA_512, SHA_512, 128, 64, 64, 32)                        \
  ...
  _ (AES_128_CTR_SHA_256, 128, CNTR, CTR, SHA_256, SHA_256, 64, 32, 32, 16)                        \
  _ (AES_192_CTR_SHA_256, 192, CNTR, CTR, SHA_256, SHA_256, 64, 32, 32, 16)                        \
  _ (AES_256_CTR_SHA_256, 256, CNTR, CTR, SHA_256, SHA_256, 64, 32, 32, 16)                        \
  _ (AES_128_CTR_SHA_384, 128, CNTR, CTR, SHA_384, SHA_384, 128, 64, 48, 24)                       \
  _ (AES_192_CTR_SHA_384, 192, CNTR, CTR, SHA_384, SHA_384, 128, 64, 48, 24)                       \
  _ (AES_256_CTR_SHA_384, 256, CNTR, CTR, SHA_384, SHA_384, 128, 64, 48, 24)                       \
  _ (AES_128_CTR_SHA_512, 128, CNTR, CTR, SHA_512, SHA_512, 128, 64, 64, 32)                       \
  _ (AES_192_CTR_SHA_512, 192, CNTR, CTR, SHA_512, SHA_512, 128, 64, 64, 32)                       \
  _ (AES_256_CTR_SHA_512, 256, CNTR, CTR, SHA_512, SHA_512, 128, 64, 64, 32)

#define foreach_chacha_poly_fixed_aad_lengths _ (0) _ (8) _ (12)

#define foreach_ipsecmb_combined_fixed_extra_op                                                    \
  _ (AES_128_CBC_SHA_256, 12)                                                                      \
  _ (AES_192_CBC_SHA_256, 12)                                                                      \
  _ (AES_256_CBC_SHA_256, 12)                                                                      \
  _ (AES_128_CTR_SHA_256, 12)                                                                      \
  _ (AES_192_CTR_SHA_256, 12)                                                                      \
  _ (AES_256_CTR_SHA_256, 12)
...
#define _(a, b, c)                                                                                 \
  ...
  {                                                                                                \
    ...
    crypto_ipsecmb_cipher_key_add_inline (ctx, key_data, imbm->mgr->keyexp_##b);                   \
                                                                                                   ...
                                                                                                   \
  VNET_CRYPTO_REG_ALG_GROUP (ipsecmb_cipher_##a##_group) = {                                       \
...
#define _(a, b, f, l)                                                                              \
  ...
  {                                                                                                \
    ...
    crypto_ipsecmb_gcm_key_add_inline (ctx, key_data, imbm->mgr->gcm##b##_pre);                    \
                                                                                                   ...
                                                                                                   \
  VNET_CRYPTO_REG_ALG_GROUP (ipsecmb_gcm_##a##_group) = {                                          \
...
#define _(a, b, c, d, e, f)                                                                        \
  ...
  {                                                                                                \
    ...
    crypto_ipsecmb_hmac_key_add_internal_##a (ctx, key_data);                                      \
                                                                                                   ...
                                                                                                   \
  VNET_CRYPTO_REG_ALG_GROUP (ipsecmb_auth_##a##_group) = {                                         \
  ...
  {                                                                                                \
    ...
    crypto_ipsecmb_combined_key_add_inline (ctx, key_data, imbm->mgr->keyexp_##b,                  \
					    ...
					    VNET_CRYPTO_ALG_AES_##b##_##j, VNET_CRYPTO_ALG_##e);   \
                                                                                                   ...
                                                                                                   \
  VNET_CRYPTO_REG_ALG_GROUP (ipsecmb_combined_##a##_group) = {                                     \
...
#ifdef HAVE_IPSECMB_CHACHA_POLY
VNET_CRYPTO_REG_ALG_GROUP (ipsecmb_chacha_poly_group) = {
...
#define _(a, b, f, l)                                                                              \
  VNET_CRYPTO_REG_ALG (ipsecmb_##a) = {                                                            \
...
#define _(a, b, c, d, e, f)                                                                        \
  VNET_CRYPTO_REG_ALG (ipsecmb_hmac_##a) = {                                                       \
...
VNET_CRYPTO_REG_ALG (ipsecmb_hmac_sha1_icv12) = {
  .group = &ipsecmb_auth_SHA1_160_group,
  .alg_id = VNET_CRYPTO_ALG_SHA1_160_ICV12,
  .simple = { .hmac_fn = ipsecmb_ops_hmac_SHA1_160, },
};

VNET_CRYPTO_REG_ALG (ipsecmb_hmac_sha256_icv12) = {
  .group = &ipsecmb_auth_SHA_256_group,
  .alg_id = VNET_CRYPTO_ALG_SHA_256_ICV12,
  .simple = { .hmac_fn = ipsecmb_ops_hmac_SHA_256, },
};

VNET_CRYPTO_REG_ALG (ipsecmb_hmac_sha256_icv16) = {
  .group = &ipsecmb_auth_SHA_256_group,
  .alg_id = VNET_CRYPTO_ALG_SHA_256_ICV16,
  .simple = { .hmac_fn = ipsecmb_ops_hmac_SHA_256, },
};

VNET_CRYPTO_REG_ALG (ipsecmb_hmac_sha384_icv24) = {
  .group = &ipsecmb_auth_SHA_384_group,
  .alg_id = VNET_CRYPTO_ALG_SHA_384_ICV24,
  .simple = { .hmac_fn = ipsecmb_ops_hmac_SHA_384, },
};

VNET_CRYPTO_REG_ALG (ipsecmb_hmac_sha512_icv32) = {
  .group = &ipsecmb_auth_SHA_512_group,
  .alg_id = VNET_CRYPTO_ALG_SHA_512_ICV32,
  .simple = { .hmac_fn = ipsecmb_ops_hmac_SHA_512, },
};
...
#define _(a, b, c, j, d, e, f, g, h, i)                                                              \
  ...
  VNET_CRYPTO_REG_ALG (ipsecmb_##a##_icv##i) = {                                                   \
    .group = &ipsecmb_combined_##a##_group,                                                        \
...
#define _(a, i)                                                                                    \
  VNET_CRYPTO_REG_ALG (ipsecmb_##a##_icv##i##_extra) = {                                           \
    .group = &ipsecmb_combined_##a##_group,                                                        \
    .alg_id = VNET_CRYPTO_ALG_##a##_ICV##i,                                                        \
    .simple = {                                                                                    \
      .enc_fn = ipsecmb_ops_combined_enc_##a,                                                      \
...
#ifdef HAVE_IPSECMB_CHACHA_POLY
	VNET_CRYPTO_REG_ALG (ipsecmb_chacha20_poly1305) = {
...
#define _(a)                                                                                       \
  VNET_CRYPTO_REG_ALG (ipsecmb_chacha20_poly1305_tag16_aad##a) = {                                 \
    .group = &ipsecmb_chacha_poly_group,                                                           \
