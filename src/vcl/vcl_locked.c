...
//      clib_warning ("UPDATE VCL wrk %u vls %u disc %u", wrk->wrk_index, vls->vls_index,
//                    do_disconnect);
...
//      clib_warning ("UPDATE wrk %u vls %u", wrk->wrk_index, vls->vls_index);
...
//      clib_warning ("UNSHARE DELETE wrk %u vls %u", wrk->wrk_index, vls->vls_index);
