...
extern int vppcom_session_quic_connect (uint32_t session_handle,
					vppcom_endpt_t * server_ep);
...
extern int vppcom_session_is_quic_listener (uint32_t session_handle);
