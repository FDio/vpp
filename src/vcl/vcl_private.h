...
void vcl_app_send_attach (void);
void vcl_app_send_detach (void);
...
void vcl_bapi_init_error_string_table (void);
...
void vcl_bapi_send_application_tls_key_add (vcl_session_t * session, char *key,
					  u32 key_len);
