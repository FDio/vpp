...
vcl_connect_request_handler_fn (u32 session_id, void *arg)
{
  ...
  reg = (vce_event_handler_reg_t *)arg;
...
vl_api_accept_session_t_handler (vl_api_accept_session_t * mp)
{
  ...
  vce_event_key_t *evk = clib_mem_alloc (sizeof (vce_event_key_t));
  ...
  int rv = vce_generate_event (evk, &vcm->event_thread);
		       ...
		       uint32_t flags)
{
  ...
  vce_event_handler_reg_t *reg = vce_register_handler (&vcm->event_thread, evk, vcl_connect_request_handler_fn);
  /* Wait for handler */
