...
vcl_session_cleanup_handler (vcl_worker_t * wrk, void *data)
{
  ...
  /* Session probably tracked with epoll, disconnect not yet handled
   * and both transport and session cleanup completed. Wait until message
   * is drained to free the session. See @ref vcl_handle_mq_event */
