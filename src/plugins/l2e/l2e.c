...
static clib_error_t *
l2_emulation_cli (vlib_main_t *vm, unformat_input_t *input,
...
static clib_error_t *
l2_emulation_show (vlib_main_t *vm, unformat_input_t *input,
		   vlib_cli_command_t *cmd)
{
  l2_emulation_main_t *em = &l2_emulation_main;
  vnet_main_t *vnm = vnet_get_main ();
...
l2_emulation_init (vlib_main_t *vm)
{
  ...
  feat_bitmap_init_next_nodes (vm, em->l2_emulation_node_index, L2INPUT_N_FEAT,
