...
{
.arc_name = "ip4-unicast",.node_name = "srv6-as4-rewrite",.runs_before = 0,};

VNET_FEATURE_INIT (srv6_as6_rewrite, static) =
{
.arc_name = "ip6-unicast",.node_name = "srv6-as6-rewrite",.runs_before = 0,};

VLIB_INIT_FUNCTION (srv6_as_init);

VLIB_PLUGIN_REGISTER () =
{
.version = "1.0",.description = "Static SRv6 proxy",};
