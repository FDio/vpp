  ...
  while (n_left)
    {
      ...
      u32 tenant_idx = vec_elt (vim->tenant_idx_by_sw_if_idx[proto], rx_sw_if_index);
      u8 offload_enabled = vec_elt (vim->offload_enabled_by_sw_if_idx[proto], rx_sw_if_index);
