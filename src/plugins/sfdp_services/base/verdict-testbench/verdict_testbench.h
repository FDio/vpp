...
#define VT_DEFAULT_AGE_TIMEOUT 10 /* seconds */
...
{
  u32 rx_sw_if_index;
  u32 rx_hw_if_index; /* resolved at enable time; ~0 if rx_sw_if_index == ~0 */
  u32 tx_sw_if_index;
  u32 hw_if_index;
  u32 tx_hw_if_index;
...
clib_error_t *verdict_testbench_enable (verdict_testbench_main_t *vt, u32 tx_sw_if_index,
					u32 rx_sw_if_index, u8 enable_counters, u8 enable_aging,
					u32 age_timeout, u8 protos);
