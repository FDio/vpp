...
clib_error_t *
verdict_testbench_enable (verdict_testbench_main_t *vt, u32 tx_sw_if_index,
			  u32 rx_sw_if_index)
{
  ...
  flow_template.steer_from_hw_if_index = rx_hw_if_index;
  ...
  /* dispatch to driver via tx-interface — both ports share the same E-Switch */
