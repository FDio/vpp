...
clib_error_t *sfdp_classifier_input_set_table (u32 table_index, u8 is_del);
clib_error_t *sfdp_classifier_input_add_del_session (u32 tenant_id, const u8 *match, u32 match_len,
						     u8 is_del);
