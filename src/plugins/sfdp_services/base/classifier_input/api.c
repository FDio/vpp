...
vl_api_sfdp_classifier_input_set_table_t_handler (vl_api_sfdp_classifier_input_set_table_t *mp)
{
  ...
  rv = sfdp_classifier_input_set_table (sw_if_index, table_index, is_ip6, is_del);
  ...
  vl_api_sfdp_classifier_input_add_del_session_t *mp)
{
  ...
  int rv = sfdp_classifier_input_add_del_session (tenant_id, sw_if_index, is_ip6, mp->match,
						  match_len, is_del);
