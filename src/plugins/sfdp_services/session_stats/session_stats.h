...
#define SFDP_SESSION_STATS_DEFAULT_BATCH_EXPORT_INTERVAL 2.0
...
void sfdp_session_stats_periodic_export_enable (vlib_main_t *vm, f64 interval, f64 batch_interval);
