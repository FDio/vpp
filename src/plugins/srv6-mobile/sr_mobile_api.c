...
static inline uint16_t sr_plugin_localsid_fn_num_find_by
  (ip6_sr_main_t *sm, const char *keyword_str)
{
  ...
  {
    if (!clib_strcmp(keyword_str, (char *)(*plugin_it)->keyword_str))
      {
...
static inline uint16_t sr_plugin_policy_fn_num_find_by
  (ip6_sr_main_t *sm, const char *keyword_str)
{
...
static void vl_api_sr_mobile_localsid_add_del_t_handler
  (vl_api_sr_mobile_localsid_add_del_t * mp)
{
  ...
  if (mp->behavior[0])
	{
    if (!clib_strcmp((char *)mp->behavior, "end.m.gtp4.e"))
    {
      kind_fn = SRV6_MOBILE_LOCALSID_END_M_GTP4_E;
    }
    else if(!clib_strcmp((char *)mp->behavior, "end.m.gtp6.e"))
    {
      kind_fn = SRV6_MOBILE_LOCALSID_END_M_GTP6_E;
    }
    else if(!clib_strcmp((char *)mp->behavior, "end.m.gtp6.d"))
    {
      kind_fn = SRV6_MOBILE_LOCALSID_END_M_GTP6_D;
    }
    else if(!clib_strcmp((char *)mp->behavior, "end.m.gtp6.d.di"))
    {
      kind_fn = SRV6_MOBILE_LOCALSID_END_M_GTP6_D_DI;
    }
    else if(!clib_strcmp((char *)mp->behavior, "end.m.gtp6.d.dt4"))
    {
      kind_fn = SRV6_MOBILE_LOCALSID_END_M_GTP6_D_DT4;
      dt_type = SRV6_GTP6_DT4;
    }
    else if(!clib_strcmp((char *)mp->behavior, "end.m.gtp6.d.dt6"))
    {
      kind_fn = SRV6_MOBILE_LOCALSID_END_M_GTP6_D_DT6;
      dt_type = SRV6_GTP6_DT6;
    }
    else if(!clib_strcmp((char *)mp->behavior, "end.m.gtp6.d.dt46"))
    {
...
vl_api_sr_mobile_policy_add_t_handler(vl_api_sr_mobile_policy_add_t * mp)
{
  ...
  if (mp->behavior[0])
	{
    if (!clib_strcmp((char *)mp->behavior, "t.m.gtp4.d"))
    {
      kind_fn = SRV6_MOBILE_POLICY_T_M_GTP4_D;
    }
    else if(!clib_strcmp((char *)mp->behavior, "t.m.gtp4.dt4"))
    {
      kind_fn = SRV6_MOBILE_POLICY_T_M_GTP4_DT4;
      dt_type = SRV6_GTP4_DT4;
    }
    else if(!clib_strcmp((char *)mp->behavior, "t.m.gtp4.dt6"))
    {
      kind_fn = SRV6_MOBILE_POLICY_T_M_GTP4_DT6;
      dt_type = SRV6_GTP4_DT6;
    }
    else if(!clib_strcmp((char *)mp->behavior, "t.m.gtp4.dt46"))
    {
