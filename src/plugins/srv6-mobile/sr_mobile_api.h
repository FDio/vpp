...
void alloc_param_srv6_end_m_gtp6_e(
  void **plugin_mem_p, 
  const u32 fib_table);

void alloc_param_srv6_end_m_gtp6_d(
  void **plugin_mem_p, 
...
void alloc_param_srv6_end_m_gtp6_dt(
  void **plugin_mem_p,
  const u32 fib_index,
  const u32 local_fib_index,
  const u32 type);

void alloc_param_srv6_t_m_gtp4_d(
  void **plugin_mem_p,
...
void alloc_param_srv6_t_m_gtp4_dt(
  void **plugin_mem_p,
  const u32 fib_index,
  const u32 local_fib_index,
  const u8 type);
