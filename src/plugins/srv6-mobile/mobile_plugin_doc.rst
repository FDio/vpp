...
link local IPv6 packet for NDP (Neighber Discovery Protocol). Outer
...
If you need to suport both IPv4 and IPv6 inner packet lookup with just
...
lookup and forwarding respectively. Specifiyng fib table for inner IP
