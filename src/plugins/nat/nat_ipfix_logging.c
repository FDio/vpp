...
vlib_frame_t *
nat_data_callback (flow_report_main_t * frm,
				  flow_report_t * fr,
				  vlib_frame_t * f,
...
vlib_frame_t *
dummy_data_callback (flow_report_main_t * frm,
		     flow_report_t * fr,
		     vlib_frame_t * f,
		     u32 * to_next, u32 node_index)
{
  ...
  if (sm->deterministic)
    {
      ...
      a.flow_data_callback = deterministic_nat_data_callback;
  ...
  else
    {
      ...
      a.flow_data_callback = nat_data_callback;
      ...
      if (rv)
	{
      ...
      a.flow_data_callback = dummy_data_callback;
