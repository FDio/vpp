...
{
  u32 limit;
} nat_ipfix_logging_max_sesssions_args_t;
...
static void
nat_ipfix_logging_max_ses_rpc_cb (nat_ipfix_logging_max_sesssions_args_t * a)
{
 ...
 */
void
nat_ipfix_logging_max_sesssions (u32 limit)
{
  //TODO: This event SHOULD be rate limited
  nat_ipfix_logging_max_sesssions_args_t a;
