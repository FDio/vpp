...
int nat44_ei_add_del_output_interface (u32 sw_if_index, u8 is_inside,
				       int is_del);
...
/**
 * @brief Add NAT44-EI static mapping
 *
 ...
 * @param flags        static mapping flags
 * @param pool_addr    prefered pool IPv4 address
...
/**
 * @brief Delete NAT44-EI static mapping
 *
 * @param l_addr       local IPv4 address
 * @param e_addr       external IPv4 address
 * @param l_port       local port number
