...
/*
#define foreach_nat44_ei_config_flag                                          \
  _ (0x00, _NONE)                                                           \
  _ (0x01, _STATIC_MAPPING_ONLY)                                            \
  _ (0x02, _CONNECTION_TRACKING)                                            \
  _ (0x04, _OUT2IN_DPO)

typedef enum nat44_ei_config_flags_t_
{
#define _(n, f) NAT44_EI_API_##f = n,
  foreach_nat44_ei_config_flag
#undef _
} nat44_ei_config_flags_t;
*/
