				...
				u8 is_in2out)
{
  ...
  while (n_left_from >= 4)
      ...
      if (is_output)
	{
      ...
      rx_fib_index0 = nat_ed_get_in2out_fib_index (sw_if_index0, b[0], is_in2out);
      rx_fib_index1 = nat_ed_get_in2out_fib_index (sw_if_index1, b[1], is_in2out);
      rx_fib_index2 = nat_ed_get_in2out_fib_index (sw_if_index2, b[2], is_in2out);
      rx_fib_index3 = nat_ed_get_in2out_fib_index (sw_if_index3, b[3], is_in2out);
