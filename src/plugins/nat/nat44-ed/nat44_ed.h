...
/**
 * @brief enable NAT44 feature on the interface
 *
...
/**
 * @brief disable NAT44 feature on the interface
 *
 * @param sw_if_index software index of the interface
 * @param is_inside   1 = inside, 0 = outside
 *
...
/**
 * @brief enable NAT44 output feature on the interface
 *
 * @param sw_if_index software index of the interface
 *
 * @return 0 on success, non-zero value otherwise
...
/**
 * @brief disable NAT44 output feature on the interface
 *
 * @param sw_if_index software index of the interface
 *
 * @return 0 on success, non-zero value otherwise
