...
#define is_addr_only(f)	     (NAT_SM_FLAG_ADDR_ONLY & f)
#define is_out2in_only(f)    (NAT_SM_FLAG_OUT2IN_ONLY & f)
#define is_identity_nat(f)   (NAT_SM_FLAG_IDENTITY_NAT & f)
#define is_lb(f)	     (NAT_SM_FLAG_LB & f)
#define is_exact_address(f)  (NAT_SM_FLAG_EXACT_ADDRESS & f)
#define is_self_twice_nat(f) (NAT_SM_FLAG_SELF_TWICE_NAT & f)
#define is_twice_nat(f)	     (NAT_SM_FLAG_TWICE_NAT & f)
#define is_switch_address(f) (NAT_SM_FLAG_SWITCH_ADDRESS & f)
