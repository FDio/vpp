...
static void
vl_api_nat44_set_translate_all_t_handler (vl_api_nat44_set_translate_all_t * mp)
{
  snat_main_t *sm = &snat_main;
...
static void *
vl_api_nat44_set_translate_all_t_print (vl_api_nat44_set_translate_all_t * mp, void *handle)
{
  u8 *s;
...
static void
vl_api_nat44_get_translate_all_t_handler (vl_api_nat44_get_translate_all_t * mp)
{
  unix_shared_memory_queue_t *q;
  snat_main_t *sm = &snat_main;
  ...
  rmp = vl_msg_api_alloc (sizeof (*rmp));
  memset (rmp, 0, sizeof (*rmp));
  rmp->_vl_msg_id = ntohs (VL_API_NAT44_GET_TRANSLATE_ALL_REPLY + sm->msg_id_base);
...
static void *
vl_api_nat44_get_translate_all_t_print (vl_api_nat44_get_translate_all_t * mp, void *handle)
{
  u8 *s;
