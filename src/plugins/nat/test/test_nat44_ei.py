...
class TestNAT44EIAPI(MethodHolder):
    ...
    def test_show_frame_queue_nelts(self):
        ...
        nat_config = self.vapi.nat44_show_running_config()
        self.assertEqual(self.frame_queue_nelts,
                         nat_config.frame_queue_nelts)
