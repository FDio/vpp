...
class TestNAT44EIAPI(MethodHolder):
    ...
    def setUp(self):
        ...
        # TODO: consider as a flag
        # TODO: create required configuration callback
        self.vapi.nat44_ei_set_fq_options(frame_queue_nelts=self.fq_nelts)
        self.vapi.nat44_ei_plugin_enable_disable(enable=1)
    ...
    def test_show_frame_queue_nelts(self):
        ...
        nat_config = self.vapi.nat44_ei_show_fq_options()
