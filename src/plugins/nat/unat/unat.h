...
typedef enum
{
  ...
  UNAT_NEXT_FASTPATH_I2O,
  UNAT_NEXT_FASTPATH_O2I,
...
typedef struct {
  ...
  u32 *pool_per_thread;
  bool pool_is_interface_address;
  u32 pool_sw_if_index;
...
typedef struct {
  u32 sw_if_index;
} unat_cfg_pool_interface_t;

typedef struct {
  u32 sw_if_index;
  bool in2out;
} unat_cfg_interface_t;
...
void unat_register_interface (u32 sw_if_index, u32 node_index, bool in2out);
