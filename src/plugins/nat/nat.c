          ...
          vec_foreach (tsm, sm->per_thread_data)
            {
              ...
              tsm->tcp_closed_lru_head_index = head - tsm->global_lru_pool;
              clib_dlist_init (tsm->global_lru_pool,
                               tsm->tcp_closed_lru_head_index);
              pool_get (tsm->global_lru_pool, head);
              tsm->tcp_lru_head_index = head - tsm->global_lru_pool;
              clib_dlist_init (tsm->global_lru_pool,
                               tsm->tcp_lru_head_index);
              pool_get (tsm->global_lru_pool, head);
              tsm->udp_lru_head_index = head - tsm->global_lru_pool;
              clib_dlist_init (tsm->global_lru_pool,
                               tsm->udp_lru_head_index);
              pool_get (tsm->global_lru_pool, head);
              tsm->icmp_lru_head_index = head - tsm->global_lru_pool;
              clib_dlist_init (tsm->global_lru_pool,
                               tsm->icmp_lru_head_index);
              pool_get (tsm->global_lru_pool, head);
              tsm->unk_proto_lru_head_index = head - tsm->global_lru_pool;
              clib_dlist_init (tsm->global_lru_pool,
