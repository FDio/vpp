          ...
          vec_foreach (tsm, sm->per_thread_data)
            {
              ...
              tsm->tcp_closed_lru_head_index = head - tsm->lru_pool;
              clib_dlist_init (tsm->lru_pool, tsm->tcp_closed_lru_head_index);

              pool_get (tsm->lru_pool, head);
              tsm->tcp_lru_head_index = head - tsm->lru_pool;
              clib_dlist_init (tsm->lru_pool, tsm->tcp_lru_head_index);
