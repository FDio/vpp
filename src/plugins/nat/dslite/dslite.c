...
void
add_del_dslite_pool_addr_clb (ip4_address_t * addr, u8 is_add, void * opaque);
...
dslite_init (vlib_main_t * vm)
{
  ...
  // init pool
  dm->pool.add_del_pool_addr_clb = add_del_dslite_pool_addr_clb;
  dm->pool.alloc_addr_and_port_clb = alloc_addr_and_port_clb_default;
