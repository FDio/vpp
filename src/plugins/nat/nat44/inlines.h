...
static_always_inline u32
nat44_max_translations_per_user_cleanup_v2 (snat_user_t * u, u32 thread_index,
					    f64 now, snat_session_t ** out)
{
  return nat44_user_session_cleanup_v2 (u, thread_index, now, out);
}
