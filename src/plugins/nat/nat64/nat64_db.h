 ...
 */
void nat64_db_bib_walk (nat64_db_t *db, u8 proto, nat64_db_bib_walk_fn_t fn,
			void *ctx);
 ...
 * @return BIB entry if found.
 */
nat64_db_bib_entry_t *nat64_db_bib_entry_by_index (nat64_db_t *db, u8 proto,
						   u32 bibe_index);
/**
...
nat64_db_st_entry_t *nat64_db_st_entry_find (nat64_db_t *db,
					     ip46_address_t *l_addr,
					     ip46_address_t *r_addr,
					     u16 l_port, u16 r_port, u8 proto,
 ...
 * @param ctx A context passed in the visit function.
 */
void nat64_db_st_walk (nat64_db_t *db, u8 proto, nat64_db_st_walk_fn_t fn,
		       void *ctx);
 ...
 * @return BIB entry if found.
 */
nat64_db_st_entry_t *nat64_db_st_entry_by_index (nat64_db_t *db, u8 proto,
						 u32 ste_index);
