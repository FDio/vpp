...
test_t tests_packets[] = {
  {
    .name = "da rewritten",
    .nsend = 28,
    .send = (char []){0x45,0x00,0x00,0x1c,0x00,0x01,0x00,0x00,0x40,0x11,0x6c,0xc1,0x01,0x01,0x01,0x01,0x05,0x06,0x07,0x08,0x00,0x50,0x1a,0xd7,0x00,0x08,0xd6,0xa7},
    .nexpect = 28,
  ...
  },
  {
    ...
    .nexpect = 28,
    .expect = (char []){0x45,0x00,0x00,0x1c,0x00,0x01,0x00,0x00,0x40,0x11,0x8b,0xe1,0x01,0x01,0x01,0xea,0x02,0x02,0xea,0x02,0x00,0x50,0x1a,0xda,0x00,0x08,0x00,0x00},
    .expect_next_index = 4242
  },
  {
    .name = "copy byte into Geneve reserved field",
    .nsend = 36,
    .send = (char []){0x45,0x00,0x00,0x24,0x00,0x01,0x00,0x00,0x40,0x11,0x35,0xc3,0x40,0x01,0x01,0x01,0x02,0x02,0x02,0x02,0x00,0x50,0x1a,0xdd,0x00,0x10,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0f,0xc8,0x00},
    .nexpect = 36,
    .expect = (char []){0x45,0x00,0x00,0x24,0x00,0x01,0x00,0x00,0x40,0x11,0x35,0xc1,0x40,0x01,0x01,0x01,0x01,0x02,0x03,0x04,0x00,0x50,0x1a,0xdd,0x00,0x10,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0f,0xc8,0x40},
    .expect_next_index = 4242
  },
  {
    .name = "copy byte into Geneve reserved field with checksum",
    .nsend = 36,
    .send = (char []){0x45,0x00,0x00,0x24,0x00,0x01,0x00,0x00,0x40,0x11,0x74,0xc3,0x01,0x01,0x01,0x01,0x02,0x02,0x02,0x02,0x00,0x50,0x1a,0xdd,0x00,0x10,0x16,0x8c,0x00,0x00,0x00,0x00,0x00,0x0f,0xc8,0x00},
    .nexpect = 36,
    .expect = (char []){0x45,0x00,0x00,0x24,0x00,0x01,0x00,0x00,0x40,0x11,0x74,0xc1,0x01,0x01,0x01,0x01,0x01,0x02,0x03,0x04,0x00,0x50,0x1a,0xdd,0x00,0x10,0x16,0x89,0x00,0x00,0x00,0x00,0x00,0x0f,0xc8,0x01},
    .expect_next_index = 4242
  },
  {
    .name = "clear byte",
  ...
  },
  {
    ...
    .nexpect = 44,
    .expect = (char []){0x46,0x00,0x00,0x2c,0x00,0x01,0x00,0x00,0x40,0x06,0x6c,0xc6,0x01,0x01,0x01,0x01,0x02,0x02,0x02,0x02,0x07,0x00,0x00,0x00,0x00,0x50,0x1a,0xd8,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x50,0x02,0x20,0x00,0x6e,0xb5,0x00,0x00},
    .expect_next_index = 0
  },
};
/* clang-format on */
