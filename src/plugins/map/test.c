...
get_domain (ip4_address_t *ip4_prefix, u8 ip4_prefix_len,
	    ...
	    ip6_address_t *ip6_src, u8 ip6_src_len, u8 ea_bits_len,
	    u8 psid_offset, u8 psid_length, u16 mtu, u8 flags)
{
  u8 suffix_len;
...
/*
 * VPP-340:
 * map_add_domain ip4-pfx 20.0.0.0/8 ip6-pfx 2001:db8::/40 ip6-src
 * 2001:db8:ffff::/96 ea-bits-len 24 psid-offset 0 psid-len 0 map-t IPv4 src =
 * 100.0.0.1 IPv4 dst = 20.169.201.219 UDP dest port = 1232 IPv6 src =
 * 2001:db8:ffff::6400:1 IPv6 dst = a9c9:dfb8::14a9:c9db:0
...
test_map_t_destaddr (void)
{
  ...
  map_domain_t *d = get_domain (&ip4_prefix, 8, &ip6_prefix, 40, &ip6_src, 96,
				24, 0, 0, 0, MAP_DOMAIN_TRANSLATION);
...
test_map_eabits (void)
{
  ...
  d =
    get_domain (&ip4_prefix, 8, &ip6_prefix, 32, &ip6_src, 128, 4, 0, 0, 0, 0);
  dst6.as_u64[0] = map_get_pfx (d, 0x14a9c9db, 1232);
  dst6.as_u64[1] = map_get_sfx (d, 0x14a9c9db, 1232);
  ...
  d =
    get_domain (&ip4_prefix, 8, &ip6_prefix, 32, &ip6_src, 128, 8, 0, 0, 0, 0);
  dst6.as_u64[0] = map_get_pfx (d, 0x14a9c9db, 1232);
  dst6.as_u64[1] = map_get_sfx (d, 0x14a9c9db, 1232);
  ...
  d = get_domain (&ip4_prefix, 8, &ip6_prefix, 32, &ip6_src, 128, 10, 0, 0, 0,
		  0);
  dst6.as_u64[0] = map_get_pfx (d, 0x14a9c9db, 1232);
  dst6.as_u64[1] = map_get_sfx (d, 0x14a9c9db, 1232);
  ...
  d = get_domain (&ip4_prefix, 8, &ip6_prefix, 32, &ip6_src, 128, 16, 0, 0, 0,
		  0);
  dst6.as_u64[0] = map_get_pfx (d, 0x14a9c9db, 1232);
  dst6.as_u64[1] = map_get_sfx (d, 0x14a9c9db, 1232);
  ...
  d = get_domain (&ip4_prefix, 8, &ip6_prefix, 32, &ip6_src, 128, 20, 0, 0, 0,
		  0);
  dst6.as_u64[0] = map_get_pfx (d, 0x14a9c9db, 1232);
  dst6.as_u64[1] = map_get_sfx (d, 0x14a9c9db, 1232);
  ...
  d = get_domain (&ip4_prefix, 8, &ip6_prefix, 32, &ip6_src, 128, 23, 0, 0, 0,
		  0);
  dst6.as_u64[0] = map_get_pfx (d, 0x14a9c9db, 1232);
  dst6.as_u64[1] = map_get_sfx (d, 0x14a9c9db, 1232);
  ...
  d =
    get_domain (&ip4_prefix, 8, &ip6_prefix, 32, &ip6_src, 128, 7, 0, 0, 0, 0);
  dst6.as_u64[0] = map_get_pfx (d, 0x14a9c9db, 1232);
  dst6.as_u64[1] = map_get_sfx (d, 0x14a9c9db, 1232);
