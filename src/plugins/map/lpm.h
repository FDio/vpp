...
typedef struct lpm_ {
  ...
  void (*add_vrf) (struct lpm_ *lpm, u32 fib_index, void *addr_v, u8 pfxlen,
		   u32 value);
  void (*delete_vrf) (struct lpm_ *lpm, u32 fib_index, void *addr_v,
		      u8 pfxlen);
  u32 (*lookup_vrf) (struct lpm_ *lpm, u32 fib_index, void *addr_v,
		     u8 pfxlen);
