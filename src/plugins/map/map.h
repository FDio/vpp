...
int map_param_set_fragmentation (u8 inner, u8 ignore_df);
...
int map_param_set_security_check (u8 enable, u8 fragments);
int map_param_set_traffic_class (u8 copy, u8 tc);
