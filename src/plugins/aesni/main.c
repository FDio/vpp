...
{
  vnet_crypto_register_ops_handler (vm, VNET_CRYPTO_ALG_AES_128_CBC,
				    VNET_CRYPTO_OP_ENCRYPT,
				    aesni_ops_enc_aes_cbc_128);

  vnet_crypto_register_ops_handler (vm, VNET_CRYPTO_ALG_AES_192_CBC,
				    VNET_CRYPTO_OP_ENCRYPT,
				    aesni_ops_enc_aes_cbc_192);

  vnet_crypto_register_ops_handler (vm, VNET_CRYPTO_ALG_AES_256_CBC,
				    VNET_CRYPTO_OP_ENCRYPT,
  ...
  vnet_crypto_register_async_queue_handler (vm, VNET_CRYPTO_ALG_AES_128_CBC,
					    VNET_CRYPTO_OP_ENCRYPT,
