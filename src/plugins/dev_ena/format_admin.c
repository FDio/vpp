...
format_ena_admin_feat_id_bitmap (u8 *s, va_list *args)
{
  ...
  foreach_set_bit_index (i, bmp)
    {
      ena_admin_feat_info_t *info = ena_admin_get_feat_info (i);
      if (line++)
	s = format (s, ", ");
      if (format_get_indent (s) > 80)
	s = format (s, "\n%U", format_white_space, indent);
...
{
  ena_admin_feature_id_t feat_id = va_arg (*args, int);
  char *feat_names[] = {
...
format_ena_admin_feat_desc (u8 *s, va_list *args)
{
  ...
  ena_admin_feat_info_t *info = ena_admin_get_feat_info (feat_id);
  u32 indent = format_get_indent (s);
  u32 line = 0;
  ...
  switch (feat_id)
    ...
    case ENA_ADMIN_FEAT_ID_DEVICE_ATTRIBUTES:
      {
	ena_admin_feat_device_attr_t *d = data;
	...
	_format_with_fn_and_val (s, d, supported_features,
				 format_ena_admin_feat_id_bitmap);
      }
      break;

    case ENA_ADMIN_FEAT_ID_AENQ_CONFIG:
      {
	ena_admin_feat_aenq_config_t *d = data;
	_format_with_fn_and_val (s, d, supported_groups,
				 format_ena_admin_aenq_groups);
    ...
    case ENA_ADMIN_FEAT_ID_INTERRUPT_MODERATION:
      {
	ena_admin_feat_intr_moder_t *d = data;
    ...
    case ENA_ADMIN_FEAT_ID_STATELESS_OFFLOAD_CONFIG:
      {
	ena_admin_feat_stateless_offload_config_t *d = data;
    ...
    case ENA_ADMIN_FEAT_ID_RSS_INDIRECTION_TABLE_CONFIG:
      {
	ena_admin_feat_rss_ind_table_config_t *d = data;
    ...
    case ENA_ADMIN_FEAT_ID_MAX_QUEUES_NUM:
      {
	ena_admin_feat_max_queue_num_t *d = data;
    ...
    case ENA_ADMIN_FEAT_ID_MAX_QUEUES_EXT:
      {
	ena_admin_feat_max_queue_ext_t *d = data;
    ...
    case ENA_ADMIN_FEAT_ID_RSS_HASH_FUNCTION:
      {
	ena_admin_feat_rss_hash_function_t *d = data;
    ...
    case ENA_ADMIN_FEAT_ID_EXTRA_PROPERTIES_STRINGS:
      {
	ena_admin_feat_extra_properties_strings_t *d = data;
    ...
    case ENA_ADMIN_FEAT_ID_EXTRA_PROPERTIES_FLAGS:
      {
	ena_admin_feat_extra_properties_flags_t *d = data;
    ...
    case ENA_ADMIN_FEAT_ID_HOST_ATTR_CONFIG:
      {
	ena_admin_feat_host_attr_config_t *d = data;
...
u8 *
format_ena_admin_create_sq_cmd (u8 *s, va_list *args)
{
  ena_admin_create_sq_cmd_t *cmd = va_arg (*args, ena_admin_create_sq_cmd_t *);
  u32 indent = format_get_indent (s);
  u32 line = 0;
...
u8 *
format_ena_admin_create_cq_cmd (u8 *s, va_list *args)
{
  ena_admin_create_cq_cmd_t *cmd = va_arg (*args, ena_admin_create_cq_cmd_t *);
  u32 indent = format_get_indent (s);
  u32 line = 0;
...
u8 *
format_ena_admin_create_sq_resp (u8 *s, va_list *args)
{
  ena_admin_create_sq_resp_t *resp =
    va_arg (*args, ena_admin_create_sq_resp_t *);
  u32 indent = format_get_indent (s);
  u32 line = 0;
...
u8 *
format_ena_admin_create_cq_resp (u8 *s, va_list *args)
{
  ena_admin_create_cq_resp_t *resp =
    va_arg (*args, ena_admin_create_cq_resp_t *);
  u32 indent = format_get_indent (s);
  u32 line = 0;
...
u8 *
format_ena_admin_destroy_sq_cmd (u8 *s, va_list *args)
{
  ena_admin_destroy_sq_cmd_t *cmd =
    va_arg (*args, ena_admin_destroy_sq_cmd_t *);
  u32 indent = format_get_indent (s);
  u32 line = 0;
...
u8 *
format_ena_admin_destroy_cq_cmd (u8 *s, va_list *args)
{
  ena_admin_destroy_cq_cmd_t *cmd =
    va_arg (*args, ena_admin_destroy_cq_cmd_t *);
  u32 indent = format_get_indent (s);
  u32 line = 0;
...
u8 *
format_ena_admin_basic_stats (u8 *s, va_list *args)
{
  ena_admin_basic_stats_t *st = va_arg (*args, ena_admin_basic_stats_t *);
  u32 indent = format_get_indent (s);
  u32 line = 0;
...
u8 *
format_ena_admin_eni_stats (u8 *s, va_list *args)
{
  ena_admin_eni_stats_t *st = va_arg (*args, ena_admin_eni_stats_t *);
  u32 indent = format_get_indent (s);
  u32 line = 0;
