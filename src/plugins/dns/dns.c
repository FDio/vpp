  ...
  if (vec_len (ep->dns_request) == 0)
    {
      ...
      /*
       * I am not aware of any nameservers that support multiple
       * questions in a single query so for now its going to
       * use DNS_TYPE_ALL. In the future it should be reworked
       * to perform two separate queries.
       */
