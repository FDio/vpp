...
is_interface_addr_fast(snat_main_t *sm, vlib_node_runtime_t *node,
...
u32 icmp_match_out2in_slow(snat_main_t *sm, vlib_node_runtime_t *node,
                           ...
                           snat_session_t **p_s0, u8 *p_dont_translate)
{
  ip4_header_t *ip0;
      ...
      if (snat_static_mapping_match(sm, key0, &sm0, 1))
        {
          ...
          if (is_interface_addr_fast(sm, node, sw_if_index0,
