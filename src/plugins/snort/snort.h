...
typedef struct snort_main_
{
  ...
  clib_bihash_16_8_t v4_flow_hash;
  clib_bihash_48_8_t v6_flow_hash;
} snort_main_t;
...
int snort_interface_add_del (u32 sw_if_index, u8 is_add);
int snort_interface_flow_add_del (snort_interface_flow_add_del_args_t *a);
