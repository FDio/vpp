...
snort_interface_add_del (snort_interface_add_del_args_t *a)
{
  ...
  if (a->is_add)
      ...
      if (sif)
	{
      ...
      sm->snort_iface_by_sw_if_index[a->sw_if_index] = snort_interface_index(sif);
      vnet_feature_enable_disable ("ip4-unicast", "snort", a->sw_if_index, 1, 0,
	                           0);
    }
  else
    {
	...
	return clib_error_return_code(0, -1, 0,
	                              ...
	                              a->sw_if_index);
      vnet_feature_enable_disable ("ip4-unicast", "snort", a->sw_if_index, 0, 0,
	                           0);
