...
{
  log_debug ("daq_version %U num_snort_instances %u", format_snort_daq_version,
	     req->connect.daq_version, req->connect.num_snort_instances);
			...
			snort_client_msg_queue_elt *e)
{
  ...
  if (req->attach_qpair.input_index >= vec_len (si->qpairs))
    {
