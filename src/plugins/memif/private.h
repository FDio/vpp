...
#define MEMIF_DMA_INFO_SIZE 256

#define DMA_INFO_STATE_CLEAR	 0
#define DMA_INFO_STATE_ALLOCATED 1
#define DMA_INFO_STATE_SUBMITTED 1 << 1
#define DMA_INFO_STATE_COMPLETED 1 << 2
