...
#define MEMIF_N_Q_WAIT_BIN_COUNTERS (32+1)
  ...
  vlib_simple_counter_main_t q_wait_fullq_bin_counters[MEMIF_N_Q_WAIT_BIN_COUNTERS];
  vlib_simple_counter_main_t q_wait_jitter_bin_counters[MEMIF_N_Q_WAIT_BIN_COUNTERS];
