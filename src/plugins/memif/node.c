  ...
  while (n_left >= 8)
    {
      ...
      _clib_memcpy (b0->data + co[0].buffer_offset, co[0].data,
		    co[0].data_len);
      _clib_memcpy (b1->data + co[1].buffer_offset, co[1].data,
		    co[1].data_len);
      _clib_memcpy (b2->data + co[2].buffer_offset, co[2].data,
		    co[2].data_len);
      _clib_memcpy (b3->data + co[3].buffer_offset, co[3].data,
		    co[3].data_len);
  ...
  while (n_alloc >= 32)
    {
      ...
      _clib_memcpy (d0, dt, sizeof (memif_desc_t));
      _clib_memcpy (d1, dt, sizeof (memif_desc_t));
      _clib_memcpy (d2, dt, sizeof (memif_desc_t));
      _clib_memcpy (d3, dt, sizeof (memif_desc_t));
