...
quic_show_aggregated_stats (vlib_main_t * vm)
{
  ...
  vlib_cli_output (vm, "Min      RTT     %f", agg_stats.rtt.minimum / nconn);
  vlib_cli_output (vm, "Smoothed RTT     %f", agg_stats.rtt.smoothed / nconn);
  vlib_cli_output (vm, "Variance on RTT  %f", agg_stats.rtt.variance / nconn);
