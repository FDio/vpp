...
static int
quicly_lib_api_on_stream_open (quicly_stream_open_t *self,
...
static void
quicly_lib_api_on_closed_by_remote (quicly_closed_by_remote_t *self,
...
static int64_t
quicly_lib_api_get_time (quicly_now_t *self)
{
  return quic_get_time ();
}

static quicly_stream_open_t on_stream_open = { quicly_lib_api_on_stream_open };
static quicly_closed_by_remote_t on_closed_by_remote = {
  quicly_lib_api_on_closed_by_remote
};
static quicly_now_t quicly_vpp_now_cb = { quicly_lib_api_get_time };
