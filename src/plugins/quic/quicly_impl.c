...
static int
quicly_impl_on_stream_open (quicly_stream_open_t *self,
...
static void
quicly_impl_on_closed_by_remote (quicly_closed_by_remote_t *self,
...
static int64_t
quicly_impl_get_time (quicly_now_t *self)
{
  return quic_get_time ();
}

static quicly_stream_open_t on_stream_open = { quicly_impl_on_stream_open };
static quicly_closed_by_remote_t on_closed_by_remote = {
  quicly_impl_on_closed_by_remote
};
static quicly_now_t quicly_vpp_now_cb = { quicly_impl_get_time };
