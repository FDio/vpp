...
#define QUIC_APP_ERROR_CLOSE_NOTIFY 0x0
#define QUIC_APP_ALLOCATION_ERROR 0x1
#define QUIC_APP_ACCEPT_NOTIFY_ERROR 0x2
#define QUIC_APP_CONNECT_NOTIFY_ERROR 0x3
#define QUIC_APP_ERROR_SIZE 0x4
