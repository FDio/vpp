...
typedef struct quic_main_
{
  ...
  quic_crypto_context_t *crypto_ctx_pool;	/**< Pool of crypto contexes */
  clib_bihash_24_8_t crypto_context_hash;	/**< params -> crypto ctx hash */
  clib_spinlock_t crypto_context_lock;		/**< crypto engine pool lock */
