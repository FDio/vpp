...
static_always_inline void
quic_stop_ctx_timer (quic_worker_ctx_t *wc, quic_ctx_t *ctx)
{
...
static_always_inline void
quic_update_timer (quic_worker_ctx_t *wc, quic_ctx_t *ctx, int64_t next_timeout)
{
  tw_timer_wheel_1t_3w_1024sl_ov_t *tw;
