	  ...
	  if (ecm->cfg.test_bytes)
	    {
	      ...
	      ((u32 *) es->test_send_buffer)[0] = test_buf_offset;
	      clib_memcpy_fast (es->test_send_buffer + sizeof (u32),
				test_data + test_buf_offset, bytes_this_chunk);
	      rv = app_send_dgram ((app_session_t *) es, es->test_send_buffer,
