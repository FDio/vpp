  ...
  if (session_transport_attribute (s, 1 /* is_get */, &attr) == 0)
    {
      ...
      cm->negotiated_key_agreement = attr.tls_profile_info.key_agreement;
      cm->negotiated_signature_algo = attr.tls_profile_info.signature_algo;
    }
  else
    {
