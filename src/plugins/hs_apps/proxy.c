...
proxy_tx_callback (session_t * proxy_s)
{
  ...
  /* Transport on ao side requested deq notification which, because of
   * shared fifos propagated to po side */
...
active_open_tx_callback (session_t * ao_s)
{
  ...
  /* Transport on po side requested deq notification which, because of
   * shared fifos propagated to ao side */
