			   ...
			   session_error_t err)
{
  ...
  new_hs_index = hcc_session_alloc (wrk);
  new_hs = hcc_session_get (new_hs_index, as->thread_index);
...
hcc_connect ()
{
  ...
  hs_index = hcc_session_alloc (wrk);
  hs = hcc_session_get (hs_index, 0);
