...
VLIB_NODE_FN (gtpu4_input) (vlib_main_t * vm,
             vlib_node_runtime_t * node,
             vlib_frame_t * from_frame)
{
...
VLIB_NODE_FN (gtpu6_input) (vlib_main_t * vm,
             vlib_node_runtime_t * node,
             vlib_frame_t * from_frame)
{
...
VLIB_NODE_FN (ip4_gtpu_bypass) (vlib_main_t * vm,
		  vlib_node_runtime_t * node,
		  vlib_frame_t * frame)
{
...
VLIB_NODE_FN (ip6_gtpu_bypass) (vlib_main_t * vm,
		  vlib_node_runtime_t * node,
		  vlib_frame_t * frame)
{
