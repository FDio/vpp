...
af_xdp_create_if (vlib_main_t * vm, af_xdp_create_if_args_t * args)
{
  ...
  clib_bitmap_alloc (bitmap, tm->n_vlib_mains);
  for (i = 0; i < ad->txq_num; i++)
    {
      u32 thread_index;
