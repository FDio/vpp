...
typedef struct
{
  ...
  my_stat_client_main_t *stat_client_main;
...
scrape_stats_segment (mt_main_t * mm)
{
  ...
  my_stat_client_main_t *sm = mm->stat_client_main;
...
main (int argc, char **argv)
{
  ...
  mm->stat_client_main = (my_stat_client_main_t *) & stat_client_main;
