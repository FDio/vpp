...
void *lisp_msg_put_map_reply (vlib_buffer_t *b, mapping_t *record, u64 nonce,
			      u8 probe_bit);

u32 lisp_msg_parse_mapping_record (vlib_buffer_t *b, gid_address_t *eid,
...
u32 lisp_msg_parse_itr_rlocs (vlib_buffer_t *b, gid_address_t **rlocs,
			      u8 rloc_count);
