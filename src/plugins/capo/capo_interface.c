...
int
capo_remove_policies (u32 sw_if_index)
{
  clib_bihash_kv_4_12_t kv;
  kv.key = sw_if_index;

  clib_bihash_add_del_4_12 (&capo_main.if_config, &kv, 0 /* is_add */);
...
int
print_capo_interface (clib_bihash_kv_4_12_t * kv, void * arg)
{
			   ...
			   unformat_input_t * input, vlib_cli_command_t * cmd)
{
  ...
  clib_bihash_foreach_key_value_pair_4_12 (&capo_main.if_config,
