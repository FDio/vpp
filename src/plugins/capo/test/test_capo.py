...
class TestCapoPolicies(BaseCapoTest):
    ...
    def test_inbound_outbound(self):
        ...
        # out policy at src
        self.configure_policies([pout], self.pg0, 0)
        ...
        self.configure_policies([pin], self.pg1, 0)
        self.send_test_packets(self.pg0, self.pg1, [matching], [not_matching])

        # policies configured at dst
        self.configure_policies([], self.pg0, 0)
        self.send_test_packets(self.pg0, self.pg1, [matching], [not_matching])

        # no policies
        self.configure_policies([], self.pg1, 0)
        self.send_test_packets(self.pg0, self.pg1, [matching, not_matching], [])
    ...
    def test_default_verdict(self):
        ...
        self.configure_policies([policy1], self.pg1, 0)
        ...
        self.configure_policies([policy4, policy3, policy1], self.pg1, 2)
        self.send_test_packets(self.pg0, self.pg1, passing, dropped)
        ...
        self.configure_policies([policy5, policy1], self.pg1, 1)
        self.send_test_packets(self.pg0, self.pg1, passing, dropped)
    ...
    def test_realistic_policy(self):
        ...
        self.configure_policies([policy], self.pg1, 1)
