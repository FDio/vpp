...
/*       gbp_recirc_add (epg_id, bd_id, rd_id, rd_id, 0, */
/* 			      uplink_sw_if_index, recirc_sw_if_index); */
/*     } */
/*   else */
/*     gbp_recirc_delete (epg_id); */
