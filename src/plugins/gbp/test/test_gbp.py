...
class VppGbpEndpointGroup(VppObject):
    ...
    def encode(self) -> dict:
        return {
            "uplink_sw_if_index": self.uplink.sw_if_index if self.uplink else INDEX_INVALID,
...
class VppGbpBridgeDomain(VppObject):
    ...
    def __init__(self, test, bd, rd, bvi, uu_fwd: typing.Optional[VppVxlanGbpTunnel] = None,
    ...
    def encode(self) -> dict:
        return {
            ...
            "uu_fwd_sw_if_index": self.uu_fwd.sw_if_index if self.uu_fwd else INDEX_INVALID,
            "bm_flood_sw_if_index": self.bm_flood.sw_if_index if self.bm_flood else INDEX_INVALID,
            "bd_id": self.bd.bd_id,
            "rd_id": self.rd.rd_id,
        }
...
class VppGbpRouteDomain(VppObject):
    ...
    def encode(self) -> dict:
        return {
            ...
            "ip4_uu_sw_if_index": self.ip4_uu.sw_if_index if self.ip4_uu else INDEX_INVALID,
            "ip6_uu_sw_if_index": self.ip6_uu.sw_if_index if self.ip6_uu else INDEX_INVALID,
