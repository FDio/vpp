...
static perfmon_intel_pmc_event_t event_table[] = {
   ...
   },
  {
   .event_code = {0x08},
   .umask = 0x82,
   .event_name = "dtlb_load_misses.demand_ld_walk_completed",
   },
  {
   .event_code = {0x08},
   .umask = 0x82,
   ...
   },
  {
   .event_code = {0x08},
   .umask = 0x84,
   .event_name = "dtlb_load_misses.demand_ld_walk_duration",
   },
  {
   .event_code = {0x08},
   .umask = 0x84,
   ...
   },
  {
   .event_code = {0xD3},
   .umask = 0x10,
   .event_name = "mem_load_uops_llc_miss_retired.remote_hitm",
   },
  {
   .event_code = {0xD3},
   .umask = 0x20,
   .event_name = "mem_load_uops_llc_miss_retired.remote_fwd",
   },
  {
   .event_code = {0xE6},
   .umask = 0x1F,
