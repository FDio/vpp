...
static u8 *
format_intel_ia32_uncore_imc_bw (u8 *s, va_list * args)
{
  ...
  switch (col)
    ...
    case 0:
      ...
      break;
    case 1:
      s = format (s, "%4.2f", (f64) r->value[0] * 64 * 1e-6 / tr);
      break;
    case 2:
      s = format (s, "%4.2f", (f64) r->value[1] * 64 * 1e-6 / tr);
      break;
    default:
      break;
    }
...
PERFMON_REGISTER_BUNDLE (intel_ia32_uncore_imc_bw) = {
  ...
  .n_events = 2,
  .format_fn = format_intel_ia32_uncore_imc_bw,
