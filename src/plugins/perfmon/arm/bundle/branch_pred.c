...
PERFMON_REGISTER_BUNDLE (arm_branch_pred) = {
  ...
  .column_events = PERFMON_COLUMN_EVENTS (
    __ (BR_RETIRED), __ (BR_RETIRED), __ (BR_MIS_PRED_RETIRED),
    __ (BR_MIS_PRED_RETIRED), __ (BR_RETIRED) | __ (BR_MIS_PRED_RETIRED),
    __ (BR_PRED), __ (BR_PRED), __ (BR_MIS_PRED), __ (BR_MIS_PRED),
    __ (BR_PRED) | __ (BR_MIS_PRED), 0),
  .footer =
