...
PERFMON_REGISTER_BUNDLE (arm_cache_data) = {
  ...
  .column_events = PERFMON_COLUMN_EVENTS (
    __ (L1D_CACHE), __ (L1D_CACHE_REFILL),
    __ (L1D_CACHE) | __ (L1D_CACHE_REFILL), __ (L2D_CACHE),
    __ (L2D_CACHE_REFILL), __ (L2D_CACHE) | __ (L2D_CACHE_REFILL),
    __ (L3D_CACHE), __ (L3D_CACHE_REFILL),
    __ (L3D_CACHE) | __ (L3D_CACHE_REFILL), 0),
