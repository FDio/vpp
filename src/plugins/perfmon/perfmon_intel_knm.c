...
static perfmon_intel_pmc_event_t event_table[] = {
   ...
   },
  {
   .event_code = {0xC2},
   .umask = 0x20,
   .event_name = "uops_retired.scalar_simd",
   },
  {
   .event_code = {0xC2},
   .umask = 0x40,
   .event_name = "uops_retired.packed_simd",
   },
  {
   .event_code = {0xC3},
   .umask = 0x01,
   ...
   },
  {
   .event_code = {0x30},
   .umask = 0x00,
   .event_name = "l2_requests_reject.all",
   },
  {
   .event_code = {0x31},
   .umask = 0x00,
   ...
   },
  {
   .event_code = {0x2E},
   .umask = 0x4F,
   .event_name = "l2_requests.reference",
   },
  {
   .event_code = {0x2E},
   .umask = 0x41,
   .event_name = "l2_requests.miss",
   },
  {
   .event_code = {0x80},
   .umask = 0x03,
   ...
   },
  {
   .event_code = {0x03},
   .umask = 0x01,
   .event_name = "recycleq.ld_block_st_forward",
   },
  {
   .event_code = {0x03},
   .umask = 0x02,
   .event_name = "recycleq.ld_block_std_notready",
   },
  {
   .event_code = {0x03},
   .umask = 0x04,
   .event_name = "recycleq.st_splits",
   },
  {
   .event_code = {0x03},
   .umask = 0x08,
   .event_name = "recycleq.ld_splits",
   },
  {
   .event_code = {0x03},
   .umask = 0x10,
   .event_name = "recycleq.lock",
   },
  {
   .event_code = {0x03},
   .umask = 0x20,
   .event_name = "recycleq.sta_full",
   },
  {
   .event_code = {0x03},
   .umask = 0x40,
   .event_name = "recycleq.any_ld",
   },
  {
   .event_code = {0x03},
   .umask = 0x80,
   .event_name = "recycleq.any_st",
   },
  {
   .event_code = {0x04},
   .umask = 0x01,
   ...
   },
  {
   .event_code = {0x04},
   .umask = 0x10,
   .event_name = "mem_uops_retired.utlb_miss_loads",
   },
  {
   .event_code = {0x04},
   .umask = 0x20,
   ...
   },
  {
   .event_code = {0xC5},
   .umask = 0xF9,
   .event_name = "br_misp_retired.call",
   },
  {
   .event_code = {0xC5},
   .umask = 0xFD,
   .event_name = "br_misp_retired.rel_call",
   },
  {
   .event_code = {0xC5},
   .umask = 0xBF,
   .event_name = "br_misp_retired.far_branch",
   },
  {
   .event_name = 0,
   },
