...
PERFMON_REGISTER_BUNDLE (topdown_lvl2_metric) = {
  ...
  .source = "intel-core",
  .events[0] = "TOPDOWN.SLOTS",
  .events[1] = "TOPDOWN_L1_RETIRING_METRIC",
  .events[2] = "TOPDOWN_L1_BAD_SPEC_METRIC",
  .events[3] = "TOPDOWN_L1_FE_BOUND_METRIC",
  .events[4] = "TOPDOWN_L1_BE_BOUND_METRIC",
  .events[5] = "TOPDOWN_L2_HEAVYOPS_METRIC",
  .events[6] = "TOPDOWN_L2_BMISPRED_METRIC",
  .events[7] = "TOPDOWN_L2_FETCHLAT_METRIC",
  .events[8] = "TOPDOWN_L2_MEMBOUND_METRIC",
  .n_events = 9,
