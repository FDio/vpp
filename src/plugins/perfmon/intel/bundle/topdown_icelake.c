...
PERFMON_REGISTER_BUNDLE (topdown_lvl2_metric_icx) = {
  ...
  .events[1] = "CYCLE_ACTIVITY.STALLS_MEM_ANY",
  .events[2] = "CYCLE_ACTIVITY.STALLS_TOTAL",
  .events[3] = "EXE_ACTIVITY.BOUND_ON_STORES",
  .events[4] = "INT_MISC.RECOVERY_CYCLES",
  .events[5] = "INT_MISC.UOP_DROPPING",
  .events[6] = "IDQ_UOPS.NOT_DELIVERED_CORE",
  .events[7] = "TOPDOWN.L1_RETIRING_METRIC",
  .events[8] = "TOPDOWN.L1_BAD_SPEC_METRIC",
  .events[9] = "TOPDOWN.L1_FE_BOUND_METRIC",
  .events[10] = "TOPDOWN.L1_BE_BOUND_METRIC",
  .n_events = 11,
