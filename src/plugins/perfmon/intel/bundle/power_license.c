...
PERFMON_REGISTER_BUNDLE (power_licensing) = {
  ...
  .events[0] = "CPU_CLK_UNHALTED.THREAD_P",
  .events[1] = "CORE_POWER.LVL0_TURBO_LICENSE",
  .events[2] = "CORE_POWER.LVL1_TURBO_LICENSE",
  .events[3] = "CORE_POWER.LVL2_TURBO_LICENSE",
  .events[4] = "CORE_POWER.THROTTLE",
  .n_events = 5,
