...
PERFMON_REGISTER_BUNDLE (intel_uncore_iio_bw_pci) = {
  ...
  .source = "intel-uncore",
  .events[0] = "IIO_DATA_REQ_OF_CPU.PART0_RD",
  .events[1] = "IIO_DATA_REQ_BY_CPU.PART0_WR",
  .events[2] = "IIO_DATA_REQ_BY_CPU.PART2_RD",
  .events[3] = "IIO_DATA_REQ_BY_CPU.PART2_WR",
  .n_events = 4,
...
PERFMON_REGISTER_BUNDLE (intel_uncore_iio_bw_cpu) = {
  ...
  .source = "intel-uncore",
  .events[0] = "IIO_DATA_REQ_BY_CPU.PART0_RD",
  .events[1] = "IIO_DATA_REQ_BY_CPU.PART0_WR",
  .events[2] = "IIO_DATA_REQ_BY_CPU.PART2_RD",
  .events[3] = "IIO_DATA_REQ_BY_CPU.PART2_WR",
  .n_events = 4,
