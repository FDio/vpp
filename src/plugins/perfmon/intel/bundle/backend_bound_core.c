...
PERFMON_REGISTER_BUNDLE (intel_core_backend_bound_core) = {
  ...
  .source = "intel-core",
  .events[0] = "UOPS_DISPATCHED.PORT_0",       /* 0xFF */
  .events[1] = "UOPS_DISPATCHED.PORT_1",       /* 0xFF */
  .events[2] = "UOPS_DISPATCHED.PORT_5",       /* 0xFF */
  .events[3] = "UOPS_DISPATCHED.PORT_6",       /* 0xFF */
  .events[4] = "UOPS_DISPATCHED.PORT_2_3",     /* 0xFF */
  .events[5] = "UOPS_DISPATCHED.PORT_4_9",     /* 0xFF */
  .events[6] = "UOPS_DISPATCHED.PORT_7_8",     /* 0xFF */
  .events[7] = "CPU_CLK_UNHALTED.DISTRIBUTED", /* 0xFF */
  .n_events = 8,
