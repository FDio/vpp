...
PERFMON_REGISTER_BUNDLE (intel_core_frontend_bound_lat) = {
  ...
  .source = "intel-core",
  .events[0] = "ICACHE_16B.IFDATA_STALL",	   /* 0x0F */
  .events[1] = "DSB2MITE_SWITCHES.PENALTY_CYCLES", /* 0x0F */
  .events[2] = "INT_MISC.CLEAR_RESTEER_CYCLES",	   /* 0xFF */
  .events[3] = "IDQ.MS_SWITCHES",		   /* 0x0F */
  .events[4] = "BACLEARS.ANY",			   /* 0x0F */
  .events[5] = "CPU_CLK_UNHALTED.THREAD_P",	   /* FIXED */
  .n_events = 6,
