...
#include "skylake_table.c"
#include "haswell_table.c"

#define foreach_cpuid_table                     \
_(0x0306C3, perfmon_haswell_table)              \
_(0x0306F2, perfmon_haswell_table)              \
_(0x0406E3, perfmon_skylake_table)              \
_(0x0506E3, perfmon_skylake_table)
