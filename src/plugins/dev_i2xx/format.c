...
static u8 *
_format_i2xx_reg (u8 *s, u32 offset, u32 val, int no_zero, u32 mask)
{
...
u8 *
format_i2xx_reg_read (u8 *s, va_list *args)
{
  u32 offset = va_arg (*args, u32);
  u32 val = va_arg (*args, u32);
  return _format_i2xx_reg (s, offset, val, 0, 0xffffffff);
}

u8 *
format_i2xx_reg_write (u8 *s, va_list *args)
{
  u32 offset = va_arg (*args, u32);
  u32 val = va_arg (*args, u32);
  return _format_i2xx_reg (s, offset, val, 1, 0xffffffff);
}

u8 *
format_i2xx_reg_diff (u8 *s, va_list *args)
{
  u32 offset = va_arg (*args, u32);
  u32 old = va_arg (*args, u32);
  u32 new = va_arg (*args, u32);
  return _format_i2xx_reg (s, offset, new, 0, old ^ new);
}

u8 *
format_i2xx_port_status (u8 *s, va_list *args)
{
