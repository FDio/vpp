...
{
  extern quic_openssl_crypto_context_t *quic_openssl_crypto_context_get_impl (u32 ctx_index, u8 thread_index);
...
extern void quic_openssl_crypto_init_per_thread (quic_main_t *qm, u8 thread_index);
extern u32 quic_openssl_crypto_context_alloc (quic_main_t *qm, u8 thread_index);
extern void quic_openssl_crypto_context_free (quic_main_t *qm,
                                              quic_openssl_crypto_context_t *crctx);
extern quic_openssl_crypto_context_t *quic_openssl_crypto_context_get_impl (u32 ctx_index,
                                                                            u8 thread_index);
extern int quic_openssl_crypto_context_init (quic_openssl_crypto_context_t *crctx, u8 is_server);
extern void quic_openssl_crypto_context_cleanup (quic_openssl_crypto_context_t *crctx);
