  ...
  while (n_left_from > 0)
      ...
      while (n_left_from >= 4 && n_left_to_next >= 2)
	{
	  ...
	  if ((tcp0->flags & TCP_FLAG_SYN) == TCP_FLAG_SYN &&
	    ...
	    {
	      no_of_responses0 = ip6_sr_multicastmap_reset(&ip0->dst_address);
              if (no_of_responses0 > 0)
		{
	      ...
	      hbh0 = (ip6_hop_by_hop_header_t *) (ip0 + 1);
	      e2e = (ioam_e2e_cache_option_t *)(hbh0 + cm->rewrite_pool_index_offset);
	...
	NEXT00:
	  ...
	  if ((tcp1->flags & TCP_FLAG_SYN) == TCP_FLAG_SYN &&
	    ...
	    {
	      no_of_responses1 = ip6_sr_multicastmap_reset(&ip1->dst_address);
              if (no_of_responses1 > 0)
		{
	      ...
	      e2e = (ioam_e2e_cache_option_t *)(hbh1 + cm->rewrite_pool_index_offset);
	      e2e->pool_id = (u8)vm->cpu_index;
