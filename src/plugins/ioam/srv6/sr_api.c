...
ioam_sr_init (vlib_main_t * vm)
{
  ...
  if ((error = vlib_call_init_function (vm, sr_localsids_init)))
    return error;
  ...
  sr_register_tlv_handler_function (vm, SRH_OPTION_TYPE_IOAM_TRACE_DATA_LIST,
				    sm->sid_next_node, NULL, NULL);
  ...
  sr_oam_register_policy_function (vm, SRH_OPTION_TYPE_IOAM_TRACE_DATA_LIST,
				   sm->policy_next_node,
