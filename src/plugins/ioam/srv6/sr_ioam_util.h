...
format_sr_ioam_trace (u8 * s, va_list * args)
{
  ...
  limit0 = (ip6_sr_tlv_header_t *) ((u8 *) fmt_trace0 + (t->trace_len << 3));
		    ...
		    u32 * next0, u32 drop_node_val)
{
  ...
  ip0 =
    (ip6_header_t *) ((u8 *) vlib_buffer_get_current (b0) + iph_offset);
