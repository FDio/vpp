...
/*
 *------------------------------------------------------------------
 * sr_ioam_export_test.c - test harness plugin
 *------------------------------------------------------------------
 */
...
_(sr_ioam_export_enable_disable_reply)
...
_(SR_IOAM_EXPORT_ENABLE_DISABLE_REPLY, sr_ioam_export_enable_disable_reply)

static int
api_sr_ioam_export_enable_disable (vat_main_t * vam)
{
  ...
  M (SR_IOAM_EXPORT_ENABLE_DISABLE, mp);
...
_(sr_ioam_export_enable_disable, "<intfc> [disable]")

static void
sr_ioam_vat_api_hookup (vat_main_t * vam)
{
