/*
 * flowprobe.h - skeleton vpp engine plug-in header file
 *
...
#define FLOWPROBE_LOG2_HASHSIZE  (16)
...
/*
 * Consider to dynamically derive these in the future
 */
#define FLOWPROBE_ACTIVITY_LOW		(15)
#define FLOWPROBE_ACTIVITY_MEDIUM	(1)
#define FLOWPROBE_ACTIVITY_HIGH		(0.1)

/* $$$$: Calculate based on entry size and MTU */
