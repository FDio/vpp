...
static lacp_fsm_state_t lacp_mux_state_attached[] = {
  ...
  { LACP_ACTION_COLLECTING_DISTRIBUTING,
    LACP_MUX_STATE_COLLECTING_DISTRIBUTING }, // event 5_SYNC
};
...
static lacp_fsm_state_t lacp_mux_state_collecting_distributing[] = {
  { LACP_ACTION_DETACHED, LACP_MUX_STATE_DETACHED }, // event 0 BEGIN
  { LACP_ACTION_COLLECTING_DISTRIBUTING,
    LACP_MUX_STATE_COLLECTING_DISTRIBUTING }, // event 1 SELECTED
  { LACP_ACTION_COLLECTING_DISTRIBUTING,
    LACP_MUX_STATE_COLLECTING_DISTRIBUTING },	     // event 2 STANDBY
  { LACP_ACTION_ATTACHED, LACP_MUX_STATE_ATTACHED }, // event 3 UNSELECTED
  { LACP_ACTION_COLLECTING_DISTRIBUTING,
    LACP_MUX_STATE_COLLECTING_DISTRIBUTING }, // event 4 READY
  { LACP_ACTION_COLLECTING_DISTRIBUTING,
    LACP_MUX_STATE_COLLECTING_DISTRIBUTING }, // event 5 SYNC
};
...
lacp_mux_action_waiting (void *p1, void *p2)
{
  ...
  if ((mif->selected == LACP_PORT_SELECTED) && mif->ready)
    lacp_machine_dispatch (&lacp_mux_machine, vm, mif, LACP_MUX_EVENT_READY,
			   &mif->mux_state);
		     ...
		     lacp_fsm_state_t *transition)
{
  ...
  ed->event = elog_string (&vlib_global_main.elog_main, "%U-MUX: %U, %U->%U%c",
