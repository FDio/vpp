			      ...
			      int set_bytes)
{
  ...
  if (set_bytes)
	...
	return VNET_API_ERROR_INVALID_VALUE;
      ...
      vec_validate_init_empty (hsm->input_skip_by_sw_if_index,
			       sw_if_index, 0);
      hsm->input_skip_by_sw_if_index[sw_if_index] = skip_bytes;
    }

  vnet_feature_enable_disable ("device-input", "hdrskip-input",
			       ...
			       int set_bytes)
{
  ...
  if (set_bytes)
	...
	return VNET_API_ERROR_INVALID_VALUE;
      ...
      vec_validate_init_empty (hsm->output_restore_by_sw_if_index,
			       sw_if_index, 0);
