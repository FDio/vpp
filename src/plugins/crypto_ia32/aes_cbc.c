...
more:
  ...
  for (i = 0; i < count; i += 16)
    {
#ifdef __VAES__
      r.x4[0] ^= aes_block_load_x4 (src, i) ^ k[0].x4[0];
      r.x4[1] ^= aes_block_load_x4 (src + 4, i) ^ k[0].x4[0];
      r.x4[2] ^= aes_block_load_x4 (src + 8, i) ^ k[0].x4[0];
      r.x4[3] ^= aes_block_load_x4 (src + 12, i) ^ k[0].x4[0];
...
#else
      r.x1[0] ^= aes_block_load (src[0] + i) ^ k[0].x1[0];
      r.x1[1] ^= aes_block_load (src[1] + i) ^ k[0].x1[1];
      r.x1[2] ^= aes_block_load (src[2] + i) ^ k[0].x1[2];
      r.x1[3] ^= aes_block_load (src[3] + i) ^ k[0].x1[3];
