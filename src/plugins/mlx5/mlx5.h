...
typedef enum
{
  MLX5_DEVICE_STATUS_INIT = 0,
  MLX5_DEVICE_STATUS_ACTIVE,
  MLX5_DEVICE_STATUS_ERROR,
} mlx5_device_status_t;

typedef struct
{
  u32 flags;
  mlx5_device_status_t status;
  /* registers */
  volatile void *hca;
...
format_function_t format_mlx5_eqe;
