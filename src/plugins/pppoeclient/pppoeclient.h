...
static_always_inline void
pppoeclient_lookup_session_1 (clib_bihash_16_8_t *session_table, u32 sw_if_index,
			      const u8 *ac_mac, u16 session_id, pppoe_client_result_t *result0)
{
...
static_always_inline void
pppoeclient_update_session_1 (clib_bihash_16_8_t *session_table, u32 sw_if_index,
			      const u8 *ac_mac, u16 session_id, pppoe_client_result_t *result0)
{
  pppoe_client_session_key_t key0;
  /* set up key */
...
static_always_inline void
pppoeclient_delete_session_1 (clib_bihash_16_8_t *session_table, u32 sw_if_index,
			      const u8 *ac_mac, u16 session_id)
{
  pppoe_client_session_key_t key0;
  /* set up key */
  pppoeclient_make_session_key (&key0, sw_if_index, ac_mac, session_id);
