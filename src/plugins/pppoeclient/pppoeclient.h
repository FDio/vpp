...
/* Maximum PPPoE session MTU: 1500 (standard Ethernet) - 8 (PPPoE header) = 1492.
 * Ref: RFC 2516 section 7 ("The default MTU of a PPPoE interface is 1492"). */
#define PPPOECLIENT_MTU_MAX 1492
...
typedef struct
{
   ...
   * embedded fixed-size array would inflate every pppoe_client_t past 4 KB
