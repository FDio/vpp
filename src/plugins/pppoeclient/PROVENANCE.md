...
- pppoeclient.c : ~0.195
- node.c        : ~0.220
- pppox/pppox.c : ~0.319 (pppox, separate plugin)
- pppox/node.c  : ~0.539
...
- pppox integration so discovery handoff, CHAP/PAP failure propagation,
  ...
  sources (see src/plugins/pppox/pppd/README.import).
...
licenses cover the imported pppd sources under src/plugins/pppox/pppd.
