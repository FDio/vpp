...
VLIB_CLI_COMMAND (clear_pppoeclient_backoff_command, static) = {
  ...
  .short_help = "clear pppoe client backoff {<client-index> | all}",
 ...
 *
 * @cliexpar
 * @cliexcmd{set pppoe backoff jitter 0.1}
 ?*/
VLIB_CLI_COMMAND (set_pppoeclient_backoff_jitter_command, static) = {
  .path = "set pppoe backoff jitter",
  .short_help = "set pppoe backoff jitter <fraction 0..0.5>",
