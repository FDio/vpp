                    ...
                    vlib_frame_t * from_frame)
{
  ...
  return wg_handoff (vm, node, from_frame, wmp->in_fq_index, WG_HANDOFF_HANDSHAKE);
}
                    ...
                    vlib_frame_t * from_frame)
{
  ...
  return wg_handoff (vm, node, from_frame, wmp->in_fq_index, WG_HANDOFF_INP_DATA);
}
                    ...
                    vlib_frame_t * from_frame)
{
  ...
  return wg_handoff (vm, node, from_frame, wmp->out_fq_index, WG_HANDOFF_OUT_TUN);
}
