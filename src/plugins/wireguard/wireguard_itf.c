...
int
wg_itf_create (u32 user_instance, u8 private_key_64[NOISE_KEY_LEN_BASE64],
                      u16 port, u32 * sw_if_indexp)
{
    ...
    *sw_if_indexp = (u32) ~ 0;
    ...
    wg_itf->ii_user_instance = instance;
    if (~0 == wg_itf->ii_user_instance)
      wg_itf->ii_user_instance = t_idx;
...
//    upcall.u_index_drop = wg_index_drop;
    ...
    wg_itf->ii_sw_if_index = *sw_if_indexp = hi->sw_if_index;
