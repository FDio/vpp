...
class VppWgPeer(VppObject):
    ...
    def validate_routing(self, is_ip6=False):
        for a in self.allowed_ips:
            self._test.assertTrue(find_route(self._test, a, is_ip6))

    def validate_no_routing(self, is_ip6=False):
        for a in self.allowed_ips:
            self._test.assertFalse(find_route(self._test, a, is_ip6))
