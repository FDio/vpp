...
class TestWg(VppTestCase):
    ...
    def test_wg_peer_init(self):
        ...
        self.logger.info(self.vapi.cli("sh wireguard peer"))
        ...
        # send a data packet from the peer thru the tunnel
        # this completes the handshake
        p = (IP(src="10.11.3.1", dst=self.pg0.remote_ip4) /
        ...
        p = [(peer_1.mk_tunnel_header(self.pg1) /
              ...
              WireguardTransport(
                  ...
                  encrypted_encapsulated_packet=peer_1.encrypt_transport(
                      (IP(src="10.11.3.1", dst=self.pg0.remote_ip4) /
                       UDP(sport=222, dport=223) /
