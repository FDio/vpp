...
static_always_inline void
wg_input_add_to_frame (vlib_main_t *vm, u32 buffer_index, u32 crypto_len, i16 crypto_start_offset,
		       u16 next_node, i16 iv_off, u8 is_chained)
{
  ...
  if (is_async)
    {
      ...
      u8 is_chained = b != lb;
      wg_input_add_to_frame (vm, buf_idx, srclen_total, src - current, async_next_node,
			     vnet_crypto_buffer_metadata_pre_data_off (b), is_chained);
      async_bi[0] = buf_idx;
