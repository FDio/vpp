...
static clib_error_t * otx2_main_init (vlib_main_t * vm)
{
...
/* *INDENT-OFF* */
VLIB_INIT_FUNCTION (otx2_main_init) =
{
    .runs_after = VLIB_INITS("otx2_init"),
};
/* *INDENT-ON* */


clib_error_t *
otx2_early_init (vlib_main_t *vm)
{
  int fd = -1;
  u64 *pt = 0;
  clib_error_t *err = 0;
...
VLIB_PLUGIN_REGISTER () = {
	...
	.default_disabled = 1,
    .description = "Marvell OCTEONTX2 Device Plugin",
    .early_init = "otx2_early_init",
};
/* *INDENT-ON* */
