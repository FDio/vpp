...
#include <match_tuple/match_tuple.h>

static vlib_log_class_t match_tuple_logger;

match_tuple_main_t match_tuple_main;

#define MATCH_TUPLE_DEBUG 0

#define DBG(...)                                        \
    vlib_log_debug (match_tuple_logger, __VA_ARGS__);
#define DBG0(...)                                        \
    vlib_log_debug (match_tuple_logger, __VA_ARGS__);

/* always_inline applied_hash_ace_entry_t **get_applied_hash_aces(match_tuple_main_t *am, u32 lc_index) */
/* { */
...
/* static void */
/* hashtable_add_del(match_tuple_main_t *am, clib_bihash_kv_48_8_t *kv, int is_add) */
/* { */
...
/* static u8 */
/* first_mask_contains_second_mask(int is_ip6, match_5tuple_t * mask1, match_5tuple_t * mask2) */
/* { */
/*   int i; */
/*   if (is_ip6) */
/*     { */
...
/* static void */
/* relax_tuple(match_5tuple_t *mask, int is_ip6, int relax2){ */
/* 	match_5tuple_t save_mask = *mask; */
...
/* static u32 */
/* find_mask_type_index(match_tuple_main_t *am, match_5tuple_t *mask) */
/* { */
...
/* static u32 */
/* assign_mask_type_index(match_tuple_main_t *am, match_5tuple_t *mask) */
/* { */
...
/*   mte->refcount++; */
/*   DBG("ASSIGN MTE index %d new refcount %d", mask_type_index, mte->refcount); */
/*   return mask_type_index; */
/* } */

/* static void */
/* lock_mask_type_index(match_tuple_main_t *am, u32 mask_type_index) */
/* { */
...
/* static void */
/* release_mask_type_index(match_tuple_main_t *am, u32 mask_type_index) */
/* { */
...
/* static u32 */
/* tm_assign_mask_type_index(match_tuple_main_t *am, match_5tuple_t *mask, int is_ip6, u32 lc_index) */
/* { */
...
/* 		match_5tuple_t relaxed_mask = *mask; */
...
/* static void */
/* fill_applied_hash_ace_kv(match_tuple_main_t *am, */
/*                             applied_hash_ace_entry_t **applied_hash_aces, */
/*                             u32 lc_index, */
/*                             u32 new_index, clib_bihash_kv_48_8_t *kv) */
/* { */
/*   match_5tuple_t *kv_key = (match_5tuple_t *)kv->key; */
...
/* static void */
/* add_del_hashtable_entry(match_tuple_main_t *am, */
/*                             u32 lc_index, */
/*                             applied_hash_ace_entry_t **applied_hash_aces, */
...
/* static void */
/* remake_hash_applied_mask_info_vec (match_tuple_main_t * am, */
...
/*   if (MATCH_TUPLE_DEBUG > 0) */
/*     acl_plugin_print_pae(vlib_get_main(), head_index, head_pae); */
...
/* static void */
/* add_colliding_rule (match_tuple_main_t * am, */
/*                     applied_hash_ace_entry_t ** applied_hash_aces, */
/*                     u32 head_index, u32 applied_entry_index) */
/* { */
/*   applied_hash_ace_entry_t *head_pae = */
...
/* static u32 */
/* activate_applied_ace_hash_entry(match_tuple_main_t *am, */
/*                             u32 lc_index, */
/*                             applied_hash_ace_entry_t **applied_hash_aces, */
/*                             u32 new_index) */
/* { */
...
/* static void * */
/* hash_acl_set_heap(match_tuple_main_t *am) */
/* { */
...
/* { */
/*   match_tuple_main_t *am = &match_tuple_main; */
...
/* static void */
/* assign_mask_type_index_to_pae(match_tuple_main_t *am, u32 lc_index, int is_ip6, applied_hash_ace_entry_t *pae) */
/* { */
/*   hash_acl_info_t *ha = vec_elt_at_index(am->hash_acl_infos, pae->acl_index); */
/*   hash_ace_info_t *ace_info = vec_elt_at_index(ha->rules, pae->hash_ace_info_index); */
...
/* static void */
/* split_partition(match_tuple_main_t *am, u32 first_index, */
/*                             u32 lc_index, int is_ip6); */


/* static void */
/* check_collision_count_and_maybe_split(match_tuple_main_t *am, u32 lc_index, int is_ip6, u32 first_index) */
/* { */
...
/* void */
/* hash_acl_apply(match_tuple_main_t *am, u32 lc_index, int acl_index, u32 acl_position) */
/* { */
/*   int i; */
...
/* static void */
/* move_applied_ace_hash_entry(match_tuple_main_t *am, */
/*                             u32 lc_index, */
/*                             applied_hash_ace_entry_t **applied_hash_aces, */
...
/* static void */
/* deactivate_applied_ace_hash_entry(match_tuple_main_t *am, */
/*                             u32 lc_index, */
/*                             applied_hash_ace_entry_t **applied_hash_aces, */
/*                             u32 old_index) */
/* { */
...
/* void */
/* hash_acl_unapply(match_tuple_main_t *am, u32 lc_index, int acl_index) */
/* { */
/*   int i; */
...
/* void */
/* hash_acl_reapply(match_tuple_main_t *am, u32 lc_index, int acl_index) */
/* { */
...
/* static void */
/* make_mask_and_match_from_rule(match_5tuple_t *mask, acl_rule_t *r, hash_ace_info_t *hi) */
/* { */
...
/* int hash_acl_exists(match_tuple_main_t *am, int acl_index) */
/* { */
...
/* static void */
/* match_tuple_list_add (match_tuple_main_t *mtm, */
/*                       index_t msi, */
/*                       index_t msei) */
/* { */
...
/* void hash_acl_delete(match_tuple_main_t *am, int acl_index) */
/* { */
/*   void *oldheap = hash_acl_set_heap(am); */
...
/* void */
/* show_hash_acl_hash (vlib_main_t * vm, match_tuple_main_t *am, u32 verbose) */
/* { */
...
/*         applied_hash_ace_entry_t **applied_hash_aces = get_applied_hash_aces(am, lc_index); */
/* 	ace_mask_type_entry_t *mte; */
/* 	match_5tuple_t the_min_tuple, *min_tuple = &the_min_tuple; */
/*         match_5tuple_t the_max_tuple, *max_tuple = &the_max_tuple; */
...
/* 		mte = vec_elt_at_index(am->ace_mask_type_pool, ace_info->base_mask_type_index); */
/* 		match_5tuple_t *mask = &mte->mask; */

/* 		if(pae->mask_type_index != coll_mask_type_index) continue; */
/* 		/\* Computing min_mask and max_mask for colliding rules *\/ */
/* 		if(i==0){ */
/*                         clib_memcpy_fast(min_tuple, mask, sizeof(match_5tuple_t)); */
/* 			clib_memcpy_fast(max_tuple, mask, sizeof(match_5tuple_t)); */
/* 		}else{ */
/* 			int j; */
/* 			for(j=0; j<2; j++){ */
/*                                 if (is_ip6) */
...
/* 		match_5tuple_t *pop_mask = &mte->mask; */
...
clib_error_t *
match_tuple_init (vlib_main_t * vm)
{
  match_tuple_main_t *mtm = &match_tuple_main;

  BV (clib_bihash_init) (&mtm->mtm_hash,
			 "Match-Tuple",
			 mtm->mtm_n_buckets, mtm->mtm_n_memory);

  match_tuple_logger = vlib_log_register_class ("match", "tuple");

  return (NULL);
}

VLIB_INIT_FUNCTION (match_tuple_init) =
{
