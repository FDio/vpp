...
struct perfmon2_source;

typedef clib_error_t *(perfmon2_source_init_fn_t) (vlib_main_t * vm,
						   struct perfmon2_source *);
typedef struct perfmon2_source
{
  ...
  perfmon2_source_init_fn_t *init_fn;
} perfmon2_source_t;


struct perfmon2_bundle;
typedef clib_error_t *(perfmon2_bundle_init_fn_t) (vlib_main_t * vm,
						   struct perfmon2_bundle *);
typedef struct perfmon2_bundle
{
  ...
  perfmon2_bundle_init_fn_t *init_fn;
