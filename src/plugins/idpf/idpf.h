...
#define IDPF_TXD_OFFSET(x,factor,val)    (((u64)val/(u64)factor) << (16 + x))
...
clib_error_t * idpf_vc_create_vport (vlib_main_t *vm, idpf_device_t *id, idpf_vport_t *vport,
...
clib_error_t * idpf_vc_config_rxq (vlib_main_t *vm, idpf_device_t *id, idpf_vport_t *vport,
		    u16 qid);
clib_error_t * idpf_vc_config_txq (vlib_main_t *vm, idpf_device_t *id, idpf_vport_t *vport, u16 qid);
clib_error_t * idpf_op_enable_queues (vlib_main_t *vm, idpf_device_t *id, idpf_vport_t *vport,
