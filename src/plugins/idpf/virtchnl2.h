...
#define foreach_idpf_queue_type                                               \
  _ (0, TX, "tx")                                                             \
  _ (1, RX, "rx")                                                             \
  _ (2, TX_COMPLETION, "tx-completion")                                       \
  _ (3, RX_BUFFER, "rx-buffer")                                               \
  _ (4, CONFIG_TX, "config-tx")                                               \
  _ (5, CONFIG_RX, "config-rx")                                               \
  _ (6, P2P_TX, "p2p-tx")                                                     \
  _ (7, P2P_RX, "p2p-rx")                                                     \
  _ (8, P2P_TX_COMPLETION, "p2p-tx-completion")                               \
  _ (9, P2P_RX_BUFFER, "p2p-rx-buffer")                                       \
  _ (10, MBX_TX, "mbx-tx")                                                    \
  _ (11, MBX_RX, "mbx-rx")

typedef enum
{
#define _(a, b, c) VIRTCHNL2_QUEUE_TYPE_##b = (1 << a),
