...
struct virtchnl2_rx_flex_desc_nic_veb_dbg
{
  ...
  u16 status_error0;
  u16 l2tag1;
  u16 dst_vsi; /* [0:12]: destination vsi */
  /* 13: vsi valid bit */
  /* [14:15] are reserved */
  u16 flex_field_1;
...
struct virtchnl2_rx_flex_desc_nic_acl_dbg
{
  ...
  /* Qword 3 */
  u16 acl_ctr2;
  u16 rsvd; /* flex words 2-3 are reserved */
  u32 ts_high;
};
...
#ifndef EXTERNAL_RELEASE
  struct virtchnl2_rx_flex_desc_nic_veb_dbg flex_ver_dbg_wb;
  struct virtchnl2_rx_flex_desc_nic_acl_dbg flex_acl_dbg_wb;
#endif /* !EXTERNAL_RELEASE */
