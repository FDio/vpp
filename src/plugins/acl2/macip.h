...
// FIXME
struct _vl_api_macip2_rule;

extern int macip_add (u32 count,
		      struct _vl_api_macip2_rule *rules,
		      u32 * acl_list_index, u8 * tag);
extern int macip_del (u32 acl_list_index);

extern int macip_bind (u32 sw_if_index, u32 macip_acl_index);
