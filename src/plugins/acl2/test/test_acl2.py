...
from vpp_match import VppMatchMaskIpMac, VppMatchNTuple, VppMatchExactIpL4, \
    VppMatchSet, VppMatchRuleSets
...
class ACL2TestCase(VppTestCase):
    ...
    def test_n_tuple(self):
        ...
        #
        aces1 = [VppAce(self.PERMIT,
                        VppMatchNTuple("1.1.1.2/32",
                                       "1.1.1.1/32",
                                       self.UDP,
    ...
    def test_sets(self):
        ...
        for i in range(N_HOSTS):
            all_pg0.append(
                VppMatchExactIpL4(SRC,
                                  self.pg0.remote_hosts[i].ip4,
                                  self.UDP, 80))
            all_pg1.append(
                VppMatchExactIpL4(DST,
        ...
        for i in range(4):
            ...
            sets_pg0[i].remove_vpp_config()
            sets_pg1[i].remove_vpp_config()
