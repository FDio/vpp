...
#define  ARP_PLUGIN_VERSION_MAJOR 1
#define  ARP_PLUGIN_VERSION_MINOR 0

static void
vl_api_arp_plugin_get_version_t_handler (vl_api_arp_plugin_get_version_t * mp)
{
  vl_api_arp_plugin_get_version_reply_t *rmp;
  ...
  rmp->_vl_msg_id = ntohs (VL_API_ARP_PLUGIN_GET_VERSION_REPLY);
  rmp->context = mp->context;
  rmp->major = htonl (ARP_PLUGIN_VERSION_MAJOR);
  rmp->minor = htonl (ARP_PLUGIN_VERSION_MINOR);
