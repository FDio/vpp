			      ...
			      rdma_txq_t * txq)
{
  ...
  for (;;)
	...
	switch (op_own & 0x0f)
	  {
	  case 0:
	    vlib_error_count (vm, node->node_index, RDMA_TX_ERROR_COMPLETION0, 1);
	    break;
	  case 1:
	  ...
	  case 3:
	    ...
	    break;
	  case 4:
	    vlib_error_count (vm, node->node_index, RDMA_TX_ERROR_COMPLETION4, 1);
	    break;
	  case 5:
	    vlib_error_count (vm, node->node_index, RDMA_TX_ERROR_COMPLETION5, 1);
	    break;
	  case 6:
	    vlib_error_count (vm, node->node_index, RDMA_TX_ERROR_COMPLETION6, 1);
	    break;
	  case 7:
	    vlib_error_count (vm, node->node_index, RDMA_TX_ERROR_COMPLETION7, 1);
	    break;
	  case 8:
	    vlib_error_count (vm, node->node_index, RDMA_TX_ERROR_COMPLETION8, 1);
	    break;
	  case 9:
	    vlib_error_count (vm, node->node_index, RDMA_TX_ERROR_COMPLETION9, 1);
	    break;
	  case 10:
	    vlib_error_count (vm, node->node_index, RDMA_TX_ERROR_COMPLETION10, 1);
	    break;
	  case 11:
	    vlib_error_count (vm, node->node_index, RDMA_TX_ERROR_COMPLETION11, 1);
	    break;
	  case 12:
	    vlib_error_count (vm, node->node_index, RDMA_TX_ERROR_COMPLETION12, 1);
	    break;
	  case 13:
	    vlib_error_count (vm, node->node_index, RDMA_TX_ERROR_COMPLETION13, 1);
	    break;
	  case 14:
	    vlib_error_count (vm, node->node_index, RDMA_TX_ERROR_COMPLETION14, 1);
	    break;
	  case 15:
	    vlib_error_count (vm, node->node_index, RDMA_TX_ERROR_COMPLETION15, 1);
	    break;
	  default:
	    vlib_error_count (vm, node->node_index, RDMA_TX_ERROR_COMPLETIONX, 1);
	  }
      idx++;
