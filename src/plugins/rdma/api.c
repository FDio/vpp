...
vl_api_rdma_create_v2_t_handler (vl_api_rdma_create_v2_t * mp)
{
  ...
  args.disable_striding_rq = mp->disable_striding_rq;
  args.disable_legacy_chained_bufs = mp->disable_legacy_chained_bufs;
  args.max_pktlen_override = ntohs (mp->max_pktlen_override);
...
vl_api_rdma_create_t_handler (vl_api_rdma_create_t * mp)
{
  ...
  args.disable_legacy_chained_bufs = 0;
  args.max_pktlen_override = 0;
