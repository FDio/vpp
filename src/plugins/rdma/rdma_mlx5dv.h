...
#define CQE_FLAG_L4_HDR_TYPE_SHIFT	   (4)
#define CQE_FLAG_L4_HDR_TYPE_MASK	   (7 << CQE_FLAG_L4_HDR_TYPE_SHIFT)
#define CQE_FLAG_L4_HDR_TYPE(f)		   (((f) >> CQE_FLAG_L4_HDR_TYPE_SHIFT) & 7)
#define CQE_FLAG_L4_HDR_TYPE_TCP	   1
#define CQE_FLAG_L4_HDR_TYPE_UDP	   2
#define CQE_FLAG_L4_HDR_TYPE_TCP_EMPTY_ACK 3
#define CQE_FLAG_L4_HDR_TYPE_TCP_WITH_ACL  4
