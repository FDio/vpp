		       ...
		       const ip46_address_t *dst, u8 is_ip6)
{
  ...
  entry->is_ip6 = is_ip6;
  entry->timestamp = (u8) (vlib_time_now (vlib_get_main ()) / 60);
  entry->flags = L2FIB_ENTRY_RESULT_FLAG_NONE;
