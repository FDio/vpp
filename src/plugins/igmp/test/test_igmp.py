...
from vpp_pom.plugins.vpp_igmp import find_igmp_state, IGMP_FILTER, \
    IgmpRecord, IGMP_MODE, IgmpSG, VppHostState, wait_for_igmp_event
...
class TestIgmp(VppTestCase):
    ...
    def test_igmp_enable(self):
        ...
        self.vclient.igmp_enable_disable(
            self.pg0.sw_if_index, 1, IGMP_MODE.HOST)
        self.vclient.igmp_enable_disable(
            self.pg1.sw_if_index, 1, IGMP_MODE.HOST)
        ...
        self.vclient.igmp_enable_disable(
            self.pg2.sw_if_index, 1, IGMP_MODE.HOST)
        self.vclient.igmp_enable_disable(
            self.pg3.sw_if_index, 1, IGMP_MODE.HOST)
        ...
        self.assertTrue(find_mroute(self.vclient, "224.0.0.22", "0.0.0.0", 32,
                                    table_id=1))
        self.vclient.igmp_enable_disable(
            self.pg0.sw_if_index, 0, IGMP_MODE.HOST)
        self.vclient.igmp_enable_disable(
            self.pg1.sw_if_index, 0, IGMP_MODE.HOST)
        self.vclient.igmp_enable_disable(
            self.pg2.sw_if_index, 0, IGMP_MODE.HOST)
        self.vclient.igmp_enable_disable(
            self.pg3.sw_if_index, 0, IGMP_MODE.HOST)
    ...
    def test_igmp_proxy_device(self):
        ...
        self.vclient.igmp_proxy_device_add_del_interface(
            0, self.pg1.sw_if_index, 1)
        self.vclient.igmp_proxy_device_add_del_interface(
            0, self.pg2.sw_if_index, 1)
        ...
        self.verify_report(
            capture[0], [
                IgmpRecord(
                    IgmpSG(
                        "239.1.1.1", ["10.1.1.3"]), "Allow New Sources")])
        self.assertTrue(find_mroute(self.vclient, "239.1.1.1", "0.0.0.0", 32))
        ...
        self.verify_report(
            capture[0], [
                IgmpRecord(
                    IgmpSG(
                        "239.1.1.1", ["10.1.1.3"]), "Block Old Sources")])
        self.assertTrue(find_mroute(self.vclient, "239.1.1.1", "0.0.0.0", 32))
        ...
        self.verify_report(
            capture[0], [
                IgmpRecord(
                    IgmpSG(
                        "239.1.1.1", ["10.1.1.2"]), "Block Old Sources")])
        self.assertTrue(find_mroute(self.vclient, "239.1.1.1", "0.0.0.0", 32))
