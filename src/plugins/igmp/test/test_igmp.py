...
from vpp_igmp import IGMP_FILTER, IgmpRecord, IGMP_MODE, \
    IgmpSG, VppHostState, IgmpEvent, Igmp, VppIgmpProxyDevice
...
class TestIgmp(VppTestCase):
    ...
    def test_igmp_router(self):
        ...
        self.pg_enable_capture(self.pg_interfaces)
        self.pg_start()
        Igmp.enable_on_interface(self.pg0.sw_if_index, IGMP_MODE.ROUTER)
        IgmpEvent.subscribe()
        ...
        #
        Igmp.disable_on_interface(self.pg0.sw_if_index, IGMP_MODE.ROUTER)
    ...
    def test_igmp_proxy_device(self):
        ...
        # enable IGMP
        Igmp.enable_on_interface(self.pg0.sw_if_index)
        Igmp.enable_on_interface(self.pg1.sw_if_index, IGMP_MODE.ROUTER)
        Igmp.enable_on_interface(self.pg2.sw_if_index, IGMP_MODE.ROUTER)
        ...
        self.pg_enable_capture(self.pg_interfaces)
        Igmp.disable_on_interface(self.pg1.sw_if_index, IGMP_MODE.ROUTER)
        ...
        Igmp.disable_on_interface(self.pg0.sw_if_index)
        Igmp.disable_on_interface(self.pg2.sw_if_index, IGMP_MODE.ROUTER)
