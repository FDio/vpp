...
/* *INDENT-OFF* */
VNET_FEATURE_INIT (ip4_hyperscan_bypass, static) = {
  .arc_name = "ip4-unicast",
  .node_name = "ip4-hyperscan-bypass",
  .runs_before = VNET_FEATURES ("ip4-lookup"),
};

VNET_FEATURE_INIT (ip6_hyperscan_bypass, static) = {
  .arc_name = "ip6-unicast",
  .node_name = "ip6-hyperscan-bypass",
...
{
  if (is_ip6)
    vnet_feature_enable_disable ("ip6-unicast", "ip6-hyperscan-bypass",
                 sw_if_index, is_enable, 0, 0);
  else
    vnet_feature_enable_disable ("ip4-unicast", "ip4-hyperscan-bypass",
                 sw_if_index, is_enable, 0, 0);
}
...
VLIB_INIT_FUNCTION (hyperscan_init);

/* *INDENT-OFF* */
VLIB_PLUGIN_REGISTER () = {
    .version = VPP_BUILD_VER,
    .description = "Hyperscan",
};
/* *INDENT-ON* */
