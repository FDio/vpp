...
vnet_dev_rv_t avf_virtchnl_req (vlib_main_t *, vnet_dev_t *,
				avf_virtchnl_req_t *);
		   ...
		   virtchnl_version_info_t *resp)
{
  ...
  return avf_virtchnl_req (vm, dev, &vr);
}

static_always_inline vnet_dev_rv_t
avf_vc_op_reset_vf (vlib_main_t *vm, vnet_dev_t *dev)
{
  avf_virtchnl_req_t vr = {
...
static_always_inline vnet_dev_rv_t
avf_vc_op_del_eth_addr (vlib_main_t *vm, vnet_dev_t *dev,
			const virtchnl_ether_addr_list_t *req)
{
  avf_virtchnl_req_t vr = {
...
static_always_inline vnet_dev_rv_t
avf_vc_op_disable_vlan_stripping_v2 (vlib_main_t *vm, vnet_dev_t *dev,
