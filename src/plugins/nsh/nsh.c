...
nsh_init (vlib_main_t * vm)
{
  ...
  uword next_node;
  vlib_node_registration_t *vxlan4_input, *vxlan6_input, *vxlan4_gpe_input,
    *vxlan6_gpe_input;
  ...
  vxlan4_gpe_input =
    vlib_get_plugin_symbol ("vxlan_gpe_plugin.so", "vxlan4_gpe_input_node");
  vxlan6_gpe_input =
    vlib_get_plugin_symbol ("vxlan_gpe_plugin.so", "vxlan6_gpe_input_node");
