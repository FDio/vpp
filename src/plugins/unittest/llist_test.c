...
//static u8
//list_elt_is_sane (list_elt_t *pl, list_elt_t *e, list_elt_t *prev,
//                  list_elt_t *next)
//{
//  if (e->ll_test.next != next - pl || e->ll_test.prev != prev - pl)
//    return 0;
//  if (prev->ll_test.next != e - pl)
//    return 0;
//  if (next->ll_test.prev != e - pl)
//    return 0;
//  return 1;
//}
...
llist_test_basic (vlib_main_t * vm, unformat_input_t * input)
{
  ...
  LLIST_TEST (llist_is_empty (pelts, ll_test, e), "list should be empty");
