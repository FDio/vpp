...
UNITTEST_REGISTER_CRYPTO_TEST (aes_gmac128_aad8_async_tc0) = {
  .name = "128-GMAC Async TC0 [aad8]",
  .alg = VNET_CRYPTO_ALG_AES_128_NULL_GMAC_ICV16_AAD8,
  .key = TEST_DATA_STR ("\x00\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0a\x0b\x0c\x0d\x0e\x0f"),
  .iv = TEST_DATA_STR ("\x10\x11\x12\x13\x14\x15\x16\x17\x18\x19\x1a\x1b"),
  .aad = TEST_DATA_STR ("\x20\x21\x22\x23\x24\x25\x26\x27"),
  .tag = TEST_DATA_STR ("\xd5\xc4\x8d\xc5\x6e\x79\x84\x8d\x6a\xaf\xee\xb4\xa4\x62\xad\xfb"),
};

UNITTEST_REGISTER_CRYPTO_TEST (aes_gmac128_aad12_async_tc0) = {
  .name = "128-GMAC Async TC0 [aad12]",
  .alg = VNET_CRYPTO_ALG_AES_128_NULL_GMAC_ICV16_AAD12,
  .key = TEST_DATA_STR ("\x00\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0a\x0b\x0c\x0d\x0e\x0f"),
  .iv = TEST_DATA_STR ("\x30\x31\x32\x33\x34\x35\x36\x37\x38\x39\x3a\x3b"),
  .aad = TEST_DATA_STR ("\x40\x41\x42\x43\x44\x45\x46\x47\x48\x49\x4a\x4b"),
  .tag = TEST_DATA_STR ("\x2e\x11\x7b\xf1\x8c\x15\x0f\xaa\x21\xa1\x4e\x3a\xbc\x07\x82\xda"),
};

UNITTEST_REGISTER_CRYPTO_TEST (aes_gmac192_aad8_async_tc0) = {
  .name = "192-GMAC Async TC0 [aad8]",
  .alg = VNET_CRYPTO_ALG_AES_192_NULL_GMAC_ICV16_AAD8,
  .key = TEST_DATA_STR ("\x00\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0a\x0b\x0c\x0d\x0e\x0f\x10\x11"
			"\x12\x13\x14\x15\x16\x17"),
  .iv = TEST_DATA_STR ("\x50\x51\x52\x53\x54\x55\x56\x57\x58\x59\x5a\x5b"),
  .aad = TEST_DATA_STR ("\x60\x61\x62\x63\x64\x65\x66\x67"),
  .tag = TEST_DATA_STR ("\x7f\xf0\x1c\xa6\xfe\xd2\xd4\xf5\xe3\x29\x97\x86\x5e\xab\xdf\xd8"),
};

UNITTEST_REGISTER_CRYPTO_TEST (aes_gmac192_aad12_async_tc0) = {
  .name = "192-GMAC Async TC0 [aad12]",
  .alg = VNET_CRYPTO_ALG_AES_192_NULL_GMAC_ICV16_AAD12,
  .key = TEST_DATA_STR ("\x00\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0a\x0b\x0c\x0d\x0e\x0f\x10\x11"
			"\x12\x13\x14\x15\x16\x17"),
  .iv = TEST_DATA_STR ("\x70\x71\x72\x73\x74\x75\x76\x77\x78\x79\x7a\x7b"),
  .aad = TEST_DATA_STR ("\x80\x81\x82\x83\x84\x85\x86\x87\x88\x89\x8a\x8b"),
  .tag = TEST_DATA_STR ("\x16\xbe\x04\x6d\x8d\x34\xa0\x35\x77\x4f\x7a\x78\xde\xed\xbf\xc2"),
};

UNITTEST_REGISTER_CRYPTO_TEST (aes_gmac256_aad8_async_tc0) = {
  .name = "256-GMAC Async TC0 [aad8]",
  .alg = VNET_CRYPTO_ALG_AES_256_NULL_GMAC_ICV16_AAD8,
  .key = TEST_DATA_STR ("\x00\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0a\x0b\x0c\x0d\x0e\x0f\x10\x11"
			"\x12\x13\x14\x15\x16\x17\x18\x19\x1a\x1b\x1c\x1d\x1e\x1f"),
  .iv = TEST_DATA_STR ("\x90\x91\x92\x93\x94\x95\x96\x97\x98\x99\x9a\x9b"),
  .aad = TEST_DATA_STR ("\xa0\xa1\xa2\xa3\xa4\xa5\xa6\xa7"),
  .tag = TEST_DATA_STR ("\xd0\x61\xe6\xac\x07\xfe\x2c\xd6\xf6\x81\xad\x68\x95\x7e\x55\x96"),
};

UNITTEST_REGISTER_CRYPTO_TEST (aes_gmac256_aad12_async_tc0) = {
  .name = "256-GMAC Async TC0 [aad12]",
  .alg = VNET_CRYPTO_ALG_AES_256_NULL_GMAC_ICV16_AAD12,
  .key = TEST_DATA_STR ("\x00\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0a\x0b\x0c\x0d\x0e\x0f\x10\x11"
			"\x12\x13\x14\x15\x16\x17\x18\x19\x1a\x1b\x1c\x1d\x1e\x1f"),
  .iv = TEST_DATA_STR ("\xb0\xb1\xb2\xb3\xb4\xb5\xb6\xb7\xb8\xb9\xba\xbb"),
  .aad = TEST_DATA_STR ("\xc0\xc1\xc2\xc3\xc4\xc5\xc6\xc7\xc8\xc9\xca\xcb"),
  .tag = TEST_DATA_STR ("\x4d\xc4\xdc\xaa\x76\x4a\x2b\xb3\x20\x59\x0b\x39\xf3\x27\x93\x14"),
};
