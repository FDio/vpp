...
/* *INDENT-OFF* */
UNITTEST_REGISTER_CRYPTO_TEST (aes_128_cbc_enc) = {
  .name = "NIST SP 800-38A",
  .alg = VNET_CRYPTO_ALG_AES_128_CBC,
  .op = VNET_CRYPTO_OP_ENCRYPT,
  .iv = iv,
  .key = key128,
  .data = plaintext,
  .expected = ciphertext128,
  .length = sizeof (plaintext),
};

UNITTEST_REGISTER_CRYPTO_TEST (aes_128_cbc_dec) = {
  .name = "NIST SP 800-38A",
  .alg = VNET_CRYPTO_ALG_AES_128_CBC,
  .op = VNET_CRYPTO_OP_DECRYPT,
  .iv = iv,
  .key = key128,
  .data = ciphertext128,
  .expected = plaintext,
...
/* *INDENT-OFF* */
UNITTEST_REGISTER_CRYPTO_TEST (aes_192_cbc_enc) = {
  .name = "NIST SP 800-38A",
  ...
  .key = key192,
  .data = plaintext,
  .expected = ciphertext192,
  .length = sizeof (plaintext),
};

UNITTEST_REGISTER_CRYPTO_TEST (aes_192_cbc_dec) = {
  .name = "NIST SP 800-38A",
  .alg = VNET_CRYPTO_ALG_AES_192_CBC,
  .op = VNET_CRYPTO_OP_DECRYPT,
  .iv = iv,
...
/* *INDENT-OFF* */
UNITTEST_REGISTER_CRYPTO_TEST (aes_256_cbc_enc) = {
  .name = "NIST SP 800-38A",
  ...
  .key = key256,
  .data = plaintext,
  .expected = ciphertext256,
  .length = sizeof (plaintext),
};

UNITTEST_REGISTER_CRYPTO_TEST (aes_256_cbc_dec) = {
  .name = "NIST SP 800-38A",
  .alg = VNET_CRYPTO_ALG_AES_256_CBC,
  .op = VNET_CRYPTO_OP_DECRYPT,
  .iv = iv,
