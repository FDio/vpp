...
#include "unity_internals.h"
   ...
   * the test runner generator will create them. resetTest will run teardown
   * and setup again, verifying any end-of-test needs between. verifyTest will
 ...
 * nothing fails. This method allows you to abort a test immediately with a
 * PASS state, ignoring the remainder of the test. */
...
#define TEST_ASSERT_BIT_HIGH(bit, actual)                                     \
  UNITY_TEST_ASSERT_BITS (((UNITY_UINT) 1 << (bit)), (UNITY_UINT) (-1),       \
			  (actual), __LINE__, NULL)
#define TEST_ASSERT_BIT_LOW(bit, actual)                                      \
  UNITY_TEST_ASSERT_BITS (((UNITY_UINT) 1 << (bit)), (UNITY_UINT) (0),        \
			  (actual), __LINE__, NULL)
...
#define TEST_ASSERT_UINT8_ARRAY_WITHIN(delta, expected, actual, num_elements) \
  UNITY_TEST_ASSERT_UINT8_ARRAY_WITHIN ((delta), (expected), (actual),        \
					num_elements, __LINE__, NULL)
#define TEST_ASSERT_UINT16_ARRAY_WITHIN(delta, expected, actual,              \
					num_elements)                         \
  UNITY_TEST_ASSERT_UINT16_ARRAY_WITHIN ((delta), (expected), (actual),       \
					 num_elements, __LINE__, NULL)
#define TEST_ASSERT_UINT32_ARRAY_WITHIN(delta, expected, actual,              \
					num_elements)                         \
...
#define TEST_ASSERT_UINT64_ARRAY_WITHIN(delta, expected, actual,              \
  ...
  UNITY_TEST_ASSERT_UINT64_ARRAY_WITHIN ((delta), (expected), (actual),       \
					 num_elements, __LINE__, NULL)
#define TEST_ASSERT_size_t_ARRAY_WITHIN(delta, expected, actual,              \
					num_elements)                         \
  UNITY_TEST_ASSERT_UINT_ARRAY_WITHIN ((delta), (expected), (actual),         \
				       num_elements, __LINE__, NULL)
...
#define TEST_ASSERT_DOUBLE_ARRAY_WITHIN(delta, expected, actual,              \
					num_elements)                         \
...
#define TEST_ASSERT_NOT_EQUAL_INT16_MESSAGE(threshold, actual, message)       \
  UNITY_TEST_ASSERT_NOT_EQUAL_INT16 ((threshold), (actual), __LINE__,         \
				     (message))
#define TEST_ASSERT_NOT_EQUAL_INT32_MESSAGE(threshold, actual, message)       \
  UNITY_TEST_ASSERT_NOT_EQUAL_INT32 ((threshold), (actual), __LINE__,         \
				     (message))
#define TEST_ASSERT_NOT_EQUAL_INT64_MESSAGE(threshold, actual, message)       \
  UNITY_TEST_ASSERT_NOT_EQUAL_INT64 ((threshold), (actual), __LINE__,         \
				     (message))
...
#define TEST_ASSERT_NOT_EQUAL_UINT8_MESSAGE(threshold, actual, message)       \
  UNITY_TEST_ASSERT_NOT_EQUAL_UINT8 ((threshold), (actual), __LINE__,         \
				     (message))
#define TEST_ASSERT_NOT_EQUAL_UINT16_MESSAGE(threshold, actual, message)      \
  UNITY_TEST_ASSERT_NOT_EQUAL_UINT16 ((threshold), (actual), __LINE__,        \
				      (message))
#define TEST_ASSERT_NOT_EQUAL_UINT32_MESSAGE(threshold, actual, message)      \
  UNITY_TEST_ASSERT_NOT_EQUAL_UINT32 ((threshold), (actual), __LINE__,        \
				      (message))
#define TEST_ASSERT_NOT_EQUAL_UINT64_MESSAGE(threshold, actual, message)      \
  UNITY_TEST_ASSERT_NOT_EQUAL_UINT64 ((threshold), (actual), __LINE__,        \
				      (message))
...
#define TEST_ASSERT_NOT_EQUAL_HEX16_MESSAGE(threshold, actual, message)       \
  UNITY_TEST_ASSERT_NOT_EQUAL_HEX16 ((threshold), (actual), __LINE__,         \
				     (message))
#define TEST_ASSERT_NOT_EQUAL_HEX32_MESSAGE(threshold, actual, message)       \
  UNITY_TEST_ASSERT_NOT_EQUAL_HEX32 ((threshold), (actual), __LINE__,         \
				     (message))
#define TEST_ASSERT_NOT_EQUAL_HEX64_MESSAGE(threshold, actual, message)       \
  UNITY_TEST_ASSERT_NOT_EQUAL_HEX64 ((threshold), (actual), __LINE__,         \
				     (message))
...
#define TEST_ASSERT_GREATER_THAN_MESSAGE(threshold, actual, message)          \
  UNITY_TEST_ASSERT_GREATER_THAN_INT ((threshold), (actual), __LINE__,        \
				      (message))
...
#define TEST_ASSERT_LESS_THAN_MESSAGE(threshold, actual, message)             \
  UNITY_TEST_ASSERT_SMALLER_THAN_INT ((threshold), (actual), __LINE__,        \
				      (message))
...
#define TEST_ASSERT_GREATER_OR_EQUAL_INT8_MESSAGE(threshold, actual, message) \
  UNITY_TEST_ASSERT_GREATER_OR_EQUAL_INT8 ((threshold), (actual), __LINE__,   \
					   (message))
#define TEST_ASSERT_GREATER_OR_EQUAL_INT16_MESSAGE(threshold, actual,         \
						   message)                   \
  UNITY_TEST_ASSERT_GREATER_OR_EQUAL_INT16 ((threshold), (actual), __LINE__,  \
					    (message))
#define TEST_ASSERT_GREATER_OR_EQUAL_INT32_MESSAGE(threshold, actual,         \
						   message)                   \
  UNITY_TEST_ASSERT_GREATER_OR_EQUAL_INT32 ((threshold), (actual), __LINE__,  \
					    (message))
#define TEST_ASSERT_GREATER_OR_EQUAL_INT64_MESSAGE(threshold, actual,         \
						   message)                   \
  UNITY_TEST_ASSERT_GREATER_OR_EQUAL_INT64 ((threshold), (actual), __LINE__,  \
					    (message))
#define TEST_ASSERT_GREATER_OR_EQUAL_UINT_MESSAGE(threshold, actual, message) \
  UNITY_TEST_ASSERT_GREATER_OR_EQUAL_UINT ((threshold), (actual), __LINE__,   \
					   (message))
#define TEST_ASSERT_GREATER_OR_EQUAL_UINT8_MESSAGE(threshold, actual,         \
						   message)                   \
  UNITY_TEST_ASSERT_GREATER_OR_EQUAL_UINT8 ((threshold), (actual), __LINE__,  \
					    (message))
...
#define TEST_ASSERT_GREATER_OR_EQUAL_HEX8_MESSAGE(threshold, actual, message) \
  UNITY_TEST_ASSERT_GREATER_OR_EQUAL_HEX8 ((threshold), (actual), __LINE__,   \
					   (message))
#define TEST_ASSERT_GREATER_OR_EQUAL_HEX16_MESSAGE(threshold, actual,         \
						   message)                   \
  UNITY_TEST_ASSERT_GREATER_OR_EQUAL_HEX16 ((threshold), (actual), __LINE__,  \
					    (message))
#define TEST_ASSERT_GREATER_OR_EQUAL_HEX32_MESSAGE(threshold, actual,         \
						   message)                   \
  UNITY_TEST_ASSERT_GREATER_OR_EQUAL_HEX32 ((threshold), (actual), __LINE__,  \
					    (message))
#define TEST_ASSERT_GREATER_OR_EQUAL_HEX64_MESSAGE(threshold, actual,         \
						   message)                   \
  UNITY_TEST_ASSERT_GREATER_OR_EQUAL_HEX64 ((threshold), (actual), __LINE__,  \
					    (message))
...
#define TEST_ASSERT_EQUAL_UINT8_ARRAY_MESSAGE(expected, actual, num_elements, \
  ...
  UNITY_TEST_ASSERT_EQUAL_UINT8_ARRAY ((expected), (actual), (num_elements),  \
				       __LINE__, (message))
#define TEST_ASSERT_EQUAL_UINT16_ARRAY_MESSAGE(expected, actual,              \
					       num_elements, message)         \
  UNITY_TEST_ASSERT_EQUAL_UINT16_ARRAY ((expected), (actual), (num_elements), \
					__LINE__, (message))
#define TEST_ASSERT_EQUAL_UINT32_ARRAY_MESSAGE(expected, actual,              \
					       num_elements, message)         \
  UNITY_TEST_ASSERT_EQUAL_UINT32_ARRAY ((expected), (actual), (num_elements), \
					__LINE__, (message))
#define TEST_ASSERT_EQUAL_UINT64_ARRAY_MESSAGE(expected, actual,              \
					       num_elements, message)         \
  UNITY_TEST_ASSERT_EQUAL_UINT64_ARRAY ((expected), (actual), (num_elements), \
					__LINE__, (message))
#define TEST_ASSERT_EQUAL_size_t_ARRAY_MESSAGE(expected, actual,              \
					       num_elements, message)         \
  UNITY_TEST_ASSERT_EQUAL_UINT_ARRAY ((expected), (actual), (num_elements),   \
				      __LINE__, (message))
...
#define TEST_ASSERT_EQUAL_PTR_ARRAY_MESSAGE(expected, actual, num_elements,   \
  ...
  UNITY_TEST_ASSERT_EQUAL_PTR_ARRAY ((expected), (actual), (num_elements),    \
				     __LINE__, (message))
#define TEST_ASSERT_EQUAL_STRING_ARRAY_MESSAGE(expected, actual,              \
					       num_elements, message)         \
  UNITY_TEST_ASSERT_EQUAL_STRING_ARRAY ((expected), (actual), (num_elements), \
					__LINE__, (message))
...
#define TEST_ASSERT_GREATER_THAN_FLOAT_MESSAGE(threshold, actual, message)    \
  UNITY_TEST_ASSERT_GREATER_THAN_FLOAT ((threshold), (actual), __LINE__,      \
					(message))
#define TEST_ASSERT_GREATER_OR_EQUAL_FLOAT_MESSAGE(threshold, actual,         \
						   message)                   \
  UNITY_TEST_ASSERT_GREATER_OR_EQUAL_FLOAT ((threshold), (actual), __LINE__,  \
					    (message))
#define TEST_ASSERT_LESS_THAN_FLOAT_MESSAGE(threshold, actual, message)       \
  UNITY_TEST_ASSERT_LESS_THAN_FLOAT ((threshold), (actual), __LINE__,         \
				     (message))
...
#define TEST_ASSERT_NOT_EQUAL_DOUBLE_MESSAGE(expected, actual, message)       \
  UNITY_TEST_ASSERT_NOT_EQUAL_DOUBLE ((expected), (actual), __LINE__,         \
				      (message))
#define TEST_ASSERT_DOUBLE_ARRAY_WITHIN_MESSAGE(delta, expected, actual,      \
						num_elements, message)        \
  UNITY_TEST_ASSERT_DOUBLE_ARRAY_WITHIN ((delta), (expected), (actual),       \
					 (num_elements), __LINE__, (message))
#define TEST_ASSERT_EQUAL_DOUBLE_ARRAY_MESSAGE(expected, actual,              \
					       num_elements, message)         \
  UNITY_TEST_ASSERT_EQUAL_DOUBLE_ARRAY ((expected), (actual), (num_elements), \
					__LINE__, (message))
...
#define TEST_ASSERT_LESS_THAN_DOUBLE_MESSAGE(threshold, actual, message)      \
  UNITY_TEST_ASSERT_LESS_THAN_DOUBLE ((threshold), (actual), __LINE__,        \
				      (message))
