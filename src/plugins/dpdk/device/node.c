...
static_always_inline void
dpdk_mbuf_to_vlib_buffer_x4 (vlib_main_t * vm, struct rte_mbuf **mb,
			     u32 * buffers, vlib_buffer_t ** b)
{
#ifdef CLIB_HAVE_VEC256
  ...
  /* write 4 vlib_buffer_t pointers back to memory */
  *(u64x4 *) b = v;
  ...
  while ((n_left + 8) < n_rx_packets)
    {
      ...
      dpdk_mbuf_to_vlib_buffer_x4 (vm, mb, buffers, b);
      buffers += 4;
