...
dpdk_device_configure_flow_offload (dpdk_device_t *xd)
{
  ...
  if (xd->flags & DPDK_DEVICE_FLAG_FLOW_OFFLOAD)
    return;
  ...
  dpdk_device_flag_set (xd, DPDK_DEVICE_FLAG_FLOW_OFFLOAD, 1);
  ...
  dpdk_device_flag_set (xd, DPDK_DEVICE_FLAG_FLOW_OFFLOAD, 0);
