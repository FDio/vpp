...
typedef struct
{
  ...
  i32 program_vlans : 1;
  i32 mq_mode_none : 1;
  i32 port_type_from_link_speed : 1;
  i32 port_type_from_capa : 1;
} dpdk_driver_t;
...
typedef struct
{
  ...
  i8 cpu_socket;
    ...
    u64 supported_tx_off;
    u64 supported_rx_off;
    u64 supported_rss_off;
    u64 enabled_tx_off;
    u64 enabled_rx_off;
...
typedef struct
{
  ...
  dpdk_port_conf_t default_dev_conf;
