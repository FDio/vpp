...
#define RTE_VLAN_HLEN 4
	...
	xd->conf.enable_rxq_int = 0;
      ...
      xd->async_flow_offload_n_queues = max_pow2 (devconf->async_flow_offload_n_queues);
      xd->async_flow_offload_queue_size = max_pow2 (devconf->async_flow_offload_queue_size);
      if (devconf->async_flow_offload_queue_batch)
	xd->async_flow_offload_queue_batch = max_pow2 (devconf->async_flow_offload_queue_batch);
      else
