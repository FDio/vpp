...
/*static*/ void
cryptodev_key_handler (vnet_crypto_key_op_t kop, vnet_crypto_key_handler_args_t a)
{
  vnet_crypto_key_index_t idx = (vnet_crypto_key_index_t) (uword) a.per_thread_key_data;
