				      ...
				      u32 n_jobs, cryptodev_op_type_t op_type)
{
  ...
  n_to_enqueue = clib_min (CRYPTODEV_NB_CRYPTO_OPS - cet->inflight, n_jobs);
  if (n_to_enqueue == 0)
    return 0;
