...
static u64
abf_itf_attach_mk_key(u32 abf_index,
                      u32 sw_if_index)
{
  u64 key;
...
abf_itf_attach_db_find (u32 abf_index,
                        u32 sw_if_index)
{
  uword *p;
  u64 key;
...
static void
abf_itf_attach_db_add (u32 abf_index,
                       u32 sw_if_index,
...
static void
abf_itf_attach_db_del (u32 abf_index,
                       u32 sw_if_index)
{
  u64 key;
...
static int
abf_cmp_attach_for_sort (void *v1,
                         void *v2)
{
            ...
            u32 sw_if_index)
{
   ...
   */
  fib_node_child_remove(abf_fib_node_type,
                        aia->aia_abf,
                        aia->aia_sibling);
