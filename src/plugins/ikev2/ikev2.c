...
static u32
ikev2_mk_local_sa_id (u32 ci, u32 ti)
{
  return (0x80000000 | (ti << 16) | ci);
}

static u32
ikev2_mk_remote_sa_id (u32 ci, u32 ti)
{
  return (0xc0000000 | (ti << 16) | ci);
}
			       ...
			       u32 child_index)
{
  ...
  child->local_sa_id =
    a.local_sa_id = ikev2_mk_local_sa_id (child_index, thread_index);
  child->remote_sa_id =
    a.remote_sa_id = ikev2_mk_remote_sa_id (child_index, thread_index);
