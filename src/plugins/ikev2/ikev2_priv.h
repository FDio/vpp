...
void ikev2_parse_vendor_payload (vlib_buffer_t * b);
ikev2_sa_proposal_t *ikev2_parse_sa_payload (vlib_buffer_t * b);
ikev2_ts_t *ikev2_parse_ts_payload (vlib_buffer_t * b);
ikev2_delete_t *ikev2_parse_delete_payload (vlib_buffer_t * b);
ikev2_notify_t *ikev2_parse_notify_payload (vlib_buffer_t * b);
