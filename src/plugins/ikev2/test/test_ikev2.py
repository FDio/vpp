...
class TestApi(VppTestCase):
    ...
    def verify_transforms(self, api_ts, cfg_ts):
        self.assertEqual(api_ts.crypto_alg, cfg_ts['crypto'])
        self.assertEqual(api_ts.crypto_key_size, cfg_ts['key_size'])
        self.assertEqual(api_ts.integ_alg, cfg_ts['integ'])

    def verify_ike_transforms(self, api_ts, cfg_ts):
        self.verify_transforms(api_ts, cfg_ts)
        self.assertEqual(api_ts.dh_group, cfg_ts['dh'])
