...
u32 http_write_transport (http_conn_t *hc, u8 *data, u32 length);
int http_transport_data_peek (http_conn_t *hc, u8 *rx_buf);
...
always_inline void
http_transport_data_drop (http_conn_t *hc, u32 len)
{
  session_t *ts;
...
always_inline void
http_transport_data_drop_all (http_conn_t *hc)
{
  session_t *ts;
...
always_inline void
http_app_drain_all (http_req_t *req)
{
