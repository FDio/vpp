...
always_inline http_header_table_t *
http_alloc_header_table ()
{
 ...
 * @param header_table Allocated header table (@c http_alloc_header_table ).
 *
 * @note If reusing already allocated header table use
 * @c http_reset_header_table first.
 */
always_inline void
http_build_header_table (u8 *buf, uword headers_ctx, http_header_table_t *ht)
{
  u8 *name;
  http_header_ht_t *header;
