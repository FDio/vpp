...
static int
http_connect_stream (u64 parent_handle, u32 opaque, u32 *req_index)
{
  session_t *hs;
...
static int
http_transport_connect_stream (transport_endpoint_cfg_t *tep, u32 *conn_index)
{
  session_endpoint_cfg_t *sep = (session_endpoint_cfg_t *) tep;

  return http_connect_stream (sep->parent_handle, sep->opaque, conn_index);
}
