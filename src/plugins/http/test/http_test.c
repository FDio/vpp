...
//
//   url = format (0,
//   "https://example.org/.well-known/masque/udp/1.2.3.4/123/"); rv =
//   http_parse_absolute_form (url, vec_len (url), &parsed_url); HTTP_TEST
//   ((rv == 0), "'%v' should be valid", url); HTTP_TEST ((parsed_url.scheme
...
//   HTTP_TEST (
//     (parsed_url.path_len == strlen
//     (".well-known/masque/udp/1.2.3.4/123/")), "path_len=%u should be %u",
...
//   HTTP_TEST ((clib_net_to_host_u16 (parsed_url.port) == 443),
//	     "port=%u should be 443", clib_net_to_host_u16 (parsed_url.port));
//   HTTP_TEST ((parsed_url.path_offset == strlen
//   ("https://[dead:beef::1234]/")),
//	     "path_offset=%u should be %u", parsed_url.path_offset,
