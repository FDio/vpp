...
#undef TEST
  ...
  static u8 *(*_format_hpack_dynamic_table) (u8 * s, va_list * args);

  _format_hpack_dynamic_table =
    vlib_get_plugin_symbol ("http_plugin.so", "format_hpack_dynamic_table");
