...
class TestURPF(VppTestCase):
    """ Unicat Reverse Path Forwarding Test Case """
    ...
    def test_urpf4(self):
        ...
        self.send_and_expect(self.pg0, p_good * N_PKTS, self.pg1)
        # packets from address for which there is a route are forwarded
        self.send_and_expect(self.pg0, p_spoof_strict * N_PKTS, self.pg1)
        # packets from address to which there is no route are dropped
        self.send_and_assert_no_replies(self.pg0, p_spoof_loose * N_PKTS)
        ...
        self.send_and_assert_no_replies(self.pg0, p_spoof_strict * N_PKTS)
        self.send_and_assert_no_replies(self.pg0, p_spoof_loose * N_PKTS)
