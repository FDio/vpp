...
static const char *urpf_feats[N_AF][VLIB_N_DIR][URPF_N_MODES] =
{
  [AF_IP4] = {
    [VLIB_RX] = {
      ...
      [URPF_MODE_CUSTOM_VRF] = "ip4-rx-urpf-custom_vrf",
    },
    [VLIB_TX] = {
      [URPF_MODE_STRICT] = "ip4-tx-urpf-strict",
      [URPF_MODE_LOOSE] = "ip4-tx-urpf-loose",
      [URPF_MODE_CUSTOM_VRF] = "ip4-tx-urpf-custom_vrf",
    },
  },
  [AF_IP6] = {
    [VLIB_RX] = {
      ...
      [URPF_MODE_CUSTOM_VRF] = "ip6-rx-urpf-custom_vrf",
    },
    [VLIB_TX] = {
      [URPF_MODE_STRICT] = "ip6-tx-urpf-strict",
      [URPF_MODE_LOOSE] = "ip6-tx-urpf-loose",
      [URPF_MODE_CUSTOM_VRF] = "ip6-tx-urpf-custom_vrf",
    },
  },
};
/* *INDENT-ON* */
