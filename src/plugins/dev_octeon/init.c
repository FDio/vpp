...
#include <dev_octeon/roc_helper.h>
...
{
  oct_plt_init_param_t param;
  int rv;

  memset (&param, 0, sizeof (param));
  param.oct_plt_log_reg_class = vlib_log_register_class;
  param.oct_plt_log = oct_plt_log;
  param.oct_plt_free = oct_plt_free;
  param.oct_plt_zmalloc = oct_plt_zmalloc;
  param.oct_plt_memzone_free = oct_plt_memzone_free;
  param.oct_plt_memzone_lookup = oct_plt_memzone_lookup;
  param.oct_plt_memzone_reserve_aligned = oct_plt_memzone_reserve_aligned;
  param.oct_plt_spinlock_init = oct_plt_spinlock_init;
  param.oct_plt_spinlock_lock = oct_plt_spinlock_lock;
  param.oct_plt_spinlock_unlock = oct_plt_spinlock_unlock;
  param.oct_plt_spinlock_trylock = oct_plt_spinlock_trylock;
  param.oct_plt_get_thread_index = oct_plt_get_thread_index;

  rv = oct_plt_init (&param);
  if (rv)
