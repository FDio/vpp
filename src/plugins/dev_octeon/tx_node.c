	      ...
	      vlib_buffer_t **b, u32 n_pkts, int trace)
{
  ...
  for (n_left = n_pkts; n_left >= 8; n_left -= 8, b += 8)
	...
	{
	  int simple = 1;
	  oct_tx_enq1 (vm, ctx, b[0], l, f0, simple, trace, &n);
	  oct_tx_enq1 (vm, ctx, b[1], l + n, f1, simple, trace, &n);
	  vlib_prefetch_buffer_header (b[13], LOAD);
	  oct_tx_enq1 (vm, ctx, b[2], l + n, f2, simple, trace, &n);
	  oct_tx_enq1 (vm, ctx, b[3], l + n, f3, simple, trace, &n);
	  vlib_prefetch_buffer_header (b[14], LOAD);
	  oct_tx_enq1 (vm, ctx, b[4], l + n, f4, simple, trace, &n);
	  oct_tx_enq1 (vm, ctx, b[5], l + n, f5, simple, trace, &n);
	  vlib_prefetch_buffer_header (b[15], LOAD);
	  oct_tx_enq1 (vm, ctx, b[6], l + n, f6, simple, trace, &n);
	  oct_tx_enq1 (vm, ctx, b[7], l + n, f7, simple, trace, &n);
	...
	{
	  int simple = 0;
	  dpl[n] = oct_tx_enq1 (vm, ctx, b[0], l, f0, simple, trace, &n);
	  dpl[n] = oct_tx_enq1 (vm, ctx, b[1], l + n, f1, simple, trace, &n);
	  vlib_prefetch_buffer_header (b[13], LOAD);
	  dpl[n] = oct_tx_enq1 (vm, ctx, b[2], l + n, f2, simple, trace, &n);
	  dpl[n] = oct_tx_enq1 (vm, ctx, b[3], l + n, f3, simple, trace, &n);
	  vlib_prefetch_buffer_header (b[14], LOAD);
	  dpl[n] = oct_tx_enq1 (vm, ctx, b[4], l + n, f4, simple, trace, &n);
	  dpl[n] = oct_tx_enq1 (vm, ctx, b[5], l + n, f5, simple, trace, &n);
	  vlib_prefetch_buffer_header (b[15], LOAD);
	  dpl[n] = oct_tx_enq1 (vm, ctx, b[6], l + n, f6, simple, trace, &n);
	  dpl[n] = oct_tx_enq1 (vm, ctx, b[7], l + n, f7, simple, trace, &n);
	}
      dpl += n;
      l += n;
      n = 0;
  ...
  for (; n_left > 0; n_left -= 1, b += 1)
    {
      u32 f0 = b[0]->flags;
      dpl[0] = oct_tx_enq1 (vm, ctx, b[0], l, f0, 0, trace, &n);
      or_flags_16 |= f0;
      dpl += n;
      l += n;
      n = 0;
