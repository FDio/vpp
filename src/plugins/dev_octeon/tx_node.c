...
oct_pkts_send_x4 (vlib_main_t *vm, struct roc_nix_sq *sq, u64 aura_handle,
		  vlib_buffer_t *b0, vlib_buffer_t *b1, vlib_buffer_t *b2,
		  vlib_buffer_t *b3)
{
  ...
  n_dwords[0] +=
    oct_add_send_hdr (send_hdr0, b0, aura_handle, sq_handle, n_dwords[0]);
  n_dwords[1] +=
    oct_add_send_hdr (send_hdr1, b1, aura_handle, sq_handle, n_dwords[1]);
  n_dwords[2] +=
    oct_add_send_hdr (send_hdr2, b2, aura_handle, sq_handle, n_dwords[2]);
  n_dwords[3] +=
    oct_add_send_hdr (send_hdr3, b3, aura_handle, sq_handle, n_dwords[3]);
...
void static_always_inline
oct_pkts_send_x1 (vlib_main_t *vm, struct roc_nix_sq *sq, u64 aura_handle,
		  vlib_buffer_t *b0)
{
  u64 lmt_arg, core_lmt_base_addr, core_lmt_id, sq_handle;
  u32 desc_sz = 10 /* Worst case - Send hdr + Two SG with 3 segs each */;
...
oct_pkts_send_tm (vlib_main_t *vm, vlib_node_runtime_t *node,
