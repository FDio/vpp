/* 
 * geneve_pcapng_show.c - PCAPNG file reader and packet display for GENEVE plugin
 *
...
static clib_error_t *
geneve_pcapng_show_command_fn (vlib_main_t * vm,
...
VLIB_CLI_COMMAND (geneve_pcapng_show_command, static) = {
  .path = "show geneve pcapng capture",
  .short_help = "show geneve pcapng capture <filename> [max-packets <count>] [verbose]",
  .function = geneve_pcapng_show_command_fn,
};
