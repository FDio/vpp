...
static void
gpcapng_output_init (gpcapng_main_t *gpm)
{
  // FIXME HERE
...
static clib_error_t *
gpcapng_output_command_fn (vlib_main_t * vm,
                               unformat_input_t * input,
                               vlib_cli_command_t * cmd)
{
  unformat_input_t _line_input, *line_input = &_line_input;
...
VLIB_CLI_COMMAND (gpcapng_output_command, static) = {
  .path = "gpcapng output",
  .short_help = "gpcapng output [file]",
  .function = gpcapng_output_command_fn,
};
