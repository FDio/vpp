...
bio_dtls_read (BIO* b, char* out, int outl) {
  ...
  rv = app_recv_dgram_raw (s->rx_fifo, (u8 *) out, outl, &at, 0 /* clear evt */,
                           0 /* peek */);
...
//  s->tx_fifo, &s->transport, s->vpp_evt_q, data,
...
bio_dtls_ctrl (BIO *b, int cmd, long larg, void *parg)
{
  ...
  switch (cmd)
    ...
    case BIO_CTRL_DGRAM_SET_MTU:
      ret = 0;
      clib_warning ("requested mtu %u", larg);
      break;
    case BIO_CTRL_DGRAM_SET_NEXT_TIMEOUT:
      ret = 0;
      clib_warning ("requested timeout %u", larg);
      break;
...
///* *INDENT-OFF* */
//const BIO_METHOD methods_dtlsp = {
//    BIO_TYPE_SOCKET,    "dtls_bio",
//    bio_dtls_write,    bio_dtls_read,
//    0 /* puts */, 0 /* gets, */,
//    bio_dtls_ctrl,     bio_dtls_new,
//    bio_dtls_free,     0 /* callback_ctrl */,
//};
///* *INDENT-ON* */
//
//const BIO_METHOD*
  ...
  if (!dtls_bio_method)
    {
      ...
      BIO_meth_set_create (dtls_bio_method, bio_dtls_new);
