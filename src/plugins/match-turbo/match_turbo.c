...
const static match_engine_vft_t mc_vft_first = {
  ...
  .mev_list_actions = {
    [MATCH_ENGINE_LIST_ADD] = match_turbo_list_action_mask_n_tuple,
    [MATCH_ENGINE_LIST_REPLACE] = match_turbo_list_action_mask_n_tuple,
    [MATCH_ENGINE_LIST_DELETE] = match_turbo_list_action_mask_n_tuple,
  },
};
/* *INDENT-ON* */
