 ...
 * @return error code
 */
extern index_t filter_chain_create_and_lock (index_t fti, const u8 *name,
					     dpo_proto_t dproto,
...
extern index_t filter_chain_rule_append (index_t fci, const u8 *name,
...
extern void filter_chain_child_add (index_t fci, index_t child_index,
				    filter_node_t *node);
