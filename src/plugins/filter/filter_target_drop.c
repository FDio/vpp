...
{
  filter_target_drop_type =
    dpo_register_new_type (&filter_target_drop_vft, filter_target_drop_nodes);
...
static clib_error_t *
filter_target_drop_show (vlib_main_t *vm, unformat_input_t *input,
