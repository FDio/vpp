...
/**
 * A sorted list of index_t an call back is invoked if the ifrst or list
 * element of the list is changed
 */

struct filter_list_t_;

typedef void (*filter_list_update_t) (index_t owner, index_t front, void *ctx);
typedef void (*filter_list_update_prev_t) (index_t owner, index_t prev,
