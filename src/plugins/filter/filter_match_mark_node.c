...
always_inline uword
filter_match_mark_inline (vlib_main_t *vm, vlib_node_runtime_t *node,
			  vlib_frame_t *frame)
{
...
VLIB_NODE_FN (filter_match_mark_mark4_node)
(vlib_main_t *vm, vlib_node_runtime_t *node, vlib_frame_t *frame)
{
  return (filter_match_mark_inline (vm, node, frame));
}

VLIB_NODE_FN (filter_match_mark_mark6_node)
(vlib_main_t *vm, vlib_node_runtime_t *node, vlib_frame_t *frame)
{
  return (filter_match_mark_inline (vm, node, frame));
}
