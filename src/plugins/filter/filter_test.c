...
filter_test (void)
{
   ...
   */
  FILTER_TEST_RV (filter_table_update (ft_name_1, DPO_PROTO_IP4, 2, &fti_1),
		  "Create Table 1");
  ...
  FILTER_TEST_RV (
    filter_table_chain_add (fti_1, fc_name_1_1, FILTER_HOOK_INPUT,
			    FILTER_CHAIN_POLICY_ACCEPT, 2, &fci_1_1),
  ...
  /* the jump should push the terminate since there are no more chains nor
   * tables */
  ...
  FILTER_TEST_RV (
    filter_table_chain_add (fti_1, fc_name_1_2, FILTER_HOOK_INPUT,
			    FILTER_CHAIN_POLICY_ACCEPT, 10, &fci_1_2),
  ...
  FILTER_TEST (
    0 == dpo_cmp (&ftj_c_1_2->ftj_push, filter_chain_jump_dpo_get (fci_1_1)),
  ...
  /*
   * add a thrid chain with a precedence in between the 2 that exist at the
   * input hook with an accept policy
   */
  u8 *fc_name_1_3 = format (NULL, "chain_1_3");
  index_t fci_1_3;

  FILTER_TEST_RV (
    filter_table_chain_add (fti_1, fc_name_1_3, FILTER_HOOK_INPUT,
			    FILTER_CHAIN_POLICY_ACCEPT, 7, &fci_1_3),
  ...
  ftj_c_1_2 = filter_target_jump_get (ftji_c_1_2);
  FILTER_TEST (
    0 == dpo_cmp (&ftj_c_1_2->ftj_push, filter_chain_jump_dpo_get (fci_1_3)),
    "jump 2 pushes next chain");
  ...
  const ip46_address_t ip = { .ip4 = {
				.as_u32 = clib_host_to_net_u32 (0xc0c0c0c0),
			      } };
  index_t fri_1_2_1;

  FILTER_TEST_RV (filter_match_ip_add_and_lock (
		    DPO_PROTO_IP4, FILTER_MATCH_SRC, &ip, &match_1_2_1),
		  "match create error");
  FILTER_TEST_RV (
    filter_target_drop_add_and_lock (DPO_PROTO_IP4, &target_1_2_1),
    "drop target create error");

  FILTER_TEST_RV (filter_table_rule_append (fti_1, fc_name_1_2, fr_name_1_2_1,
					    &match_1_2_1, &target_1_2_1,
					    &fri_1_2_1),
  ...
  FILTER_TEST (
    filter_target_is_return (&fmi_1_2_1->fmi_base.fm_results[FILTER_MATCH_NO]),
    "match 1 false jumps to chain terminator");
  FILTER_TEST (0 == dpo_cmp (&fmi_1_2_1->fmi_base.fm_results[FILTER_MATCH_YES],
			     &target_1_2_1),
  ...
  FILTER_TEST_RV (filter_match_ip_add_and_lock (
		    DPO_PROTO_IP4, FILTER_MATCH_SRC, &ip, &match_1_2_2),
		  "match create error");
  FILTER_TEST_RV (
    filter_target_drop_add_and_lock (DPO_PROTO_IP4, &target_1_2_2),
    "drop target create error");

  FILTER_TEST_RV (filter_table_rule_append (fti_1, fc_name_1_2, fr_name_1_2_2,
					    &match_1_2_2, &target_1_2_2,
					    &fri_1_2_2),
  ...
  FILTER_TEST (
    filter_target_is_return (&fmi_1_2_2->fmi_base.fm_results[FILTER_MATCH_NO]),
    "match 2 false jumps to chain terminator");
  FILTER_TEST (0 == dpo_cmp (&fmi_1_2_2->fmi_base.fm_results[FILTER_MATCH_YES],
			     &target_1_2_2),
  ...
  FILTER_TEST_RV (
    filter_table_chain_add (fti_1, fc_name_1_4, FILTER_HOOK_BRANCH,
			    FILTER_CHAIN_POLICY_ACCEPT, ~0, &fci_1_4),
  ...
  FILTER_TEST_RV (filter_match_ip_add_and_lock (
		    DPO_PROTO_IP4, FILTER_MATCH_SRC, &ip, &match_1_2_3),
		  "match create error");
  FILTER_TEST_RV (
    filter_target_jump_add_and_lock (DPO_PROTO_IP4, fci_1_4, &target_1_2_3),
    "jump target create error");

  FILTER_TEST_RV (filter_table_rule_append (fti_1, fc_name_1_2, fr_name_1_2_3,
					    &match_1_2_3, &target_1_2_3,
					    &fri_1_2_3),
  ...
  FILTER_TEST (
    filter_target_is_return (&fmi_1_2_3->fmi_base.fm_results[FILTER_MATCH_NO]),
    "match 3 false jumps to chain terminator");
  FILTER_TEST (0 == dpo_cmp (&fmi_1_2_3->fmi_base.fm_results[FILTER_MATCH_YES],
			     &target_1_2_3),
  ...
  FILTER_TEST_RV (filter_match_ip_add_and_lock (
		    DPO_PROTO_IP4, FILTER_MATCH_SRC, &ip, &match_1_4_1),
		  "match create error");
  FILTER_TEST_RV (
    filter_target_drop_add_and_lock (DPO_PROTO_IP4, &target_1_4_1),
    "drop target create error");

  FILTER_TEST_RV (filter_table_rule_append (fti_1, fc_name_1_4, fr_name_1_4_1,
					    &match_1_4_1, &target_1_4_1,
					    &fri_1_4_1),
  ...
  FILTER_TEST (
    filter_target_is_accept (&fmi_1_4_1->fmi_base.fm_results[FILTER_MATCH_NO]),
    "match 3 false jumps to chain terminator");
  FILTER_TEST (0 == dpo_cmp (&fmi_1_4_1->fmi_base.fm_results[FILTER_MATCH_YES],
			     &target_1_4_1),
   ...
   * cleanup
   */
  FILTER_TEST_RV (filter_table_rule_delete (fti_1, fc_name_1_2, fr_name_1_2_1),
		  "remove rule 1, chain 2, table 1");
  FILTER_TEST_RV (filter_table_rule_delete (fti_1, fc_name_1_2, fr_name_1_2_2),
		  "remove rule 2, chain 2, table 1");
  FILTER_TEST_RV (filter_table_rule_delete (fti_1, fc_name_1_2, fr_name_1_2_3),
		  "remove rule 3, chain 2, table 1");
  FILTER_TEST_RV (filter_table_rule_delete (fti_1, fc_name_1_4, fr_name_1_4_1),
  ...
  FILTER_TEST (0 == filter_rule_n_elts (), "filter rule pool empty: %d",
	       filter_rule_n_elts ());
  FILTER_TEST (0 == filter_chain_n_elts (), "filter chain pool empty: %d",
	       filter_chain_n_elts ());
...
static clib_error_t *
filter_test_cli (vlib_main_t *vm, unformat_input_t *input,
...
VLIB_CLI_COMMAND (test_filter_command, static) = {
  .path = "test filter",
  .short_help = "filter unit tests - DO NOT RUN ON A LIVE SYSTEM",
  .function = filter_test_cli,
};
