...
pipe_determine_next_node (ethernet_main_t *em, u32 is_l20, u32 type0, vlib_buffer_t *b0,
...
pipe_rx (vlib_main_t *vm, vlib_node_runtime_t *node, vlib_frame_t *from_frame)
{
  ...
  if (node->flags & VLIB_NODE_FLAG_TRACE)
    vlib_trace_frame_buffers_only (vm, node, from, n_left_from, sizeof (from[0]),
...
int
vnet_create_pipe_interface (u8 is_specified, u32 user_instance, u32 *parent_sw_if_index,
