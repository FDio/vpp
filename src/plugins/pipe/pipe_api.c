...
#include <pipe/pipe.api_enum.h>
#include <pipe/pipe.api_types.h>
...
vl_api_pipe_create_t_handler (vl_api_pipe_create_t *mp)
{
  ...
  rv =
    vnet_create_pipe_interface (is_specified, user_instance, &parent_sw_if_index, pipe_sw_if_index);
...
static walk_rc_t
pipe_send_details (u32 parent_sw_if_index, u32 pipe_sw_if_index[2], u32 instance, void *args)
{
