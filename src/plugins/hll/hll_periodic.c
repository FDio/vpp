...
void hll_create_periodic_process (hll_main_t *hmp)
{
  ...
  hmp->periodic_node_index = vlib_process_create (hmp->vlib_main,
    "hll-periodic-process",
    hll_periodic_process, 16 /* log2_n_stack_bytes */);
}
