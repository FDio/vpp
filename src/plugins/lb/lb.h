...
#define lb_vip_is_gre4_sticky(vip) (((vip)->type == LB_VIP_TYPE_IP6_GRE4 \
                            || (vip)->type == LB_VIP_TYPE_IP4_GRE4) \
                            && ((vip)->port == 0) \
                            && lb_vip_is_src_ip_sticky(vip))

#define lb_vip_is_gre6_sticky(vip) (((vip)->type == LB_VIP_TYPE_IP6_GRE6 \
                            || (vip)->type == LB_VIP_TYPE_IP4_GRE6) \
                            && ((vip)->port == 0) \
                            && lb_vip_is_src_ip_sticky(vip))

#define lb_vip_is_gre4_port_sticky(vip) (((vip)->type == LB_VIP_TYPE_IP6_GRE4 \
                                 || (vip)->type == LB_VIP_TYPE_IP4_GRE4) \
                                 && ((vip)->port != 0) \
                                 && lb_vip_is_src_ip_sticky(vip))

#define lb_vip_is_gre6_port_sticky(vip) (((vip)->type == LB_VIP_TYPE_IP6_GRE6 \
                                 || (vip)->type == LB_VIP_TYPE_IP4_GRE6) \
                                 && ((vip)->port != 0) \
                                 && lb_vip_is_src_ip_sticky(vip))
...
{
  return (vip->type == LB_VIP_TYPE_IP4_L3DSR && vip->port == 0 && !lb_vip_is_src_ip_sticky(vip));
}
...
{
  return (vip->type == LB_VIP_TYPE_IP4_NAT4 && vip->port != 0 && !lb_vip_is_src_ip_sticky(vip));
}
always_inline bool
lb_vip_is_nat6_port(const lb_vip_t *vip)
{
  return (vip->type == LB_VIP_TYPE_IP6_NAT6 && vip->port != 0 && !lb_vip_is_src_ip_sticky(vip));
}
