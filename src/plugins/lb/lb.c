  ...
  vec_foreach(ip, to_be_added) {
    ...
    *as_index = as - lbm->ass;
	...
	m_key4.fib_index = 0;
        ...
        m->node_ip_is_ipv6 = 0;
        m->as_ip_is_ipv6 = 0;
        m->port = vip->encap_args.port;
        m->node_port = vip->encap_args.node_port;
	...
	m_key6.fib_index = 0;
        ...
        m->vip.ip6.as_u64[0] = vip->prefix.ip6.as_u64[0];
        m->vip.ip6.as_u64[1] = vip->prefix.ip6.as_u64[1];
        m->node_ip.ip6.as_u64[0] = 0;
        m->node_ip.ip6.as_u64[1] = 0;
