...
const static char * const lb_dpo_gre4_ip4_sticky[] = { "lb4-gre4-sticky" , NULL };
const static char * const lb_dpo_gre4_ip6_sticky[] = { "lb6-gre4-sticky" , NULL };
...
const static char * const lb_dpo_gre6_ip4_sticky[] = { "lb4-gre6-sticky" , NULL };
const static char * const lb_dpo_gre6_ip6_sticky[] = { "lb6-gre6-sticky" , NULL };
...
const static char * const lb_dpo_gre4_ip4_port_sticky[] = { "lb4-gre4-port-sticky" , NULL };
const static char * const lb_dpo_gre4_ip6_port_sticky[] = { "lb6-gre4-port-sticky" , NULL };
const static char* const * const lb_dpo_gre4_port_sticky_nodes[DPO_PROTO_NUM] =
    {
        [DPO_PROTO_IP4]  = lb_dpo_gre4_ip4_port_sticky,
        [DPO_PROTO_IP6]  = lb_dpo_gre4_ip6_port_sticky,
    };

const static char * const lb_dpo_gre6_ip4_port_sticky[] = { "lb4-gre6-port-sticky" , NULL };
const static char * const lb_dpo_gre6_ip6_port_sticky[] = { "lb6-gre6-port-sticky" , NULL };
const static char* const * const lb_dpo_gre6_port_sticky_nodes[DPO_PROTO_NUM] =
    {
        [DPO_PROTO_IP4]  = lb_dpo_gre6_ip4_port_sticky,
        [DPO_PROTO_IP6]  = lb_dpo_gre6_ip6_port_sticky,
    };

const static char * const lb_dpo_l3dsr_ip4_sticky[] = {"lb4-l3dsr-sticky" , NULL};
const static char* const * const lb_dpo_l3dsr_sticky_nodes[DPO_PROTO_NUM] =
    {
        [DPO_PROTO_IP4]  = lb_dpo_l3dsr_ip4_sticky,
    };

const static char * const lb_dpo_l3dsr_ip4_port_sticky[] = {"lb4-l3dsr-port-sticky" , NULL};
const static char* const * const lb_dpo_l3dsr_port_sticky_nodes[DPO_PROTO_NUM] =
    {
        [DPO_PROTO_IP4]  = lb_dpo_l3dsr_ip4_port_sticky,
    };

const static char * const lb_dpo_nat4_ip4_port_sticky[] = { "lb4-nat4-port-sticky" , NULL };
const static char* const * const lb_dpo_nat4_port_sticky_nodes[DPO_PROTO_NUM] =
    {
        [DPO_PROTO_IP4]  = lb_dpo_nat4_ip4_port_sticky,
    };

const static char * const lb_dpo_nat6_ip6_port_sticky[] = { "lb6-nat6-port-sticky" , NULL };
const static char* const * const lb_dpo_nat6_port_sticky_nodes[DPO_PROTO_NUM] =
    {
...
lb_init (vlib_main_t * vm)
{
  ...
  lbm->dpo_gre4_sticky_type = dpo_register_new_type(&lb_vft,
                                                    lb_dpo_gre4_sticky_nodes);
  lbm->dpo_gre6_sticky_type = dpo_register_new_type(&lb_vft,
                                                    lb_dpo_gre6_sticky_nodes);
  lbm->dpo_gre4_port_sticky_type = dpo_register_new_type(&lb_vft,
                                                         lb_dpo_gre4_port_sticky_nodes);
  lbm->dpo_gre6_port_sticky_type = dpo_register_new_type(&lb_vft,
                                                         lb_dpo_gre6_port_sticky_nodes);
  lbm->dpo_l3dsr_sticky_type = dpo_register_new_type(&lb_vft,
                                                     lb_dpo_l3dsr_sticky_nodes);
  lbm->dpo_l3dsr_port_sticky_type = dpo_register_new_type(&lb_vft,
                                                          lb_dpo_l3dsr_port_sticky_nodes);
  lbm->dpo_nat4_port_sticky_type = dpo_register_new_type(&lb_vft,
                                                         lb_dpo_nat4_port_sticky_nodes);
  lbm->dpo_nat6_port_sticky_type = dpo_register_new_type(&lb_vft,
                                                         lb_dpo_nat6_port_sticky_nodes);
