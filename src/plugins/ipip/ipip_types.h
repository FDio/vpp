 ...
 */
typedef int (*ipip_add_tunnel_fn_t) (ipip_transport_t transport, u32 instance, ip46_address_t *src,
...
typedef ipip_tunnel_t *(*ipip_tunnel_db_find_fn_t) (const ipip_tunnel_key_t *key);
