...
#define igc_reg_srrctl_t_fields                                               \
  __ (7, bsizepacket)                                                         \
  __ (1, _reserved7)                                                          \
  __ (6, bsizeheader)                                                         \
  __ (2, timer1_sel)                                                          \
...
#define igc_reg_rxdctl_t_fields                                               \
  __ (5, pthresh)                                                             \
  __ (3, _reserved5)                                                          \
  __ (5, hthresh)                                                             \
  __ (3, _reserved13)                                                         \
...
IGC_REG_STRUCT (igc_reg_srrctl_t);
IGC_REG_STRUCT (igc_reg_rxdctl_t);
...
#define foreach_igc_reg                                                       \
  ...
  _ (0x0c004, RDBAH0, )                                                       \
  _ (0x0c008, RDLEN0, )                                                       \
  _ (0x0c00c, SRRCTL0, igc_reg_srrctl_t_fields)                               \
  _ (0x0c010, RDH0, )                                                         \
  _ (0x0c018, RDT0, )                                                         \
  _ (0x0c028, RXDCTL0, igc_reg_rxdctl_t_fields)                               \
  _ (0x12010, EEC, igc_reg_eec_t_fields)                                      \
  _ (0x12030, EEMNGCTL, igc_reg_eemngctl_t_fields)

#define IGC_REG_RDBAL(n)  (IGC_REG_RDBAL0 + (n) *0x40)
#define IGC_REG_RDBAH(n)  (IGC_REG_RDBAH0 + (n) *0x40)
#define IGC_REG_RDLEN(n)  (IGC_REG_RDLEN0 + (n) *0x40)
#define IGC_REG_SRRCTL(n) (IGC_REG_SRRCTL0 + (n) *0x40)
#define IGC_REG_RDH(n)	  (IGC_REG_RDH0 + (n) *0x40)
#define IGC_REG_RDT(n)	  (IGC_REG_RDT0 + (n) *0x40)
#define IGC_REG_RXDCTL(n) (IGC_REG_RXDCTL0 + (n) *0x40)
#define IGC_REG_SRRCTL(n) (IGC_REG_SRRCTL0 + (n) *0x40)
