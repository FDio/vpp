...
#define HSI_TCP_TRACKED_ACTION_CONSUME HSI_TRACKED_ACTION_CONSUME
...
#define HSI_UDP_TRACKED_ACTION_CONSUME HSI_TRACKED_ACTION_CONSUME
...
int hsi_udp_try_complete_drain (udp_connection_t *uc);
				   ...
				   void *ip_hdr, udp_header_t *udp_hdr, u8 is_ip4)
{
  ...
  if (!hsi_udp_try_complete_drain (uc))
