...
typedef enum hsi_tcp_tracked_action_
{
  HSI_TCP_TRACKED_ACTION_INPUT,
  HSI_TCP_TRACKED_ACTION_FORWARD,
  HSI_TCP_TRACKED_ACTION_DROP,
  ...
  if (state != TCP_STATE_CLOSED)
    {
      ...
      return HSI_TCP_TRACKED_ACTION_INPUT;
    }
