...
typedef enum hsi_test_peer_rpc_fail_op_
{
  HSI_TEST_PEER_RPC_FAIL_NONE,
  HSI_TEST_PEER_RPC_FAIL_COMMIT,
  HSI_TEST_PEER_RPC_FAIL_DRAIN_START,
  HSI_TEST_PEER_RPC_FAIL_PEER_UPDATE,
} hsi_test_peer_rpc_fail_op_t;
...
typedef struct hsi_main_
{
  ...
  transport_proto_t test_peer_rpc_fail_proto;
  hsi_test_peer_rpc_fail_op_t test_peer_rpc_fail_op;
  u8 test_peer_rpc_fail_once;
