...
typedef struct
{
  u64 key[5];
  u64 value[4];
} clib_bihash_kv_40_32_t;

static inline int
clib_bihash_is_free_40_32 (const clib_bihash_kv_40_32_t * v)
{
...
static inline u64
clib_bihash_hash_40_32 (const clib_bihash_kv_40_32_t * v)
{
...
static inline u8 *
format_bihash_kvp_40_32 (u8 * s, va_list * args)
{
  clib_bihash_kv_40_32_t *v = va_arg (*args, clib_bihash_kv_40_32_t *);
...
static inline int
clib_bihash_key_compare_40_32 (u64 * a, u64 * b)
{
...
#endif /* __included_bihash_40_32_h__ */
