...
typedef struct calico_translation_t_
{
  ...
  /**
   * The vip object this translation belongs on
   */
  index_t ct_vipi;
 ...
 * @param proto the translation proto
 */
extern void calico_remove_translation (index_t cvipi, u16 port,
				       ip_protocol_t proto);
