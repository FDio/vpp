...
#ifndef __CALICO_SNAT_H__
#define __CALICO_SNAT_H__

#include <calico/calico_types.h>

always_inline int
calico_search_snat_prefix (ip46_address_t * addr, ip_address_family_t af)
{
...
extern int calico_add_snat_prefix (ip_prefix_t * pfx);
extern int calico_del_snat_prefix (ip_prefix_t * pfx);
