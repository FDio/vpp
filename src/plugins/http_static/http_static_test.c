...
api_http_static_enable (vat_main_t * vam)
{
  ...
  vl_api_to_api_string(strnlen((const char *) www_root, 256), www_root, (vl_api_string_t *) &mp->www_root);
  vl_api_to_api_string(strnlen((const char *) uri, 256), uri, (vl_api_string_t *) &mp->uri);
