...
_(http_static_enable_disable_reply)
...
_(HTTP_STATIC_ENABLE_DISABLE_REPLY, http_static_enable_disable_reply)


static int
api_http_static_enable_disable (vat_main_t * vam)
{
  ...
  M (HTTP_STATIC_ENABLE_DISABLE, mp);
...
_(http_static_enable_disable, "<intfc> [disable]")
