...
static void
vl_api_http_static_get_reply_t_handler (vl_api_http_static_get_reply_t *mp)
{
}

static int
api_http_static_get (vat_main_t *vam)
{
  vl_api_http_static_get_t *mp;
  int ret;

  M (HTTP_STATIC_GET, mp);
  /* send it... */
  S (mp);
...
static int
api_http_static_disable (vat_main_t *vam)
{
  vl_api_http_static_disable_t *mp;
  int ret;

  M (HTTP_STATIC_DISABLE, mp);
  /* send it... */
  S (mp);
