...
typedef union hss_url_handler_args_
{
  /* Request args */
  struct
  {
...
{
  HSS_URL_HANDLER_RC_OK,
  HSS_URL_HANDLER_RC_ASYNC,
  HSS_URL_HANDLER_RC_NOT_FOUND
} hss_url_handler_rc_t;

typedef int (*hss_url_handler_fn) (hss_url_handler_args_t *);
