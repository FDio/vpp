  ...
  if (~0 != sw_if_index)
    {
      ...
      /*
       * FIB Path Weight of 0 is meaningless and replaced with 1 further along. See fib_path_create.
       * fib_path_cmp_w_route_path would fail to match such a fib_route_path_t with any fib_path_t,
       * because a fib_path_t's fp_weight can never be 0.
       */
