			   ...
			   u32 context)
{
  ...
  REPLY_MACRO_DETAILS4 (
    VL_API_LCP_ITF_PAIR_DETAILS, rp, context, ({
      rmp->phy_sw_if_index = htonl (lcp_pair->lip_phy_sw_if_index);
      rmp->host_sw_if_index = htonl (lcp_pair->lip_host_sw_if_index);
      rmp->vif_index = htonl (lcp_pair->lip_vif_index);
