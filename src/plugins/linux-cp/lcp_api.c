...
static void
send_lcp_itf_pair_details (vl_api_registration_t *reg, u32 context,
			   lcp_itf_pair_t *lcp_pair)
{
  ...
  clib_strncpy ((char *) mp->host_if_name, (char *) lcp_pair->lip_host_name,
		vec_len (lcp_pair->lip_host_name) - 1);

  clib_strncpy ((char *) mp->namespace, (char *) lcp_pair->lip_namespace,
