...
static session_t *
upf_session_lookup_listener4 (u32 fib_index, ip4_address_t * lcl,
...
static session_t *
upf_session_lookup_listener6 (u32 fib_index, ip6_address_t * lcl,
...
proxy_server_listen (u32 fib_index, int is_ip4)
{
  ...
  *cfg = (session_endpoint_cfg_t) SESSION_ENDPOINT_CFG_NULL;
  ...
  table_index =
    session_lookup_get_index_for_fib (fib_ip_proto (!is_ip4), fib_index);
