...
//       return;
//     }
//   if ((rv = app_worker_connect_notify (app_wrk, 0, err,
//   ctx->client_opaque)))
...
quic_quicly_connection_closed (quic_ctx_t *ctx)
{
  ...
  switch (ctx->conn_state)
    ...
    case QUIC_CONN_STATE_HANDSHAKE:
      ...
      //       quic_quicly_notify_app_connect_failed (ctx,
...
//   QUIC_DBG (2, "Allocated quic session 0x%lx", session_handle
//   (quic_session)); ctx->c_s_index = quic_session->session_index;
