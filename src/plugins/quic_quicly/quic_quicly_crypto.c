					      ...
					      quic_ctx_t *ctx)
{
  ...
  /* key[0]: ckpair(32b) | verify_cfg(8b @bits31:24) | profile(16b @bits23:8) | engine(8b)
   * profile_index ~0 (no profile) maps to 0xFFFF, which is safe because pool
   * indices are always much smaller than 65535. */
