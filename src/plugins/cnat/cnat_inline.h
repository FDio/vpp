...
cnat_timestamp_alloc (u32 fib_index, bool is_v6)
{
  ...
  vec_validate_init_empty_aligned (ctm->sessions_per_vrf_ip4, fib_index, ctm->max_sessions_per_vrf,
				   CLIB_CACHE_LINE_BYTES);
  vec_validate_init_empty_aligned (ctm->sessions_per_vrf_ip6, fib_index, ctm->max_sessions_per_vrf,
				   CLIB_CACHE_LINE_BYTES);
