...
static u32
cnat_buffer_set_alloc_free_callback (vlib_main_t *vm, u8 buffer_pool_index, u32 *buffers,
				     u32 n_buffers)
{
  u32 i;
  vlib_buffer_t *b;
...
{
  vlib_buffer_set_alloc_free_callback (vm, cnat_buffer_set_alloc_free_callback, 0);
  cnat_main_t *cm = &cnat_main;
