...
#define CTS_DPOI_NEXT_UNSET (u16) ~0
#define CTS_DPOI_NEXT_DROP  0
...
typedef struct cnat_timestamp_mpool_t_
{
  ...
  /* A CNAT flow is an allocated timestamp. The reserved timestamp at index
   * zero is not included. */
  u64 active_flows;
  u64 active_flows_by_class[CNAT_N_FLOW_CLASSES];
