...
STATIC_ASSERT (CNAT_TRANSLATION_ALLOC_PORT == CNAT_TR_FLAG_ALLOCATE_PORT,
	       "cnat api enum mismatch");
STATIC_ASSERT (CNAT_TRANSLATION_NO_RETURN_SESSION ==
		 CNAT_TR_FLAG_NO_RETURN_SESSION,
	       "cnat api enum mismatch");

STATIC_ASSERT (CNAT_EPT_NO_NAT == CNAT_TRK_FLAG_NO_NAT,
	       "cnat api enum mismatch");

STATIC_ASSERT (CNAT_LB_TYPE_DEFAULT == CNAT_LB_DEFAULT,
	       "cnat api enum mismatch");
STATIC_ASSERT (CNAT_LB_TYPE_MAGLEV == CNAT_LB_MAGLEV,
	       "cnat api enum mismatch");

STATIC_ASSERT (CNAT_POLICY_INCLUDE_V4 == CNAT_SNAT_IF_MAP_INCLUDE_V4,
	       "cnat api enum mismatch");
STATIC_ASSERT (CNAT_POLICY_INCLUDE_V6 == CNAT_SNAT_IF_MAP_INCLUDE_V6,
	       "cnat api enum mismatch");
STATIC_ASSERT (CNAT_POLICY_POD == CNAT_SNAT_IF_MAP_INCLUDE_POD,
	       "cnat api enum mismatch");

STATIC_ASSERT (CNAT_POLICY_NONE == CNAT_SNAT_POLICY_NONE,
	       "cnat api enum mismatch");
STATIC_ASSERT (CNAT_POLICY_IF_PFX == CNAT_SNAT_POLICY_IF_PFX,
	       "cnat api enum mismatch");
STATIC_ASSERT (CNAT_POLICY_K8S == CNAT_SNAT_POLICY_K8S,
	       "cnat api enum mismatch");
