...
void
cnat_k8s_snat_policy (vlib_main_t * vm,
		      vlib_buffer_t * b,
	       ...
	       unformat_input_t * input, vlib_cli_command_t * cmd)
{
  ...
  vlib_cli_output (vm, "cnat k8s snat: sw_if %d enable %d ip6 %d",
		   sw_if_index, is_enable, is_ip6);
...
static clib_error_t *
cnat_k8s_show_snat (vlib_main_t * vm,
		    unformat_input_t * input, vlib_cli_command_t * cmd)
{
  u8 *s;
  int i;
...
static clib_error_t *
cnat_k8s_show_pods (vlib_main_t * vm,
		    unformat_input_t * input, vlib_cli_command_t * cmd)
{
  u8 *s;
  int i;
...
static clib_error_t *
cnat_k8s_show_pod_cidrs (vlib_main_t * vm,
			 unformat_input_t * input, vlib_cli_command_t * cmd)
{
  u8 *s;
  ip_prefix_t *pfx;
