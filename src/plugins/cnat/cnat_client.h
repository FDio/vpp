...
typedef struct cnat_client_t_
{
  ...
  /* Forward scope (used to look up SNAT policy & port allocator) */
  u32 fwd_scope_id;
...
extern void cnat_client_free_by_ip (const ip46_address_t *ip, u32 fib_index, int is_session);
