...
extern void cnat_client_free_by_ip (ip4_address_t *ip4, ip6_address_t *ip6,
				    u8 af, u32 fib_index, int is_session);
...
extern index_t cnat_client_add_pfx (const ip_address_t *pfx, u8 pfx_len,
				    u32 fib_index, u8 flags);
