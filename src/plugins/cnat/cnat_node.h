		    ...
		    bool alloc_if_not_found)
{
  ...
  while (n_left >= 4)
      ...
      if (cnat_sub != NULL)
	{
      ...
      if (n_left >= 8)
	{
	  cnat_make_buffer_5tuple (b[4], af, (cnat_5tuple_t *) &bkey[0], 0, 0, 0);
	  cnat_make_buffer_5tuple (b[5], af, (cnat_5tuple_t *) &bkey[1], 0, 0, 0);
	  cnat_make_buffer_5tuple (b[6], af, (cnat_5tuple_t *) &bkey[2], 0, 0, 0);
	  cnat_make_buffer_5tuple (b[7], af, (cnat_5tuple_t *) &bkey[3], 0, 0, 0);
