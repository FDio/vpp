 ...
 */
extern void cnat_session_delete (u32 session_index);

/**
 * Scan the session DB for expired sessions
 */
extern u64 cnat_session_scan (vlib_main_t *vm, f64 start_time, int i,
			      int *to_delete_now, int *to_delete_next,
			      int *del_now_count, int *del_next_count);
 ...
 */
extern void (*cnat_free_port_cb) (u32 fib_index, u16 port,
