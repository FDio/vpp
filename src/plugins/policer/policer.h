...
{
  policer_get_main_fn_t *fn = (policer_get_main_fn_t *) vlib_get_plugin_symbol (
    "policer_plugin.so", "policer_get_main");
  if (!fn)
    return 0;
  return fn ();
}
...
{
  policer_get_counters_fn_t *fn =
    (policer_get_counters_fn_t *) vlib_get_plugin_symbol (
