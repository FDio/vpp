...
always_inline void
acl_fill_5tuple_l4_and_finish (acl_main_t * am, u32 lc_index0, vlib_buffer_t * b0, const int is_ip6, const int l4_offset, const u16 proto, fa_5tuple_t * p5tuple_pkt)
{
  int l4_valid = acl_fill_tuple_l4(am, b0, proto, is_ip6 ? IP_PROTOCOL_ICMP6:IP_PROTOCOL_ICMP, p5tuple_pkt);
