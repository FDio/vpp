...
{
  acl_main_t *am = &acl_main;
  *r_acl_pos_p = 0; // FIXME-FIXME
  if (am->use_hash_acl_matching) {
    return hash_multi_acl_match_5tuple(lc_index, (fa_5tuple_t *)pkt_5tuple, is_ip6,
                                 r_acl_match_p, r_rule_match_p, trace_bitmap);
  } else {
    return linear_multi_acl_match_5tuple(lc_index, (fa_5tuple_t *)pkt_5tuple, is_ip6,
                                 r_acl_match_p, r_rule_match_p, trace_bitmap);
  }
}
