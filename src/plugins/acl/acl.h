...
#undef _
  ...
  /* callbacks */
  void (**acl_add_list_cbs) (struct acl_main_t *, u32 acl_list_index, int before_or_after);
  void (**acl_del_list_cbs) (struct acl_main_t *, u32 acl_list_index, int before_or_after);
} acl_main_t;
