...
#define ACL_FA_DEFAULT_HEAP_SIZE (2 << 16)

#define ACL_PLUGIN_HASH_LOOKUP_HEAP_SIZE (2 << 15)
#define ACL_PLUGIN_HASH_LOOKUP_HASH_BUCKETS 256
#define ACL_PLUGIN_HASH_LOOKUP_HASH_MEMORY (2 << 15)
