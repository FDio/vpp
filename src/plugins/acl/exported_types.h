...
typedef u32 (*acl_plugin_register_user_module_fn_t) (
  char *caller_module_string, char *val1_label, char *val2_label);
...
typedef int (*acl_plugin_get_lookup_context_index_fn_t) (u32 acl_user_id,
							 u32 val1, u32 val2);
...
typedef int (*acl_plugin_set_acl_vec_for_context_fn_t) (u32 lc_index,
							u32 *acl_list);

typedef void (*acl_plugin_fill_5tuple_fn_t) (u32 lc_index, vlib_buffer_t *b0,
					     int is_ip6, int is_input,
					     int is_l2_path,
					     fa_5tuple_opaque_t *p5tuple_pkt);

typedef int (*acl_plugin_match_5tuple_fn_t) (
  u32 lc_index, fa_5tuple_opaque_t *pkt_5tuple, int is_ip6, u8 *r_action,
  u32 *r_acl_pos_p, u32 *r_acl_match_p, u32 *r_rule_match_p,
  u32 *trace_bitmap);
 ...
 * static inline clib_error_t * acl_plugin_exports_init (acl_plugin_methods_t
 * *m);
 */

typedef clib_error_t *(*acl_plugin_methods_vtable_init_fn_t) (
