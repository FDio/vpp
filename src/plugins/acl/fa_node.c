...
// FIXME HACK
	      if (found_session0 || found_session1)
		{
...
// END OF HACK
          ...
          if (PREDICT_FALSE( (lc_index0 != lc_index1) ||
                             (acl_check_needed0 ^ acl_check_needed1) ))
            {
	      ...
	      if (acl_check_needed1)
		{
		  ...
		  acl_plugin_match_5tuple_inline (lc_index1, (fa_5tuple_opaque_t *)&fa_5tuple1,
            ...
            {
              action0 = action1 = 0;
              acl_plugin_match_5tuple_inline_x2 (lc_index0,
                                                 &fa_5tuple0, &fa_5tuple1, is_ip6,
                                                 &action0, &action1,
                                                 &match_acl_pos0, &match_acl_in_index0, &match_rule_index0, &trace_bitmap0,
                                                 &match_acl_pos1, &match_acl_in_index1, &match_rule_index1, &trace_bitmap1);
            }
...
/** FIXME THE TRACE **/
	  ...
	  vlib_validate_buffer_enqueue_x2 (vm, node, next_index,
					   to_next, n_left_to_next, bi0, bi1, next0, next1);
	}

#endif // ENABLE_DOUBLE_LOOP
