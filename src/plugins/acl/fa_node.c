  ...
  while (n_left_from > 0)
    {
	  ...
	  clib_bihash_prefetch_bucket_40_8(&am->fa_sessions_hash, block_meta[3].hash);
	  clib_bihash_prefetch_data_40_8(&am->fa_sessions_hash, block_meta[2].hash);
  ...
  while (n_left_from > 0)
    {
	  ...
	  bi0 = from[0];
          ...
          // if (n_left_from > 4)
            {
              block_meta_t *bm1 = &block_meta[3];
	      clib_bihash_prefetch_bucket_40_8(&am->fa_sessions_hash, bm1->hash);
            }
            {
              block_meta_t *bm1 = &block_meta[2];
	      clib_bihash_prefetch_data_40_8(&am->fa_sessions_hash, bm1->hash);
            }
