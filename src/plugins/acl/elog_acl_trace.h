...
/* use like: elog_acl_cond_trace_X1(am, (x < 0), "foobar: %d", "i4",
 * int32_value); */
...
/* use like: elog_acl_cond_trace_X2(am, (x<0), "foobar: %d some u64: %lu",
 * "i4i8", int32_value, int64_value); */
...
/* use like: elog_acl_cond_trace_X3(am, (x<0), "foobar: %d some u64 %lu baz:
 * %d", "i4i8i4", int32_value, u64_value, int_value); */
...
/* use like: elog_acl_cond_trace_X4(am, (x<0), "foobar: %d some int %d baz: %d
 * bar: %d", "i4i4i4i4", int32_value, int32_value2, int_value, int_value); */
