...
//  acl_interface_set_acl_list <intfc> | sw_if_index <if-idx> input [acl-idx list] output [acl-idx list]
    ...
    applied_hash_ace_entry_t **applied_hash_aces = is_input ? vec_elt_at_index(sm->input_hash_entry_vec_by_sw_if_index, sw_if_index)
	    : vec_elt_at_index(sm->output_hash_entry_vec_by_sw_if_index, sw_if_index);
