...
/* use like: elog_acl_maybe_trace_X2(am, "foobar: %d some float: %lf", "i4f8", int32_value, double_value); */
...
/* use like: elog_acl_maybe_trace_X3(am, "foobar: %d some float %lf baz: %d", "i4f8i4", int32_value, double_value, int_value); */
