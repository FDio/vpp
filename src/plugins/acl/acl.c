...
//    W (ret);
    ...
    vlib_cli_output(vm, "use_hash_acl_matching: %d", sm->use_hash_acl_matching);
    /* use the new fancy hash-based matching */
    sm->use_hash_acl_matching = 1;
    sm->use_tm_hash_acl_matching = 1;
    vlib_cli_output(vm, "use_hash_acl_matching: %d %d", sm->use_hash_acl_matching, sm->use_tm_hash_acl_matching);
