	...
	for (tt = 0; tt < ACL_N_TIMEOUTS; tt++)
	  {
        ...
        vec_validate_aligned (pw->block_meta[0], MAX_PACKETS_PER_STRIDE + 8, CLIB_CACHE_LINE_BYTES);
        vec_validate_aligned (pw->block_meta[1], MAX_PACKETS_PER_STRIDE + 8, CLIB_CACHE_LINE_BYTES);
      }
  }
