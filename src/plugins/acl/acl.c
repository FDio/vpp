  ...
  if (is_ip4)
      ...
      if (1 == proto)
	{
	  *trace_bitmap |= 0x00000001;
	  /* type */
	  src_port = ntohs((u16) (*(u8 *) get_ptr_to_offset (b0, 34)));
	  /* code */
	  dst_port = ntohs((u16) (*(u8 *) get_ptr_to_offset (b0, 35)));
	}
      else
	{
	  /* assume TCP/UDP */
      ...
      if (58 == proto)
	{
	  *trace_bitmap |= 0x00000002;
	  /* type */
	  src_port = ntohs((u16) (*(u8 *) get_ptr_to_offset (b0, 54)));
	  /* code */
	  dst_port = ntohs((u16) (*(u8 *) get_ptr_to_offset (b0, 55)));
	}
      else
	{
	  /* assume TCP/UDP */
