...
#define foreach_atl_reg                                                       \
  ...
  _ (0x05a00, RX_DMA_DESC_CACHE_INIT,                                         \
     atl_reg_rx_dma_desc_cache_init_t_fields)                                 \
  _ (0x05b00, RX_DMA_DESC_BASE_ADDRLSW0,                                      \
     atl_reg_rx_dma_desc_base_addrlsw_t_fields)                               \
  _ (0x05b04, RX_DMA_DESC_BASE_ADDRMSW0,                                      \
     atl_reg_rx_dma_desc_base_addrmsw_t_fields)                               \
  ...
  _ (0x06ff0, AQ2_RPF_REC_TAB_ENABLE,                                         \
     atl_reg_aq2_rpf_rec_tab_enable_t_fields)                                 \
  ...
  _ (0x07c00, TX_DMA_DESC_BASE_ADDRLSW0,                                      \
     atl_reg_tx_dma_desc_base_addrlsw_t_fields)                               \
  _ (0x07c04, TX_DMA_DESC_BASE_ADDRMSW0,                                      \
     atl_reg_tx_dma_desc_base_addrmsw_t_fields)                               \
  ...
  _ (0x12010, AQ2_FW_INTERFACE_IN_LINK_CONTROL,                               \
     atl_reg_aq2_fw_interface_in_link_control_t_fields)                       \
  _ (0x12018, AQ2_FW_INTERFACE_IN_LINK_OPTIONS,                               \
     atl_reg_aq2_fw_interface_in_link_options_t_fields)                       \
...
typedef union
{
  ...
  atl_reg_aq2_fw_interface_out_transaction_id_t
    aq2_fw_interface_out_transaction_id;
  atl_reg_aq2_fw_interface_out_version_iface_t
    aq2_fw_interface_out_version_iface;
  ...
  atl_reg_aq2_fw_interface_in_request_policy_t
...
#define ATL_REG_RPF_ETHERTYPE_FILTER(i)                                       \
  (ATL_REG_RPF_ETHERTYPE_FILTER0 + (i) *4)
...
#define ATL_REG_AQ2_RPF_ACT_ART_REQ_TAG(i)                                    \
  (ATL_REG_AQ2_RPF_ACT_ART_REQ_TAG0 + (i) *0x10)
#define ATL_REG_AQ2_RPF_ACT_ART_REQ_MASK(i)                                   \
  (ATL_REG_AQ2_RPF_ACT_ART_REQ_MASK0 + (i) *0x10)
#define ATL_REG_AQ2_RPF_ACT_ART_REQ_ACTION(i)                                 \
  (ATL_REG_AQ2_RPF_ACT_ART_REQ_ACTION0 + (i) *0x10)
...
#define ATL_REG_RX_DMA_DESC_BASE_ADDRLSW(i)                                   \
  (ATL_REG_RX_DMA_DESC_BASE_ADDRLSW0 + (i) *0x20)
#define ATL_REG_RX_DMA_DESC_BASE_ADDRMSW(i)                                   \
  (ATL_REG_RX_DMA_DESC_BASE_ADDRMSW0 + (i) *0x20)
#define ATL_REG_RX_DMA_DESC_LEN(i) (ATL_REG_RX_DMA_DESC_LEN0 + (i) *0x20)
#define ATL_REG_RX_DMA_DESC_HEAD_PTR(i)                                       \
  (ATL_REG_RX_DMA_DESC_HEAD_PTR0 + (i) *0x20)
#define ATL_REG_RX_DMA_DESC_TAIL_PTR(i)                                       \
  (ATL_REG_RX_DMA_DESC_TAIL_PTR0 + (i) *0x20)

#define ATL_REG_TX_DMA_DESC_BASE_ADDRLSW(i)                                   \
  (ATL_REG_TX_DMA_DESC_BASE_ADDRLSW0 + (i) *0x40)
#define ATL_REG_TX_DMA_DESC_BASE_ADDRMSW(i)                                   \
  (ATL_REG_TX_DMA_DESC_BASE_ADDRMSW0 + (i) *0x40)
#define ATL_REG_TX_DMA_DESC_LEN(i) (ATL_REG_TX_DMA_DESC_LEN0 + (i) *0x40)
#define ATL_REG_TX_DMA_DESC_HEAD_PTR(i)                                       \
  (ATL_REG_TX_DMA_DESC_HEAD_PTR0 + (i) *0x40)
#define ATL_REG_TX_DMA_DESC_TAIL_PTR(i)                                       \
  (ATL_REG_TX_DMA_DESC_TAIL_PTR0 + (i) *0x40)
