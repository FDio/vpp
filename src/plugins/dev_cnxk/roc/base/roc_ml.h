...
uint64_t __roc_api roc_ml_addr_pa_to_offset(struct roc_ml *roc_ml,
					    uint64_t phys_addr);
uint64_t __roc_api roc_ml_addr_offset_to_pa(struct roc_ml *roc_ml,
					    uint64_t offset);
...
bool __roc_api roc_ml_jcmdq_enqueue_lf(struct roc_ml *roc_ml,
				       struct ml_job_cmd_s *job_cmd);
bool __roc_api roc_ml_jcmdq_enqueue_sl(struct roc_ml *roc_ml,
				       struct ml_job_cmd_s *job_cmd);
