...
#define AVF_RX_DESC_ERROR_SHIFT		19
#define AVF_RX_DESC_PTYPE_SHIFT		30
#define AVF_RX_DESC_LENGTH_SHIFT	38

#define AVF_RX_DESC_ERROR_IPE		(1ULL << (AVF_RX_DESC_ERROR_SHIFT + 3))
#define AVF_RX_DESC_ERROR_L4E		(1ULL << (AVF_RX_DESC_ERROR_SHIFT + 4))
