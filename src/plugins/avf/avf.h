...
typedef enum
{
  AVF_INIT_STATE_START = 0,
  AVF_INIT_STATE_VERSION_SENT,
  AVF_INIT_STATE_GET_VF_RESOURCES_SENT,
  AVF_INIT_STATE_CONFIG_VSI_QUEUES_SENT,
  AVF_INIT_STATE_CONFIG_IRQ_MAP_SENT,
  AVF_INIT_STATE_ADD_ETH_ADDR_SENT,
  AVF_INIT_STATE_ENABLE_QUEUES_SENT,
  AVF_INIT_STATE_DONE,
} avf_init_state_t;
