...
#define avf_memcmp(a, b, c) clib_memcmp ((a), (b), (c))
#define avf_memset_genrl(a, b, c) clib_memset ((a), (b), (c))
#define avf_memcpy_genrl(a, b, c) clib_memcpy ((a), (b), (c))
#define avf_malloc(s) clib_mem_alloc ((s))
#define avf_free(p) clib_mem_free ((p))
