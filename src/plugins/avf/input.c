  ...
  if (memcmp (ld, d, 32))
    {
      ...
      fformat (stderr, "\ndesc %p", d);
      fformat (stderr, "\n%-20s0x%lx", "qword0", avf_get_u64_bits (d, 0, 63, 0));
      fformat (stderr, "\n%-20s0x%lx", "qword1", avf_get_u64_bits (d, 8, 63, 0));
      fformat (stderr, "\n%-20s0x%lx", "status", avf_get_u64_bits (d, 8, 18, 0));
      fformat (stderr, "\n%-20s0x%lx", "error", avf_get_u64_bits (d, 8, 26, 19));
      fformat (stderr, "\n%-20s0x%lx", "ptype", avf_get_u64_bits (d, 8, 37, 30));
      fformat (stderr, "\n%-20s0x%lx", "length", avf_get_u64_bits (d, 8, 63, 38));
      fformat (stderr, "\ndata\n%U", format_hexdump,
