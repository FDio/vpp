...
#define VMXNET3_INPUT_REFILL_TRESHOLD 32
 ...
 * flags:
 *   checksum                -- bits 0 - 15
 *   tcp/udp checksum correct-- bit  17
 *   udp packet              -- bit  18
 *   tcp packet              -- bit  19
 *   ip checksum correct     -- bit  20
 *   ipv6                    -- bit  21
 *   ipv4                    -- bit  22
 *   ip fragment             -- bit  23
 *   frame crc correct       -- bit  24
 *   completion type         -- bits 25-30
 *   generation              -- bit  31
 */
typedef CLIB_PACKED (struct
		     {
