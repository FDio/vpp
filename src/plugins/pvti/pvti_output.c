...
start_new_pvti_buffer (vlib_main_t *vm, pvti_if_t *pvti_if0, u32 bi0)
{
  ...
  clib_memset(pvti0, 0xcc, sizeof(*pvti0));
 ...
 */
always_inline void
pvti_chop_chunk (vlib_buffer_t *b0, u32 nbi0, u16 chop_size)
{
}
	  ...
	  if (pvti_if0->bi0 == INDEX_INVALID)
	      ...
	      if (pvc0->total_chunk_length > pvti_if0->bi0_max_current_length)
		{
		  ...
		  if (INDEX_INVALID == nbi0)
		    ...
		    {
		      pvti_chop_chunk (b0, nbi0, excess_length);
		  ...
		  if (pvc0->total_chunk_length >
			  ...
			  pvti_if0->bi0_max_current_length)
			{
			  ...
			  vlib_validate_buffer_enqueue_x1 (
			    vm, node, next_index, to_next, n_left_to_next, pvti_if0->bi0,
			    next0);
			  start_new_pvti_buffer (vm, pvti_if0, bi0);
			  continue;
			}
