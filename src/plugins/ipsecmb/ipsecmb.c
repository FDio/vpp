...
#undef __set_funcs
  ...
  node = vlib_get_node_by_name (vm, (u8 *) "ipsec-output-ip4");
  ASSERT (node);
  im->ah4_encrypt_node_index = next_node->index;
  ...
  node = vlib_get_node_by_name (vm, (u8 *) "ipsec-input-ip4");
  ASSERT (node);
  im->ah4_decrypt_node_index = next_node->index;
  ...
  node = vlib_get_node_by_name (vm, (u8 *) "ipsec-output-ip6");
  ASSERT (node);
  im->ah6_encrypt_node_index = next_node->index;
  ...
  node = vlib_get_node_by_name (vm, (u8 *) "ipsec-input-ip6");
  ASSERT (node);
  im->ah6_decrypt_node_index = next_node->index;
