...
#define foreach_vpe_api_reply_msg                               \
  ...
  _(KP_ADD_DEL_AS_REPLY, kp_add_del_as_reply)
...
static int api_kp_add_del_as (vat_main_t * vam)
{
  unformat_input_t * i = vam->input;
  vl_api_kp_add_del_as_t mps, *mp;
  int ret;
  mps.is_del = 0;
...
_(kp_add_del_as, "<vip-ip-prefix> <address> [del]")
