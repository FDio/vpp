...
#define REPLY_MSG_ID_BPODE kpm->msg_id_bpode
...
{
#define _(id,n,crc) \
  vl_msg_api_add_msg_name_crc (am, #n "_" #crc, id + kpm->msg_id_bpode);
...
static clib_error_t * kp_api_init (vlib_main_t * vm)
{
  ...
  kpm->msg_id_bpode = vl_msg_api_get_msg_ids
      ((char *) name, VL_MSG_FIRST_AVAILABLE);

#define _(N,n)                                                  \
    vl_msg_api_set_handlers((VL_API_##N + kpm->msg_id_bpode),     \
                           #n,                  \
