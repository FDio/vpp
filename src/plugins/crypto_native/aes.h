...
static_always_inline void
aes128_key_assist (u8x16 * k, u8x16 r)
{
  u8x16 t = k[-1];
  t ^= u8x16_word_shift_left (t, 4);
  t ^= u8x16_word_shift_left (t, 4);
  t ^= u8x16_word_shift_left (t, 4);
  k[0] = t ^ (u8x16) u32x4_shuffle ((u32x4) r, 3, 3, 3, 3);
}

static_always_inline void
aes128_key_expand (u8x16 * k, u8 * key)
{
  k[0] = *(u8x16u *) key;
  aes128_key_assist (k + 1, aes_keygen_assist (k[0], 0x01));
  aes128_key_assist (k + 2, aes_keygen_assist (k[1], 0x02));
  aes128_key_assist (k + 3, aes_keygen_assist (k[2], 0x04));
  aes128_key_assist (k + 4, aes_keygen_assist (k[3], 0x08));
  aes128_key_assist (k + 5, aes_keygen_assist (k[4], 0x10));
  aes128_key_assist (k + 6, aes_keygen_assist (k[5], 0x20));
  aes128_key_assist (k + 7, aes_keygen_assist (k[6], 0x40));
  aes128_key_assist (k + 8, aes_keygen_assist (k[7], 0x80));
  aes128_key_assist (k + 9, aes_keygen_assist (k[8], 0x1b));
  aes128_key_assist (k + 10, aes_keygen_assist (k[9], 0x36));
}
...
static_always_inline void
aes256_key_assist (u8x16 * k, int i, u8x16 key_assist)
{
  u8x16 r, t;
  k += i;
  r = k[-2];
  r ^= t = u8x16_word_shift_left (r, 0x4);
  r ^= t = u8x16_word_shift_left (t, 0x4);
  r ^= u8x16_word_shift_left (t, 0x4);
  ...
  key_assist = aes_keygen_assist (k[0], 0x0);
  r = k[-1];
  r ^= t = u8x16_word_shift_left (r, 0x4);
  r ^= t = u8x16_word_shift_left (t, 0x4);
  r ^= u8x16_word_shift_left (t, 0x4);
...
static_always_inline void
aes256_key_expand (u8x16 * k, u8 * key)
{
  k[0] = *(u8x16u *) key;
  k[1] = *(u8x16u *) (key + 16);
  aes256_key_assist (k, 2, aes_keygen_assist (k[1], 0x01));
  aes256_key_assist (k, 4, aes_keygen_assist (k[3], 0x02));
  aes256_key_assist (k, 6, aes_keygen_assist (k[5], 0x04));
  aes256_key_assist (k, 8, aes_keygen_assist (k[7], 0x08));
  aes256_key_assist (k, 10, aes_keygen_assist (k[9], 0x10));
  aes256_key_assist (k, 12, aes_keygen_assist (k[11], 0x20));
  aes256_key_assist (k, 14, aes_keygen_assist (k[13], 0x40));
}
#endif
