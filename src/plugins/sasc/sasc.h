...
sasc_service_chain_next_index(u32 ingress_node_index, sasc_proto_group_t proto_group,
                              u32 chain_id) {
...
sasc_buffer_init_chain(u32 ingress_node_index, u8 proto, vlib_buffer_t *b, u32 effective_index) {
    ...
    sbo->next_indices_index =
        (ingress_node_index * SASC_MAX_CHAINS * SASC_PROTO_GROUP_N) + effective_index;
    sbo->position = 0;
}
