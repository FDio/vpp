...
extract_ipv4_5tuple_neon(vlib_buffer_t *b, ipv4_5tuple_t tuple) {
    ...
    // Store IPs and protocol
    vst1_lane_u32((uint32_t*)tuple, vreinterpret_u32_u8(vreinterpret_u8_u32(src_dst_ips)), 0); // src_ip
    vst1_lane_u32((uint32_t*)(tuple + 4), vreinterpret_u32_u8(vreinterpret_u8_u32(src_dst_ips)), 1); // dst_ip
    tuple[8] = protocol;
