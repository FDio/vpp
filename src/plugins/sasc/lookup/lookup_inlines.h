...
static inline int sasc_header_offset(void *start, void *end, int header_size) {
    return (end - start) + header_size;
}

static inline void sasc_calc_key_v4(vlib_buffer_t *b, u32 context_id,
                                    enum sasc_lookup_mode_e lookup_mode, sasc_session_key_t *skey) {
...
static inline void sasc_calc_key_v6(vlib_buffer_t *b, u32 context_id,
                                    enum sasc_lookup_mode_e lookup_mode, sasc_session_key_t *skey) {
...
static inline void sasc_calc_key(vlib_buffer_t *b, u32 context_id, sasc_session_key_t *k, u64 *h,
                                 bool is_ip6, enum sasc_lookup_mode_e lookup_mode) {
    if (is_ip6) {
 ...
 */
static inline int sasc_calc_key_slow(vlib_buffer_t *b, u32 context_id, sasc_session_key_t *k,
                                     u64 *h, bool is_ip6) {
    int offset = 0;
    udp_header_t *udp;
