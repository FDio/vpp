 ...
 */
int sasc_interface_input_enable_disable(u32 sw_if_index, u32 tenant_idx, bool output_arc,
                                        bool is_enable) {
    ...
    if (output_arc)
        return vnet_feature_enable_disable("ip4-output", "sasc-input-out", sw_if_index, is_enable,
                                           0, 0);
    else
        return vnet_feature_enable_disable("ip4-unicast", "sasc-input", sw_if_index, is_enable, 0,
                                           0);
}
