...
clib_error_t *sasc_unittest_init(vlib_main_t *vm) {
...
void tcp_packet_info_reverse(tcp_packet_info_t *src, tcp_packet_info_t *dst) {
...
static const test_packet_template_t tcp_options_mss_wscale_packets[] = {
    ...
    {0x0a000002, 0x0a000001, 80, 12370, 2000, 1001, TCP_FLAG_SYN | TCP_FLAG_ACK, "('MSS', 1460), ('WScale', 8)"},
    /* ACK (no options) */
...
static const test_packet_template_t tcp_options_timestamp_packets[] = {
    ...
    {0x0a000002, 0x0a000001, 80, 12371, 2000, 1001, TCP_FLAG_SYN | TCP_FLAG_ACK, "('Timestamp', (987654321, 123456789))"},
    /* ACK with Timestamp option */
    {0x0a000001, 0x0a000002, 12371, 80, 1001, 2001, TCP_FLAG_ACK, "('Timestamp', (123456790, 987654321))"},
    /* Data packet with Timestamp */
    {0x0a000001, 0x0a000002, 12371, 80, 1001, 2001, TCP_FLAG_ACK | TCP_FLAG_PSH, "('Timestamp', (123456791, 987654321))"},
    /* ACK for data with Timestamp */
    {0x0a000002, 0x0a000001, 80, 12371, 2001, 1041, TCP_FLAG_ACK, "('Timestamp', (987654322, 123456791))"},
};
...
static const test_packet_template_t tcp_options_combined_packets[] = {
    ...
    /* ACK with Timestamp option */
    {0x0a000001, 0x0a000002, 12373, 80, 1001, 2001, TCP_FLAG_ACK, "('Timestamp', (123456790, 987654321))"},
    /* Data packet with Timestamp */
    {0x0a000001, 0x0a000002, 12373, 80, 1001, 2001, TCP_FLAG_ACK | TCP_FLAG_PSH, "('Timestamp', (123456791, 987654321))"},
    /* ACK for data with Timestamp */
    {0x0a000002, 0x0a000001, 80, 12373, 2001, 1041, TCP_FLAG_ACK, "('Timestamp', (987654322, 123456791))"},
};
...
static int post_test_wait_for_timeout(void) {
...
static clib_error_t *sasc_test_registry_init(vlib_main_t *vm) {
...
SASC_TEST_REGISTER_TCP(multiple_sessions, "Multiple TCP sessions test", multiple_sessions_packets, 0);
...
SASC_TEST_REGISTER_REORDER(reorder_basic, "TCP basic reorder detection test",
                           reorder_basic_packets, true, 0);
...
/* Advanced TCP tests */
SASC_TEST_REGISTER_TCP(data_length_detection, "TCP data length detection test", data_length_detection_packets, 0);
SASC_TEST_REGISTER_TCP(window_reorder_within, "TCP window reorder within test", window_reorder_within_packets, 0);
SASC_TEST_REGISTER_TCP(window_reorder_outside, "TCP window reorder outside test", window_reorder_outside_packets, 0);
SASC_TEST_REGISTER_TCP(fast_retransmit, "TCP fast retransmit test", fast_retransmit_packets, 0);
SASC_TEST_REGISTER_TCP(timeout_retransmit, "TCP timeout retransmit test", timeout_retransmit_packets, 0);
SASC_TEST_REGISTER_TCP(pure_ack_retransmit, "TCP pure ACK retransmit test", pure_ack_retransmit_packets, 0);

/* TCP Options tests */
SASC_TEST_REGISTER_TCP(tcp_options_mss_wscale, "TCP MSS and Window Scale options test", tcp_options_mss_wscale_packets, 0);
SASC_TEST_REGISTER_TCP(tcp_options_timestamp, "TCP Timestamp options test", tcp_options_timestamp_packets, 0);
SASC_TEST_REGISTER_TCP(tcp_options_sack, "TCP SACK options test", tcp_options_sack_packets, 0);
SASC_TEST_REGISTER_TCP(tcp_options_combined, "TCP multiple options test", tcp_options_combined_packets, 0);
//SASC_TEST_REGISTER_TCP(tcp_options_selective_ack, "TCP selective ACK test", tcp_options_selective_ack_packets, 0);
SASC_TEST_REGISTER_TCP(tcp_options_large_window, "TCP large window test", tcp_options_large_window_packets, 0);
...
// SASC_TEST_REGISTER_UDP(udp_bidirectional, "UDP bidirectional test", udp_bidirectional_packets, 0);
// SASC_TEST_REGISTER_UDP(udp_normal_progression, "UDP normal progression test", udp_normal_progression_packets, 0);
...
// SASC_TEST_REGISTER_ICMP(icmp_bidirectional, "ICMP bidirectional test", icmp_bidirectional_packets, 0);