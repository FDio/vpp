...
static clib_error_t *
show_sasc_service_chains_command_fn(vlib_main_t *vm, unformat_input_t *input,
...
static clib_error_t *
sasc_show_tenant_detail_command_fn(vlib_main_t *vm, unformat_input_t *input,
                                   vlib_cli_command_t *cmd) {
    unformat_input_t line_input_, *line_input = &line_input_;
    clib_error_t *err = 0;
    sasc_main_t *sasc = &sasc_main;
...
static clib_error_t *
sasc_show_next_indices_command_fn(vlib_main_t *vm, unformat_input_t *input,
    ...
    for (u32 chain_id = 0; chain_id < max_chain_id; chain_id++) {
        ...
        for (sasc_proto_group_t proto_group = 0; proto_group < SASC_PROTO_GROUP_N; proto_group++) {
            ...
            for (u32 ingress_idx = 0; ingress_idx < SASC_INGRESS_NODE_N_LOOKUPS; ingress_idx++) {
                ...
                next_indices_index =
                    sasc_service_chain_next_index(ingress_idx, proto_group, chain_id);
