...
static_always_inline bool sasc_service_valid_for_proto(sasc_service_registration_t *service,
                                                       sasc_proto_group_t proto_group) {
...
static_always_inline bool sasc_add_node_to_chain(vlib_main_t *vm, vlib_node_t *node,
                                                 u32 service_index, u32 **next_indices,
                                                 u32 *next_index) {
...
static bool sasc_build_next_indices_from_effective_chain(vlib_main_t *vm, u32 *effective_services,
