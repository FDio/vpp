...
#define SASC_TCP_CHECK_COUNTER_TYPES                                                               \
    ...
    X(SASC_TCP_CHECK_COUNTER_SACK_INVALID_BLOCK, sack_invalid_block, "sasc/tcp_check")             \
    X(SASC_TCP_CHECK_COUNTER_SACK_DUPLICATE_BLOCK, sack_duplicate_block, "sasc/tcp_check")         \
    X(SASC_TCP_CHECK_COUNTER_SACK_RENEGING, sack_reneging, "sasc/tcp_check")                       \
    X(SASC_TCP_CHECK_COUNTER_SACK_EXCESSIVE_BLOCKS, sack_excessive_blocks, "sasc/tcp_check")       \
    X(SASC_TCP_CHECK_COUNTER_ECN_CE_MARK, ecn_ce_mark, "sasc/tcp_check")                           \
    X(SASC_TCP_CHECK_COUNTER_ECN_ECT_MARK, ecn_ect_mark, "sasc/tcp_check")                         \
    X(SASC_TCP_CHECK_COUNTER_ECN_NEGOTIATED, ecn_negotiated, "sasc/tcp_check")
