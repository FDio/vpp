...
#define SASC_TCP_CHECK_TCP_FLAGS_MASK (0x3F)  /* Include all TCP flags: FIN(0x1) | SYN(0x2) | RST(0x4) | PSH(0x8) | ACK(0x10) | URG(0x20) */
...
typedef struct {
  ...
  u32 rtt_histogram[SASC_FLOW_F_B_N][10]; /* RTT histogram in milliseconds */
...
// u32
// sasc_table_format_insert_tcp_check_session(table_t *t, u32 n, sasc_main_t *sasc, u32 session_index,
//                                            sasc_session_t *session, sasc_tcp_check_session_state_t *tcp_session);
