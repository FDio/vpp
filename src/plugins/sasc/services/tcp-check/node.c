...
static const sasc_field_desc_t tcp_check_desc[] = {
    {"flags", SASC_T_U32, offsetof(sasc_tcp_check_session_state_t, flags), -1, NULL, NULL, false},
    {"fwd_retransmits", SASC_T_U32, offsetof(sasc_tcp_check_session_state_t, retransmit_count), 0, NULL, NULL, false},
    {"rev_retransmits", SASC_T_U32, offsetof(sasc_tcp_check_session_state_t, retransmit_count), 1, NULL, NULL, false},
    {"fwd_reorders", SASC_T_U32, offsetof(sasc_tcp_check_session_state_t, reorder_count), 0, NULL, NULL, false},
    {"rev_reorders", SASC_T_U32, offsetof(sasc_tcp_check_session_state_t, reorder_count), 1, NULL, NULL, false},
    {"anomalies_total", SASC_T_U32, 0, -1, (sasc_get_u64_fn)get_anom_total, NULL, false},
    {"fwd_rtt_avg_ms", SASC_T_F64, 0, -1, NULL, (sasc_get_f64_fn)get_fwd_rtt_ms, false},
    {"rev_rtt_avg_ms", SASC_T_F64, 0, -1, NULL, (sasc_get_f64_fn)get_rev_rtt_ms, false},
};
