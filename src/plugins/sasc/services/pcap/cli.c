...
static clib_error_t *sasc_pcap_start_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd) {
...
static clib_error_t *sasc_pcap_stop_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd) {
    sasc_pcap_main_t *pcm = &sasc_pcap_main;
...
static clib_error_t *sasc_pcap_show_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd) {
    sasc_pcap_main_t *pcm = &sasc_pcap_main;
