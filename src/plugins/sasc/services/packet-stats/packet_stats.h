...
typedef struct {
    ...
    /* Inter-packet timing */
    f64 min_inter_packet_time;
    f64 max_inter_packet_time;
    f64 avg_inter_packet_time;
    ...
    f64 peak_packets_per_second; /* Peak packets per second observed */
    f64 peak_bytes_per_second;   /* Peak bytes per second observed */
    u64 burst_count;             /* Number of packet bursts detected */
    u64 idle_periods;            /* Number of idle periods detected */
    f64 last_rate_update_time;   /* Last time rates were updated */
