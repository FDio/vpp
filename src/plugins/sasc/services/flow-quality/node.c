...
sasc_quality_compute(const sasc_session_t *session, sasc_packet_stats_session_data_t *session_data) {
    ...
    session_data->q_congestion =
        compute_q_congestion(session_data->ecn_ce, session_data->ecn_ect, session_data->ttl_stddev[0], session_data->ttl_stddev[1]); // Changed to use session_data->ttl_stddev[0]
