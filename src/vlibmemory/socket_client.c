...
void
vl_socket_client_read_sync (void)
{
...
int
vl_socket_client_write_sync (void)
{
  socket_client_main_t *scm = &socket_client_main;
  int n;
                          ...
                          u32 socket_buffer_size)
{
  ...
  if (vl_socket_client_write_sync () <= 0)
    return (-1);
...
int
vl_socket_client_init_shm (void)
{
  socket_client_main_t *scm = &socket_client_main;
  ...
  rv = vl_socket_client_write_sync ();
  if (rv <= 0)
    return rv;
