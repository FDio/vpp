...
#undef _
  ...
  vl_msg_api_set_thread_safe (am, VL_API_CONTROL_PING, 1);
  vl_msg_api_set_thread_safe (am, VL_API_CONTROL_PING_REPLY, 1);
...
#undef _
  ...
  vl_msg_api_set_replay_allowed (am, VL_API_TRACE_PLUGIN_MSG_IDS, 0);

  /* No reason to halt the parade to create a trace record... */
  vl_msg_api_set_thread_safe (am, VL_API_TRACE_PLUGIN_MSG_IDS, 1);
