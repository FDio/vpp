...
static void
vl_api_get_f64_endian_value_reply_t_handler (vl_api_get_f64_endian_value_reply_t * mp)
{
  // not yet implemented
}

static void
vl_api_get_f64_increment_by_one_reply_t_handler (vl_api_get_f64_increment_by_one_reply_t * mp)
{
  // not yet implemented
}
