...
#define _(T) int vl_api_##T##_fromjson (cJSON *o, T *d);
foreach_vat2_fromjson
#undef _

  int
  vl_api_bool_fromjson (cJSON *o, bool *d);
void *vl_api_ip4_address_t_fromjson (void *mp, int *len, cJSON *o,
				     vl_api_ip4_address_t *a);
void *vl_api_ip4_prefix_t_fromjson (void *mp, int *len, cJSON *o,
				    vl_api_ip4_prefix_t *a);
void *vl_api_ip4_address_with_prefix_t_fromjson (void *mp, int *len, cJSON *o,
						 vl_api_ip4_prefix_t *a);
void *vl_api_ip6_address_t_fromjson (void *mp, int *len, cJSON *o,
				     vl_api_ip6_address_t *a);
void *vl_api_ip6_prefix_t_fromjson (void *mp, int *len, cJSON *o,
				    vl_api_ip6_prefix_t *a);
void *vl_api_ip6_address_with_prefix_t_fromjson (void *mp, int *len, cJSON *o,
						 vl_api_ip6_prefix_t *a);
void *vl_api_address_t_fromjson (void *mp, int *len, cJSON *o,
				 vl_api_address_t *a);
void *vl_api_prefix_t_fromjson (void *mp, int *len, cJSON *o,
				vl_api_prefix_t *a);
void *vl_api_address_with_prefix_t_fromjson (void *mp, int *len, cJSON *o,
					     vl_api_prefix_t *a);
void *vl_api_mac_address_t_fromjson (void *mp, int *len, cJSON *o,
...
#define _(T) cJSON *vl_api_##T##_t_tojson (vl_api_##T##_t *);
foreach_vat2_tojson
#undef _
