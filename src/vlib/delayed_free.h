...
__clib_export __clib_flatten void clib_mem_heap_free_mt_safe (void *heap,
							      void *p);
/* Implemented in .c file as the implementation needs main.h which needs this.
 */

/* TODO: Move also other implementations into the .c file? */
...
__clib_export void *
_vec_realloc_internal_mp_safe (void *v, uword n_elts,
