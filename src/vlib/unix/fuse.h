...
typedef int (vlib_fuse_file_op_fn_t) (vlib_main_t *,
				      vlib_fuse_file_op_data_t *);
...
clib_error_t *vlib_fuse_create (vlib_fuse_handle_t *h,
				vlib_fuse_create_args_t *args, char *fmt, ...);
...
void vlib_fuse_set_private_data (vlib_fuse_handle_t h, u64 private_data);
u64 vlib_fuse_get_private_data (vlib_fuse_handle_t h);
void vlib_fuse_set_node_private_data (vlib_fuse_handle_t h,
				      vlib_fuse_nodeid_t ino,
				      u64 private_data);
u64 vlib_fuse_get_node_private_data (vlib_fuse_handle_t h,
				     vlib_fuse_nodeid_t ino);
u32 vlib_fuse_remove_node (vlib_fuse_handle_t h, vlib_fuse_nodeid_t ino,
			   int recursive);
