...
#define foreach_vllib_usb_req_type                                            \
  ...
  _ (0, 1, 0, VENDOR_DEVICE_OUT)                                              \
  _ (0, 1, 1, VENDOR_INTERFACE_OUT)                                           \
  _ (0, 1, 2, VENDOR_ENDPOINT_OUT)                                            \
  ...
  _ (1, 1, 0, VENDOR_DEVICE_IN)                                               \
  _ (1, 1, 1, VENDOR_INTERFACE_IN)                                            \
  _ (1, 1, 2, VENDOR_ENDPOINT_IN)
