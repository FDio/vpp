...
vlib_thread_init (vlib_main_t * vm)
{
  ...
  stats_num_worker_threads_dir_index = vlib_stats_new_entry (
    STAT_DIR_TYPE_SCALAR_INDEX, "/sys/num_worker_threads");
  ...
  vlib_stats_set_value (stats_num_worker_threads_dir_index, n_vlib_mains - 1);
