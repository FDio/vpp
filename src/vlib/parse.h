...
typedef vlib_parse_match_t (vlib_parse_match_function_t) (
  struct vlib_parse_main *, struct vlib_parse_type *, vlib_lex_token_t *,
  vlib_parse_value_t *);
...
typedef vlib_parse_match_t (vlib_parse_eval_function_t) (vlib_parse_main_t *,
							 vlib_parse_item_t *,
							 vlib_parse_value_t *);
...
#define _PARSE_REGISTRATION_DATA(x)                                           \
  VLIB_ELF_SECTION_DATA (x##_registration, parse_registration_t,              \
			 parse_registrations)
