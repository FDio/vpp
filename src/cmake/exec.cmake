...
execute_process(COMMAND ${CC} --print-file-name libclang_rt.fuzzer-x86_64.a
	OUTPUT_VARIABLE LIB_FUZZER_PATH
	OUTPUT_STRIP_TRAILING_WHITESPACE)
add_custom_target(modified_lib_fuzzer
           COMMAND objcopy --redefine-sym main=fuzzer_lib_main ${LIB_FUZZER_PATH} ${PROJECT_BINARY_DIR}/lib/modified_lib_fuzzer.a
)
