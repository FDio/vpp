...
elseif(DEFINED VPP_PLATFORM)
  ...
  if(NOT EXISTS ${platform_file})
    if(CMAKE_SYSTEM_PROCESSOR MATCHES "^(aarch64.*|AARCH64.*)")
      ...
      set(VPP_PLATFORM_CFLAGS -mcpu=${VPP_PLATFORM}+crc+crypto)
    elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "amd64.*|x86_64.*|AMD64.*")
      set(VPP_PLATFORM_CACHE_LINE_SIZE 64)
      set(VPP_PLATFORM_CFLAGS -march=${VPP_PLATFORM})
    else()
...
if(DEFINED VPP_PLATFORM)
  if(DEFINED VPP_PLATFORM_CFLAGS)
     ...
     string(REGEX REPLACE "[^A-Za-z0-9]" "_" march_flags_var "${march_flags_str}")
     check_c_compiler_flag("${march_flags_str}" compiler_flag_platform_${march_flags_var})
     if(NOT compiler_flag_platform_${march_flags_var})
