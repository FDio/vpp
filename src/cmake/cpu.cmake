...
elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "^(aarch64.*|AARCH64.*)")
  ...
  check_c_compiler_flag("-march=armv8.3-a+crc+crypto+sve -msve-vector-bits=256" compiler_flag_march_neoversen2)
  if(compiler_flag_march_neoversen2)
    list(APPEND MARCH_VARIANTS "neoversen2\;-march=armv8.3-a+crc+crypto+sve -msve-vector-bits=256 -DCLIB_N_PREFETCHES=12")
  endif()
endif()
