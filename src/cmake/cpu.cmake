...
if(CMAKE_SYSTEM_PROCESSOR MATCHES "^(aarch64.*|AARCH64.*)")
  ...
  set(CLIB_CPU_PREFETCH_THUNDERX2 8)
  # Qualcomm Centriq 2400, Impermenter 0x51, Part 0xc00
  set(CLIB_CPU_PREFETCH_QDF24XX 8)
  # Cortex-A72, Impermenter 0x41, Part 0xd08
  set(CLIB_CPU_PREFETCH_CORTEXA72 6)
  # Other aarch64
  set(CLIB_CPU_PREFETCH 8)
else()
  set(VPP_LOG2_CACHE_LINE_SIZE 6)
endif()
...
elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "^(aarch64.*|AARCH64.*)")
  ...
  if(compiler_flag_march_core_qdf24xx)
    list(APPEND MARCH_VARIANTS "qdf24xx\;-march=armv8-a+crc+crypto -DCLIB_CPU_PREFETCH=${CLIB_CPU_PREFETCH_QDF24XX}")
  endif()
  ...
  if(compiler_flag_march_thunderx2t99)
    if (CMAKE_C_COMPILER_VERSION VERSION_GREATER 7.3)
      list(APPEND MARCH_VARIANTS "thunderx2t99\;-march=armv8.1-a+crc+crypto -mtune=thunderx2t99 -DCLIB_CPU_PREFETCH=${CLIB_CPU_PREFETCH_THUNDERX2}")
    else()
      list(APPEND MARCH_VARIANTS "thunderx2t99\;-march=armv8.1-a+crc+crypto -DCLIB_CPU_PREFETCH=${CLIB_CPU_PREFETCH_THUNDERX2}")
    endif()
  endif()
  ...
  if(compiler_flag_march_cortexa72)
    list(APPEND MARCH_VARIANTS "cortexa72\;-march=armv8-a+crc+crypto -mtune=cortex-a72 -DCLIB_CPU_PREFETCH=${CLIB_CPU_PREFETCH_CORTEXA72}")
  endif()
endif()
