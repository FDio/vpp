...
elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "^(aarch64.*|AARCH64.*)")
  ...
  check_c_compiler_flag("-march=armv8.3-a+crc+crypto+sve" compiler_flag_march_neoversen2)
  if(compiler_flag_march_neoversen2)
    list(APPEND MARCH_VARIANTS "neoversen2\;-march=armv8.3-a+crc+crypto+sve -DCLIB_N_PREFETCHES=12")
  endif()
endif()
