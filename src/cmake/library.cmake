...
macro(add_vpp_test_library lib)
  ...
  foreach(file ${ARGN})
    ...
    #if (TARGET ${name}_plugin_api_headers)
    #  add_dependencies(${test_lib} ${name}.api.h)
    #  #add_dependencies(${test_lib} ${name}_plugin_api_headers)
    #  #message("APIDEPS: ${name}_plugin_api_headers")
    #endif()
