...
function(vpp_generate_api_c_header file)
  ...
  add_custom_command (OUTPUT ${output_name}
    ...
    COMMAND ${VPP_APIGEN}
    ARGS --includedir ${CMAKE_SOURCE_DIR} --input ${CMAKE_CURRENT_SOURCE_DIR}/${file} vppapigen_c --output ${output_name}
...
function(vpp_generate_api_json_header file dir component)
  ...
  add_custom_command (OUTPUT ${output_name}
    COMMAND mkdir -p ${output_dir}
    COMMAND ${VPP_APIGEN}
    ARGS --includedir ${CMAKE_SOURCE_DIR} --input ${CMAKE_CURRENT_SOURCE_DIR}/${file} vppapigen_json --output ${output_name}
    DEPENDS ${CMAKE_CURRENT_SOURCE_DIR}/${file}
    COMMENT "Generating API header ${output_name}"
  )
  install(
