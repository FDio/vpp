...
_(WANT_INTERFACE_SIMPLE_COUNTERS, want_interface_simple_counters)	\
_(VNET_INTERFACE_COMBINED_COUNTERS, vnet_interface_combined_counters)	\
_(WANT_INTERFACE_COMBINED_COUNTERS, want_interface_combined_counters)	\
_(VNET_IP4_FIB_COUNTERS, vnet_ip4_fib_counters)				\
_(WANT_IP4_FIB_COUNTERS, want_ip4_fib_counters)            \
_(VNET_IP6_FIB_COUNTERS, vnet_ip6_fib_counters)				\
_(WANT_IP6_FIB_COUNTERS, want_ip6_fib_counters)        \
_(VNET_IP4_NBR_COUNTERS, vnet_ip4_nbr_counters)				\
_(WANT_IP4_NBR_COUNTERS, want_ip4_nbr_counters)            \
_(VNET_IP6_NBR_COUNTERS, vnet_ip6_nbr_counters) \
_(WANT_IP6_NBR_COUNTERS, want_ip6_nbr_counters)
...
static void
vl_api_want_interface_simple_counters_t_handler (vl_api_want_interface_simple_counters_t * mp)
{
  stats_main_t *sm = &stats_main;
  vpe_client_stats_registration_t *rp;
  vl_api_want_interface_simple_counters_reply_t *rmp;
  uword *p;
  i32 retval = 0;
  unix_shared_memory_queue_t *q;
...
static void
vl_api_want_interface_combined_counters_t_handler (vl_api_want_interface_combined_counters_t * mp)
{
}

static void
vl_api_want_ip4_fib_counters_t_handler (vl_api_want_ip4_fib_counters_t * mp)
{
}

static void
vl_api_want_ip6_fib_counters_t_handler (vl_api_want_ip6_fib_counters_t * mp)
{
}

static void
vl_api_want_ip4_nbr_counters_t_handler (vl_api_want_ip4_nbr_counters_t * mp)
{
}

static void
vl_api_want_ip6_nbr_counters_t_handler (vl_api_want_ip6_nbr_counters_t * mp)
{
}
