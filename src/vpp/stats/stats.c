...
vl_api_want_stats_t_handler (vl_api_want_stats_t * mp)
{
  ...
  rp->stat_registrations |= INTERFACE_SIMPLE_COUNTERS;
  rp->stat_registrations |= INTERFACE_COMBINED_COUNTERS;
  rp->stat_registrations |= IP4_FIB_COUNTERS;
  rp->stat_registrations |= IP4_NBR_COUNTERS;
  rp->stat_registrations |= IP6_FIB_COUNTERS;
  rp->stat_registrations |= IP6_NBR_COUNTERS;
