  ...
  if (0 != adj_counter.packets)
    {
      ...
      vl_counter->address =
	clib_host_to_net_u32 (adj->sub_type.nbr.next_hop.ip4.as_u32);
  ...
  if (0 != adj_counter.packets)
    {
      ...
      vl_counter->packets = clib_host_to_net_u64(adj_counter.packets);
      vl_counter->bytes   = clib_host_to_net_u64(adj_counter.bytes);
      vl_counter->address[0] =
        clib_host_to_net_u64(adj->sub_type.nbr.next_hop.ip6.as_u64[0]);
      vl_counter->address[1] =
        clib_host_to_net_u64(adj->sub_type.nbr.next_hop.ip6.as_u64[1]);
      vl_counter->link_type = adj->ia_link;
    }
}
