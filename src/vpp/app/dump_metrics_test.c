...
test_data_t test_data[] = {
  {
    .res = "interfaces_drops{interface=\"GigabitEthernet0_13_0.100\",index=\"0\",thread=\"0\"} 42\n"
  ...
  {
    .res = "interfaces_drops{interface=\"GigabitEthernet0:13:0.100\",index=\"0\",thread=\"0\"} 42\n"
