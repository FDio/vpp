 ...
 * from session_stats.h (512 bytes total, schema v5)
 */
typedef struct
{
  ...
  /* ECN/CWR metrics - offset 288 */
  u32 tcp_ecn_ect_packets;
  u32 tcp_ecn_ce_packets;
  u32 tcp_ece_packets;
  u32 tcp_cwr_packets;

  /* Custom data metadata - offset 304 */
  u8 custom_data_flags;
  u8 reserved_custom[7];

  /* Custom data - offset 312, size 16 */
  u64 custom_api_data;
  u64 custom_callback_data;

  /* Padding to 512 bytes - offset 328, size 184 */
  u8 reserved_pad[184];
