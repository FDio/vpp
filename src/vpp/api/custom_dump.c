...
static void *vl_api_tapv2_create_t_print
  (vl_api_tapv2_create_t * mp, void *handle)
{
  u8 *s;
  u8 null_mac[6];
  ...
  s = format (0, "SCRIPT: tapv2_create ");
...
static void *vl_api_tapv2_delete_t_print
  (vl_api_tapv2_delete_t * mp, void *handle)
{
  u8 *s;

  s = format (0, "SCRIPT: tapv2_delete ");
  s = format (s, "sw_if_index %d ", ntohl (mp->sw_if_index));

  FINISH;
}

static void *vl_api_sw_interface_tapv2_dump_t_print
  (vl_api_sw_interface_tapv2_dump_t * mp, void *handle)
{
  u8 *s;

  s = format (0, "SCRIPT: sw_interface_tapv2_dump ");
