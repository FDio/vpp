...
void set_publisher_node (uword node_index, uword event_type);
...
enum
{ DHCP6_DP_REPLY_REPORT, REPORT_MAX };
...
} dhcp6_client_public_main_t;

extern dhcp6_client_public_main_t dhcp6_client_public_main;
...
static void __vnet_dhcp6_reply_event_function_init_##f (void)             \
{                                                                         \
 dhcp6_client_public_main_t * nm = &dhcp6_client_public_main;             \
