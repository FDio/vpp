...
esp_encrypt_init (vlib_main_t *vm)
{
  ...
  im->esp4_enc_fq_index =
    vlib_frame_queue_main_init (esp4_encrypt_node.index, im->worker_queue_size);
  im->esp6_enc_fq_index =
    vlib_frame_queue_main_init (esp6_encrypt_node.index, im->worker_queue_size);
  im->esp4_enc_tun_fq_index =
    vlib_frame_queue_main_init (esp4_encrypt_tun_node.index, im->worker_queue_size);
  im->esp6_enc_tun_fq_index =
    vlib_frame_queue_main_init (esp6_encrypt_tun_node.index, im->worker_queue_size);
  im->esp_mpls_enc_tun_fq_index =
    vlib_frame_queue_main_init (esp_mpls_encrypt_tun_node.index, im->worker_queue_size);
