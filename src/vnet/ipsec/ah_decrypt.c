...
static uword
ip4_ah_decrypt_node_fn (vlib_main_t * vm,
			vlib_node_runtime_t * node, vlib_frame_t * from_frame)
{
...
/* *INDENT-OFF* */
VLIB_REGISTER_NODE (ip4_ah_decrypt_node) = {
  .function = ip4_ah_decrypt_node_fn,
  .name = "ip4-ah-decrypt",
...
VLIB_NODE_FUNCTION_MULTIARCH (ip4_ah_decrypt_node, ip4_ah_decrypt_node_fn);

static uword
ip6_ah_decrypt_node_fn (vlib_main_t * vm,
			vlib_node_runtime_t * node, vlib_frame_t * from_frame)
{
...
/* *INDENT-OFF* */
VLIB_REGISTER_NODE (ip6_ah_decrypt_node) = {
  .function = ip6_ah_decrypt_node_fn,
  .name = "ip6-ah-decrypt",
  .vector_size = sizeof (u32),
  .format_trace = format_ah_decrypt_trace,
  .type = VLIB_NODE_TYPE_INTERNAL,
...
VLIB_NODE_FUNCTION_MULTIARCH (ip6_ah_decrypt_node, ip6_ah_decrypt_node_fn);
/*
