...
static const ipsec_sa_crypto_integ_map_t
  ...
  [IPSEC_CRYPTO_ALG_AES_GCM_128][IPSEC_INTEG_ALG_NONE] = {
    .esn_alg = VNET_CRYPTO_ALG_AES_128_GCM_TAG16_AAD12,
  ...
  [IPSEC_CRYPTO_ALG_AES_GCM_192][IPSEC_INTEG_ALG_NONE] = {
    .esn_alg = VNET_CRYPTO_ALG_AES_192_GCM_TAG16_AAD12,
  ...
  [IPSEC_CRYPTO_ALG_AES_GCM_256][IPSEC_INTEG_ALG_NONE] = {
    .esn_alg = VNET_CRYPTO_ALG_AES_256_GCM_TAG16_AAD12,
  ...
  [IPSEC_CRYPTO_ALG_CHACHA20_POLY1305][IPSEC_INTEG_ALG_NONE] = {
    .esn_alg = VNET_CRYPTO_ALG_CHACHA20_POLY1305_TAG16_AAD12,
  ...
  [IPSEC_CRYPTO_ALG_AES_NULL_GMAC_128][IPSEC_INTEG_ALG_NONE] = {
    .esn_alg = VNET_CRYPTO_ALG_AES_128_NULL_GMAC_TAG16_AAD12,
    .alg = VNET_CRYPTO_ALG_AES_128_NULL_GMAC_TAG16_AAD8,
    .integ_icv_size = 16,
    .iv_size = 8,
    .block_align = 1,
    .is_aead = 1,
  ...
  [IPSEC_CRYPTO_ALG_AES_NULL_GMAC_192][IPSEC_INTEG_ALG_NONE] = {
    .esn_alg = VNET_CRYPTO_ALG_AES_192_NULL_GMAC_TAG16_AAD12,
    .alg = VNET_CRYPTO_ALG_AES_192_NULL_GMAC_TAG16_AAD8,
    .integ_icv_size = 16,
    .iv_size = 8,
    .block_align = 1,
    .is_aead = 1,
  ...
  [IPSEC_CRYPTO_ALG_AES_NULL_GMAC_256][IPSEC_INTEG_ALG_NONE] = {
    .esn_alg = VNET_CRYPTO_ALG_AES_256_NULL_GMAC_TAG16_AAD12,
    .alg = VNET_CRYPTO_ALG_AES_256_NULL_GMAC_TAG16_AAD8,
    .integ_icv_size = 16,
    .iv_size = 8,
    .block_align = 1,
    .is_aead = 1,
  ...
  if (key_alg != VNET_CRYPTO_ALG_NONE)
    {
      ...
      ctx = vnet_crypto_ctx_create (vm, key_alg, crypto_key_data, crypto_key_len, integ_key_data,
				    integ_key_len);
      if (ctx == 0)
	{
	  clib_mem_free (irt);
