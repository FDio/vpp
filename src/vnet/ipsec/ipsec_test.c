...
static void
vl_api_ipsec_sa_originator_details_t_handler (vl_api_ipsec_sa_originator_details_t *mp)
{
}

static void
vl_api_ipsec_spd_originator_details_t_handler (vl_api_ipsec_spd_originator_details_t *mp)
{
}
...
static int
api_ipsec_set_originator (vat_main_t *mp)
{
  return -1;
}

static int
api_ipsec_sa_originator_dump (vat_main_t *mp)
{
  return -1;
}

static int
api_ipsec_spd_originator_dump (vat_main_t *mp)
{
  return -1;
}
