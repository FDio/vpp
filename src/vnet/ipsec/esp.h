...
typedef struct
{
  ...
  u32 esp4_decrypt_post_index[VNET_CRYPTO_N_MODES];
  u32 esp6_decrypt_post_index[VNET_CRYPTO_N_MODES];
  u32 esp4_decrypt_tun_post_index[VNET_CRYPTO_N_MODES];
  u32 esp6_decrypt_tun_post_index[VNET_CRYPTO_N_MODES];
