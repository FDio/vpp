...
always_inline u16
esp_aad_fill_seq (u8 *data, const esp_header_t *esp, u32 seq_hi)
{
  esp_aead_t *aad;
...
{
  return esp_aad_fill_seq (data, esp,
			   ipsec_sa_is_set_USE_ESN (sa) ? sa->seq_hi : ~0);
}
