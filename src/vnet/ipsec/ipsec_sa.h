...
typedef struct
{
  ...
  vnet_crypto_buffer_metadata_t async_op_data_tmpl;
...
STATIC_ASSERT (sizeof (ipsec_sa_outb_rt_cached_t) == 40,
	       "ipsec_sa_outb_rt_cached_t must be 40 bytes");
...
extern int ipsec_sa_add_and_lock (u32 id, u32 spi, ipsec_protocol_t proto,
				  ...
				  ipsec_sa_flags_t flags, ipsec_sa_tfs_type_t tfs_type,
				  void *tfs_config, u32 salt, u16 src_port, u16 dst_port,
				  u32 anti_replay_window_size, const tunnel_t *tun,
				  u32 *sa_out_index);
