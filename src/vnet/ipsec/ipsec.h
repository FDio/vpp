...
typedef int (*tfs_add_del_sa_cb_t) (u32 sa_index, void *tfs_config, u8 is_add, clib_error_t **pce);
...
STATIC_ASSERT_SIZEOF (ipsec4_inbound_spd_tuple_t, 24);
