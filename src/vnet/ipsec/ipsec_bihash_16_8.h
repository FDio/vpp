...
#define BIHASH_TYPE			   _16_8_1
#define BIHASH_KVP_PER_PAGE		   1
...
#ifndef __included_ipsec_bihash_16_8_1_h__
#define __included_ipsec_bihash_16_8_1_h__
...
typedef struct
{
  u64 key[2];
  u64 value;
} clib_bihash_kv_16_8_1_t;

static inline int
clib_bihash_is_free_16_8_1 (clib_bihash_kv_16_8_1_t *v)
{
...
static inline u64
clib_bihash_hash_16_8_1 (clib_bihash_kv_16_8_1_t *v)
{
...
static inline u8 *
format_bihash_kvp_16_8_1 (u8 *s, va_list *args)
{
  clib_bihash_kv_16_8_1_t *v = va_arg (*args, clib_bihash_kv_16_8_1_t *);
...
static inline int
clib_bihash_key_compare_16_8_1 (u64 *a, u64 *b)
{
...
#endif /* __included_ipsec_bihash_16_8_1_h__ */
