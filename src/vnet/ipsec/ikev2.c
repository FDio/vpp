...
ikev2_initiate_sa_init (vlib_main_t * vm, u8 * name)
{
  ...
  /* Create the Initiator Request */
  {
    ...
    *(u64 *)((void*)&nat_detection_source[0]) = (sa.ispi);
    *(u64 *)((void*)&nat_detection_source[8]) = (sa.rspi);
    *(u16 *)((void*)&nat_detection_source[8 + 8 + 4]) = clib_host_to_net_u16 (500);
    *(u32 *)((void*)&nat_detection_source[8 + 8]) =
    ...
    *(u64 *) sig_hash_algo = clib_host_to_net_u64 (0x0001000200030004);
    ikev2_payload_add_notify (chain,
