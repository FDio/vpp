...
ikev2_initiate_sa_init (vlib_main_t * vm, u8 * name)
{
  ...
  /* Create the Initiator Request */
  {
    ...
    *(u64 *) (&nat_detection_source[0]) = (sa.ispi);
    *(u64 *) (&nat_detection_source[8]) = (sa.rspi);
    *(u16 *) (&nat_detection_source[8 + 8 + 4]) = clib_host_to_net_u16 (500);
...
ikev2_initiate_delete_ike_sa (vlib_main_t * vm, u64 ispi)
{
  ...
  ikev2_main_per_thread_data_t *tkm;
  ikev2_sa_t *fsa = 0;
  ikev2_main_per_thread_data_t *ftkm;
