...
ipsc_register_sched_node (vlib_main_t * vm)
{
  ...
  /* esp_encrypt */
  vnet_scheduler_create_instance (vm,
				  "esp4-encrypt-sched-process",
				  "esp4-encrypt-post",
				  &enc_sched_next->esp4_distribute,
				  &enc_sched_next->esp4_aggregate);
  vnet_scheduler_create_instance (vm,
				  "esp6-encrypt-sched-process",
				  "esp6-encrypt-post",
				  &enc_sched_next->esp6_distribute,
				  &enc_sched_next->esp6_aggregate);
  vnet_scheduler_create_instance (vm,
				  "esp4-encrypt-tun-sched-process",
				  "esp4-encrypt-tun-post",
				  &enc_sched_next->esp4_tun_distribute,
				  &enc_sched_next->esp4_tun_aggregate);
  vnet_scheduler_create_instance (vm,
				  "esp6-encrypt-tun-sched-process",
				  "esp6-encrypt-tun-post",
				  &enc_sched_next->esp6_tun_distribute,
				  &enc_sched_next->esp6_tun_aggregate);
  vnet_scheduler_create_instance (vm,
				  "esp-mpls-encrypt-tun-sched-process",
				  "esp-mpls-encrypt-tun-post",
				  &enc_sched_next->esp_mpls_distribute,
				  &enc_sched_next->esp_mpls_aggregate);
}
