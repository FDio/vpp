...
ipsec_init (vlib_main_t * vm)
{
  ...
  a->key_type = VNET_CRYPTO_KEY_TYPE_DES;
  ...
  a->key_type = VNET_CRYPTO_KEY_TYPE_3DES;
  a->iv_size = a->block_size = 8;
  ...
  a->key_type = VNET_CRYPTO_KEY_TYPE_AES_128;
  ...
  a->key_type = VNET_CRYPTO_KEY_TYPE_AES_192;
  a->iv_size = a->block_size = 16;
  ...
  a->key_type = VNET_CRYPTO_KEY_TYPE_AES_256;
  a->iv_size = a->block_size = 16;
  ...
  a->key_type = VNET_CRYPTO_KEY_TYPE_HMAC_SHA1;
  i->icv_size = 12;

  i = &im->integ_algs[IPSEC_INTEG_ALG_SHA_256_96];
  i->op_id = VNET_CRYPTO_OP_SHA1_HMAC;
  a->key_type = VNET_CRYPTO_KEY_TYPE_HMAC_SHA256;
  i->icv_size = 12;
  ...
  a->key_type = VNET_CRYPTO_KEY_TYPE_HMAC_SHA512;
  i->icv_size = 24;
