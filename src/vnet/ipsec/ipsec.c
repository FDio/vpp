...
static void
ipsec_add_node(vlib_main_t * vm, const char *prev_node_name, const char *node_name, u32 *out_node_index, u32 *out_next_index)
{
			   ...
			   add_del_sa_sess_cb_t ah_add_del_sa_sess_cb)
{
  ...
  ipsec_add_node(vm, ah4_encrypt_node_name, "ipsec4-output", &b->ah4_encrypt_node_index, &b->ah4_encrypt_next_index);
  ipsec_add_node(vm, ah4_decrypt_node_name, "ipsec4-input", &b->ah4_decrypt_node_index, &b->ah4_decrypt_next_index);
  ipsec_add_node(vm, ah6_encrypt_node_name, "ipsec6-output", &b->ah6_encrypt_node_index, &b->ah6_encrypt_next_index);
  ipsec_add_node(vm, ah6_decrypt_node_name, "ipsec6-input", &b->ah6_decrypt_node_index, &b->ah6_decrypt_next_index);
			    ...
			    add_del_sa_sess_cb_t esp_add_del_sa_sess_cb)
{
  ...
  ipsec_add_node(vm, esp4_encrypt_node_name, "ipsec4-output", &b->esp4_encrypt_node_index, &b->esp4_encrypt_next_index);
  ipsec_add_node(vm, esp4_decrypt_node_name, "ipsec4-input", &b->esp4_decrypt_node_index, &b->esp4_decrypt_next_index);
  ipsec_add_node(vm, esp6_encrypt_node_name, "ipsec6-output", &b->esp6_encrypt_node_index, &b->esp6_encrypt_next_index);
  ipsec_add_node(vm, esp6_decrypt_node_name, "ipsec6-input", &b->esp6_decrypt_node_index, &b->esp6_decrypt_next_index);
