			   ...
			   add_del_sa_sess_cb_t ah_add_del_sa_sess_cb)
{
  ...
  vlib_node_t *node;
  node = vlib_get_node_by_name (vm, (u8*)ah4_encrypt_node_name);
  ASSERT (node);
  b->ah4_encrypt_node_index = node->index;
  b->ah4_encrypt_next_index = ah4_encrypt_next_index;
  node = vlib_get_node_by_name (vm, (u8*)ah4_decrypt_node_name);
  ASSERT (node);
  b->ah4_decrypt_node_index = node->index;
  b->ah4_decrypt_next_index = ah4_decrypt_next_index;
  node = vlib_get_node_by_name (vm, (u8*)ah6_encrypt_node_name);
  ASSERT (node);
  b->ah6_encrypt_node_index = node->index;
  b->ah6_encrypt_next_index = ah6_encrypt_next_index;
  node = vlib_get_node_by_name (vm, (u8*)ah6_decrypt_node_name);
  ASSERT (node);
  b->ah6_decrypt_node_index = node->index;
			    ...
			    add_del_sa_sess_cb_t esp_add_del_sa_sess_cb)
{
  ...
  vlib_node_t *node;
  node = vlib_get_node_by_name (vm, (u8*)esp4_encrypt_node_name);
  ASSERT (node);
  b->esp4_encrypt_node_index = node->index;
  b->esp4_encrypt_next_index = esp4_encrypt_next_index;
  node = vlib_get_node_by_name (vm, (u8*)esp4_decrypt_node_name);
  ASSERT (node);
  b->esp4_decrypt_node_index = node->index;
  b->esp4_decrypt_next_index = esp4_decrypt_next_index;
  node = vlib_get_node_by_name (vm, (u8*)esp6_encrypt_node_name);
  ASSERT (node);
  b->esp6_encrypt_node_index = node->index;
  b->esp6_encrypt_next_index = esp6_encrypt_next_index;
  node = vlib_get_node_by_name (vm, (u8*)esp6_decrypt_node_name);
  ASSERT (node);
  b->esp6_decrypt_node_index = node->index;
...
ipsec_init (vlib_main_t * vm)
{
  ...
  u32 idx = ipsec_register_ah_backend (vm, im, "default openssl backend",
				       "ah4-encrypt",
				       IPSEC_OUTPUT_NEXT_AH4_ENCRYPT,
				       "ah4-decrypt",
				       IPSEC_INPUT_NEXT_AH4_DECRYPT,
				       "ah6-encrypt",
				       IPSEC_OUTPUT_NEXT_AH6_ENCRYPT,
				       "ah6-decrypt",
				       IPSEC_INPUT_NEXT_AH6_DECRYPT,
				       ipsec_check_support,
				       NULL);
  ...
  idx = ipsec_register_esp_backend (vm, im, "default openssl backend",
				    ...
				    "esp4-decrypt",
				    IPSEC_INPUT_NEXT_ESP4_DECRYPT,
				    "esp6-encrypt",
				    IPSEC_OUTPUT_NEXT_ESP6_ENCRYPT,
				    "esp6-decrypt",
				    IPSEC_INPUT_NEXT_ESP6_DECRYPT,
