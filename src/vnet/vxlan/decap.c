             ...
             u32 is_ip4)
{
  ...
  while (n_left_from > 0)
           ...
           if (PREDICT_FALSE (key4_0.as_u64 != last_key4.as_u64))
              {
                ...
                last_key4 = key4_0;
                tunnel_index0 = last_tunnel_index = p[0];
              }
            else
	...
	next0:
          ...
          u32 sw_if_index0 = t0->sw_if_index;
	  ...
	  sw_if_index0 = stats_t0->sw_if_index;
	    ...
	    if (PREDICT_FALSE (key4_1.as_u64 != last_key4.as_u64))
              {
                ...
                last_key4 = key4_1;
                tunnel_index1 = last_tunnel_index = p[0];
              }
            else
	...
	next1:
          ...
          u32 sw_if_index1 = t1->sw_if_index;
	  ...
	  sw_if_index1 = stats_t1->sw_if_index;
      ...
      while (n_left_from > 0 && n_left_to_next > 0)
	{
	  ...
	  u32 next0;
          ip4_header_t * ip4_0;
          ip6_header_t * ip6_0;
          vxlan_tunnel_t * t0, * stats_t0 = NULL;
