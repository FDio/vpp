					      ...
					      vlib_frame_t * f)
{
  ...
  while (n_left_from > 0)
  {
    ...
    while (n_left_from > 3 && n_left_to_next > 3)
    {
      ...
      u8 ip_err1 = vxlan_check_ip (b1);
      u8 ip_err2 = vxlan_check_ip (b2);
      u8 ip_err3 = vxlan_check_ip (b3);
      ...
      u32 t_index1 = vnet_buffer2 (b1)->flow_id - vxm->flow_id_start;
      u32 t_index2 = vnet_buffer2 (b2)->flow_id - vxm->flow_id_start;
      u32 t_index3 = vnet_buffer2 (b3)->flow_id - vxm->flow_id_start;
