...
#define foreach_punt_reason         \
  _(IP4_ACL_DENY, "ip4 ACL-deny")   \
  _(IP6_ACL_DENY, "ip6 ACL-deny")
 ...
 */
extern int punt_reason_alloc (punt_hdl_t client,
...
extern int punt_register (punt_hdl_t client,
			  punt_reason_t reason, const char *node);
extern int punt_unregister (punt_hdl_t client,
			    punt_reason_t pr, const char *node);
