  ...
  while (areg)
    {
      ...
      vca = &cm->config_arc;
      if ((error = vnet_feature_arc_init (vm, vca, areg->start_nodes, areg->n_start_nodes,
					...
					u32 n_feature_config_bytes)
{
  ...
  ci = (enable_disable ? vnet_config_add_feature : vnet_config_del_feature) (
    vlib_get_main (), &cm->config_arc, ci, feature_index, feature_config, n_feature_config_bytes);
  if (ci == ~0)
    {
      return 0;
    }
...
vnet_feature_get_end_node (u8 arc_index, u32 sw_if_index)
{
  ...
  return (vnet_config_get_end_node (vlib_get_main (), &cm->config_arc, ci));
}
...
vnet_feature_reset_end_node (u8 arc_index, u32 sw_if_index)
{
  ...
  ci = vnet_config_reset_end_node (vlib_get_main (), &cm->config_arc, ci);
			      ...
			      u32 sw_if_index, u32 end_node_index)
{
  ...
  ci = vnet_config_modify_end_node (vlib_get_main (), &cm->config_arc, ci, end_node_index);
