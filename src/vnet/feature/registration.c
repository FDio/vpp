 ...
 */
clib_error_t *
vnet_feature_arc_init (vlib_main_t *vm, vnet_config_arc_t *vca, char **feature_start_nodes,
...
again:
  ...
  vnet_config_arc_init (vm, vca, &feature_main.feature_config_main, feature_start_nodes,
			num_feature_start_nodes, feature_nodes, vec_len (feature_nodes));
