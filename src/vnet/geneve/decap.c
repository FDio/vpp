...
{
  .function = geneve4_input,.name = "geneve4-input",
    /* Takes a vector of packets. */
    .vector_size = sizeof (u32),.n_errors = GENEVE_N_ERROR,.error_strings =
    geneve_error_strings,.n_next_nodes = GENEVE_INPUT_N_NEXT,.next_nodes =
  {
...
{
  .function = geneve6_input,.name = "geneve6-input",
    /* Takes a vector of packets. */
    .vector_size = sizeof (u32),.n_errors = GENEVE_N_ERROR,.error_strings =
    geneve_error_strings,.n_next_nodes = GENEVE_INPUT_N_NEXT,.next_nodes =
  {
