      ...
      while (n_left_from >= 4 && n_left_to_next >= 2)
	{
	  ...
	  b1 = vlib_get_buffer (vm, bi1);
	    ...
	    vlib_buffer_advance
          ...
          if (is_ip4) {
            vlib_buffer_advance
              (b0, sizeof(*ip4_0)+sizeof(udp_header_t)+sizeof(*geneve0));
	    vlib_buffer_advance
              (b1, sizeof(*ip4_1)+sizeof(udp_header_t)+sizeof(*geneve1));
          } else {
	    vlib_buffer_advance
              (b0, sizeof(*ip6_0)+sizeof(udp_header_t)+sizeof(*geneve0));
            vlib_buffer_advance
              (b1, sizeof(*ip6_1)+sizeof(udp_header_t)+sizeof(*geneve1));
          }
