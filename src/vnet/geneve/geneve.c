...
{
.name = "GENEVE",.format_device_name = format_geneve_name,.format_tx_trace =
    format_geneve_encap_trace,.tx_function =
...
{
.name = "GENEVE",.format_header =
    format_geneve_header_with_length,.build_rewrite = default_build_rewrite,};
