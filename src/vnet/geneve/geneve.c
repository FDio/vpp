...
geneve_tunnel_back_walk (fib_node_t *node,
...
#undef _
      ...
      /* copy the key */
      if (is_ip6)
        hash_set_key_copy (&vxm->geneve6_tunnel_by_key, &key6, t - vxm->tunnels);
      else
      ...
      if (!ip46_address_is_multicast(&t->dst))
        {
	     ...
	     FIB_ENTRY_FLAG_NONE);
          t->sibling_index = fib_entry_child_add
            (t->fib_entry_index, FIB_NODE_TYPE_GENEVE_TUNNEL, t - vxm->tunnels);
