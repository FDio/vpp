  ...
  while (n_left_from > 0)
      ...
      while (n_left_from >= 4 && n_left_to_next >= 2)
	{
	  ...
	  u32 len0, len1;
          ...
          u64 * copy_local0, * copy_remote0;
          u64 * copy_local1, * copy_remote1;
          u32 * copy_local_last0, * copy_remote_last0;
          u32 * copy_local_last1, * copy_remote_last1;
          u16 new_l0, new_l1;
          ip_csum_t sum0, sum1;
	  ...
	  if (is_ip4)
	    {
	      ...
	      copy_remote0 = (u64 *) ip4_0;
	      copy_local0 = (u64 *) t0->rewrite;
	      copy_remote1 = (u64 *) ip4_1;
	      copy_local1 = (u64 *) t1->rewrite;
	      /* Copy first 32 octets 8-bytes at a time */
#define _(offs) copy_remote0[offs] = copy_local0[offs];
	      foreach_fixed_header4_offset;
#undef _
#define _(offs) copy_remote1[offs] = copy_local1[offs];
	      foreach_fixed_header4_offset;
#undef _
	      /* Last 4 octets. Hopefully gcc will be our friend */
              copy_remote_last0 = (u32 *)(&copy_remote0[4]);
              copy_local_last0 = (u32 *)(&copy_local0[4]);
              copy_remote_last0[0] = copy_local_last0[0];
              copy_remote_last1 = (u32 *)(&copy_remote1[4]);
              copy_local_last1 = (u32 *)(&copy_local1[4]);
              copy_remote_last1[0] = copy_local_last1[0];
	  ...
	  else /* ipv6 */
	    {
	      ...
	      /* Copy the fixed header */
	      copy_remote0 = (u64 *) ip6_0;
	      copy_local0 = (u64 *) t0->rewrite;
	      copy_remote1 = (u64 *) ip6_1;
	      copy_local1 = (u64 *) t1->rewrite;
