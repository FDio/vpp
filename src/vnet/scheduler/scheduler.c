				   ...
				   u32 *consumer_thread_indices, u32 n_cti)
{
  ...
  clib_bitmap_validate (pt, tm->n_vlib_mains);
  clib_bitmap_validate (wt, tm->n_vlib_mains);
  clib_bitmap_validate (ct, tm->n_vlib_mains);
...
vnet_scheduler_init (vlib_main_t *vm)
{
  ...
  clib_bitmap_validate (sm->producer_thread_indices, tm->n_vlib_mains);
  clib_bitmap_validate (sm->worker_thread_indices, tm->n_vlib_mains);
  clib_bitmap_validate (sm->consumer_thread_indices, tm->n_vlib_mains);
