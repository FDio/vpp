 ...
 */
#define foreach_scheduler_dispatch_next \
 ...
 */
typedef int (vnet_scheduler_thread_role_cfg_t) (vlib_main_t * vm,
...
vnet_scheduler_enqueue_buffers (vlib_main_t * vm,
				vnet_scheduler_event_type_t type,
				u32 * buffers, u16 * scheduler_nexts,
				u32 n_buffers, int drop_on_congestion)
{
  vnet_scheduler_main_t *sm = &scheduler_main;
  u32 enqueued = 0;
