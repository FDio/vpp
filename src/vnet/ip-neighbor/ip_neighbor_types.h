...
#define IP_NEIGHBOR_CTR_INIT(_ctr, _proto)                                    \
  ip_neighbor_counters_t _ctr = {                                       \
    .ipnc = {                                                           \
      [VLIB_RX] = {                                                     \
        [IP_NEIGHBOR_CTR_REPLY] = {                                     \
          .name = _proto "-rx-replies",                                 \
          .stat_segment_name = "/net/" _proto "/rx/replies",            \
        },                                                              \
        [IP_NEIGHBOR_CTR_REQUEST] = {                                   \
          .name = _proto "-rx-requests",                                \
          .stat_segment_name = "/net/" _proto "/rx/requests",           \
        },                                                              \
        [IP_NEIGHBOR_CTR_GRAT] = {                                      \
          .name = _proto "-rx-gratuitous",                              \
          .stat_segment_name = "/net/" _proto "/rx/gratuitous",         \
        },                                                              \
      },                                                                \
      [VLIB_TX] = {                                                     \
        [IP_NEIGHBOR_CTR_REPLY] = {                                     \
          .name = _proto "-tx-replies",                                 \
          .stat_segment_name = "/net/" _proto "/tx/replies",            \
        },                                                              \
        [IP_NEIGHBOR_CTR_REQUEST] = {                                   \
          .name = _proto "-tx-requests",                                \
          .stat_segment_name = "/net/" _proto "/tx/requests",           \
        },                                                              \
        [IP_NEIGHBOR_CTR_GRAT] = {                                      \
          .name = _proto "-tx-gratuitous",                              \
          .stat_segment_name = "/net/" _proto "/tx/gratuitous",         \
        },                                                              \
      },                                                                \
    },                                                                  \
  };
