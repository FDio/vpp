...
static inline adj_midchain_delegate_t*
adj_midchain_from_base (adj_delegate_t *ad)
{
    if (NULL != ad)
    {
...
/**
 * @brief Callback function registered with MIDCHAIN module to receive notifications
 * of the CRUD of MIDCHAIN sessions
