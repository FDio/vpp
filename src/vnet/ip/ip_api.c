...
ip_api_hookup (vlib_main_t * vm)
{
   ...
   */
  vl_api_msg_set_mp_safe (VL_API_IP_ROUTE_ADD_DEL, 1);
  vl_api_msg_set_mp_safe (VL_API_IP_ROUTE_ADD_DEL_REPLY, 1);
  vl_api_msg_set_mp_safe (VL_API_IP_ROUTE_ADD_DEL_V2, 1);
  vl_api_msg_set_mp_safe (VL_API_IP_ROUTE_ADD_DEL_V2_REPLY, 1);
