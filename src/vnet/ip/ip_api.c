                       ...
                       fib_node_index_t fib_entry_index)
{
  ...
  mp->route.table_id = htonl (fib_table_get_table_id(fib_entry_get_fib_index(fib_entry_index),
                                                     pfx->fp_proto));
                        ...
                        fib_node_index_t mfib_entry_index)
{
  ...
  mp->table_id = htonl (mfib_table_get_table_id(mfib_entry_get_fib_index(mfib_entry_index),
                                                pfx->fp_proto));
...
api_mroute_add_del_t_handler (vl_api_ip_mroute_add_del_t * mp)
{
  ...
  rv = mfib_api_path_decode (apath, rpath);
