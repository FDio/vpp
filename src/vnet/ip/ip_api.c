...
_(SEND_ROUTER_SOLICITATION, send_router_solicitation)                   \
...
static void
vl_api_send_router_solicitation_t_handler (vl_api_send_router_solicitation_t *
					   mp)
{
  vl_api_send_router_solicitation_reply_t *rmp;
  ...
  BAD_SW_IF_INDEX_LABEL;
  REPLY_MACRO (VL_API_SEND_ROUTER_SOLICITATION_REPLY);
