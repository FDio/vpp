  ...
  vl_api_ip6_destination_options_enable_disable_t *mp)
{
  ...
  if (mp->enable)
    ...
    {
      rv = ip6_destination_options_enable_disable (0 /* disable */);
    }
...
void
vl_api_ip6_destination_options_get_t_handler (
  vl_api_ip6_destination_options_get_t *mp)
{
  vl_api_ip6_destination_options_get_reply_t *rmp;
  int rv = 0;
  u8 is_enabled;

  is_enabled = ip6_destination_options_is_enabled ();

  REPLY_MACRO2 (VL_API_IP6_DESTINATION_OPTIONS_GET_REPLY,
