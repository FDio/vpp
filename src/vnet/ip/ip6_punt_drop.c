...
static uword
ip6_drop_or_punt_arc_end (vlib_main_t * vm,
...
static uword
ip6_punt_end_of_arc (vlib_main_t * vm,
		     vlib_node_runtime_t * node, vlib_frame_t * frame)
{
  return ip6_drop_or_punt_arc_end (vm, node, frame, IP6_ERROR_PUNT);
}

static uword
ip6_drop_end_of_arc (vlib_main_t * vm,
		     vlib_node_runtime_t * node, vlib_frame_t * frame)
{
  return ip6_drop_or_punt_arc_end (vm, node, frame, IP6_ERROR_DROP);
}
...
VLIB_REGISTER_NODE (ip6_punt_node_end_of_arc,static) = {
  .function = ip6_punt_end_of_arc,
  .format_trace = format_ip6_forward_next_trace,
  .name = "ip6-punt-end-of-arc",
  .vector_size = sizeof (u32),
  .sibling_of = "ip6-punt",
};

VLIB_NODE_FUNCTION_MULTIARCH (ip6_punt_node_end_of_arc,
                              ip6_punt_end_of_arc);

VLIB_REGISTER_NODE (ip6_drop_node_end_of_arc,static) = {
  .function = ip6_drop_end_of_arc,
  .format_trace = format_ip6_forward_next_trace,
  .name = "ip6-drop-end-of-arc",
  .vector_size = sizeof (u32),
  .sibling_of = "ip6-drop",
};

VLIB_NODE_FUNCTION_MULTIARCH (ip6_drop_node_end_of_arc,
                              ip6_drop_end_of_arc);

VNET_FEATURE_INIT (ip6_punt_end_of_arc, static) = {
  .arc_name = "ip6-punt",
  .node_name = "ip6-punt-end-of-arc",
  .runs_before = 0, /* not before any other features */
};

VNET_FEATURE_INIT (ip6_drop_end_of_arc, static) = {
  .arc_name = "ip6-drop",
  .node_name = "ip6-drop-end-of-arc",
  .runs_before = 0, /* not before any other features */
};
/* *INDENT-ON */
...
VNET_FEATURE_INIT (ip6_punt_redirect_node, static) = {
  ...
  .runs_before = VNET_FEATURES("ip6-punt-end-of-arc")
};
/* *INDENT-ON* */
