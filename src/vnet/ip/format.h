...
__clib_export format_function_t format_ip_protocol;
__clib_export unformat_function_t unformat_ip_protocol;
...
__clib_export format_function_t format_ip_adjacency;
__clib_export format_function_t format_ip_adjacency_packet_data;
...
__clib_export unformat_function_t unformat_ip46_address;

/* IP4 */

/* Parse an IP4 address %d.%d.%d.%d. */
__clib_export unformat_function_t unformat_ip4_address;
/* Parse an IP4 address and mask %d.%d.%d.%d/%d.%d.%d.%d */
unformat_function_t unformat_ip4_address_and_mask;

/* Format an IP4 address. */
__clib_export format_function_t format_ip4_address;
...
__clib_export format_function_t format_ip4_header;
...
/* IP6 */
__clib_export unformat_function_t unformat_ip6_address;
unformat_function_t unformat_ip6_address_and_mask;
__clib_export format_function_t format_ip6_address;
__clib_export format_function_t format_ip6_address_and_length;
format_function_t format_ip6_address_and_mask;
unformat_function_t unformat_ip6_header;
__clib_export format_function_t format_ip6_header;
format_function_t format_ip6_frag_hdr;
unformat_function_t unformat_pg_ip6_header;

/* Format a TCP/UDP headers. */
__clib_export format_function_t format_tcp_header, format_udp_header;
