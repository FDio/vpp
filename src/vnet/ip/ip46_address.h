...
#define FOR_EACH_IP46_TYPE(_type) \
...
extern void ip46_address_increment (ip46_type_t type,
                                    ip46_address_t * ip);
extern u32 ip4_address_get_range (const ip4_address_t *srart,
                                  const ip4_address_t *end);
extern u32 ip6_address_get_range (const ip6_address_t *srart,
                                  const ip6_address_t *end);
extern u32 ip46_address_get_range (ip46_type_t type,
                                   const ip46_address_t *srart,
