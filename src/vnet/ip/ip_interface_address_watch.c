...
static uword
ip_interface_address_event_process (vlib_main_t *vm, vlib_node_runtime_t *rt,
				    vlib_frame_t *f)
{
...
static void
common_interface_address_signal (ip46_type_t type, u32 sw_if_index,
				 void *address, u32 prefix_len, u32 is_delete)
{
  ...
  for (i = 0; i < 2; i++)
      ...
      vec_foreach (watcher, watchers)
	{
	  ...
	  event = vlib_process_signal_event_data (
	    vlib_get_main (), ip_interface_address_event_process_node.index,
...
static void
ip4_interface_address_signal (ip4_main_t *im, uword opaque, u32 sw_if_index,
			      ip4_address_t *address, u32 prefix_len,
...
static void
ip6_interface_address_signal (ip6_main_t *im, uword opaque, u32 sw_if_index,
			      ip6_address_t *address, u32 prefix_len,
			      u32 if_address_index, u32 is_delete)
{
