...
always_inline void
ip4_dv_reass_free (vlib_main_t *vm, ip4_dv_reass_main_t * rm, ip4_dv_reass_per_thread_t * rt,
    ...
    .next_nodes =
        {
                [IP4_DV_REASSEMBLY_NEXT_INPUT] = "ip4-input",
                [IP4_DV_REASSEMBLY_NEXT_DROP] = "ip4-drop",
                [IP4_DV_REASSEMBLY_NEXT_HANDOFF] = "ip4-dr-feature-hoff",
        },
};
/* *INDENT-ON* */
