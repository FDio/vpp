...
always_inline void
ip6_dv_reass_free (ip6_dv_reass_main_t * rm,
...
ip6_dv_reass_finalize (vlib_main_t * vm, vlib_node_runtime_t * node,
		       ip6_dv_reass_main_t * rm,
		       ip6_dv_reass_per_thread_t * rt,
		       ip6_dv_reass_t * reass, u32 * bi0, u32 * next0,
		       u32 * error0, bool is_feature)
{
  *bi0 = reass->first_bi;
  *error0 = IP6_ERROR_NONE;
  ...
  ip6_dv_reass_rc_t rv = IP6_DV_REASS_RC_OK;
  do
    {
...
ip6_dv_reass_update (vlib_main_t * vm, vlib_node_runtime_t * node,
		     ...
		     ip6_dv_reass_per_thread_t * rt,
		     ip6_dv_reass_t * reass, u32 * bi0, u32 * next0,
		     u32 * error0, ip6_frag_hdr_t * frag_hdr, bool is_feature)
{
  int consumed = 0;
...
check_if_done_maybe:
  ...
  if (~0 != reass->last_packet_octet &&
    ...
    {
      return ip6_dv_reass_finalize (vm, node, rm, rt, reass, bi0, next0,
				    error0, is_feature);
    }
  else
    {
