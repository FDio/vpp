...
typedef struct
{
  ...
  // extended reassembly flag - see ip4_sv_reass_enable_disable_extended()
  bool extended;
} ip4_sv_reass_main_t;
...
{
  ip4_sv_reass_main.extended = is_enable;
}
			    ...
			    struct ip4_sv_lock_unlock_args *a)
{
  ...
  if (!vec_is_member (per_thread, ip4_sv_reass_main.per_thread_data))
    return -1;
