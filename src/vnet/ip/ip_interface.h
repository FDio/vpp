...
clib_error_t *ip_interface_address_add (ip_lookup_main_t *lm, u32 sw_if_index,
					void *address, u32 address_length,
					u32 *result_index);
clib_error_t *ip_interface_address_del (ip_lookup_main_t *lm, vnet_main_t *vnm,
...
u32 ip_interface_address_find (ip_lookup_main_t *lm, void *addr_fib,
			       u32 address_length);
