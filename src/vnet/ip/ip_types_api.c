...
int
ip_address_family_decode (u8 _af, ip_address_family_t * out)
{
  vl_api_address_family_t af = _af;
...
int
ip_proto_decode (u8 _ipp, ip_protocol_t * out)
{
  ip_protocol_t ipp = _ipp;
