...
__clib_export extern u8 ip_is_zero (ip46_address_t *ip46_address, u8 is_ip4);
extern u8 ip_is_local_host (ip46_address_t *ip46_address, u8 is_ip4);
__clib_export extern void ip_copy (ip46_address_t *dst, ip46_address_t *src, u8 is_ip4);
