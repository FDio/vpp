 ...
 */
bool
ip6_sas (u32 table_id, u32 sw_if_index, const ip6_address_t *dst, ip6_address_t *src)
{
  fib_prefix_t prefix;
 ...
 */
bool
ip4_sas (u32 table_id, u32 sw_if_index, const ip4_address_t *dst, ip4_address_t *src)
{
  fib_prefix_t prefix;
  u32 if_index = sw_if_index;
