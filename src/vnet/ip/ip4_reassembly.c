    ...
    .next_nodes =
        {
                [IP4_REASSEMBLY_NEXT_INPUT] = "ip4-input",
                [IP4_REASSEMBLY_NEXT_DROP] = "ip4-drop",
                [IP4_REASSEMBLY_NEXT_HANDOFF] = "ip4-reassembly-feature-handoff",
        },
};
/* *INDENT-ON* */
...
always_inline uword
ip4_reassembly_handoff_node_fn (vlib_main_t * vm,
				vlib_node_runtime_t * node,
				vlib_frame_t * frame, bool is_feature)
{
  ip4_reass_main_t *rm = &ip4_reass_main;
...
static uword
ip4_reassembly_handoff (vlib_main_t * vm,
			vlib_node_runtime_t * node, vlib_frame_t * frame)
{
  return ip4_reassembly_handoff_node_fn (vm, node, frame,
					 false /* is_feature */ );
}
...
VLIB_REGISTER_NODE (ip4_reassembly_handoff_node) = {
  .function = ip4_reassembly_handoff,
...
VLIB_NODE_FUNCTION_MULTIARCH (ip4_reassembly_handoff_node,
			      ip4_reassembly_handoff);


static uword
ip4_reassembly_feature_handoff (vlib_main_t * vm,
				vlib_node_runtime_t * node,
				vlib_frame_t * frame)
{
  return ip4_reassembly_handoff_node_fn (vm, node, frame,
...
VLIB_REGISTER_NODE (ip4_reassembly_feature_handoff_node) = {
  .function = ip4_reassembly_feature_handoff,
  .name = "ip4-reassembly-feature-handoff",
  .vector_size = sizeof (u32),
  .format_trace = format_ip4_reassembly_handoff_trace,
  .type = VLIB_NODE_TYPE_INTERNAL,
  .n_errors = ARRAY_LEN(ip4_reassembly_handoff_error_strings),
...
VLIB_NODE_FUNCTION_MULTIARCH (ip4_reassembly_feature_handoff_node,
			      ip4_reassembly_feature_handoff);
