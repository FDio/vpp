...
static int
api_ip_forus_reass_enable_disable (vat_main_t *vat)
{
  return -1;
}

static int
api_ip_forus_reass_get (vat_main_t *vat)
{
  return -1;
}

static void
vl_api_ip_forus_reass_get_reply_t_handler (
  vl_api_ip_forus_reass_get_reply_t *mp)
{
}
