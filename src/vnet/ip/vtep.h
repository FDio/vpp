...
always_inline u8
vtep4_check_avx512 (vtep_table_t * t, vlib_buffer_t * b0, ip4_header_t * ip40,
		    vtep4_key_t * last_k4, vtep4_cache_t * vtep4_u512)
{
  ...
  u8 result = u64x8_mask_cmpeq (0xff, cache, k4_u64x8);
  if (PREDICT_TRUE (result != 0))
    {
      k4.as_u64 = vtep4_u512->vtep4_cache[__builtin_ctz (result)].as_u64;
      return VTEP_CHECK_PASS_UNCHANGED;
    }
#endif
