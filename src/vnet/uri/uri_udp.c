...
u32
vnet_bind_ip4_udp_uri (vlib_main_t * vm, u32 session_index,
...
u32
vnet_bind_ip6_udp_uri (vlib_main_t * vm, u32 session_index,
		       ip46_address_t * ip, u16 port_number_host_byte_order)
{
  udp_session_t *listener;
  pool_get (udp_listeners, listener);
...
u32
uri_tx_ip6_udp (vlib_main_t * vm, stream_session_t * s, vlib_buffer_t * b)
{
  clib_warning ("unimplmented");
  return 0;
}
...
u32
uri_tx_fifo (vlib_main_t * vm, stream_session_t * s, vlib_buffer_t * b)
{
  clib_warning ("unimplmented");
  return 0;
}
