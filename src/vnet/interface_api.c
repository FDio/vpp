			   ...
			   u8 * interface_name, u32 context)
{
  ...
  vl_api_sw_interface_details_t *mp = vl_msg_api_alloc (sizeof (*mp) + if_name_len + tag_len);
  ...
  p += vl_api_to_api_string (if_name_len, (char *) interface_name, (vl_api_string_t *)p);
  if (tag != NULL)
