...
interface_api_hookup (vlib_main_t * vm)
{
  ...
  vl_api_msg_set_mp_safe (REPLY_MSG_ID_BASE + VL_API_SW_INTERFACE_DUMP, 1);
  vl_api_msg_set_mp_safe (REPLY_MSG_ID_BASE + VL_API_SW_INTERFACE_DETAILS, 1);
  vl_api_msg_set_mp_safe (REPLY_MSG_ID_BASE + VL_API_SW_INTERFACE_TAG_ADD_DEL,
			  1);
  vl_api_msg_set_mp_safe (
    REPLY_MSG_ID_BASE + VL_API_SW_INTERFACE_SET_INTERFACE_NAME, 1);

  /* Do not replay VL_API_SW_INTERFACE_DUMP messages */
  vl_api_msg_replay_enable (REPLY_MSG_ID_BASE + VL_API_SW_INTERFACE_DUMP, 0);

  /* Mark these APIs as autoendian */
  vl_api_msg_set_autoendian (
    REPLY_MSG_ID_BASE + VL_API_SW_INTERFACE_SET_TX_PLACEMENT, 1);
  vl_api_msg_set_autoendian (
    REPLY_MSG_ID_BASE + VL_API_SW_INTERFACE_TX_PLACEMENT_GET, 1);
