		     ...
		     u16 port_host_byte_order, u8 is_ip4)
{
  ...
  TCP_EVT_DBG(listener, TCP_EVT_BIND);
...
tcp_connection_unbind (u32 listener_index)
{
  ...
  TCP_EVT_DBG(pool_elt_at_index(tm->listener_pool, listener_index),
	      TCP_EVT_UNBIND);
