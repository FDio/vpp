 ...
 *
 * Additionally, if our window is 0 and the packet is in sequence, let it pass
 * through. It should be dropped later.
 *
 */
always_inline u8
		 ...
		 u16 n_data_bytes, u32 * next0)
{
  ...
  if (PREDICT_FALSE (tc->rcv_wnd == 0))
    {
      error = TCP_ERROR_NO_WND;
      *next0 = TCP_NEXT_DROP;
      goto done;
    }
