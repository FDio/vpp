 ...
 * better precision time measurements, i.e., mrtt must be provided as us
 * multiple. Note that timestamps are measured as ms multiples so they
 * must be converted before calling this function.
 */
static void
