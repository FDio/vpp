...
#ifndef TLS_RECORD_H__
#define TLS_RECORD_H__
...
STATIC_ASSERT_SIZEOF (tls_record_header_t, TLS_HEADER_LEN);
...
u8 tls_record_hdr_is_valid (tls_record_header_t rec_hdr);
tls_handshake_parse_error_t
