...
static void
tls_ho_pool_realloc_rpc (void *rpc_args)
{
  tls_main_t *tm = &tls_main;

  pool_realloc_safe_aligned (tm->half_open_ctx_pool, CLIB_CACHE_LINE_BYTES);
}
...
tls_ctx_half_open_alloc (void)
{
  ...
  pool_get_aligned_safe (tm->half_open_ctx_pool, ctx, 0 /* thread index */,
			 tls_ho_pool_realloc_rpc, CLIB_CACHE_LINE_BYTES);
