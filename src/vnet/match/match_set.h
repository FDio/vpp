...
#define MATCH_SET_POS_MISS_INIT {               \
    .msp_list_index = MATCH_RESULT_MISS,        \
...
const static match_set_result_t MATCH_SET_RESULT_MISS = {
  .msr_pos = MATCH_SET_POS_MISS_INIT,
};

static_always_inline bool
match_set_result_is_hit (const match_set_result_t * msr)
{
  return (msr->msr_pos.msp_rule_index != MATCH_RESULT_MISS);
}
...
extern bool match_set_is_empty (index_t msi);
