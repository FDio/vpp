...
typedef struct match_icmp_range_t_
{
  u16 mir_begin;
  u16 mir_end;
} match_icmp_range_t;

extern u8 *format_match_icmp_range (u8 * s, va_list * args);
...
#define MATCH_TYPE_EASIEST MATCH_TYPE_MASK_SRC_IP_MAC
#define MATCH_TYPE_HARDEST MATCH_TYPE_MASK_N_TUPLE
