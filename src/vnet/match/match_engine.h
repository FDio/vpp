...
typedef void (*match_engine_apply_t) (match_set_t * mt,
				      ...
				      match_set_app_t * msa);
typedef void (*match_engine_update_t) (match_set_t * mt,
				       const match_set_app_t * msa);
typedef void (*match_engine_list_delete_t) (match_set_t * mt,
					    index_t msei,
					    const match_set_app_t * msa);
typedef void (*match_engine_list_update_t) (match_set_t * mt,
					    index_t msei,
					    const match_set_app_t * msa);
...
typedef struct match_engine_vft_t_
{
  ...
  match_engine_update_t mev_update;
  match_engine_unapply_t mev_unapply;
  match_engine_list_update_t mev_list_update;
  match_engine_list_delete_t mev_list_delete;
