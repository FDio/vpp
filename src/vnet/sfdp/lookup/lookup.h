...
#define foreach_sfdp_lookup_error                                                                  \
  ...
  _ (FLOW_OFFLOAD_SYNC_ENABLE_OK, "flow offload sync enable ok")                                   \
  _ (FLOW_OFFLOAD_SYNC_ENABLE_FAILED, "flow offload sync enable failed")                           \
  _ (FLOW_OFFLOAD_ASYNC_ENABLE_OK, "flow offload async enable ok")                                 \
  _ (FLOW_OFFLOAD_ASYNC_ENABLE_FAILED, "flow offload async enable failed")
