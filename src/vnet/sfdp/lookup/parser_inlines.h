...
sfdp_parser_create_session_inline (const sfdp_parser_registration_t *reg, uword parser_data_index,
				   ...
				   sfdp_tenant_t *tenant, u32 tenant_idx, u16 thread_index,
				   f64 time_now, void *k, u64 *h, u64 *lookup_val, u32 scope_index,
				   void *kv, const uword key_size, void *table_bihash)
{
  u64 value;
  u8 proto;
