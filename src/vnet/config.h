...
typedef struct _vnet_config_main_t vnet_config_main_t;
...
struct _vnet_config_main_t
{
  ...
  /* Arc-local metadata used by control-plane config operations. */
  vnet_config_arc_t *arc;
};
...
void vnet_config_init (vlib_main_t *vm, vnet_config_main_t *cm, char *start_node_names[],
		       int n_start_node_names, char *feature_node_names[],
...
u32 vnet_config_add_feature (vlib_main_t *vm, vnet_config_main_t *cm, u32 config_id,
			     u32 feature_index, void *feature_config, u32 n_feature_config_bytes);

u32 vnet_config_del_feature (vlib_main_t *vm, vnet_config_main_t *cm, u32 config_id,
			     u32 feature_index, void *feature_config, u32 n_feature_config_bytes);

u32 vnet_config_modify_end_node (vlib_main_t *vm, vnet_config_main_t *cm,
