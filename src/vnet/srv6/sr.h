...
{
  uword next_node;
  sr_policy_callback_t *creation;			/**< Function within plugin that will be called after policy creation*/
  sr_policy_callback_t *removal;			/**< Function within plugin that will be called before policy removal */
  sr_policy_callback_t *encap_creation;			/**< Function within plugin that will be called after encap policy creation*/
  sr_policy_callback_t *encap_removal;			/**< Function within plugin that will be called before encap policy removal */
