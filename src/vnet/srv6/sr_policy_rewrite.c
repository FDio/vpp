...
compute_rewrite_insert (ip6_address_t * sl, u8 is_ioam_trace_tlv_present, u8 is_ioam_e2e_tlv_present)
{
  ...
  if (hm->options_size[SRH_OPTION_TYPE_IOAM_TRACE_DATA_LIST] == 0)
  {
      hm->get_sizeof_options[SRH_OPTION_TYPE_IOAM_TRACE_DATA_LIST](&size);
      hm->options_size[SRH_OPTION_TYPE_IOAM_TRACE_DATA_LIST] = size;
  }
