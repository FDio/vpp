...
{
  _clib_memcpy (&sr_pr_encaps_src, address, sizeof (sr_pr_encaps_src));
}
  ...
  if (vec_len (sl) > 1)
    {
      ...
      {
	_clib_memcpy (addrp->as_u8, this_address->as_u8,
...
compute_rewrite_insert (ip6_address_t * sl)
{
  ...
  vec_foreach (this_address, sl)
  {
    _clib_memcpy (addrp->as_u8, this_address->as_u8, sizeof (ip6_address_t));
    addrp--;
  }
  return rs;
}
	       ...
	       u32 weight, u8 behavior, u32 fib_table, u8 is_encap)
{
  ...
  _clib_memcpy (&sr_policy->bsid, bsid, sizeof (ip6_address_t));
		      ...
		      vlib_cli_command_t * cmd)
{
  ...
  while (unformat_check_input (input) != UNFORMAT_END_OF_INPUT)
	...
	if (unformat (input, "next %U", unformat_ip6_address, &next_address))
	{
	  ...
	  _clib_memcpy (this_seg->as_u8, next_address.as_u8,
			sizeof (*this_seg));
	}
			  ...
			  vlib_frame_t * from_frame)
{
  ...
  while (n_left_from > 0)
      ...
      while (n_left_from >= 8 && n_left_to_next >= 4)
	{
	  ...
	  _clib_memcpy (((u8 *) ip0_encap) - vec_len (sl0->rewrite),
			sl0->rewrite, vec_len (sl0->rewrite));
	  _clib_memcpy (((u8 *) ip1_encap) - vec_len (sl1->rewrite),
			sl1->rewrite, vec_len (sl1->rewrite));
	  _clib_memcpy (((u8 *) ip2_encap) - vec_len (sl2->rewrite),
			sl2->rewrite, vec_len (sl2->rewrite));
	  _clib_memcpy (((u8 *) ip3_encap) - vec_len (sl3->rewrite),
	  ...
	  if (PREDICT_FALSE ((node->flags & VLIB_NODE_FLAG_TRACE)))
	      ...
	      if (PREDICT_FALSE (b1->flags & VLIB_BUFFER_IS_TRACED))
		{
		  ...
		  _clib_memcpy (tr->src.as_u8, ip1->src_address.as_u8,
				sizeof (tr->src.as_u8));
		  _clib_memcpy (tr->dst.as_u8, ip1->dst_address.as_u8,
				sizeof (tr->dst.as_u8));
		}
	      ...
	      if (PREDICT_FALSE (b2->flags & VLIB_BUFFER_IS_TRACED))
		{
		  ...
		  _clib_memcpy (tr->src.as_u8, ip2->src_address.as_u8,
				sizeof (tr->src.as_u8));
		  _clib_memcpy (tr->dst.as_u8, ip2->dst_address.as_u8,
				sizeof (tr->dst.as_u8));
		}
	      ...
	      if (PREDICT_FALSE (b3->flags & VLIB_BUFFER_IS_TRACED))
		{
		  ...
		  _clib_memcpy (tr->src.as_u8, ip3->src_address.as_u8,
				sizeof (tr->src.as_u8));
		  _clib_memcpy (tr->dst.as_u8, ip3->dst_address.as_u8,
				sizeof (tr->dst.as_u8));
		}
	    }
			     ...
			     vlib_frame_t * from_frame)
{
  ...
  while (n_left_from > 0)
      ...
      while (n_left_from >= 8 && n_left_to_next >= 4)
	{
	  ...
	  _clib_memcpy (((u8 *) en0) - vec_len (sl0->rewrite), sl0->rewrite,
			vec_len (sl0->rewrite));
	  _clib_memcpy (((u8 *) en1) - vec_len (sl1->rewrite), sl1->rewrite,
			vec_len (sl1->rewrite));
	  _clib_memcpy (((u8 *) en2) - vec_len (sl2->rewrite), sl2->rewrite,
			vec_len (sl2->rewrite));
	  _clib_memcpy (((u8 *) en3) - vec_len (sl3->rewrite), sl3->rewrite,
			vec_len (sl3->rewrite));
			  ...
			  vlib_frame_t * from_frame)
{
  ...
  while (n_left_from > 0)
      ...
      while (n_left_from >= 8 && n_left_to_next >= 4)
	{
	  ...
	  _clib_memcpy ((u8 *) ip0 - vec_len (sl0->rewrite), (u8 *) ip0,
			(void *) sr0 - (void *) ip0);
	  _clib_memcpy ((u8 *) ip1 - vec_len (sl1->rewrite), (u8 *) ip1,
			(void *) sr1 - (void *) ip1);
	  _clib_memcpy ((u8 *) ip2 - vec_len (sl2->rewrite), (u8 *) ip2,
			(void *) sr2 - (void *) ip2);
	  _clib_memcpy ((u8 *) ip3 - vec_len (sl3->rewrite), (u8 *) ip3,
			(void *) sr3 - (void *) ip3);

	  _clib_memcpy (((u8 *) sr0 - vec_len (sl0->rewrite)), sl0->rewrite,
			vec_len (sl0->rewrite));
	  _clib_memcpy (((u8 *) sr1 - vec_len (sl1->rewrite)), sl1->rewrite,
			vec_len (sl1->rewrite));
	  _clib_memcpy (((u8 *) sr2 - vec_len (sl2->rewrite)), sl2->rewrite,
			vec_len (sl2->rewrite));
	  _clib_memcpy (((u8 *) sr3 - vec_len (sl3->rewrite)), sl3->rewrite,
			vec_len (sl3->rewrite));
			    ...
			    vlib_frame_t * from_frame)
{
  ...
  while (n_left_from > 0)
      ...
      while (n_left_from >= 8 && n_left_to_next >= 4)
	{
	  ...
	  _clib_memcpy ((u8 *) ip0 - vec_len (sl0->rewrite_bsid), (u8 *) ip0,
			(void *) sr0 - (void *) ip0);
	  _clib_memcpy ((u8 *) ip1 - vec_len (sl1->rewrite_bsid), (u8 *) ip1,
			(void *) sr1 - (void *) ip1);
	  _clib_memcpy ((u8 *) ip2 - vec_len (sl2->rewrite_bsid), (u8 *) ip2,
			(void *) sr2 - (void *) ip2);
	  _clib_memcpy ((u8 *) ip3 - vec_len (sl3->rewrite_bsid), (u8 *) ip3,
			(void *) sr3 - (void *) ip3);

	  _clib_memcpy (((u8 *) sr0 - vec_len (sl0->rewrite_bsid)),
			sl0->rewrite_bsid, vec_len (sl0->rewrite_bsid));
	  _clib_memcpy (((u8 *) sr1 - vec_len (sl1->rewrite_bsid)),
			sl1->rewrite_bsid, vec_len (sl1->rewrite_bsid));
	  _clib_memcpy (((u8 *) sr2 - vec_len (sl2->rewrite_bsid)),
			sl2->rewrite_bsid, vec_len (sl2->rewrite_bsid));
	  _clib_memcpy (((u8 *) sr3 - vec_len (sl3->rewrite_bsid)),
