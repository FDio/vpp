...
static void send_sr_localsid_with_packet_stats_details
  (int local_sid_index, ip6_sr_localsid_t * t,
...
static void vl_api_sr_localsids_with_packet_stats_dump_t_handler
  (vl_api_sr_localsids_with_packet_stats_dump_t * mp)
{
  ...
  /* *INDENT-OFF* */
  pool_foreach (t, sm->localsids)  { vec_add1 (localsid_list, t); }
