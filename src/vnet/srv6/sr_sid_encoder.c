...
always_inline void 
alloc_sr_sid_encoder_flexible(void **mem_p, const void *v6src_addr, const void *v6dst_addr){
...
sr_sid_encoder_unformat_flaxible(unformat_input_t * input, va_list * args)
{
    ...
    {
        if (unformat (input, "flaxible %U %U", 
            unformat_ip6_address, &src_v6addr,
...
static void 
sr_sid_encoder_build_flaxible(void *mem_p, ip6_address_t *v6src_addr, ip6_address_t *v6dst_addr)
{
...
sr_sid_encoder_flaxible_init (vlib_main_t * vm)
{
    ...
    sr_sid_encoder_flavor_register_function(
        ...
        sr_sid_encoder_format_flaxible,
        sr_sid_encoder_unformat_flaxible,
        sr_sid_encoder_removal_flaxible,
