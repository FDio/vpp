...
vl_api_flow_del_t_handler (vl_api_flow_del_t * mp)
{
  ...
  vnet_main_t *vnm = vnet_get_main ();
  rv = vnet_flow_del_inline (vnm, ntohl (mp->flow_index));
...
vl_api_flow_enable_t_handler (vl_api_flow_enable_t * mp)
{
  ...
  vnet_main_t *vnm = vnet_get_main ();
  rv = vnet_flow_enable_inline (vnm, ntohl (mp->flow_index), ntohl (mp->hw_if_index));
...
vl_api_flow_disable_t_handler (vl_api_flow_disable_t * mp)
{
  ...
  vnet_main_t *vnm = vnet_get_main ();
  rv = vnet_flow_disable_inline (vnm, ntohl (mp->flow_index), ntohl (mp->hw_if_index));
