...
#define foreach_flow_entry_ip4                                                \
  _fe (ip4_address_and_mask_t, src_addr)                                      \
    _fe (ip4_address_and_mask_t, dst_addr) _fe (ip_prot_and_mask_t, protocol)

#define foreach_flow_entry_ip6                                                \
  _fe (ip6_address_and_mask_t, src_addr)                                      \
    _fe (ip6_address_and_mask_t, dst_addr) _fe (ip_prot_and_mask_t, protocol)

#define foreach_flow_entry_ip4_l2tpv3oip                                      \
  foreach_flow_entry_ip4 _fe (u32, session_id)
...
#define foreach_flow_entry_ip4_n_tuple                                        \
  foreach_flow_entry_ip4 _fe (ip_port_and_mask_t, src_port)                   \
    _fe (ip_port_and_mask_t, dst_port)

#define foreach_flow_entry_ip6_n_tuple                                        \
  foreach_flow_entry_ip6 _fe (ip_port_and_mask_t, src_port)                   \
    _fe (ip_port_and_mask_t, dst_port)
...
#define foreach_flow_entry_ip4_vxlan                                          \
  foreach_flow_entry_ip4_n_tuple _fe (u16, vni)

#define foreach_flow_entry_ip6_vxlan                                          \
  foreach_flow_entry_ip6_n_tuple _fe (u16, vni)

#define foreach_flow_entry_ip4_gtpc                                           \
  foreach_flow_entry_ip4_n_tuple _fe (u32, teid)
