...
int vnet_flow_range_bind (vnet_main_t *vnm, u32 range_index, u32 flow_index,
			  u32 *range_flow_index);
int vnet_flow_range_unbind (vnet_main_t *vnm, u32 range_index,
			    u32 range_flow_index, u32 *flow_index);
