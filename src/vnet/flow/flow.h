...
#define foreach_flow_type \
  ...
  _(IP4_N_TUPLE_VLANSENSITIVE, ip4_n_tuple_vlan, "ipv4-n-tuple-vlan-sensitive") \
  _(IP6_N_TUPLE_VLANSENSITIVE, ip6_n_tuple_vlan, "ipv6-n-tuple-vlan-sensitive") \
  /* L4 tunnel flow*/ \
...
#define foreach_flow_entry_ip4_n_tuple_vlan \
  _fe(ip4_address_and_mask_t, src_addr) \
  _fe(ip4_address_and_mask_t, dst_addr) \
  _fe(ip_port_and_mask_t, src_port) \
  _fe(ip_port_and_mask_t, dst_port) \
...
#define foreach_flow_entry_ip6_n_tuple_vlan \
  _fe(ip6_address_and_mask_t, src_addr) \
  _fe(ip6_address_and_mask_t, dst_addr) \
  _fe(ip_port_and_mask_t, src_port) \
  _fe(ip_port_and_mask_t, dst_port) \
