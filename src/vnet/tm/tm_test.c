...
api_tm_sys_node_add (vat_main_t *vam)
{
  ...
  if (flow_name != NULL)
    {
      strncpy ((char *) mp->flow_name, (char *) flow_name, sizeof (mp->flow_name) - 1);
    }
...
static void
vl_api_tm_sys_node_suspend_reply_t_handler (vl_api_tm_sys_node_suspend_reply_t *mp)
{
  vat_main_t *vam = tm_test_main.vat_main;
...
static void
vl_api_tm_sys_node_resume_reply_t_handler (vl_api_tm_sys_node_resume_reply_t *mp)
{
  vat_main_t *vam = tm_test_main.vat_main;
...
static void
vl_api_tm_sys_node_delete_reply_t_handler (vl_api_tm_sys_node_delete_reply_t *mp)
{
  vat_main_t *vam = tm_test_main.vat_main;
...
static void
vl_api_tm_sys_node_shaper_update_reply_t_handler (vl_api_tm_sys_node_shaper_update_reply_t *mp)
{
  vat_main_t *vam = tm_test_main.vat_main;
...
static void
vl_api_tm_sys_node_read_stats_reply_t_handler (vl_api_tm_sys_node_read_stats_reply_t *mp)
{
  vat_main_t *vam = tm_test_main.vat_main;
...
static void
vl_api_tm_sys_get_capabilities_reply_t_handler (vl_api_tm_sys_get_capabilities_reply_t *mp)
{
  vat_main_t *vam = tm_test_main.vat_main;
