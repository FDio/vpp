...
api_tm_sys_node_add (vat_main_t *vam)
{
  ...
  u8 priority_set = 0, level_set = 0, sw_if_idx_set = 0;
  u32 sw_if_idx = 0, shaper_id = 0;
...
api_tm_sys_shaper_profile_create (vat_main_t *vam)
{
  ...
  unformat_input_t *i = vam->input;
  u32 sw_if_idx = 0, tm_shaper_id = 0;
  u32 shaper_len_adjust = 0, is_packet_mode = 0;
  u64 shaper_commit_rate = 0, shaper_commit_burst = 0;
  u64 shaper_peak_rate = 0, shaper_peak_burst = 0;
  u8 sw_if_idx_set = 0;
  int ret;
...
api_tm_sys_node_shaper_update (vat_main_t *vam)
{
  ...
  u32 shaper_profile = 0, node_id = 0, sw_if_idx = 0;
  unformat_input_t *i = vam->input;
...
{
  u8 sw_if_idx_set = 0;
  u32 node_id = 0, weight = 0, sw_if_idx = 0;
  unformat_input_t *i = vam->input;
