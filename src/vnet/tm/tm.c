		 ...
		 tm_node_params_t *params, char *flow_name)
{
  ...
  dev_class->tm_sys_impl->node_add (hw_if_idx, node_id, parent_node_id, priority, weight, lvl,
				    params, flow_name);
...
tm_sys_node_sched_weight_update (u32 hw_if_idx, u32 node_id, u32 weight)
{
  ...
  dev_class->tm_sys_impl->node_sched_weight_update (hw_if_idx, node_id, weight);
