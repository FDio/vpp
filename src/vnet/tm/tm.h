...
{
  u32 hw_if_idx;
  int (*node_add) (u32 hw_if_idx, u32 node_id, i32 parent_node_id, u32 priority, u32 weight,
  ...
  int (*node_shaper_update) (u32 hw_if_idx, u32 node_id, i32 shaper_profile_id);
  int (*node_sched_weight_update) (u32 hw_if_idx, u32 node_id, u32 weight);
  int (*node_read_stats) (u32 hw_if_idx, u32 node_idx, vnet_tm_stats_params_t *param);
  int (*tm_get_capabilities) (u32 hw_if_idx, vnet_tm_capa_params_t *capa_param);
  int (*tm_level_get_capabilities) (u32 hw_if_idx, vnet_tm_level_capa_params_t *cap, u32 lvl);
...
{
  return (flow_id >= vnet_tm_flow_id_start && flow_id < vnet_tm_flow_id_start + VNET_TM_MAX_FLOWS);
}
 ...
 * @return 0 on success.
 */
int vnet_tm_sys_node_add (u32 hw_if_idx, u32 node_id, i32 parent_node_id, u32 priority, u32 weight,
			  u32 lvl, vnet_tm_node_params_t *params, const char *flow_name);
 ...
 * @return 0 on success.
 */
int vnet_tm_sys_shaper_profile_create (u32 hw_if_idx, vnet_tm_shaper_params_t *param);
 ...
 * @return 0 on success.
 */
int vnet_tm_sys_node_shaper_update (u32 hw_if_idx, u32 node_id, i32 shaper_profile_id);
 ...
 * @return 0 on success.
 */
int vnet_tm_sys_node_sched_weight_update (u32 hw_if_idx, u32 node_id, u32 weight);
 ...
 * @return 0 on success.
 */
int vnet_tm_sys_node_read_stats (u32 hw_if_idx, u32 node_idx, vnet_tm_stats_params_t *param);
/**
 * @brief Read Capabilities for a specific traffic management system.
 */
int vnet_tm_sys_get_capabilities (u32 hw_if_idx, vnet_tm_capa_params_t *capa_param);

/**
 * @brief Read level Capabilities for a specific traffic management system.
 */
int vnet_tm_sys_level_get_capabilities (u32 hw_if_idx, vnet_tm_level_capa_params_t *cap, u32 lvl);
