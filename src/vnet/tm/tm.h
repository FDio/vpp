...
typedef struct tm_system_t_
{
  ...
  int (*node_add) (u32 hw_if_idx, u32 node_id, i32 parent_node_id, u32 priority, u32 weight,
		   u32 lvl, tm_node_params_t *params, const char *flow_name);
  ...
  int (*node_read_stats) (u32 hw_if_idx, u32 node_idx, tm_stats_params_t *param);
  int (*tm_get_capabilities) (u32 hw_if_idx, tm_capa_params_t *capa_param);
  int (*tm_level_get_capabilities) (u32 hw_if_idx, tm_level_capa_params_t *cap, u32 lvl);
 ...
 * @return 0 on success.
 */
int tm_sys_node_add (u32 hw_if_idx, u32 node_id, i32 parent_node_id, u32 priority, u32 weight,
		     u32 lvl, tm_node_params_t *params, const char *flow_name);
 ...
 * @return 0 on success.
 */
int tm_sys_node_shaper_update (u32 hw_if_idx, u32 node_id, i32 shaper_profile_id);
 ...
 * @return 0 on success.
 */
int tm_sys_node_read_stats (u32 hw_if_idx, u32 node_idx, tm_stats_params_t *param);
/**
 ...
 */
int tm_sys_level_get_capabilities (u32 hw_if_idx, tm_level_capa_params_t *cap, u32 lvl);
