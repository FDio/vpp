...
safe_eth_identify_subint (vnet_hw_interface_t *hi,
                          u32 match_flags,
                          main_intf_t *main_intf,
                          vlan_intf_t *vlan_intf,
                          qinq_intf_t *qinq_intf,
                          u32 *subint_sw_if_index,
                          u8 *error,
                          u32 *is_l2)
{
  if (PREDICT_TRUE (hi != 0))
    return eth_identify_subint (hi, match_flags, main_intf, vlan_intf, qinq_intf,
                               subint_sw_if_index, error, is_l2);
      ...
      while (n_left_from >= 6 && n_left_to_next >= 2)
        {
          ...
          matched0 = safe_eth_identify_subint (hi0,
                                               match_flags0,
                                               main_intf0,
                                               vlan_intf0,
                                               qinq_intf0,
          ...
          matched1 = safe_eth_identify_subint (hi1,
                                               match_flags1,
                                               main_intf1,
                                               vlan_intf1,
                                               qinq_intf1,
