 ...
 * the packet to 00:8a:00:0d:0e:02 (where \"ffffffffffff00000000000000000000\"
 * is Ethernet header's mask,\"008a000d0e0200000000000000000000\" is Ethernet
 * header's value):
 ...
 *
 * @cliexpar
 * Example use the classify to filter packets that do not need to be
modified(where
...
YusurK2Eth6/0/1/3
 * is interface,\"table 0\" mean Table Id is 0,\"miss 0\" mean the packet that
match
...
bridge-domain.
 * Use this command to manage bridge-domains.
 *
 * @cliexpar
