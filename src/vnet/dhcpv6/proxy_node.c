...
clib_error_t * dhcpv6_proxy_init (vlib_main_t * vm)
{
  ...
  /* RFC says this is the global dhcpv6 server address  */
  dm->all_dhcpv6_server_address.as_u64[0] = clib_host_to_net_u64 (0xFF02000100000000);
  dm->all_dhcpv6_server_address.as_u64[1] = clib_host_to_net_u64 (0x00000002);
							 ...
							 int insert_vss, int is_del)
{
  ...
  initialize_it:
  {
      const mfib_prefix_t all_dhcp_servers = {
          ...
          .fp_grp_addr = {
              .ip6 = dm->all_dhcpv6_server_address,
          }
      };
