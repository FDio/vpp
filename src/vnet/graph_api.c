...
static void
send_graph_node_details (vl_api_registration_t * reg,
			 u32 context, vlib_node_t * n, vlib_node_main_t * nm)
{
  ...
  if (node_index != ~0)
    {
      ...
      if (n)
	send_graph_node_details (reg, mp->context, n, nm);
      return;
    }
