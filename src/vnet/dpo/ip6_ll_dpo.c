...
{
  .function = ip6_ll_dpo_switch,.name = "ip6-link-local",.vector_size =
    sizeof (u32),.format_trace = format_ip6_ll_dpo_trace,.n_next_nodes =
    IP6_LL_NEXT_NUM,.next_nodes =
  {
  [IP6_LL_NEXT_DROP] = "ip6-drop",[IP6_LL_NEXT_LOOKUP] = "ip6-lookup",}
,};
