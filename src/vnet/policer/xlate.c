 ...
 */
int
x86_pol_compute_hw_params (const u64 cpu_cps, qos_pol_cfg_params_st *cfg,
			   policer_t *hw)
{
  ...
  if ((cfg->rfc == QOS_POLICER_TYPE_1R2C) ||
	  ...
	  || (cfg->rb.kbps.cb_bytes == 0) || (cfg->rb.kbps.eb_bytes == 0))
	{
      ...
      if (compute_policer_params (
	    cpu_cps, (u64) cfg->rb.kbps.cir_kbps * BYTES_PER_KBIT,
 ...
 */
int
pol_logical_2_physical (const qos_pol_cfg_params_st *cfg, const u64 cpu_cps,
			policer_t *phys)
{
  int rc;
