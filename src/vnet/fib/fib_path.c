                                    ...
                                    dpo_id_t *dpo)
{
    ...
    dpo_set(dpo, DPO_ADJACENCY, path->fp_nh_proto, ai);
    adj_unlock(ai);
}
                           ...
                           dpo_id_t *dpo)
{
    ...
    else
    {
        ...
        ai = adj_glean_add_or_lock(dpo_proto_to_fib(path->fp_nh_proto),
                                   link,
                                   path->attached.fp_interface,
                                   NULL);
        dpo_set(dpo, DPO_ADJACENCY_GLEAN, path->fp_nh_proto, ai);
        adj_unlock(ai);
    }
}
