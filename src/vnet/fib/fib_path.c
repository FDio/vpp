                                    ...
                                    dpo_id_t *dpo)
{
    ...
    dproto = dpo_proto_to_fib(path->fp_nh_proto);
	 ...
	 */
	ai = adj_nbr_add_or_lock(dproto, link, &zero_addr,
                                 path->attached_next_hop.fp_interface);
    }
    else
    {
	ai = adj_nbr_add_or_lock(dproto, link,
                                 &path->attached_next_hop.fp_nh,
                                 path->attached_next_hop.fp_interface);
    }
                           ...
                           dpo_id_t *dpo)
{
    ...
    else
    {
        ...
        ai = adj_glean_add_or_lock(dproto,
                                   link,
                                   path->attached.fp_interface,
                                   NULL);
