 ...
 */
typedef u16 fib_source_priority_t;
...
#define foreach_fib_source                                      \
    ...
    _(FIB_SOURCE_SPECIAL,       0,     FIB_SOURCE_BH_SIMPLE)    \
    _(FIB_SOURCE_CLASSIFY,      100,   FIB_SOURCE_BH_SIMPLE)    \
    _(FIB_SOURCE_PROXY,         200,   FIB_SOURCE_BH_SIMPLE)    \
    _(FIB_SOURCE_INTERFACE,     300,   FIB_SOURCE_BH_INTERFACE) \
    _(FIB_SOURCE_SR,            400,   FIB_SOURCE_BH_API)       \
    _(FIB_SOURCE_BIER,          500,   FIB_SOURCE_BH_SIMPLE)    \
    _(FIB_SOURCE_6RD,           600,   FIB_SOURCE_BH_API)       \
    _(FIB_SOURCE_API,           700,   FIB_SOURCE_BH_API)       \
    _(FIB_SOURCE_CLI,           800,   FIB_SOURCE_BH_API)       \
    _(FIB_SOURCE_LISP,          900,   FIB_SOURCE_BH_LISP)      \
    _(FIB_SOURCE_MAP,           1000,  FIB_SOURCE_BH_SIMPLE)    \
    _(FIB_SOURCE_DHCP,          1100,  FIB_SOURCE_BH_API)       \
    _(FIB_SOURCE_IP6_ND_PROXY,  1200,  FIB_SOURCE_BH_API)       \
    _(FIB_SOURCE_IP6_ND,        1300,  FIB_SOURCE_BH_API)       \
    _(FIB_SOURCE_ADJ,           1400,  FIB_SOURCE_BH_ADJ)       \
    _(FIB_SOURCE_MPLS,          1500,  FIB_SOURCE_BH_MPLS)      \
    _(FIB_SOURCE_AE,            1600,  FIB_SOURCE_BH_SIMPLE)    \
    _(FIB_SOURCE_RR,            1700,  FIB_SOURCE_BH_RR)        \
    _(FIB_SOURCE_URPF_EXEMPT,   1800,  FIB_SOURCE_BH_RR)        \
    _(FIB_SOURCE_DEFAULT_ROUTE, 1800,  FIB_SOURCE_BH_DROP)      \
    _(FIB_SOURCE_INTERPOSE,     65000, FIB_SOURCE_BH_INTERPOSE) \
    _(FIB_SOURCE_INVALID,       65535, FIB_SOURCE_BH_DROP)

extern fib_source_priority_t fib_source_get_prio(fib_source_t src);
