...
extern int fib_api_path_decode(const struct _vl_api_fib_path *in,
                               fib_route_path_t *out);
extern void fib_api_prefix_encode(const fib_prefix_t *pfx,
                                  struct _vl_api_fib_prefix *out);
extern void fib_api_prefix_decode(const struct _vl_api_fib_prefix *in,
                                 fib_prefix_t *out);
