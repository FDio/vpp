			    ...
			    u32 * parent_sw_if_index, u32 pipe_sw_if_index[2])
{
  ...
  /*
   * Default MAC address (2222:0000:0000 + instance) is allocated
   */
  address[5] = instance;
...
/*?
 * Create a pipe interface. Optionally, a MAC Address can be
 ...
 * @cliexcmd{create pipe interface [mac <mac-addr>] [instance <instance>]}
 * Example of how to create a pipe interface:
 * @cliexcmd{pipe create-interface}
 ?*/
/* *INDENT-OFF* */
VLIB_CLI_COMMAND (pipe_create_interface_command, static) = {
  .path = "pipe create-interface",
  .short_help = "pipe create-interface [mac <mac-addr>] [instance <instance>]",
 ...
 * @cliexcmd{create pipe interface [mac <mac-addr>] [instance <instance>]}
 * Example of how to create a pipe interface:
 * @cliexcmd{create pipe interface}
 ?*/
/* *INDENT-OFF* */
VLIB_CLI_COMMAND (create_pipe_interface_command, static) = {
  .path = "create pipe interface",
  .short_help = "create pipe interface [mac <mac-addr>] [instance <instance>]",
  .function = create_pipe_interfaces,
};
/* *INDENT-ON* */
 ...
 * @cliexpar
 * The following two command syntaxes are equivalent:
 * @cliexcmd{pipe delete-interface intfc <interface>}
 * @cliexcmd{delete pipe interface intfc <interface>}
...
VLIB_CLI_COMMAND (pipe_delete_interface_command, static) = {
  .path = "pipe delete-interface",
  .short_help = "pipe delete-interface intfc <interface>",
 ...
 * @cliexcmd{delete pipe interface intfc <interface>}
 * Example of how to delete a pipe interface:
 * @cliexcmd{delete pipe interface intfc loop0}
 ?*/
/* *INDENT-OFF* */
VLIB_CLI_COMMAND (delete_pipe_interface_command, static) = {
  .path = "delete pipe interface",
  .short_help = "delete pipe interface intfc <interface>",
  .function = delete_pipe_interfaces,
};
/* *INDENT-ON* */
