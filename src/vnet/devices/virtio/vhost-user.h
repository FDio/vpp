...
#define SECONDS_IN_100_YEARS 3153600000.0 /* 100 years */ ;
...
#define VHOST_USER_INVALID_MODE   0
#define VHOST_USER_POLLING_MODE   1
#define VHOST_USER_INTERRUPT_MODE 2
#define VHOST_USER_ADAPTIVE_MODE  3
...
typedef struct
{
  ...
  /* The operation mode that is set in the vlib */
  u8 operation_mode;
} vhost_cpu_t;
...
typedef struct
{
  ...
  /* Interrupt node started for vhost-user */
  u8 interrupt_node_started;
} vhost_user_main_t;
