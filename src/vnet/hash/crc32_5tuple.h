...
#ifndef __VNET_CRC32_5TUPLE_H__
#define __VNET_CRC32_5TUPLE_H__
...
compute_ip6_key (ip6_header_t *ip, crc32_5tuple_key_t *k)
{
  u8 pr;
...
static_always_inline void
compute_ip4_key (ip4_header_t *ip, crc32_5tuple_key_t *k)
{
  u8 pr;
  u64 *key = (u64 *) k;
