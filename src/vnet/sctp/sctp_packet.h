...
#define IPV4_ADDRESS_TYPE_LENGTH 8
#define IPV6_ADDRESS_TYPE	6
#define IPV6_ADDRESS_TYPE_LENGTH 20
#define STATE_COOKIE		7
/* #define UNRECOGNIZED_PARAM	8 Defined with the rest of ERROR CAUSES: see line 796 in this file */
#define COOKIE_PRESERVATIVE_TYPE	9
#define COOKIE_PRESERVATIVE_TYPE_LENGTH	8
...
} sctp_optional_parameters_hdr_t;
...
typedef struct
{
  sctp_optional_parameters_hdr_t param_hdr;
...
{
  a->param_hdr.type = clib_host_to_net_u16 (IPV4_ADDRESS_TYPE);
...
{
  a->param_hdr.type = clib_host_to_net_u16 (IPV6_ADDRESS_TYPE);
...
vnet_sctp_set_cookie_preservative (sctp_cookie_preservative_t * c,
				   u32 life_span_inc)
{
  c->param_hdr.type = clib_host_to_net_u16 (COOKIE_PRESERVATIVE_TYPE);
...
vnet_sctp_set_hostname_address (sctp_hostname_address_t * h, char *hostname)
{
  ...
  h->param_hdr.type = clib_host_to_net_u16 (HOSTNAME_ADDRESS_TYPE);
...
{
  s->param_hdr.type = clib_host_to_net_u16 (SUPPORTED_ADDRESS_TYPES);
...
{
  s->param_hdr.type = clib_host_to_net_u16 (STATE_COOKIE);
