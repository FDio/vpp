...
always_inline bool
sctp_is_init (sctp_packet_t * p)
{
  if (vnet_sctp_get_chunk_type ((sctp_chunks_common_hdr_t *) & p->chunks[0])
      == INIT)
    return true;
  return false;
}
...
always_inline bool
sctp_is_init_ack (sctp_packet_t * p)
{
  if (vnet_sctp_get_chunk_type ((sctp_chunks_common_hdr_t *) & p->chunks[0])
      == INIT_ACK)
    return true;
...
always_inline bool
sctp_is_shutdown (sctp_packet_t * p)
{
  if (vnet_sctp_get_chunk_type ((sctp_chunks_common_hdr_t *) & p->chunks[0])
      == SHUTDOWN)
    return true;
...
typedef struct
{
   ...
   * ============================================================
   */
  sctp_chunks_common_hdr_t header;
...
always_inline void
vnet_sctp_set_ebit (sctp_payload_data_t * p, u8 enable)
{
  p->header.flags = clib_host_to_net_u16 (enable);
}

always_inline u8
vnet_sctp_get_ebit (sctp_payload_data_t * p)
{
  return (clib_net_to_host_u16 (p->header.flags));
}

always_inline void
vnet_sctp_set_bbit (sctp_payload_data_t * p, u8 enable)
{
  p->header.flags = clib_host_to_net_u16 (enable << 1);
}

always_inline u8
vnet_sctp_get_bbit (sctp_payload_data_t * p)
{
  return (clib_net_to_host_u16 (p->header.flags >> 1));
}

always_inline void
vnet_sctp_set_ubit (sctp_payload_data_t * p, u8 enable)
{
  p->header.flags = clib_host_to_net_u16 (enable << 2);
}

always_inline u8
vnet_sctp_get_ubit (sctp_payload_data_t * p)
{
  return (clib_net_to_host_u16 (p->header.flags >> 2));
}

always_inline void
vnet_sctp_set_tsn (sctp_payload_data_t * p, u32 tsn)
{
  p->tsn = clib_host_to_net_u32 (tsn);
}

always_inline u32
vnet_sctp_get_tsn (sctp_payload_data_t * p)
{
  return (clib_net_to_host_u32 (p->tsn));
}

always_inline void
vnet_sctp_set_stream_id (sctp_payload_data_t * p, u16 stream_id)
{
  p->stream_id = clib_host_to_net_u16 (stream_id);
}

always_inline u16
vnet_sctp_get_stream_id (sctp_payload_data_t * p)
{
  return (clib_net_to_host_u16 (p->stream_id));
}

always_inline void
vnet_sctp_set_stream_seq (sctp_payload_data_t * p, u16 stream_seq)
{
  p->stream_seq = clib_host_to_net_u16 (stream_seq);
}

always_inline u16
vnet_sctp_get_stream_seq (sctp_payload_data_t * p)
{
  return (clib_net_to_host_u16 (p->stream_seq));
}

always_inline void
vnet_sctp_set_payload_id (sctp_payload_data_t * p, u32 payload_id)
{
  p->payload_id = clib_host_to_net_u32 (payload_id);
}

always_inline u32
vnet_sctp_get_payload_id (sctp_payload_data_t * p)
{
  return (clib_net_to_host_u32 (p->payload_id));
}

always_inline u16
vnet_sctp_calculate_payload_data_padding (sctp_payload_data_t * p)
{
...
always_inline void
vnet_sctp_set_ipv4_address (sctp_ipv4_address_t * a, ip4_address_t address)
{
...
always_inline u32
vnet_sctp_get_ipv4_address (sctp_ipv4_address_t * a)
{
...
always_inline void
vnet_sctp_set_ipv6_address (sctp_ipv6_address_t * a, ip6_address_t address)
{
...
vnet_sctp_get_ipv6_address (sctp_ipv6_address_t * a)
{
...
} sctp_cookie_preservative_t;

always_inline void
vnet_sctp_set_cookie_preservative (sctp_cookie_preservative_t * c,
				   u32 life_span_inc)
{
...
always_inline u32
vnet_sctp_get_cookie_preservative (sctp_cookie_preservative_t * c)
{
...
} sctp_hostname_address_t;

always_inline void
vnet_sctp_set_hostname_address (sctp_hostname_address_t * h, char *hostname)
{
...
} sctp_supported_address_types_t;

always_inline void
vnet_sctp_set_supported_address_types (sctp_supported_address_types_t * s)
{
 ...
 * +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
 */
typedef sctp_init_chunk_t sctp_initiation_ack_chunk;
...
always_inline void
vnet_sctp_set_state_cookie (sctp_state_cookie_t * s)
{
...
} sctp_heartbeat_info_t;

always_inline void
vnet_sctp_set_heartbeat_info (sctp_heartbeat_info_t * h, u64 hb_info,
			      u16 hb_info_length)
{
...
typedef struct
{
  ...
  sctp_heartbeat_info_t hb_info;

} sctp_heartbeat_request_chunk_t;

always_inline void
vnet_sctp_set_hb_request_info (sctp_heartbeat_request_chunk_t * h,
			       sctp_heartbeat_info_t * hb_info)
{
 ...
 * +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
 */
typedef sctp_heartbeat_request_chunk_t sctp_heartbeat_ack_chunk_t;

always_inline void
vnet_sctp_set_hb_ack_info (sctp_heartbeat_ack_chunk_t * h,
			   sctp_heartbeat_info_t * hb_info)
{
...
always_inline void
vnet_sctp_fill_shutdown_ack (sctp_shutdown_ack_t * s)
{
