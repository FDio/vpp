...
static inline void
vnet_sctp_set_cookie_preservative (sctp_cookie_preservative * c,
				   u32 life_span_inc)
{
...
static inline void
vnet_sctp_set_cumulative_tsn_ack (sctp_selective_ack_chunk * s,
				  u32 cumulative_tsn_ack)
{
...
static inline void
vnet_sctp_set_gap_ack_blocks_count (sctp_selective_ack_chunk * s,
				    u16 gap_ack_blocks_count)
{
  vnet_sctp_set_chunk_type (&s->header, SACK);
...
static inline void
vnet_sctp_set_duplicate_tsn_count (sctp_selective_ack_chunk * s,
				   u16 duplicate_tsn_count)
{
  vnet_sctp_set_chunk_type (&s->header, SACK);
...
static inline void
vnet_sctp_set_heartbeat_info (sctp_heartbeat_info * h, u64 hb_info,
			      u16 hb_info_length)
{
...
static inline void
vnet_sctp_set_hb_request_info (sctp_heartbeat_request_chunk * h,
			       sctp_heartbeat_info * hb_info)
{
...
static inline void
vnet_sctp_set_hb_ack_info (sctp_heartbeat_ack_chunk * h,
			   sctp_heartbeat_info * hb_info)
{
...
static inline void
vnet_sctp_set_tsn_last_received_chunk (sctp_shutdown_association_chunk * s,
				       u32 tsn_last_chunk)
{
