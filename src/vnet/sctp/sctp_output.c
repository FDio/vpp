			    ...
			    ip6_address_t * ip6_addr)
{
  ...
  if (PREDICT_TRUE (ip6_addr != NULL))
	...
	(sctp_ipv6_addr_param_t *) init_ack_chunk + sizeof (sctp_init_chunk_t) +
	pointer_offset;
  ...
  init_ack_chunk->a_rwnd = 0x0;
  init_ack_chunk->inboud_streams_count = 0x0;
  init_ack_chunk->outbound_streams_count = 0x0;
  init_ack_chunk->initial_tsn = 0x0;
