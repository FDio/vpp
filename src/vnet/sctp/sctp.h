...
typedef struct _sctp_connection
{
  ...
  u32 rcv_a_rwnd;		/**< LOCAL max seg size that includes options */
  u32 snd_a_rwnd;		/**< REMOTE max seg size that includes options */
...
void sctp_prepare_cookie_ack_chunk (sctp_connection_t * tc,
				    vlib_buffer_t * b);
void sctp_prepare_sack_chunk (sctp_connection_t * tc,
		vlib_buffer_t * b);
