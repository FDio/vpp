...
#define N_BIER_ECMP_TABLES 16
    ...
    bier_table_route_add(&bt_0_0_0_256, 1, &path_1_1_1_1);
    ...
    bier_table_route_add(&bt_0_0_0_256, 2, &path_1_1_1_1);
    ...
    fei = fib_table_entry_path_add(0,
                                   ...
                                   out_lbl_101,
                                   FIB_ROUTE_PATH_FLAG_NONE);
    bier_table_route_add(&bt_0_0_0_256, 3, &path_1_1_1_2);
     ...
     */
    bier_table_route_add(&bt_0_0_0_256, 3, &path_1_1_1_1);
     ...
     */
    bier_table_route_remove(&bt_0_0_0_256, 3, &path_1_1_1_2);
    BIER_TEST(bier_test_validate_entry(bei_3, 1,
                                       &dpo_o_bfm_1_1_1_1),
     ...
     */
    bier_table_route_remove(&bt_0_0_0_256, 2, &path_1_1_1_1);
    bier_table_route_remove(&bt_0_0_0_256, 3, &path_1_1_1_2);
    bier_table_route_remove(&bt_0_0_0_256, 3, &path_1_1_1_1);
    bier_table_route_remove(&bt_0_0_0_256, 1, &path_1_1_1_1);
...
bier_test_mpls_disp (void)
{
     ...
     */
    fib_route_path_t path_via_disp = {
        // .frp_addr = all-zeros
        .frp_bier_fib_index = bier_disp_tbl_id,
        .frp_flags = FIB_ROUTE_PATH_BIER_FMASK,
    };

    bier_table_route_add(&bt_0_0_0_256, 3, &path_via_disp);
    ...
    bier_disp_table_entry_path_add(bdti1, src, BIER_HDR_PROTO_IPV4, rpaths);
    ...
    dpo_disp_entry_lb = &bde_99->bde_dpo[BIER_HDR_PROTO_IPV4];
    ...
    bier_disp_table_entry_path_remove(bdti1, src, BIER_HDR_PROTO_IPV4, rpaths);
    bier_table_route_remove(&bt_0_0_0_256, 3, &path_via_disp);
