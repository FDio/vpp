                         ...
                         vlib_frame_t * from_frame)
{
    ...
    while (n_left_from > 0)
    {
        ...
        while (n_left_from > 0 && n_left_to_next > 0)
        {
            ...
            /*
             * header is in network order
             */
            pproto0 = ((clib_net_to_host_u16(hdr0->bh_oam_dscp_proto) &
                        BIER_HDR_PROTO_FIELD_MASK) >>
                       BIER_HDR_PROTO_FIELD_SHIFT);
            entropy0 = ((clib_net_to_host_u32(hdr0->bh_first_word) &
