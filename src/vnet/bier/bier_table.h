...
extern void bier_table_route_path_add (const bier_table_id_t *bti,
				       bier_bp_t bp, fib_route_path_t *brp);
...
extern void bier_table_ecmp_set_fmask (index_t bti, bier_bp_t bp,
				       index_t bfmi);
...
extern void bier_table_ecmp_walk (index_t bti, bier_table_ecmp_walk_fn_t fn,
				  void *ctx);
...
typedef void (*bier_table_walk_fn_t) (const bier_table_t *bt,
				      const bier_entry_t *be, void *ctx);
extern void bier_table_walk (const bier_table_id_t *id,
			     bier_table_walk_fn_t fn, void *ctx);
...
bier_table_lookup (const bier_table_t *bt, bier_bp_t bp)
{
  return (bt->bt_entries[BIER_BP_TO_INDEX (bp)]);
}

static inline const index_t
bier_table_fwd_lookup (const bier_table_t *bt, bier_bp_t bp)
{
