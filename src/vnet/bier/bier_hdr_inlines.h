...
{
  return ((bier_hdr->bh_first_word & BIER_HDR_VERSION_FIELD_MASK) >>
...
{
  return ((bier_hdr->bh_first_word & BIER_HDR_LEN_FIELD_MASK) >>
...
{
  return ((bier_hdr->bh_first_word & BIER_HDR_ENTROPY_FIELD_MASK) >>
...
bier_hdr_1st_nibble (bier_hdr_t *hdr)
{
  ...
  hdr->bh_first_word |=
    (BIER_HDR_1ST_NIBBLE_VALUE << BIER_HDR_1ST_NIBBLE_SHIFT);
}
...
bier_hdr_ntoh (bier_hdr_t *bier_hdr)
{
  ...
  bier_hdr->bh_oam_dscp_proto =
    clib_net_to_host_u16 (bier_hdr->bh_oam_dscp_proto);
...
bier_hdr_hton (bier_hdr_t *bier_hdr)
{
  ...
  bier_hdr->bh_oam_dscp_proto =
    clib_host_to_net_u16 (bier_hdr->bh_oam_dscp_proto);
...
{
  clib_memset (
    &bier_hdr->bh_bit_string, 0,
    bier_hdr_len_id_to_num_buckets (bier_hdr_get_len_id (bier_hdr)));
}

static inline void
bier_hdr_init (bier_hdr_t *bier_hdr, bier_hdr_version_t version,
	       bier_hdr_proto_id_t proto, bier_hdr_len_id_t len,
