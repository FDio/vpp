...
static index_t
bier_disp_table_get_w_table_id (u32 table_id)
{
    uword *p;
...
bier_disp_table_add_or_lock (u32 table_id)
{
    ...
    bdti = bier_disp_table_get_w_table_id(table_id);
...
void
bier_disp_table_entry_path_add (index_t bdti,
                                bier_bp_t src,
                                ...
                                const fib_route_path_t *rpath)
{
    ...
    bier_disp_entry_path_add(bdei, payload_proto, rpath);
}

void
bier_disp_table_entry_path_remove (index_t bdti,
                                   bier_bp_t src,
                                   bier_hdr_proto_id_t payload_proto,
                                   const fib_route_path_t *rpath)
{
...
/* extern u32 bier_disp_table_find(u32 table_id); */
...
const static dpo_vft_t bier_disp_table_dpo_vft = {
    ...
    .dv_format = format_bier_disp_table,
};
