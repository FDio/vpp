...
static void
bier_fmask_db_mk_key (index_t bti, const fib_route_path_t *rpath,
		      bier_fmask_id_t *key)
{
  /*
...
u32
bier_fmask_db_find (index_t bti, const fib_route_path_t *rpath)
{
...
{
  bier_fmask_db.bfdb_hash =
    hash_create_mem (0, sizeof (bier_fmask_id_t), sizeof (index_t));
