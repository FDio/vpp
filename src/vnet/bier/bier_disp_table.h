...
extern void bier_disp_table_entry_path_add(index_t bdti,
                                           bier_bp_t src,
                                           bier_hdr_proto_id_t payload_proto,
                                           const fib_route_path_t *rpath);

extern void bier_disp_table_entry_path_remove(index_t fib_index,
                                              bier_bp_t src,
                                              bier_hdr_proto_id_t payload_proto,
...
extern u32 bier_disp_table_add_or_lock(u32 table_id);
...
{
    return (&bier_disp_table_pool[bdti]);
}
