...
device_create_sec_if_cmd_fn (vlib_main_t *vm, unformat_input_t *input,
			     vlib_cli_command_t *cmd)
{
  vnet_dev_api_create_port_sec_if_args_t a = {};
  vnet_main_t *vnm = vnet_get_main ();
  vnet_dev_rv_t rv;
  ...
  rv = vnet_dev_api_create_port_sec_if (vm, &a);
...
device_remove_sec_if_cmd_fn (vlib_main_t *vm, unformat_input_t *input,
			     vlib_cli_command_t *cmd)
{
  vnet_dev_api_remove_port_sec_if_args_t a = { .sw_if_index = ~0 };
  vnet_main_t *vnm = vnet_get_main ();
  vnet_dev_rv_t rv;
  ...
  rv = vnet_dev_api_remove_port_sec_if (vm, &a);
