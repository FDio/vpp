...
typedef struct vnet_dev_port_sec_if
{
  u32 id;
  u32 sw_if_index;
  u32 hw_if_index;
...
typedef struct vnet_dev_port_intf
{
  ...
  u16 txq_sz;
  u16 rxq_sz;
  vnet_dev_port_sec_if_t **secondary_interfaces;
...
{
  u32 sw_if_index;
} vnet_dev_port_sec_if_remove_args_t;
...
vnet_dev_port_op_with_ptr_t vnet_dev_port_sec_if_create;
vnet_dev_port_op_with_ptr_t vnet_dev_port_sec_if_remove;
