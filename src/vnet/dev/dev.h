...
vnet_dev_rv_t vnet_dev_attach (vlib_main_t *, vnet_dev_t *);
vnet_dev_rv_t vnet_dev_detach (vlib_main_t *, vnet_dev_t *);
...
void vnet_dev_port_update_tx_node_runtime (vnet_dev_port_t *);
