...
typedef struct
{
  enum
  {
    VNET_DEV_HW_ADDR_TYPE_ETHERNET = 1
  } __clib_packed type;
  u8 addr[6];
} vnet_dev_hw_addr_t;
...
typedef struct vnet_dev_counter_t vnet_dev_counter_t;
typedef struct vnet_dev_counter_main_t vnet_dev_counter_main_t;
...
typedef struct
{
  ...
  vnet_dev_port_config_t new;
} vnet_dev_port_config_change_req_t;
...
void vnet_dev_port_state_change (vlib_main_t *, vnet_dev_port_t *,
				 vnet_dev_port_state_changes_t);
vnet_dev_rv_t
vnet_dev_port_config_change (vlib_main_t *, vnet_dev_port_t *,
			     vnet_dev_port_config_change_req_t *);
...
vnet_dev_rv_t
vnet_dev_process_port_config_change_req (vlib_main_t *, vnet_dev_port_t *,
					 vnet_dev_port_config_change_req_t *);
