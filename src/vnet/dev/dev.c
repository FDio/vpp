			    ...
			    void *cb)
{
  ...
  log_info ("starting");
  log_info ("arc %u (%s) vdm %u (%s)", arc_index,
	    vnet_get_feature_arc_index (arc_index),
	    vdm->eth_port_rx_feature_arc_index,
	    vnet_get_feature_arc_index (vdm->eth_port_rx_feature_arc_index));
