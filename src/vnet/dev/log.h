...
#define log_debug(dev, f, ...)                                                \
  vlib_log (VLIB_LOG_LEVEL_DEBUG, dev_log._class, "%U" f,                     \
	    ...
	    clib_string_skip_prefix (__func__, "vnet_dev_"), ##__VA_ARGS__)
#define log_notice(dev, f, ...)                                               \
  vlib_log (VLIB_LOG_LEVEL_NOTICE, dev_log._class, "%U" f,                    \
	    format_vnet_dev_log, dev, 0, ##__VA_ARGS__)
#define log_warn(dev, f, ...)                                                 \
  vlib_log (VLIB_LOG_LEVEL_WARNING, dev_log._class, "%U" f,                   \
	    format_vnet_dev_log, dev, 0, ##__VA_ARGS__)
