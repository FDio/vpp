					  ...
					  vnet_dev_rx_queue_t *rxq)
{
  ...
  if (req.update_next_index)
    {
      vnet_dev_port_sec_if_t **si = rxq->port->interface->secondary_interfaces;
      rxq->if_rt_data.next_index = intf->rx_next_index;
