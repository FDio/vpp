...
/**
 * @file
 * @brief Declarations of vnet-owned notification bridge API between BFD and vnet consumers
 */
 ...
 */
typedef void (*bfd_vnet_bridge_listener_fn_t) (bfd_vnet_bridge_listener_t *listener,
 ...
 */
void bfd_vnet_bridge_publish (bfd_listen_event_e event, const vnet_bfd_event_t *payload);
