...
VLIB_CLI_COMMAND (bfd_cli_key_add_command, static) = {
  .path = "bfd key set",
  .short_help = "bfd key set conf-key-id <id> type "
                "<keyed-sha1|meticulous-keyed-sha1> secret <secret>",
...
VLIB_CLI_COMMAND (bfd_cli_udp_session_add_command, static) = {
  ...
  .short_help =
      "bfd udp session add " INTERFACE_STR " <interface> " LOCAL_ADDR_STR
      " <local-address> " PEER_ADDR_STR " <peer-address> " DESIRED_MIN_TX_STR
      " <desired min tx interval> " REQUIRED_MIN_RX_STR
      " <required min rx interval> " DETECT_MULT_STR " <detect multiplier> "
      "[" CONF_KEY_ID_STR " <config key ID> " BFD_KEY_ID_STR " <BFD key ID>"
      "]",
...
VLIB_CLI_COMMAND (bfd_cli_udp_session_mod_command, static) = {
  ...
  .short_help = "bfd udp session mod " INTERFACE_STR
                " <interface> " LOCAL_ADDR_STR
                " <local-address> " PEER_ADDR_STR
                " <peer-address> " DESIRED_MIN_TX_STR
                " <desired min tx interval> " REQUIRED_MIN_RX_STR
                " <required min rx interval> " DETECT_MULT_STR
                " <detect multiplier> ",
...
VLIB_CLI_COMMAND (bfd_cli_udp_session_del_command, static) = {
  ...
  .short_help = "bfd udp session del " INTERFACE_STR
                " <interface> " LOCAL_ADDR_STR
                " <local-address> " PEER_ADDR_STR "<peer-address> ",
...
VLIB_CLI_COMMAND (bfd_cli_udp_session_set_flags_command, static) = {
  ...
  .short_help = "bfd udp session set-flags " INTERFACE_STR
                " <interface> " LOCAL_ADDR_STR
                " <local-address> " PEER_ADDR_STR "<peer-address> " ADMIN_STR
                " <up|down>",
...
VLIB_CLI_COMMAND (bfd_cli_udp_session_auth_activate_command, static) = {
  ...
  .short_help = "bfd udp session auth activate " INTERFACE_STR
                " <interface> " LOCAL_ADDR_STR
                " <local-address> " PEER_ADDR_STR
                " <peer-address> " CONF_KEY_ID_STR
                " <config key ID> " BFD_KEY_ID_STR " <BFD key ID> "
                "[" DELAYED_STR " <yes|no>]",
...
VLIB_CLI_COMMAND (bfd_cli_udp_session_auth_deactivate_command, static) = {
  ...
  .short_help = "bfd udp session auth deactivate " INTERFACE_STR
                " <interface> " LOCAL_ADDR_STR
                " <local-address> " PEER_ADDR_STR " <peer-address> "
                "[" DELAYED_STR " <yes|no>]",
...
VLIB_CLI_COMMAND (bfd_cli_udp_set_echo_source_cmd, static) = {
  ...
  .short_help = "bfd udp echo-source set interface " INTERFACE_STR,
