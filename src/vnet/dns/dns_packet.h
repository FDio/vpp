...
#define DNS_RA (1<<8)           /**< recursion available */
#define DNS_RD (1<<9)           /**< recursion desired */
#define DNS_TC (1<<10)          /**< truncation  */
#define DNS_AA (1<<11)          /**< authoritative answer  */
#define DNS_OPCODE_MASK (0xf<<12) /**< opcode mask */
#define DNS_OPCODE_QUERY (0<<12)  /**< standard query */
#define DNS_OPCODE_IQUERY (1<<12) /**< inverse query (deprecated) */
#define DNS_OPCODE_STATUS (2<<12) /**< server status  */
