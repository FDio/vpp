...
u32
session_lookup_get_index_for_nns (u32 fib_proto, u32 nns_index)
{
  if (vec_len (fib_index_to_table_index[fib_proto]) <= nns_index)
    return SESSION_TABLE_INVALID_INDEX;
  return fib_index_to_table_index[fib_proto][nns_index];
}
