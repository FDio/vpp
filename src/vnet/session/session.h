...
void session_register_transport (session_type_t session_type,
                                 u32 output_node);
...
{
  return pool_elt_at_index (session_manager_main.listen_sessions[session_type],
	                    index);
}
