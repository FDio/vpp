...
#define pool_realloc_safe(P)                                                  \
  do                                                                          \
    {                                                                         \
      ...
      pool_alloc (P, free_elts + n_alloc);                                    \
...
{
  /* Reuse mmap_size as a realloc flag. No realloc for fixed pools */
...
#define pool_get_aligned_safe(P, thread_index, rpc_fn, align)                 \
  do                                                                          \
    {                                                                         \
      ...
      if (PREDICT_FALSE (pool_free_elts (P) < POOL_REALLOC_SAFE_ELT_THRESH))  \
	{                                                                     \
	  if (PREDICT_FALSE (!(P)))                                           \
	    {                                                                 \
	    ...
	    {                                                                 \
	      ...
	      if (thread_index)                                               \
		{                                                             \
		  while (pool_header (*PP)->mmap_size)                        \
		    {                                                         \
