...
u8
stream_session_half_table_has_no_tc (transport_connection_t *tc)
{
...
u8
stream_session_table_has_no_tc (transport_connection_t *tc)
{
  session_manager_main_t *smm = &session_manager_main;
  session_kv4_t kv4;
  int rv;
...
stream_session_table_add_for_tc (transport_connection_t * tc, u64 value)
{
  ...
  ASSERT (stream_session_table_has_no_tc (tc));
				    ...
				    transport_connection_t * tc, u64 value)
{
  ...
  ASSERT (stream_session_half_table_has_no_tc (tc));
