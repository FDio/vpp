 ...
 *
 * Should be called by transport prior to calling delete notify once it knows
 * that no more data will be exchanged. This could serve as an acknowledgment
 * of an active close.
 */
void
...
session_transport_close (session_t * s)
{
  ...
  /* The transport, if the tx queue wasn't drained, can continue to try
