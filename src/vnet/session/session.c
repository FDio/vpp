...
/* Bound aggregate retained RX data per worker, regardless of session count. */
#define SESSION_RX_DATA_MAX_WORKER_BYTES (1 << 20)
...
session_rx_buffers_enqueue (session_t *s, vlib_buffer_t *b, u32 n_bytes)
{
  ...
  worker_space = SESSION_RX_DATA_MAX_WORKER_BYTES;
