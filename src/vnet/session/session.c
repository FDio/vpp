...
transport_proto_t
session_register_new_transport (const transport_proto_vft_t * vft, u8 is_ip4,
				u32 output_node)
{
  transport_proto_t new_proto;

  new_proto = session_add_transport_proto ();
  session_register_transport (new_proto, vft, is_ip4, output_node);
  return new_proto;
}
