...
{
  APP_API_MSG_TYPE_NONE,
  APP_API_MSG_TYPE_ATTACH,
  APP_API_MSG_TYPE_ATTACH_REPLY,
  APP_API_MSG_TYPE_ADD_DEL_WORKER,
  APP_API_MSG_TYPE_ADD_DEL_WORKER_REPLY,
  APP_API_MSG_TYPE_SEND_FDS,
...
typedef struct
{
  ...
  union
  {
    ...
    app_api_add_del_worker_reply_msg_t add_del_worker_reply;
  };
