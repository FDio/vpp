...
typedef struct _vnet_add_app_certificate_args_
{
  u8 *cert;
  u8 *key;
  u32 index;
} vnet_add_app_certificate_args_t;
...
int vnet_add_app_certificate (vnet_add_app_certificate_args_t * a);
int vnet_del_app_certificate (u32 index);
