...
__clib_export uword unformat_transport_proto (unformat_input_t *input, va_list *args);
...
__clib_export transport_service_type_t transport_protocol_service_type (transport_proto_t);
