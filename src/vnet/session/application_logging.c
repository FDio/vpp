...
app_log_collect (app_log_collector_t *c, session_t *s)
{
  ...
  data_msg =
    app_log_buf_chunk_append_uninit (chunk, sizeof (app_log_msg_data_t));
  ...
  switch (tc->proto)
	...
	data_msg->msg_len =
	  sizeof (app_log_msg_data_t) + sizeof (tcp_transport_stats_t);
	data_msg->data_type = APP_LOG_MSG_DATA_TCP;
...
#undef _
	...
	data_msg->msg_len =
	  sizeof (app_log_msg_data_t) + sizeof (udp_transport_stats_t);
	data_msg->data_type = APP_LOG_MSG_DATA_UDP;
...
#undef _
  ...
  msg->msg_len += sizeof (app_log_msg_t) + data_msg->msg_len;
