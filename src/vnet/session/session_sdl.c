  ...
  if ((fib_proto == FIB_PROTOCOL_IP4 || all) && (sdlb->ip_fib_index != ~0))
    {
      ...
      auto_sdl_plugin.cleanup_by_fib_index (FIB_PROTOCOL_IP4, fib_index);
  ...
  if ((fib_proto == FIB_PROTOCOL_IP6 || all) && (sdlb->ip6_fib_index != ~0))
    {
      ...
      auto_sdl_plugin.cleanup_by_fib_index (FIB_PROTOCOL_IP6, fib_index);
