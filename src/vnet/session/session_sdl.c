  ...
  if (fib_proto == FIB_PROTOCOL_IP4)
    {
      ...
      session_sdl_table_walk4 (srt, sdlb->ip_fib_index,
			       session_sdl_fib_table_show, vm);
    }
  else if (fib_proto == FIB_PROTOCOL_IP6)
    {
      vlib_cli_output (vm, "IP6 rules, fib index %d", sdlb->ip6_fib_index);
      session_sdl_table_walk6 (srt, sdlb->ip6_fib_index,
			       session_sdl_fib_table_show, vm);
    }
}
...
void
session_sdl_table_walk4 (session_rules_table_t *srt, u32 fib_index,
			 session_sdl_table_walk_fn_t fn, void *args)
{
  ip4_fib_t *fib;
...
void
session_sdl_table_walk6 (session_rules_table_t *srt, u32 fib_index,
			 session_sdl_table_walk_fn_t fn, void *args)
{
  ip6_fib_t *fib;
  fib_node_index_t *fei;
