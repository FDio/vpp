...
int session_table_add_session_endpoint (u32 table_index,
                                        session_endpoint_t *sep,
                                        u64 value);
int session_table_del_session_endpoint (u32 table_index,
                                        session_endpoint_t *sep);
u32 session_table_get_index_for_nns (u32 nns_index);

session_lookup_table_t *session_table_alloc (void);
session_lookup_table_t *session_table_get (u32 table_index);
u32 session_table_index (session_lookup_table_t *slt);
void session_table_init (session_lookup_table_t *slt);

u64 session_lookup_local_listener_make_handle (session_endpoint_t *sep);
int session_lookup_local_listener_parse_handle (u64 handle, u16 *port,
                                                u8 *proto);
