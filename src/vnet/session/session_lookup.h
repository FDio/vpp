...
__clib_export session_t *session_lookup_safe4 (u32 fib_index, ip4_address_t *lcl,
					       ip4_address_t *rmt, u16 lcl_port, u16 rmt_port,
					       u8 proto);
__clib_export session_t *session_lookup_safe6 (u32 fib_index, ip6_address_t *lcl,
					       ip6_address_t *rmt, u16 lcl_port, u16 rmt_port,
					       u8 proto);
__clib_export transport_connection_t *
session_lookup_connection_wt4 (u32 fib_index, ip4_address_t *lcl, ip4_address_t *rmt, u16 lcl_port,
			       u16 rmt_port, u8 proto, clib_thread_index_t thread_index,
			       u8 *is_filtered);
__clib_export transport_connection_t *session_lookup_connection4 (u32 fib_index, ip4_address_t *lcl,
...
session_t *session_lookup_listener6 (u32 fib_index, ip6_address_t * lcl,
				     u16 lcl_port, u8 proto, u8 use_wildcard);
__clib_export session_t *session_lookup_listener (u32 table_index, session_endpoint_t *sep);
__clib_export session_t *session_lookup_listener_wildcard (u32 table_index,
							   session_endpoint_t *sep);
__clib_export int session_lookup_add_connection (transport_connection_t *tc, u64 value);
__clib_export int session_lookup_del_connection (transport_connection_t *tc);
u64 session_lookup_endpoint_listener (u32 table_index,
				      session_endpoint_t * sepi,
				      u8 use_rules);
__clib_export u64 session_lookup_local_endpoint (u32 table_index, session_endpoint_t *sep);
...
int session_lookup_del_session_endpoint (u32 table_index,
					 session_endpoint_t * sep);
__clib_export int session_lookup_del_session_endpoint2 (session_endpoint_t *sep);
__clib_export int session_lookup_del_session (session_t *s);
...
__clib_export void session_lookup_dump_rules_table (u32 fib_index, u8 fib_proto,
						    u8 transport_proto);
__clib_export void session_lookup_dump_local_rules_table (u32 fib_index, u8 fib_proto,
							  u8 transport_proto);
...
__clib_export session_error_t vnet_session_rule_add_del (session_rule_add_del_args_t *args);
void session_lookup_set_tables_appns (app_namespace_t * app_ns);

void session_lookup_init (void);
__clib_export session_table_t *session_table_get_for_fib_index (u32 fib_proto, u32 fib_index);
