...
{
  /** Worker index in app's worker pool*/
  u32 wrk_index;
...
int application_start_local_listen (app_worker_t * server,
				    ...
				    session_handle_t * handle);
int app_worker_stop_listen (app_worker_t * srv, session_handle_t handle);
int application_stop_local_listen (app_worker_t * server,
				   session_handle_t listener_handle);
int app_worker_open_session (app_worker_t * app, session_endpoint_t * tep,
			      u32 api_context);
int application_api_queue_is_full (app_worker_t * app);

segment_manager_t *app_worker_get_listen_segment_manager (app_worker_t *,
							   stream_session_t *);
segment_manager_t *app_worker_get_connect_segment_manager (app_worker_t *);
int app_worker_alloc_connects_segment_manager (app_worker_t * app);
int app_worker_add_segment_notify (u32 app_index, ssvm_private_t * fs);
...
void application_remove_proxy (app_worker_t * app);

segment_manager_properties_t *application_get_segment_manager_properties (u32
									  app_index);
segment_manager_properties_t
  * application_segment_manager_properties (app_worker_t * app);
...
int application_send_event (app_worker_t * app, stream_session_t * s,
			    u8 evt);
