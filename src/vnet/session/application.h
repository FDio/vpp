...
typedef struct _stream_session_cb_vft
{
  ...
  int (*redirect_connect_callback) (u32 api_client_index,
...
stream_session_t *application_alloc_local_session (application_t *app);
void application_free_local_session (application_t *app, stream_session_t *s);
