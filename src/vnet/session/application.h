...
__clib_export app_listener_t *app_listener_get (u32 al_index);
 ...
 */
__clib_export app_listener_t *app_listener_get_w_handle (session_handle_t handle);
__clib_export session_t *app_listener_get_session (app_listener_t *al);
session_t *app_listener_get_local_session (app_listener_t * al);
session_t *app_listener_get_wrk_cl_session (app_listener_t *al, u32 wrk_index);

__clib_export application_t *application_get (u32 index);
application_t *application_get_if_valid (u32 index);
application_t *application_lookup (u32 api_client_index);
__clib_export application_t *application_lookup_name (const u8 *name);
__clib_export app_worker_t *application_get_worker (application_t *app, u32 wrk_index);
__clib_export app_worker_t *application_get_default_worker (application_t *app);
...
__clib_export u32 application_session_table (application_t *app, u8 fib_proto);
__clib_export u32 application_local_session_table (application_t *app);
...
__clib_export segment_manager_props_t *application_get_segment_manager_properties (u32 app_index);

segment_manager_props_t __clib_export *application_segment_manager_properties (application_t *app);
...
int application_alloc_worker_and_init (application_t * app,
				       app_worker_t ** wrk);
__clib_export app_worker_t *app_worker_get (u32 wrk_index);
__clib_export app_worker_t *app_worker_get_if_valid (u32 wrk_index);
__clib_export application_t *app_worker_get_app (u32 wrk_index);
...
__clib_export int app_worker_init_accepted (session_t *s);
...
int app_worker_unlisten_reply (app_worker_t *app_wrk, session_handle_t sh,
			       u32 opaque, session_error_t err);
__clib_export int app_worker_accept_notify (app_worker_t *app_wrk, session_t *s);
__clib_export int app_worker_init_connected (app_worker_t *app_wrk, session_t *s);
__clib_export int app_worker_connect_notify (app_worker_t *app_wrk, session_t *s,
...
__clib_export int app_worker_rx_notify (app_worker_t *app_wrk, session_t *s);
...
segment_manager_t *app_worker_get_listen_segment_manager (app_worker_t *,
							  session_t *);
__clib_export segment_manager_t *app_worker_get_connect_segment_manager (app_worker_t *);
