  ...
  vl_api_session_enable_disable_v2_t *mp)
{
  ...
  STATIC_ASSERT (RT_BACKEND_ENGINE_API_DISABLE == RT_BACKEND_ENGINE_DISABLE,
		 "API value mismatch");
  STATIC_ASSERT (RT_BACKEND_ENGINE_API_NONE == RT_BACKEND_ENGINE_NONE,
		 "API value mismatch");
  STATIC_ASSERT (RT_BACKEND_ENGINE_API_RULE_TABLE ==
		   RT_BACKEND_ENGINE_RULE_TABLE,
		 "API value mismatch");
  STATIC_ASSERT (RT_BACKEND_ENGINE_API_SDL == RT_BACKEND_ENGINE_SDL,
		 "API value mismatch");
