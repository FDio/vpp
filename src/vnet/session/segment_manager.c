...
segment_manager_alloc_segment_w_lock (segment_manager_t * sm)
{
...
segment_manager_add_segment_i (segment_manager_t * sm, u32 segment_size)
{
   ...
   */
  seg = segment_manager_alloc_segment_w_lock (sm);
...
again:
  ...
  if (props->add_segment)
      ...
      if ((new_segment_index = segment_manager_add_segment_i (sm, 0)) < 0)
	{
      ...
      fifo_segment = segment_manager_get_segment_w_lock (sm, new_segment_index);
