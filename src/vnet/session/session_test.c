...
session_test_namespace (vlib_main_t * vm, unformat_input_t * input)
{
  ...
  u32 dummy_port = 1234, local_listener;
  ...
  /*
   * Test namespace insertion and lookup
   */
  ...
  /*
   * Attach with local and global scope
   */
  ...
  s = session_lookup_listener (server_st_index, &sep);
