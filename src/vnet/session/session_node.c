			       ...
			       u8 peek_data)
{
  ...
  ctx->n_segs_per_evt = ceil ((double) ctx->max_len_to_snd / n_bytes_per_seg);
				...
				u8 peek_data)
{
  ...
  ctx->n_segs_per_evt = clib_min (ctx->n_segs_per_evt,
  ...
  ctx->n_segs_per_evt = clib_min (n_left_to_next, ctx->n_segs_per_evt);
