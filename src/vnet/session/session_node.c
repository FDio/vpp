				...
				u8 peek_data)
{
  ...
  while (n_left >= 4)
    {
      ...
      CLIB_PREFETCH (b[2]->data + 64, CLIB_CACHE_LINE_BYTES, STORE);
      vlib_prefetch_buffer_header (b[3], STORE);
      CLIB_PREFETCH (b[3]->data + 64, CLIB_CACHE_LINE_BYTES, STORE);
  ...
  while (n_left)
      ...
      if (n_left > 1)
	{
	  ...
	  CLIB_PREFETCH (b[1]->data + 64, CLIB_CACHE_LINE_BYTES, STORE);
	}
