...
struct _session_lookup_table;
struct _session_rules_table_t;
...
void session_sdl_block_init (struct _session_lookup_table *st);
...
void session_sdl_table_walk4 (struct _session_rules_table_t *srt,
			      u32 fib_index, session_sdl_table_walk_fn_t fn,
			      void *args);
void session_sdl_table_walk6 (struct _session_rules_table_t *srt,
			      u32 fib_index, session_sdl_table_walk_fn_t fn,
			      void *args);
