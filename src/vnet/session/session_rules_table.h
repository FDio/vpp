...
typedef CLIB_PACKED (struct
		     ...
		     ip4_address_t lcl_ip; u16 rmt_port; u16 lcl_port;
		     }; u64 as_u64[2];
		     };
...
typedef CLIB_PACKED (struct
		     ...
		     ip6_address_t lcl_ip; u16 rmt_port; u16 lcl_port;
		     }; u64 as_u64[5];
		     };
...
void *session_rules_table_get (u8 transport_proto, u8 fib_proto);
clib_error_t *vnet_session_rule_add_del (session_rule_add_del_args_t * args);
u32 session_rules_table_lookup4 (u8 transport_proto, ip4_address_t * lcl_ip,
				 ip4_address_t * rmt_ip, u16 lcl_port,
				 u16 rmt_port);
u32 session_rules_table_lookup6 (u8 transport_proto, ip6_address_t * lcl_ip,
