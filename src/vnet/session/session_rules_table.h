...
extern void
session_rules_table_app_namespace_walk_cb (struct _app_namespace *app_ns,
					   void *ctx);

void session_rules_table_init (struct _session_lookup_table *st, u8 fib_proto);
