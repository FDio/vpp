...
typedef struct _session_rule_table_add_del_args
{
  u8 transport_proto;
  fib_prefix_t lcl;
  fib_prefix_t rmt;
...
typedef struct _session_rules_table_t
{
   ...
   */
  session_rules_table_16_t session_rules_tables_16[TRANSPORT_N_PROTO];
  session_rules_table_40_t session_rules_tables_40[TRANSPORT_N_PROTO];
