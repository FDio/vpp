...
#define TRANSPORT_PACER_MIN_MTU 1460
...
{
  pacer->max_burst_size = clib_max (max_burst_bytes, TRANSPORT_PACER_MIN_MTU);
}
...
void
transport_connection_pacer_update (transport_connection_t *tc,
                                   u64 bytes_per_sec)
{
  u32 burst_size;
