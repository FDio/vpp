  ...
  if (PREDICT_FALSE (n_periods > pacer->idle_timeout_us))
    {
      ...
      clib_warning ("reset %.3f idle %u", (f64) time_now / 1e6, pacer->idle_timeout_us);
