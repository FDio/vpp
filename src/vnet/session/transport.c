                      ...
                      u32 idle_timeout_us)
{
  ...
  pacer->idle_timeout_us = clib_max (idle_timeout_us, 100);
}
...
transport_connection_tx_pacer_reset (transport_connection_t * tc,
				     ...
				     u32 idle_timeout_us)
{
  spacer_set_pace_rate (&tc->pacer, rate_bytes_per_sec, idle_timeout_us);
...
transport_connection_tx_pacer_update (transport_connection_t * tc,
				      ...
				      u32 idle_timeout_us)
{
  spacer_set_pace_rate (&tc->pacer, bytes_per_sec, idle_timeout_us);
}
