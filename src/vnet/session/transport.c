...
//  clib_warning ("nperiods %u tokens/p %.2f inc %lu", n_periods,
//                pacer->tokens_per_period, (u64) ((f32) n_periods * pacer->tokens_per_period));
  if (n_periods > 0 && (inc = (f32) n_periods * pacer->tokens_per_period) > 10)
    {
