...
typedef struct _transport_connection
{
  ...
  fib_node_t fib_node;		/**< Node in FIB control plane graph */
  fib_node_index_t rmt_fei;	/**< Sourced FIB entry for rmt */
  u32 rmt_fib_child_index;	/**< FIB entry child index */
  dpo_id_t rmt_dpo;		/**< Forwarding DPO for rmt endpoint */
...
#define c_fib_node connection.fib_node
#define c_rmt_fei connection.rmt_fei
#define c_rmt_fib_child_index connection.rmt_fib_child_index
