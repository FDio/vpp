...
/*
 * Keep the formatter ABI scalar across the varargs boundary and decode it
 * locally when formatters want named access to the bitfields.
 */
...
session_fmt_req_decode (u32 fmt)
{
  session_fmt_req_t decoded = { .as_u32 = fmt };
