...
typedef enum session_fifo_last_action_type_
{
  SESSION_FIFO_LAST_ACTION_ENQUEUED,
  SESSION_FIFO_LAST_ACTION_DEQUEUED,
  SESSION_FIFO_LAST_ACTION_N_ACTIONS
} session_fifo_last_action_type_t;
