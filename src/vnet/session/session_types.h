...
always_inline u32
session_handle_index (session_handle_tu_t ho_handle)
{
  //   return (ho_handle & 0xffffffff);
  return ho_handle.session_index;
}

always_inline u32
session_handle_data (session_handle_tu_t ho_handle)
{
  //   return (ho_handle >> 32);
  return ho_handle.thread_index;
}
