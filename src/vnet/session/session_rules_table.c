...
u8
rule_is_less_than_16 (session_rule_16_t *rule1, session_rule_16_t *rule2)
{
  session_mask_or_match_4_t *r1, *r2;
  r1 = (session_mask_or_match_4_t *) &rule1->match;
  r2 = (session_mask_or_match_4_t *) &rule2->match;
  if (r1->rmt_ip.as_u32 != r2->rmt_ip.as_u32)
    return (clib_net_to_host_u32 (r1->rmt_ip.as_u32)
	< clib_net_to_host_u32 (r2->rmt_ip.as_u32));
  if (r1->lcl_ip.as_u32 != r2->lcl_ip.as_u32)
    return (clib_net_to_host_u32 (r1->lcl_ip.as_u32)
	< clib_net_to_host_u32 (r2->lcl_ip.as_u32));
  if (r1->rmt_port != r2->rmt_port)
    return (r1->rmt_port < r2->rmt_port);
  if (r1->lcl_port != r2->lcl_port)
    return (r1->lcl_port < r2->lcl_port);
  return 0;
}

u8
rule_is_less_than_40 (session_rule_40_t *rule1, session_rule_40_t *rule2)
{
  session_mask_or_match_6_t *r1, *r2;
  r1 = (session_mask_or_match_6_t *) rule1;
  r2 = (session_mask_or_match_6_t *) rule2;
  if (r1->rmt_ip.as_u64[0] != r2->rmt_ip.as_u64[0])
    return (r1->rmt_ip.as_u64[0] < r2->rmt_ip.as_u64[0]);
  if (r1->rmt_ip.as_u64[1] != r2->rmt_ip.as_u64[1])
    return (r1->rmt_ip.as_u64[1] < r2->rmt_ip.as_u64[1]);
  if (r1->lcl_ip.as_u64[0] != r2->lcl_ip.as_u64[0])
    return (r1->lcl_ip.as_u64[0] < r2->lcl_ip.as_u64[0]);
  if (r1->lcl_ip.as_u64[1] != r2->lcl_ip.as_u64[1])
    return (r1->lcl_ip.as_u64[1] < r2->lcl_ip.as_u64[1]);
  if (r1->rmt_port != r2->rmt_port)
    return (r1->rmt_port < r2->rmt_port);
  if (r1->lcl_port != r2->lcl_port)
    return (r1->lcl_port < r2->lcl_port);
...
void
session_rules_table_init_rule_16 (session_rule_16_t *rule, fib_prefix_t *lcl,
                                  u16 lcl_port, fib_prefix_t *rmt, u16 rmt_port)
{
  ...
  match->lcl_port = lcl_port == (u16) ~0 ? 0 : lcl_port;
  match->rmt_port = rmt_port == (u16) ~0 ? 0 : rmt_port;
  ...
  mask->lcl_port = lcl_port == (u16) ~0 ? 0 : (u16) ~0;
  mask->rmt_port = rmt_port == (u16) ~0 ? 0 : (u16) ~0;
}

void
session_rules_table_init_rule_40 (session_rule_40_t *rule, fib_prefix_t *lcl,
                                  u16 lcl_port, fib_prefix_t *rmt, u16 rmt_port)
{
