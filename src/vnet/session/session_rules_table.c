				  ...
				  fib_prefix_t * rmt, u16 rmt_port)
{
  ...
  _clib_memcpy (&match->lcl_ip, &lcl->fp_addr.ip6, sizeof (match->lcl_ip));
  _clib_memcpy (&match->rmt_ip, &rmt->fp_addr.ip6, sizeof (match->rmt_ip));
  match->lcl_port = lcl_port;
  match->rmt_port = rmt_port;
				  ...
				  u16 rmt_port)
{
  ...
  _clib_memcpy (&key.lcl_ip, lcl_ip, sizeof (*lcl_ip));
  _clib_memcpy (&key.rmt_ip, rmt_ip, sizeof (*rmt_ip));
			       ...
			       u8 is_ip4)
{
  ...
  if (is_ip4)
	...
	.rmt_port = rmt_port,
      ...
      _clib_memcpy (&key.lcl_ip, &lcl_ip->ip6, sizeof (lcl_ip->ip6));
      _clib_memcpy (&key.rmt_ip, &rmt_ip->ip6, sizeof (rmt_ip->ip6));
