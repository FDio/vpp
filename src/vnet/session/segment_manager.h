 ...
 *
 * Since the fifos allocated in the segment keep backpointers to their
 * owning sessions, prior to removing the segment disconnect is called on all
 * active sessions.
 *
...
svm_fifo_segment_t *segment_manager_get_segment (segment_manager_t *,
						 u32 segment_index);
svm_fifo_segment_t *segment_manager_get_segment_w_handle (u64 sh);
svm_fifo_segment_t *segment_manager_get_segment_w_lock (segment_manager_t *sm,
                                                        u32 segment_index);
