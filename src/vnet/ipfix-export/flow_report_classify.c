...
u8 *
ipfix_classify_template_rewrite (flow_report_main_t *frm, flow_report_t *fr,
...
vlib_frame_t *
ipfix_classify_send_flows (flow_report_main_t *frm, flow_report_t *fr,
...
static clib_error_t *
set_ipfix_classify_stream_command_fn (vlib_main_t *vm, unformat_input_t *input,
				      vlib_cli_command_t *cmd)
{
  flow_report_classify_main_t *fcm = &flow_report_classify_main;
  flow_report_main_t *frm = &flow_report_main;
