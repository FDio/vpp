 ...
 *
 * geneve <geneve-header>
 *
 * <geneve-header> vni opt_len
 *
 ...
 *
 * @cliexcmd{classify filter trace mask geneve opt_len 56 g3 ip4 src dst
 * match geneve opt_len 56 g3 ip4 src 192.168.1.10 dst 192.168.2.10}
 * <b><em>trace add dpdk-input 100 filter</em></b>
 *
