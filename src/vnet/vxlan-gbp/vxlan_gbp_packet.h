...
static inline u16
vnet_get_vxlan_gbp_flags (vxlan_gbp_header_t * h)
{
...
static inline u32
vnet_get_vxlan_gbp_flags_sclass (vxlan_gbp_header_t * h)
{
  u32 flags_sclass_host_byte_order;

  flags_sclass_host_byte_order =
    clib_net_to_host_u32 (h->flags_sclass_as_u32);
  return flags_sclass_host_byte_order;
}
			   ...
			   u16 sclass)
{
  ...
  *(u32 *) h = 0;
  flags |= VXLAN_GBP_FLAGS_I | VXLAN_GBP_FLAGS_G;
