...
format_vxlan_gbp_encap_trace (u8 * s, va_list * args)
{
  ...
  s = format (s, "VXLAN_GBP encap to vxlan_gbp_tunnel%d vni %d",
...
{
  .function = vxlan4_gbp_encap,.name = "vxlan4-gbp-encap",.vector_size =
    sizeof (u32),.format_trace = format_vxlan_gbp_encap_trace,.type =
    VLIB_NODE_TYPE_INTERNAL,.n_errors =
    ARRAY_LEN (vxlan_gbp_encap_error_strings),.error_strings =
    vxlan_gbp_encap_error_strings,.n_next_nodes =
    VXLAN_GBP_ENCAP_N_NEXT,.next_nodes =
  {
...
{
  .function = vxlan6_gbp_encap,.name = "vxlan6-gbp-encap",.vector_size =
    sizeof (u32),.format_trace = format_vxlan_gbp_encap_trace,.type =
    VLIB_NODE_TYPE_INTERNAL,.n_errors =
    ARRAY_LEN (vxlan_gbp_encap_error_strings),.error_strings =
    vxlan_gbp_encap_error_strings,.n_next_nodes =
