...
#define MFIB_ENTRY_DBG(_e, _fmt, _args...)                                    \
  {                                                                           \
    vlib_log_debug (mfib_entry_logger, "e:[%d:%U]: " _fmt,                    \
		    mfib_entry_get_index (_e), format_mfib_prefix,            \
		    &_e->mfe_prefix, ##_args);                                \
  }
...
extern fib_node_index_t mfib_entry_create (u32 fib_index, mfib_source_t source,
...
extern const mfib_prefix_t *
mfib_entry_get_prefix (fib_node_index_t fib_entry_index);
...
extern int mfib_entry_is_marked (fib_node_index_t fib_entry_index,
				 mfib_source_t source);
extern void mfib_entry_mark (fib_node_index_t fib_entry_index,
			     mfib_source_t source);
