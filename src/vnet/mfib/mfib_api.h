...
struct _vl_api_mfib_prefix;

/**
 * Encode and decode functions from the API types to internal types
 */
extern void mfib_api_prefix_encode(const mfib_prefix_t *pfx,
                                   struct _vl_api_mfib_prefix *out);
extern void mfib_api_prefix_decode(const struct _vl_api_mfib_prefix *in,
                                   mfib_prefix_t *out);
extern void mfib_api_path_encode(const mfib_route_path_t * api_rpath,
                                 struct _vl_api_mfib_path *out);
extern int mfib_api_path_decode(const struct _vl_api_mfib_path *in,
