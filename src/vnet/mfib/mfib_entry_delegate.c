...
mfib_entry_delegate_find_i (const mfib_entry_t *mfib_entry,
			    mfib_entry_delegate_type_t type, u32 *index)
{
...
static int
mfib_entry_delegate_cmp_for_sort (void *v1, void *v2)
{
 ...
 */
static u8 *
mfib_entry_delegate_fmt_covered (const mfib_entry_delegate_t *fed, u8 *s)
{
  s = format (s, "covered:[");
