...
void vnet_crypto_register_ops_handler_chained (vlib_main_t * vm,
					       u32 engine_index,
					       vnet_crypto_op_id_t opt,
...
typedef struct
{
  ...
  vnet_crypto_ops_handler_t *chained_ops_handlers[VNET_CRYPTO_N_OP_IDS];
...
typedef struct
{
  ...
  vnet_crypto_ops_handler_t **chained_ops_handlers;
