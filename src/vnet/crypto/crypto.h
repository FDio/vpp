...
#define foreach_crypto_aead_alg                                                                    \
  _ (AES_128_GCM, "aes-128-gcm", .key_length = 16)                                                 \
  _ (AES_192_GCM, "aes-192-gcm", .key_length = 24)                                                 \
  _ (AES_256_GCM, "aes-256-gcm", .key_length = 32)                                                 \
  _ (AES_128_NULL_GMAC, "aes-128-null-gmac", .key_length = 16)                                     \
  _ (AES_192_NULL_GMAC, "aes-192-null-gmac", .key_length = 24)                                     \
  _ (AES_256_NULL_GMAC, "aes-256-null-gmac", .key_length = 32)                                     \
  _ (CHACHA20_POLY1305, "chacha20-poly1305", .key_length = 32)
...
/* CRYPTO_ID, INTEG_ID, PRETTY_NAME, KEY_LENGTH_IN_BYTES */
#define foreach_crypto_combined_alg_non_ctr                                                        \
  _ (3DES_CBC, MD5, "3des-cbc-hmac-md5", 24)                                                       \
  _ (AES_128_CBC, MD5, "aes-128-cbc-hmac-md5", 16)                                                 \
  _ (AES_192_CBC, MD5, "aes-192-cbc-hmac-md5", 24)                                                 \
  _ (AES_256_CBC, MD5, "aes-256-cbc-hmac-md5", 32)                                                 \
  _ (3DES_CBC, SHA1, "3des-cbc-hmac-sha-1", 24)                                                    \
  _ (AES_128_CBC, SHA1, "aes-128-cbc-hmac-sha-1", 16)                                              \
  _ (AES_192_CBC, SHA1, "aes-192-cbc-hmac-sha-1", 24)                                              \
  _ (AES_256_CBC, SHA1, "aes-256-cbc-hmac-sha-1", 32)                                              \
  _ (3DES_CBC, SHA224, "3des-cbc-hmac-sha-224", 24)                                                \
  _ (AES_128_CBC, SHA224, "aes-128-cbc-hmac-sha-224", 16)                                          \
  _ (AES_192_CBC, SHA224, "aes-192-cbc-hmac-sha-224", 24)                                          \
  _ (AES_256_CBC, SHA224, "aes-256-cbc-hmac-sha-224", 32)                                          \
  _ (3DES_CBC, SHA256, "3des-cbc-hmac-sha-256", 24)                                                \
  _ (AES_128_CBC, SHA256, "aes-128-cbc-hmac-sha-256", 16)                                          \
  _ (AES_192_CBC, SHA256, "aes-192-cbc-hmac-sha-256", 24)                                          \
  _ (AES_256_CBC, SHA256, "aes-256-cbc-hmac-sha-256", 32)                                          \
  _ (3DES_CBC, SHA384, "3des-cbc-hmac-sha-384", 24)                                                \
  _ (AES_128_CBC, SHA384, "aes-128-cbc-hmac-sha-384", 16)                                          \
  _ (AES_192_CBC, SHA384, "aes-192-cbc-hmac-sha-384", 24)                                          \
  _ (AES_256_CBC, SHA384, "aes-256-cbc-hmac-sha-384", 32)                                          \
  _ (3DES_CBC, SHA512, "3des-cbc-hmac-sha-512", 24)                                                \
  _ (AES_128_CBC, SHA512, "aes-128-cbc-hmac-sha-512", 16)                                          \
  _ (AES_192_CBC, SHA512, "aes-192-cbc-hmac-sha-512", 24)                                          \
  _ (AES_256_CBC, SHA512, "aes-256-cbc-hmac-sha-512", 32)

#define foreach_crypto_combined_alg_ctr                                                            \
  _ (AES_128_CTR, SHA1, "aes-128-ctr-hmac-sha-1", 16)                                              \
  _ (AES_192_CTR, SHA1, "aes-192-ctr-hmac-sha-1", 24)                                              \
  _ (AES_256_CTR, SHA1, "aes-256-ctr-hmac-sha-1", 32)                                              \
  _ (AES_128_CTR, SHA256, "aes-128-ctr-hmac-sha-256", 16)                                          \
  _ (AES_192_CTR, SHA256, "aes-192-ctr-hmac-sha-256", 24)                                          \
  _ (AES_256_CTR, SHA256, "aes-256-ctr-hmac-sha-256", 32)                                          \
  _ (AES_128_CTR, SHA384, "aes-128-ctr-hmac-sha-384", 16)                                          \
  _ (AES_192_CTR, SHA384, "aes-192-ctr-hmac-sha-384", 24)                                          \
  _ (AES_256_CTR, SHA384, "aes-256-ctr-hmac-sha-384", 32)                                          \
  _ (AES_128_CTR, SHA512, "aes-128-ctr-hmac-sha-512", 16)                                          \
  _ (AES_192_CTR, SHA512, "aes-192-ctr-hmac-sha-512", 24)                                          \
  _ (AES_256_CTR, SHA512, "aes-256-ctr-hmac-sha-512", 32)
...
#define foreach_crypto_combined_fixed_alg_non_ctr                                                  \
  _ (3DES_CBC, MD5, "3des-cbc-hmac-md5-tag12", 24, 12)                                             \
  _ (AES_128_CBC, MD5, "aes-128-cbc-hmac-md5-tag12", 16, 12)                                       \
  _ (AES_192_CBC, MD5, "aes-192-cbc-hmac-md5-tag12", 24, 12)                                       \
  _ (AES_256_CBC, MD5, "aes-256-cbc-hmac-md5-tag12", 32, 12)                                       \
  _ (3DES_CBC, SHA1, "3des-cbc-hmac-sha-1-tag12", 24, 12)                                          \
  _ (AES_128_CBC, SHA1, "aes-128-cbc-hmac-sha-1-tag12", 16, 12)                                    \
  _ (AES_192_CBC, SHA1, "aes-192-cbc-hmac-sha-1-tag12", 24, 12)                                    \
  _ (AES_256_CBC, SHA1, "aes-256-cbc-hmac-sha-1-tag12", 32, 12)                                    \
  _ (3DES_CBC, SHA224, "3des-cbc-hmac-sha-224-tag14", 24, 14)                                      \
  _ (AES_128_CBC, SHA224, "aes-128-cbc-hmac-sha-224-tag14", 16, 14)                                \
  _ (AES_192_CBC, SHA224, "aes-192-cbc-hmac-sha-224-tag14", 24, 14)                                \
  _ (AES_256_CBC, SHA224, "aes-256-cbc-hmac-sha-224-tag14", 32, 14)                                \
  _ (3DES_CBC, SHA256, "3des-cbc-hmac-sha-256-tag16", 24, 16)                                      \
  _ (AES_128_CBC, SHA256, "aes-128-cbc-hmac-sha-256-tag16", 16, 16)                                \
  _ (AES_192_CBC, SHA256, "aes-192-cbc-hmac-sha-256-tag16", 24, 16)                                \
  _ (AES_256_CBC, SHA256, "aes-256-cbc-hmac-sha-256-tag16", 32, 16)                                \
  _ (3DES_CBC, SHA384, "3des-cbc-hmac-sha-384-tag24", 24, 24)                                      \
  _ (AES_128_CBC, SHA384, "aes-128-cbc-hmac-sha-384-tag24", 16, 24)                                \
  _ (AES_192_CBC, SHA384, "aes-192-cbc-hmac-sha-384-tag24", 24, 24)                                \
  _ (AES_256_CBC, SHA384, "aes-256-cbc-hmac-sha-384-tag24", 32, 24)                                \
  _ (3DES_CBC, SHA512, "3des-cbc-hmac-sha-512-tag32", 24, 32)                                      \
  _ (AES_128_CBC, SHA512, "aes-128-cbc-hmac-sha-512-tag32", 16, 32)                                \
  _ (AES_192_CBC, SHA512, "aes-192-cbc-hmac-sha-512-tag32", 24, 32)                                \
  _ (AES_256_CBC, SHA512, "aes-256-cbc-hmac-sha-512-tag32", 32, 32)

#define foreach_crypto_combined_fixed_alg_ctr                                                      \
  _ (AES_128_CTR, SHA1, "aes-128-ctr-hmac-sha-1-tag12", 16, 12)                                    \
  _ (AES_192_CTR, SHA1, "aes-192-ctr-hmac-sha-1-tag12", 24, 12)                                    \
  _ (AES_256_CTR, SHA1, "aes-256-ctr-hmac-sha-1-tag12", 32, 12)                                    \
  _ (AES_128_CTR, SHA256, "aes-128-ctr-hmac-sha-256-tag16", 16, 16)                                \
  _ (AES_192_CTR, SHA256, "aes-192-ctr-hmac-sha-256-tag16", 24, 16)                                \
  _ (AES_256_CTR, SHA256, "aes-256-ctr-hmac-sha-256-tag16", 32, 16)                                \
  _ (AES_128_CTR, SHA384, "aes-128-ctr-hmac-sha-384-tag24", 16, 24)                                \
  _ (AES_192_CTR, SHA384, "aes-192-ctr-hmac-sha-384-tag24", 24, 24)                                \
  _ (AES_256_CTR, SHA384, "aes-256-ctr-hmac-sha-384-tag24", 32, 24)                                \
  _ (AES_128_CTR, SHA512, "aes-128-ctr-hmac-sha-512-tag32", 16, 32)                                \
  _ (AES_192_CTR, SHA512, "aes-192-ctr-hmac-sha-512-tag32", 24, 32)                                \
  _ (AES_256_CTR, SHA512, "aes-256-ctr-hmac-sha-512-tag32", 32, 32)
...
#undef _
#define _(c, h, s, k) VNET_CRYPTO_ALG_##c##_##h,
...
vnet_crypto_get_cypher_key (const vnet_crypto_key_t *k)
{
...
#define _(n, s, k, t, a)                                                      \
  VNET_CRYPTO_OP_##n##_TAG##t##_AAD##a##_ENC,                                 \
    VNET_CRYPTO_OP_##n##_TAG##t##_AAD##a##_DEC,
      foreach_crypto_aead_async_alg
#undef _
#define _(c, h, s, k) VNET_CRYPTO_OP_##c##_##h##_ENC, VNET_CRYPTO_OP_##c##_##h##_DEC,
	foreach_crypto_combined_alg
#undef _
#define _(c, h, s, k, d)                                                      \
...
void vnet_crypto_register_key_handlers (vlib_main_t *vm, vnet_crypto_engine_id_t engine,
					vnet_crypto_key_data_fn_t *key_add_fn,
					vnet_crypto_key_data_fn_t *key_del_fn);
void vnet_crypto_register_key_add_handler (vlib_main_t *vm, vnet_crypto_engine_id_t engine,
					   vnet_crypto_key_data_fn_t *key_add_fn);
void vnet_crypto_register_key_del_handler (vlib_main_t *vm, vnet_crypto_engine_id_t engine,
					   vnet_crypto_key_data_fn_t *key_del_fn);
...
u32 vnet_crypto_key_add_for_engine (vlib_main_t *vm, vnet_crypto_engine_id_t engine,
				    vnet_crypto_alg_t alg, const u8 *crypto_data, u16 crypto_length,
				    const u8 *integ_data, u16 integ_length);
u32 vnet_crypto_key_add_for_async_engine (vlib_main_t *vm, vnet_crypto_engine_id_t engine,
