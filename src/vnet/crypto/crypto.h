...
#define foreach_crypto_hash_alg                                                                    \
  ...
  _ (SHA2_224, "sha2-224", NONE, SHA2, 28, 64)                                                     \
  _ (SHA2_256, "sha2-256", NONE, SHA2, 32, 64)                                                     \
  _ (SHA2_384, "sha2-384", NONE, SHA2, 48, 128)                                                    \
  _ (SHA2_512, "sha2-512", NONE, SHA2, 64, 128)
...
#define foreach_crypto_hash_fixed_alg                                                              \
  ...
  _ (SHA2_256_ICV12, "sha2-256-icv12", NONE, SHA2, 12, 64)                                         \
  _ (SHA2_256_ICV16, "sha2-256-icv16", NONE, SHA2, 16, 64)                                         \
  _ (SHA2_384_ICV24, "sha2-384-icv24", NONE, SHA2, 24, 128)                                        \
  _ (SHA2_512_ICV32, "sha2-512-icv32", NONE, SHA2, 32, 128)
...
#define foreach_crypto_combined_alg_non_ctr                                                        \
  ...
  _ (3DES_CBC, SHA2_224, "3des-cbc-sha2-224", TDES_CBC, SHA2, 24, 28, 64, 8)                       \
  _ (AES_128_CBC, SHA2_224, "aes-128-cbc-sha2-224", AES_CBC, SHA2, 16, 28, 64, 16)                 \
  _ (AES_192_CBC, SHA2_224, "aes-192-cbc-sha2-224", AES_CBC, SHA2, 24, 28, 64, 16)                 \
  _ (AES_256_CBC, SHA2_224, "aes-256-cbc-sha2-224", AES_CBC, SHA2, 32, 28, 64, 16)                 \
  _ (3DES_CBC, SHA2_256, "3des-cbc-sha2-256", TDES_CBC, SHA2, 24, 32, 64, 8)                       \
  _ (AES_128_CBC, SHA2_256, "aes-128-cbc-sha2-256", AES_CBC, SHA2, 16, 32, 64, 16)                 \
  _ (AES_192_CBC, SHA2_256, "aes-192-cbc-sha2-256", AES_CBC, SHA2, 24, 32, 64, 16)                 \
  _ (AES_256_CBC, SHA2_256, "aes-256-cbc-sha2-256", AES_CBC, SHA2, 32, 32, 64, 16)                 \
  _ (3DES_CBC, SHA2_384, "3des-cbc-sha2-384", TDES_CBC, SHA2, 24, 48, 128, 8)                      \
  _ (AES_128_CBC, SHA2_384, "aes-128-cbc-sha2-384", AES_CBC, SHA2, 16, 48, 128, 16)                \
  _ (AES_192_CBC, SHA2_384, "aes-192-cbc-sha2-384", AES_CBC, SHA2, 24, 48, 128, 16)                \
  _ (AES_256_CBC, SHA2_384, "aes-256-cbc-sha2-384", AES_CBC, SHA2, 32, 48, 128, 16)                \
  _ (3DES_CBC, SHA2_512, "3des-cbc-sha2-512", TDES_CBC, SHA2, 24, 64, 128, 8)                      \
  _ (AES_128_CBC, SHA2_512, "aes-128-cbc-sha2-512", AES_CBC, SHA2, 16, 64, 128, 16)                \
  _ (AES_192_CBC, SHA2_512, "aes-192-cbc-sha2-512", AES_CBC, SHA2, 24, 64, 128, 16)                \
  _ (AES_256_CBC, SHA2_512, "aes-256-cbc-sha2-512", AES_CBC, SHA2, 32, 64, 128, 16)
...
#define foreach_crypto_combined_alg_ctr                                                            \
  ...
  _ (AES_128_CTR, SHA2_256, "aes-128-ctr-sha2-256", AES_CTR, SHA2, 16, 32, 64, 16)                 \
  _ (AES_192_CTR, SHA2_256, "aes-192-ctr-sha2-256", AES_CTR, SHA2, 24, 32, 64, 16)                 \
  _ (AES_256_CTR, SHA2_256, "aes-256-ctr-sha2-256", AES_CTR, SHA2, 32, 32, 64, 16)                 \
  _ (AES_128_CTR, SHA2_384, "aes-128-ctr-sha2-384", AES_CTR, SHA2, 16, 48, 128, 16)                \
  _ (AES_192_CTR, SHA2_384, "aes-192-ctr-sha2-384", AES_CTR, SHA2, 24, 48, 128, 16)                \
  _ (AES_256_CTR, SHA2_384, "aes-256-ctr-sha2-384", AES_CTR, SHA2, 32, 48, 128, 16)                \
  _ (AES_128_CTR, SHA2_512, "aes-128-ctr-sha2-512", AES_CTR, SHA2, 16, 64, 128, 16)                \
  _ (AES_192_CTR, SHA2_512, "aes-192-ctr-sha2-512", AES_CTR, SHA2, 24, 64, 128, 16)                \
  _ (AES_256_CTR, SHA2_512, "aes-256-ctr-sha2-512", AES_CTR, SHA2, 32, 64, 128, 16)
...
#define foreach_crypto_combined_fixed_alg_non_ctr                                                  \
  ...
  _ (3DES_CBC, SHA2_224, "3des-cbc-sha2-224-icv14", TDES_CBC, SHA2, 24, 14, 64, 8)                 \
  _ (AES_128_CBC, SHA2_224, "aes-128-cbc-sha2-224-icv14", AES_CBC, SHA2, 16, 14, 64, 16)           \
  _ (AES_192_CBC, SHA2_224, "aes-192-cbc-sha2-224-icv14", AES_CBC, SHA2, 24, 14, 64, 16)           \
  _ (AES_256_CBC, SHA2_224, "aes-256-cbc-sha2-224-icv14", AES_CBC, SHA2, 32, 14, 64, 16)           \
  _ (3DES_CBC, SHA2_256, "3des-cbc-sha2-256-icv12", TDES_CBC, SHA2, 24, 12, 64, 8)                 \
  _ (AES_128_CBC, SHA2_256, "aes-128-cbc-sha2-256-icv12", AES_CBC, SHA2, 16, 12, 64, 16)           \
  _ (AES_192_CBC, SHA2_256, "aes-192-cbc-sha2-256-icv12", AES_CBC, SHA2, 24, 12, 64, 16)           \
  _ (AES_256_CBC, SHA2_256, "aes-256-cbc-sha2-256-icv12", AES_CBC, SHA2, 32, 12, 64, 16)           \
  _ (3DES_CBC, SHA2_256, "3des-cbc-sha2-256-icv16", TDES_CBC, SHA2, 24, 16, 64, 8)                 \
  _ (AES_128_CBC, SHA2_256, "aes-128-cbc-sha2-256-icv16", AES_CBC, SHA2, 16, 16, 64, 16)           \
  _ (AES_192_CBC, SHA2_256, "aes-192-cbc-sha2-256-icv16", AES_CBC, SHA2, 24, 16, 64, 16)           \
  _ (AES_256_CBC, SHA2_256, "aes-256-cbc-sha2-256-icv16", AES_CBC, SHA2, 32, 16, 64, 16)           \
  _ (3DES_CBC, SHA2_384, "3des-cbc-sha2-384-icv24", TDES_CBC, SHA2, 24, 24, 128, 8)                \
  _ (AES_128_CBC, SHA2_384, "aes-128-cbc-sha2-384-icv24", AES_CBC, SHA2, 16, 24, 128, 16)          \
  _ (AES_192_CBC, SHA2_384, "aes-192-cbc-sha2-384-icv24", AES_CBC, SHA2, 24, 24, 128, 16)          \
  _ (AES_256_CBC, SHA2_384, "aes-256-cbc-sha2-384-icv24", AES_CBC, SHA2, 32, 24, 128, 16)          \
  _ (3DES_CBC, SHA2_512, "3des-cbc-sha2-512-icv32", TDES_CBC, SHA2, 24, 32, 128, 8)                \
  _ (AES_128_CBC, SHA2_512, "aes-128-cbc-sha2-512-icv32", AES_CBC, SHA2, 16, 32, 128, 16)          \
  _ (AES_192_CBC, SHA2_512, "aes-192-cbc-sha2-512-icv32", AES_CBC, SHA2, 24, 32, 128, 16)          \
  _ (AES_256_CBC, SHA2_512, "aes-256-cbc-sha2-512-icv32", AES_CBC, SHA2, 32, 32, 128, 16)
...
#define foreach_crypto_combined_fixed_alg_ctr                                                      \
  ...
  _ (AES_128_CTR, SHA2_256, "aes-128-ctr-sha2-256-icv12", AES_CTR, SHA2, 16, 12, 64, 16)           \
  _ (AES_192_CTR, SHA2_256, "aes-192-ctr-sha2-256-icv12", AES_CTR, SHA2, 24, 12, 64, 16)           \
  _ (AES_256_CTR, SHA2_256, "aes-256-ctr-sha2-256-icv12", AES_CTR, SHA2, 32, 12, 64, 16)           \
  _ (AES_128_CTR, SHA2_256, "aes-128-ctr-sha2-256-icv16", AES_CTR, SHA2, 16, 16, 64, 16)           \
  _ (AES_192_CTR, SHA2_256, "aes-192-ctr-sha2-256-icv16", AES_CTR, SHA2, 24, 16, 64, 16)           \
  _ (AES_256_CTR, SHA2_256, "aes-256-ctr-sha2-256-icv16", AES_CTR, SHA2, 32, 16, 64, 16)           \
  _ (AES_128_CTR, SHA2_384, "aes-128-ctr-sha2-384-icv24", AES_CTR, SHA2, 16, 24, 128, 16)          \
  _ (AES_192_CTR, SHA2_384, "aes-192-ctr-sha2-384-icv24", AES_CTR, SHA2, 24, 24, 128, 16)          \
  _ (AES_256_CTR, SHA2_384, "aes-256-ctr-sha2-384-icv24", AES_CTR, SHA2, 32, 24, 128, 16)          \
  _ (AES_128_CTR, SHA2_512, "aes-128-ctr-sha2-512-icv32", AES_CTR, SHA2, 16, 32, 128, 16)          \
  _ (AES_192_CTR, SHA2_512, "aes-192-ctr-sha2-512-icv32", AES_CTR, SHA2, 24, 32, 128, 16)          \
  _ (AES_256_CTR, SHA2_512, "aes-256-ctr-sha2-512-icv32", AES_CTR, SHA2, 32, 32, 128, 16)
...
vnet_crypto_alg_has_op_type (vnet_crypto_alg_t alg, vnet_crypto_op_type_t type)
{
  ...
  return crypto_main.algs[alg].op_type_mask & (1 << type);
}
