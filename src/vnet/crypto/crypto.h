...
void vnet_crypto_integ_key_add (vnet_crypto_key_t *key,
				vnet_crypto_alg_t integ_alg,
				const u8 *integ_data, u16 length);
void vnet_crypto_key_del (vlib_main_t *vm, vnet_crypto_key_t *key);
void vnet_crypto_key_update (vnet_crypto_key_t *key, vnet_crypto_alg_t alg,
			     const u8 *data, u16 length);
void *vnet_crypto_get_active_engine_key_data (vnet_crypto_key_t *key,
					      vnet_crypto_op_id_t opt,
...
u32 vnet_crypto_key_add_idx (vlib_main_t *vm, vnet_crypto_alg_t alg, u8 *data,
			     u16 length);
void vnet_crypto_key_del_idx (vlib_main_t *vm, vnet_crypto_key_index_t index);
void vnet_crypto_key_update_idx (vlib_main_t *vm,
 ...
 **/
u32 vnet_crypto_key_add_linked_idx (vlib_main_t *vm,
...
vnet_crypto_async_add_to_frame (vlib_main_t *vm, vnet_crypto_async_frame_t *f,
				uword keys, u32 crypto_len, i16 integ_len_adj,
