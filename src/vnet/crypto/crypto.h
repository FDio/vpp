...
typedef u32 (vnet_crypto_queue_handler_t) (vlib_main_t * vm,
					   vnet_crypto_queue_t * q);

typedef u32 (vnet_crypto_ops_handler_t) (vlib_main_t * vm,
					 vnet_crypto_op_t * ops[], u32 n_ops);

u32 vnet_crypto_register_provider (vlib_main_t * vm, char *name, int prio,
				   char *desc);
...
typedef struct
{
  ...
  vnet_crypto_provider_t *providers;
} vnet_crypto_main_t;
...
u32 vnet_crypto_run (vlib_main_t * vm, vnet_crypto_op_t * ops[], u32 n_ops);
