...
#define foreach_hmac_alg \
  _(SHA1_96, "hmac-sha1-96") \
  _(SHA256_96, "hmac-sha256-96")   \
  _(SHA256_128, "hmac-sha256-128")  \
  _(SHA384_192, "hmac-sha384-192")  \
  _(SHA512_256, "hmac-sha512-256")
...
{
  return VNET_CRYPTO_N_OP_TYPES * alg + op;
}
