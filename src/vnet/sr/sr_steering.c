  ...
  u8 traffic_type)
{
  ...
  if (traffic_type == SR_STEER_L2)
  {
    ...
    if(vnet_feature_enable_disable ("device-input", "sr-policy-rewrite-encaps-l2",
      sw_if_index, 1, 0, 0))
      goto cleanup_error_redirection;
    ...
    ethernet_set_flags (vnm, sw_if_index, ETHERNET_INTERFACE_FLAG_ACCEPT_ALL);
  }
  ...
  vlib_cli_command_t * cmd)
{
  ...
  rv = sr_steering_policy (is_del, (sr_policy_index == ~(u32)0 ? &bsid : NULL), 
