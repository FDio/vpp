...
#define SR_BEHAVIOR_DX2 3 
#define SR_BEHAVIOR_DX6 4
#define SR_BEHAVIOR_DX4 5
#define SR_BEHAVIOR_DT6 6
#define SR_BEHAVIOR_DT4 7
#define SR_BEHAVIOR_LAST 8		/* Must always be the last one */
...
int sr_localsid_register_function (vlib_main_t * vm, 
	u8 *fn_name, dpo_type_t *dpo, format_function_t *ls_format, 
