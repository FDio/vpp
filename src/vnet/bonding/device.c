...
static inline u32
bond_load_balance_src_dst_mac (vlib_main_t * vm, vlib_node_runtime_t * node,
			       bond_if_t * bif, vlib_buffer_t * b0)
{
...
static inline u32
bond_load_balance_src_mac (vlib_main_t * vm, vlib_node_runtime_t * node,
			   bond_if_t * bif, vlib_buffer_t * b0)
{
  ethernet_header_t *eth = (ethernet_header_t *) vlib_buffer_get_current (b0);
  u32 port, hash;
...
static inline u32
bond_load_balance_dst_mac (vlib_main_t * vm, vlib_node_runtime_t * node,
			   bond_if_t * bif, vlib_buffer_t * b0)
{
  ethernet_header_t *eth = (ethernet_header_t *) vlib_buffer_get_current (b0);
  u32 port, hash;
...
static inline u32
bond_load_balance_src_dst_ip (vlib_main_t * vm, vlib_node_runtime_t * node,
			      bond_if_t * bif, vlib_buffer_t * b0)
{
  ethernet_header_t *eth = (ethernet_header_t *) vlib_buffer_get_current (b0);
  ...
  if (PREDICT_FALSE (ip_version != 0x4))
    return (bond_load_balance_src_dst_mac (vm, node, bif, b0));
...
static inline u32
bond_load_balance_src_ip (vlib_main_t * vm, vlib_node_runtime_t * node,
			  bond_if_t * bif, vlib_buffer_t * b0)
{
  ethernet_header_t *eth = (ethernet_header_t *) vlib_buffer_get_current (b0);
  ip4_header_t *ip4 = (ip4_header_t *) (eth + 1);
...
static inline u32
bond_load_balance_dst_ip (vlib_main_t * vm, vlib_node_runtime_t * node,
			  bond_if_t * bif, vlib_buffer_t * b0)
{
  ethernet_header_t *eth = (ethernet_header_t *) vlib_buffer_get_current (b0);
  ip4_header_t *ip4 = (ip4_header_t *) (eth + 1);
...
static inline u32
bond_load_balance_round_robin (vlib_main_t * vm, vlib_node_runtime_t * node,
			       bond_if_t * bif, vlib_buffer_t * b0)
{
...
static inline u32
bond_load_balance_active_backup (vlib_main_t * vm, vlib_node_runtime_t * node,
				 bond_if_t * bif, vlib_buffer_t * b0)
{
