...
#define foreach_lacp_mux_sm_state       \
  _(0, UNKNOWN, "unknown")              \
  _(1, DETACHED, "detached")            \
  _(2, ATTACHED, "attached")            \
  _(3, WAITING, "waiting")              \
  _(4, COLLECTING_DISTRIBUTING, "collecting distributing")
...
void lacp_mux_debug_func (int event, int state,
			  lacp_fsm_state_t * transition);
u8 *format_mux_sm_state (u8 * s, va_list * args);
