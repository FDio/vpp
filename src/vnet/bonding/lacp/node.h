...
void lacp_init_neighbor (lacp_neighbor_t * n, u32 sw_if_index,
			 uword port_number, u32 group);
void lacp_init_state_machines (vlib_main_t * vm, lacp_neighbor_t * n);
void lacp_init_rx_machine (vlib_main_t * vm, lacp_neighbor_t * n);
void lacp_init_tx_machine (vlib_main_t * vm, lacp_neighbor_t * n);
void lacp_init_ptx_machine (vlib_main_t * vm, lacp_neighbor_t * n);
void lacp_init_mux_machine (vlib_main_t * vm, lacp_neighbor_t * n);
void lacp_selection_logic (vlib_main_t * vm, lacp_neighbor_t * n);
