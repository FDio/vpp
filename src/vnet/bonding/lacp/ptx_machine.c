...
static lacp_fsm_state_t lacp_ptx_state_fast_periodic[] = {
  ...
  {LACP_NOACTION, LACP_PTX_STATE_FAST_PERIODIC},	// event 1 LONG_TIMEOUT
  {LACP_NOACTION, LACP_PTX_STATE_FAST_PERIODIC},	// event 2 TIMER_EXPIRED
...
static lacp_fsm_state_t lacp_ptx_state_slow_periodic[] = {
  ...
  {LACP_NOACTION, LACP_PTX_STATE_SLOW_PERIODIC},	// event 2 TIMER_EXPIRED
  {LACP_NOACTION, LACP_PTX_STATE_SLOW_PERIODIC},	// event 3 SHORT_TIMEOUT
};
...
lacp_ptx_action_fast_periodic (void *p1, void *p2)
{
  ...
  sif->periodic_timer = now + LACP_FAST_PERIODIC_TIMER;
