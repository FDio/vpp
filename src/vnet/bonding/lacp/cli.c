  ...
  for (i = 0; i < vec_len (sw_if_indices); i++)
	...
	continue;
      ...
      vlib_cli_output (vm,
		       ...
		       format_vnet_sw_if_index_name, vnet_get_main (),
		       bif->sw_if_index, lacp_bit_test (sif->actor.state, 0),
		       ...
		       lacp_bit_test (sif->actor.state, 7),
      ...
      vlib_cli_output (vm,
		       ...
		       sif->actor.system_priority, sif->actor.system[0],
		       sif->actor.system[1], sif->actor.system[2],
		       sif->actor.system[3], sif->actor.system[4],
		       sif->actor.system[5], sif->actor.key,
		       sif->actor.port_priority, sif->actor.port_number,
		       sif->partner.system_priority, sif->partner.system[0],
		       sif->partner.system[1], sif->partner.system[2],
		       sif->partner.system[3], sif->partner.system[4],
		       sif->partner.system[5], sif->partner.key,
		       sif->partner.port_priority, sif->partner.port_number);
    }
}
