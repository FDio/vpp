...
DBGvpp# sh bond
sh bond
interface name   sw_if_index  id    mode         load balance  active slaves  slaves
BondEthernet0    10           0     lacp         l2            1              1
BondEthernet1    11           1     lacp         l34           4              4
BondEthernet2    12           2     lacp         l23           2              2
DBGvpp#
