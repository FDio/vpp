...
{
  /**
   * Hash mapping parent sw_if_index and client mac address to p2p_ethernet
   * sub-interface
   */
...
int p2p_ethernet_add_del (vlib_main_t *vm, u32 parent_if_index, u8 *client_mac,
			  u32 sub_id, int is_add, u32 *p2pe_if_index);
