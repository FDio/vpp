...
typedef clib_error_t *(vnet_eth_set_rss_key_fn_t) (vnet_main_t *vnm, struct vnet_hw_interface_t *hi,
						   u8 *key, u8 key_len);
typedef clib_error_t *(vnet_eth_set_rss_type_fn_t) (vnet_main_t *vnm,
...
typedef struct
{
  ...
  /* set RSS key callback */
  vnet_eth_set_rss_key_fn_t *set_rss_key;

  /* set RSS type callback */
  vnet_eth_set_rss_type_fn_t *set_rss_type;
...
clib_error_t *vnet_eth_set_rss_key (vnet_main_t *vnm, u32 hw_if_index, u8 *key, u8 key_len);
clib_error_t *vnet_eth_set_rss_type (vnet_main_t *vnm, u32 hw_if_index,
