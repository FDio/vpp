		   ...
		   vlib_frame_t * frame, int is_ip6)
{
  ...
  while (n_left_from > 0)
      ...
      while (n_left_from > 0 && n_left_to_next > 0)
	{
	  ...
	  vnet_buffer2 (b0)->qos_markings.qos_source = QOS_SOURCE_IP;
...
/* *INDENT-OFF* */
VLIB_REGISTER_NODE (qos_record_ip_4_node) = {
...
VLIB_NODE_FUNCTION_MULTIARCH (qos_record_ip_4_node, qos_record_ip_4);

VNET_FEATURE_INIT (qos_record_ip_4_node, static) = {
    .arc_name = "ip4-unicast",
    .node_name = "ip4-qos-record",
};

VLIB_REGISTER_NODE (qos_record_ip_6_node) = {
...
VLIB_NODE_FUNCTION_MULTIARCH (qos_record_ip_6_node, qos_record_ip_6);

VNET_FEATURE_INIT (qos_record_ip_6_node, static) = {
