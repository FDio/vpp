...
gro_flow_set_timeout (gro_flow_t * gro_flow, f64 timeout_expire)
{
  ...
  //gro_flow->next_timeout_ts = clib_cpu_time_now () + timeout_expire;
}
  ...
  if (gro_flow)
    {
      ...
      //gro_flow_buffers_init (gro_flow, GRO_FLOW_N_BUFFERS - 1);
      return gro_flow;
    }
...
gro_get_packet_data (vlib_main_t * vm, vlib_buffer_t * b0,
		     ...
		     gro_flow_key_t * flow_key0, u32 * pkt_len0)
{
