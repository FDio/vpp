...
gro_get_packet_data (vlib_main_t * vm, vlib_buffer_t * b0,
		     ...
		     gro_flow_key_t * flow_key0, int is_l2, int is_ip4,
		     int is_ip6)
{
  ...
  vnet_generic_header_offset_parser (b0, gho0, is_l2, is_ip4, is_ip6);
		      ...
		      vlib_buffer_t * b1, u32 bi1, int is_l2)
{
  ...
  int is_ip4_0 = b0->flags & VNET_BUFFER_F_IS_IP4;
  int is_ip6_0 = b0->flags & VNET_BUFFER_F_IS_IP6;
  int is_ip4_1 = b1->flags & VNET_BUFFER_F_IS_IP4;
  int is_ip6_1 = b1->flags & VNET_BUFFER_F_IS_IP6;


  pkt_len0 = vlib_buffer_length_in_chain (vm, b0);
  pkt_len1 = vlib_buffer_length_in_chain (vm, b1);
  vnet_generic_header_offset_parser (b0, &gho0, is_l2, is_ip4_0, is_ip6_0);
  vnet_generic_header_offset_parser (b1, &gho1, is_l2, is_ip4_1, is_ip6_1);
