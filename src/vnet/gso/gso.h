			 ...
			 clib_ip_csum_t *c, u8 tcp_flags)
{
  ...
  if (!is_l2 && ((oflags & (VNET_BUFFER_OFFLOAD_F_TNL_VXLAN |
			    VNET_BUFFER_OFFLOAD_F_TNL_IPIP)) == 0))
    {
