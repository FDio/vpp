...
def mk_vpp_cfg4(
    ...
    punt_l4 = {
        "type": pt_l4,
        "punt": {"l4": {"af": af_ip4, "protocol": proto, "table_id": table_id}},
    }
    if port is not None:
...
def mk_vpp_cfg6(
    ...
    punt_l4 = {
        "type": pt_l4,
        "punt": {"l4": {"af": af_ip6, "protocol": proto, "table_id": table_id}},
    }
    if port is not None:
        return set_port(punt_l4, port)
    return punt_l4
...
class TestPunt(VppTestCase):
    ...
    def __test_punt_l4(self, proto: VppEnum.vl_api_ip_proto_t):
        ...
        self.vapi.set_punt(punt=punt4_l4, is_add=True)
        self.vapi.set_punt(punt=punt6_l4, is_add=True)
