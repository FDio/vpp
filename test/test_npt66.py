...
class TestNPT66(VppTestCase):
    ...
    def send_and_verify(self, in2out, internal, external):
        ...
        p = (Ether(dst=local_mac, src=remote_mac) / IPv6(src=src, dst=dst) / ICMPv6EchoRequest())
    ...
    def do_test(self, internal, external):
        self.vapi.npt66_binding_add_del(sw_if_index=self.pg1.sw_if_index, internal=internal, external=external, is_add=True)
        ...
        self.vapi.npt66_binding_add_del(sw_if_index=self.pg1.sw_if_index, internal=internal, external=external, is_add=False        )
