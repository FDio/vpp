...
NOTE: These tests verify RFC 7112 compliance in forwarding/transit scenarios
where VPP acts as an intermediate system. RFC 7112 Section 5 states that
intermediate systems MAY enforce header completeness checks (optional), while
hosts (destination endpoints) SHOULD enforce them (recommended). VPP's current
behavior of accepting well-formed fragments with complete headers is compliant.
"""
