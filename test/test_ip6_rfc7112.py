...
class TestRFC7112(VppTestCase):
    ...
    def test_rfc7112_udp_incomplete_header_dropped(self):
        ...
        pkt = (
            ...
            / Raw(
                b"\x11\x00\x00\x01\x00\x00\x03\xe9"
                +
                # Frag: nh=17 UDP, M=1, id=1001
                b"\x04\xd2\x16\x2e\x00\x6c"
            )
        )  # 6 bytes (incomplete UDP)
    ...
    def test_rfc7112_tcp_incomplete_header_dropped(self):
        ...
        pkt = (
            ...
            / IPv6(src=self.pg0.remote_ip6, dst=self.pg1.remote_ip6, nh=44)
            / Raw(
                b"\x06\x00\x00\x01\x00\x00\x03\xea"  # Frag: nh=6 TCP, M=1, id=1002
                + b"\x04\xd2\x00\x50\x00\x00\x03\xe8\x00\x00\x00\x00"
            )
        )  # 10 bytes
    ...
    def test_rfc7112_icmpv6_complete_header_accepted(self):
        ...
        pkt = (
            ...
            / IPv6(src=self.pg0.remote_ip6, dst=self.pg1.remote_ip6, nh=44)
            / Raw(
                b"\x3a\x00\x00\x01\x00\x00\x03\xeb"  # Frag: nh=58 ICMPv6, M=1
