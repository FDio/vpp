...
class TestDHCP(VppTestCase):
    ...
    def test_dhcp_proxy(self):
        ...
        self.vapi.dhcp_proxy_set_vss(2, 0, vpn_ascii_id="ip4-table-2", is_add=1)
    ...
    def test_dhcp6_proxy(self):
        ...
        self.vapi.dhcp_proxy_set_vss(2, 0, vpn_ascii_id="ip6-table-2", is_ip6=1)
        ...
        #
        self.pg1.generate_remote_hosts(2)
        server_addr12 = socket.inet_pton(AF_INET6, self.pg1.remote_hosts[1].ip6)
