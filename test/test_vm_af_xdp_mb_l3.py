...
class TestVPPInterfacesQemuAfXDPMBL3(TestVPPInterfacesQemu, VppTestCase):
    """Test af_xdp interfaces in multi-buffer L3 mode for IPv4/v6."""
    ...
    def setUpClass(cls):
        ...
        super(TestVPPInterfacesQemuAfXDPMBL3, cls).setUpClass()

    @classmethod
    def tearDownClass(cls):
        try:
            super(TestVPPInterfacesQemuAfXDPMBL3, cls).tearDownClass()
        finally:
            # Release lock
    ...
    def tearDown(self):
        super(TestVPPInterfacesQemuAfXDPMBL3, self).tearDown()


SELECTED_TESTS = TestVPPInterfacesQemuAfXDPMBL3.tests_to_run
tests = filter(TestSelector(SELECTED_TESTS).filter_tests, test_config["tests"])
generate_vpp_interface_tests(tests, TestVPPInterfacesQemuAfXDPMBL3)
