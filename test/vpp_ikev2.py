...
class Profile(VppObject):
    ...
    def add_auth(self, method, data, is_hex=0):
    ...
    def remove_vpp_config(self):
        self.vapi.ikev2_profile_add_del(name=self.profile_name, is_add=0)

    def add_vpp_config(self):
        self.vapi.ikev2_profile_add_del(name=self.profile_name, is_add=1)
