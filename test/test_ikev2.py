...
AUTH_ALGOS = {
    ...
    "AES-128-GMAC": AuthAlgo("AES-128-GMAC", mac=None, mod=None, key_len=16, trunc_len=16),
    "AES-192-GMAC": AuthAlgo("AES-192-GMAC", mac=None, mod=None, key_len=24, trunc_len=16),
    "AES-256-GMAC": AuthAlgo("AES-256-GMAC", mac=None, mod=None, key_len=32, trunc_len=16),
...
class TemplateInitiator(IkePeer):
    ...
    def send_init_response(self):
        ...
        trans = (
            ...
            / self.sa.integ_transform(self.sa.ike_integ)
    ...
    def send_auth_response(self):
        ...
        trans = (
            ...
            / self.sa.integ_transform(self.sa.esp_integ)
            / ikev2.IKEv2_payload_Transform(
...
class TestResponderPskAesCtrEsp(TestResponderPsk):
    ...
    def config_tc(self):
        self.config_params(
            {"esp-crypto": ("AES-CTR", 32), "esp-integ": "SHA2-256-128"}
        )
