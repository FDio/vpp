...
create loop inter
set inter state loop0 up 
set inter ip6 table loop0 0
set inter ip address loop0 2001::1/126
set inter state loop1 up
set inter ip6 table loop1 1
set inter ip address loop1 2002::1/126
app ns add id 0 secret 1234 sw_if_index 1
app ns add id 1 secret 5678 sw_if_index 2
ip route add 2001::1/128 table 1 via lookup in table 0
ip route add 2002::1/128 table 0 via lookup in table 1
EOF
