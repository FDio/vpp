...
class TestNsimCli(VppTestCase):
    ...
    def test_nsim_drop(self):
        ...
        self.vapi.cli(
            "set nsim bandwidth 1 gbit packet-size 128 drop-fraction 1.0 packets-per-drop 0"
        )
...
class TestNsimApi(VppTestCase):
    ...
    def tearDownClass(cls):
        ...
        cls.vapi.nsim_output_feature_enable_disable(enable_disable=True, sw_if_index=1)
        for i in cls.pg_interfaces:
            i.unconfig_ip4()
            i.admin_down()
