...
class VppVxlanTunnel(VppInterface):
    ...
    def __init__(self, test, src, dst, vni, mcast_itf=None, mcast_sw_if_index=INDEX_INVALID, decap_next_index=INDEX_INVALID,
    ...
    def add_vpp_config(self):
        reply = self.test.vapi.vxlan_add_del_tunnel(
            ...
            mcast_sw_if_index=self.mcast_sw_if_index, encap_vrf_id=self.encap_vrf_id,
    ...
    def remove_vpp_config(self):
        self.test.vapi.vxlan_add_del_tunnel(
            is_add=0, src_address=self.src, dst_address=self.dst, vni=self.vni, mcast_sw_if_index=self.mcast_sw_if_index,
