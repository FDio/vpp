...
class BaseSfdpTest(VppTestCase):
    def create_tcp_packet(
        self, src_mac, dst_mac, src_ip, dst_ip, sport, dport, flags="S", ttl=64, seq=0, ack=0, payload=b"\xa5" * 100
    ):
        return (
    ...
    def create_tcp6_packet(
        self, src_mac, dst_mac, src_ip, dst_ip, sport, dport, flags="S", hlim=64, seq=0, ack=0, payload=b"\xa5" * 100
    ):
        return (
            Ether(src=src_mac, dst=dst_mac)
