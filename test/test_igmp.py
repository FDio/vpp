...
class TestIgmp(VppTestCase):
    ...
    def test_igmp_parse_report(self):
        ...
        self.assertEqual(dump[0].gaddr, socket.inet_pton(socket.AF_INET, "224.1.1.1"))
        self.assertEqual(dump[0].saddr, socket.inet_pton(socket.AF_INET, "10.1.1.1"))
	...
	for pg in self.pg_interfaces:
        ...
        for pg in self.pg_interfaces:
            self.config_list.append(VppIgmpConfig(self, pg._sw_if_index, self.sg_list))
