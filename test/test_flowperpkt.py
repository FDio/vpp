...
class TestL2Flowperpkt(VppTestCase):
    ...
    def test_l2_fpp(self):
        ...
        self.vapi.flowperpkt_tx_interface_add_del(is_add=1,
                                                  which=2,
...
class TestIP6Flowperpkt(VppTestCase):
    ...
    def create_vector_stream(self, src_if, dst_if):
        """Create a packet stream to tickle the plugin
    ...
    '''
    def test_ip6_fpp_vector(self):
        """ Vector Flow per packet IPv6 test """
        ...
        pkts = self.create_vector_stream(self.pg0, self.pg1)
        self.pg0.add_stream(pkts)
        self.pg_start()
