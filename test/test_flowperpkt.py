...
class TestFFP_Timers(MethodHolder):
    ...
    def test_0001(self):
        ...
        ipfix = VppCFLOW(test=self, timeout=10, active=10)
    ...
    def test_0003(self):
        ...
        templates = ipfix.verify_templates(ipfix_decoder, timeout=26)
    ...
    def test_0004(self):
        ...
        # make sure the one packet we expect actually showed up
        self.wait_for_cflow_packet(self.collector, templates[1], 15)
...
class TestFFP_DatapathL2(MethodHolder):
    ...
    def test_0001(self):
        ...
        ipfix = VppCFLOW(test=self, timeout=20, active=10, layer='l2')
        ipfix.add_vpp_config()
    ...
    def test_0002(self):
        ...
        ipfix = VppCFLOW(test=self, timeout=20, active=10, layer='l3')
        ipfix.add_vpp_config()
    ...
    def test_0003(self):
        ...
        ipfix = VppCFLOW(test=self, timeout=20, active=10, layer='l4')
        ipfix.add_vpp_config()
...
class TestFFP_DatapathIP4(MethodHolder):
    ...
    def test_0000(self):
        ...
        ipfix = VppCFLOW(test=self, timeout=20, active=10, datapath='ip4')
        ipfix.add_vpp_config()
    ...
    def test_0001(self):
        ...
        ipfix = VppCFLOW(test=self, intf='pg4', timeout=20, active=10,
                         layer='l2', datapath='ip4')
        ipfix.add_vpp_config()

        ipfix_decoder = IPFIXDecoder()
        # template packet should arrive immediately
        templates = ipfix.verify_templates(ipfix_decoder, timeout=13, count=1)
...
class TestFFP_DatapathIP6(MethodHolder):
    ...
    def test_0000(self):
        ...
        ipfix = VppCFLOW(test=self, timeout=20, active=10, datapath='ip6')
        ipfix.add_vpp_config()
    ...
    def test_0001(self):
        ...
        ipfix = VppCFLOW(test=self, intf='pg6', timeout=20, active=10,
