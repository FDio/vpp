...
class TestIpsec4TunIfEspAll(TemplateIpsec, IpsecTun4):
    ...
    def test_tun_44(self):
        ...
        algos = [{'crypto': (VppEnum.vl_api_ipsec_crypto_alg_t.
                             IPSEC_API_CRYPTO_ALG_AES_GCM_128),
                  'integ': (VppEnum.vl_api_ipsec_integ_alg_t.
                            IPSEC_API_INTEG_ALG_NONE),
                  'scapy': "AES-GCM",
                  'key': "JPjyOWBeVEQiMe7h",
                  'salt': chr(0) + chr(0) + chr(0) + chr(0)},
                  {'crypto': VppEnum.vl_api_ipsec_crypto_alg_t.
        ...
        for engine in engines:
            ...
            for algo in algos:
                ...
                p.auth_algo_vpp_id = algo['integ']
                p.crypt_algo_vpp_id = algo['crypto']
