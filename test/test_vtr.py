...
class TestVtr(VppTestCase):
    ...
    def vtr_test(self, swif, tags):
        ...
        self.vapi.sw_interface_set_l2_bridge(i.sw_if_index, bd_id=self.bd_id)
        i.admin_up()
        ...
        self.vapi.sw_interface_set_l2_bridge(i.sw_if_index, bd_id=0)
        i.remove_vpp_config()
    ...
    def test_1ad_vtr_translate_1_1(self):
        """ 1AD VTR translate 1 -> 1 test
        """
    ...
    def test_1ad_vtr_translate_1_2(self):
        """ 1AD VTR translate 1 -> 2 test
        """
    ...
    def test_1ad_vtr_translate_2_1(self):
        """ 1AD VTR translate 2 -> 1 test
        """
        self.pg1.sub_if.set_vtr(L2_VTR_OP.L2_TRANSLATE_2_1, tag=300)
        self.vtr_test(self.pg1, [Tag(dot1=DOT1AD, vlan=300)])

    def test_1ad_vtr_translate_2_2(self):
        """ 1AD VTR translate 2 -> 2 test
        """
        self.pg1.sub_if.set_vtr(
