...
START_TEST (test_swap_to_be_2)
{
  ...
  htobevapi_type_msg_header2_t (&h);
  ck_assert_int_eq (be16toh (h._vl_msg_id), _vl_msg_id);
  ck_assert_int_eq (h.client_index, client_index);
}
END_TEST;

START_TEST (test_swap_to_be_3)
{
  ...
  vapi_msg_vnet_interface_combined_counters_swap_to_be (m);
...
START_TEST (test_swap_to_host_1)
{
  const u16 _vl_msg_id = 1;
  vapi_type_msg_header1_t h;
  h._vl_msg_id = _vl_msg_id;
  bevapi_type_msg_header1_ttoh (&h);
  ck_assert_int_eq (htobe16 (h._vl_msg_id), _vl_msg_id);
}
END_TEST;

START_TEST (test_swap_to_host_2)
{
  const u16 _vl_msg_id = 1;
  const u32 client_index = 3;
  vapi_type_msg_header2_t h;
  h._vl_msg_id = _vl_msg_id;
  h.client_index = client_index;
  bevapi_type_msg_header2_ttoh (&h);
  ck_assert_int_eq (htobe16 (h._vl_msg_id), _vl_msg_id);
  ck_assert_int_eq (h.client_index, client_index);
}
END_TEST;

START_TEST (test_swap_to_host_3)
{
  const size_t data_size = 10;
  vapi_msg_vnet_interface_combined_counters *m = 
      malloc (sizeof (vapi_msg_vnet_interface_combined_counters) +
  ...
  vapi_msg_vnet_interface_combined_counters_swap_to_host (m);
  ck_assert_int_eq (_vl_msg_id, be16toh (p->_vl_msg_id));
  ck_assert_int_eq (first_sw_if_index, be32toh (p->first_sw_if_index));
...
START_TEST (test_show_version_1)
{
  ...
  vapi_msg_init_show_version (ctx, sv);
  vapi_msg_show_version_swap_to_be(sv);
...
vapi_error_e generic_cb (vapi_ctx_t ctx, void *callback_ctx, vapi_msg_id_t id,
                         void *msg)
{
  int *called = callback_ctx;
  ck_assert_int_eq (0, *called);
...
START_TEST (test_show_version_5)
{
  ...
  ck_assert_int_eq (VAPI_OK, rv);
  ck_assert_int_eq (1, called);
  sv = vapi_msg_alloc (ctx, sizeof (*sv));
  ck_assert_ptr_ne (NULL, sv);
  vapi_msg_init_show_version (ctx, sv);
  vapi_msg_show_version_swap_to_be(sv);
  while (VAPI_EAGAIN == (rv = vapi_send (ctx, sv)))
...
Suite *test_suite (void)
{
  ...
  tcase_add_test (tc_swap, test_swap_to_be_1);
  tcase_add_test (tc_swap, test_swap_to_be_2);
  tcase_add_test (tc_swap, test_swap_to_be_3);
  tcase_add_test (tc_swap, test_swap_to_host_1);
  tcase_add_test (tc_swap, test_swap_to_host_2);
  tcase_add_test (tc_swap, test_swap_to_host_3);
