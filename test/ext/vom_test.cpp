...
BOOST_AUTO_TEST_CASE(test_acl) {
    ...
    ACL::ethertype_rule_t e1(ethertype_t::ETHERTYPE_ARP, direction_t::INPUT);
    ACL::ethertype_rule_t e2(ethertype_t::ETHERTYPE_ARP, direction_t::OUTPUT);
    ACL::ethertype_rule_t e3(ethertype_t::ETHERTYPE_IPV4, direction_t::INPUT);
    ACL::acl_ethertype::ethertype_rules_t l_e = {e1, e2, e3};
    ACL::acl_ethertype *a_e = new ACL::acl_ethertype(itf1, l_e, 2);
    HW::item<bool> ae_binding(true, rc_t::OK);
    ADD_EXPECT(ACL::acl_ethertype_cmds::bind_cmd(ae_binding, hw_ifh.data(), l_e, 2));
