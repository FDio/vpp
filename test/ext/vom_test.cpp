...
BOOST_AUTO_TEST_CASE(test_acl) {
    ...
    ACL::ethertype_t e1(0x806, direction_t::INPUT);
    ACL::ethertype_t e2(0x806, direction_t::OUTPUT);
    ACL::ethertype_t e3(0x800, direction_t::INPUT);
    ACL::acl_ethertype::list_ethertype_t l_e = {e1, e2, e3};
