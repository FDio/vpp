...
class TestMemif(VppTestCase):
    ...
    def test_memif_create_delete(self):
        ...
        memif = VppMemif(self, VppEnum.vl_api_memif_role_t.MEMIF_ROLE_API_SLAVE, VppEnum.vl_api_memif_mode_t.MEMIF_MODE_API_ETHERNET)
    ...
    def test_memif_connect(self):
        """ Memif connect """
        memif = VppMemif(self, VppEnum.vl_api_memif_role_t.MEMIF_ROLE_API_SLAVE,  VppEnum.vl_api_memif_mode_t.MEMIF_MODE_API_ETHERNET,
                         ring_size=1024, buffer_size=2048, secret="abc")
        ...
        remote_memif = VppMemif(self.remote_test, VppEnum.vl_api_memif_role_t.MEMIF_ROLE_API_MASTER,
                                VppEnum.vl_api_memif_mode_t.MEMIF_MODE_API_ETHERNET, socket_id=1,
                                ring_size=1024, buffer_size=2048, secret="abc")
