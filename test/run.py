...
# Gracefully exit after execting the post_test_run() script
# upon SIGINT & SIGTERM
...
def post_test_run():
    # Revert the ownership of certain directories back to the
    # original user after running in QEMU as the root user
    print("Resetting file ownership after VM test run")
