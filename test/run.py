...
def build_vpp(debug=False):
    """
    Install VPP Release or Debug(if debug=True) Binaries
    """
...
if __name__ == '__main__':
    ...
    if vm_tests:
        ...
        if int(args.mem) > avail_mem:
            print(f"Error: Mem Size:{args.mem}G > Avail Mem:{avail_mem}G")
            sys.exit(1)
