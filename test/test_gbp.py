...
class TestGBP(VppTestCase):
    ...
    def test_gbp_redirect(self):
        ...
        bd3.add_vpp_config()
        gbd3 = VppGbpBridgeDomain(self, bd3, self.loop2, learn=False)
        gbd3.add_vpp_config()
        bd4 = VppBridgeDomain(self, 4)
        bd4.add_vpp_config()
        gbd4 = VppGbpBridgeDomain(self, bd4, self.loop3, learn=False)
        gbd4.add_vpp_config()
        ...
        c1 = VppGbpContract(
            ...
            [VppGbpContractRule(
                ...
                [VppGbpContractNextHop(sep1.vmac, sep1.epg.bd, sep1.ip4),
                 VppGbpContractNextHop(sep2.vmac, sep2.epg.bd, sep2.ip4)]),
             VppGbpContractRule(
                 VppEnum.vl_api_gbp_rule_action_t.GBP_API_RULE_REDIRECT,
                 [VppGbpContractNextHop(sep3.vmac, sep3.epg.bd, sep3.ip6),
                  VppGbpContractNextHop(sep4.vmac, sep4.epg.bd, sep4.ip6)])])
        c1.add_vpp_config()

        self.logger.error(self.vapi.cli("sh gbp contract"))
