...
class TestGBP(VppTestCase):
    ...
    def test_gbp_learn_l2(self):
        ...
        self.logger.error(self.vapi.cli("sh gbp bridge"))
        ...
        ep = VppGbpEndpoint(self, self.pg0,
                            ...
                            "2001:10::1", "3001::1")
        ep.add_vpp_config()
        self.assertTrue(find_route(self, ep.ip4.address, 32))
        ...
        #
        self.logger.error(self.vapi.cli("show gbp endpoint"))
        self.logger.error(self.vapi.cli("show l2fib all"))
        for l in learned:
    ...
    def test_gbp_learn_l3(self):
        ...
        gt4 = VppIpTable(self, 1)
        gt4.add_vpp_config()
        gt6 = VppIpTable(self, 1, True)
        gt6.add_vpp_config()

        rd1 = VppGbpRouteDomain(self, 2, gt4, gt6)
        rd1.add_vpp_config()
        ...
        self.logger.error(self.vapi.cli("sh bridge 1 detail"))
        self.logger.error(self.vapi.cli("sh gbp bridge"))
        self.logger.error(self.vapi.cli("sh gbp route"))
        ...
        for ii, l in enumerate(learned):
            ...
            p = (Ether(src=self.pg2.remote_mac,
                 ...
                 Ether(src=l['mac'], dst="00:00:00:00:00") /
                 IP(src=l['ip'], dst=ep.ip4.address) /
                 UDP(sport=1234, dport=1234) /
                 Raw('\xa5' * 100))
