...
class TestGBP(VppTestCase):
    ...
    def test_gbp(self):
        ...
        #
        s1 = VppGbpSubnet(self, 0, "10.0.0.0", 24)
        s2 = VppGbpSubnet(self, 0, "10.0.1.0", 24)
        s3 = VppGbpSubnet(self, 0, "10.0.2.0", 24)
        s1.add_vpp_config()
        s2.add_vpp_config()
        s3.add_vpp_config()
        ...
        self.logger.error(self.vapi.cli("sh ip fib 0.0.0.0/0"))
        self.logger.error(self.vapi.cli("sh ip fib 11.0.0.1"))
