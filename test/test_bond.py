...
class TestBondInterface(VppTestCase):
    ...
    def test_bond_traffic(self):
        ...
        self.logger.info(self.vapi.cli("set ip arp static BondEthernet0 10.10.10.12 abcd.abcd.0002"))
        self.logger.info(self.vapi.cli("set ip arp static BondEthernet0 10.10.10.11 abcd.abcd.0004"))
