...
class VCLCutThruTestCase(VCLTestCase):
    ...
    def setUp(self):
        ...
        self.client_uni_dir_nsock_timeout = 15
        self.client_uni_dir_nsock_test_args = ["-N", "4096",
                                               "-I", "5", "-U", "-X",
                                               self.server_addr,
                                               self.server_port]
        self.client_bi_dir_nsock_timeout = 30
        self.client_bi_dir_nsock_test_args = ["-N", "4096",
                                              "-I", "5", "-B", "-X",
                                              self.server_addr,
                                              self.server_port]
...
class VCLThruHostStackExtendedATestCase(VCLTestCase):
    ...
    def setUp(self):
        ...
        if self.vppDebug:
            ...
            self.client_bi_dir_nsock_timeout = 10
            self.numSockets = 5
...
class VCLThruHostStackExtendedCTestCase(VCLTestCase):
    ...
    def setUp(self):
        ...
        if self.vppDebug:
            ...
            self.client_uni_dir_nsock_timeout = 10
            self.numSockets = "5"

        self.client_uni_dir_nsock_test_args = ["-N", "4069",
                                               "-I", self.numSockets,
                                               "-U", "-X",
                                               self.loop0.local_ip4,
                                               self.server_port]
...
class VCLIpv6CutThruTestCase(VCLTestCase):
    ...
    def setUp(self):
        ...
        if self.vppDebug:
            ...
            self.client_uni_dir_nsock_timeout = 10
            self.client_bi_dir_nsock_timeout = 15
            self.numSockets = "5"
        ...
        self.client_ipv6_uni_dir_nsock_test_args = ["-N", "4096", "-6",
                                                    "-I", self.numSockets,
                                                    "-U", "-X",
                                                    self.server_ipv6_addr,
                                                    self.server_port]
        self.client_ipv6_bi_dir_nsock_test_args = ["-N", "4096", "-6",
                                                   "-I", self.numSockets,
                                                   "-B", "-X",
                                                   self.server_ipv6_addr,
                                                   self.server_port]
