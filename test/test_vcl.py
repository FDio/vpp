...
class VclTestCase(VppTestCase):
    ...
    def thru_host_stack_test(self, server_appname, client_appname):
        self.env = {'VCL_API_PREFIX': self.shm_prefix,
...
class VCLThruHostStackTestCase(VclTestCase):
    ...
    def test_ldp_thru_host_stack(self):
        """ run LDP thru host stack test """
...
# TBD: Remove this when VPP crash is fixed.
    ...
    def test_vcl_thru_host_stack(self):
        """ run VCL thru host stack test """
