...
func init() {
	RegisterVethTests(XEchoVclClientUdpTest, XEchoVclClientTcpTest, XEchoVclServerUdpTest, VclEchoQuicUnidirectionalStreamTest,
	...
	RegisterVethMWTests(VclEchoQuicUnidirectionalStreamsMWTest)
}
...
func VclEchoQuicUnidirectionalStreamTest(s *VethsSuite) {
	_, oSrv := testVclEcho(s, "quic", "-N 1000")
	s.AssertNotContains(oSrv, "ERROR: expected unidirectional stream")
}

func VclEchoQuicUnidirectionalStreamsMWTest(s *VethsSuite) {
