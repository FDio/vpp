...
func (s *TcpHarnessSuite) serverNFQueueScriptSnapshotGet() (TcpHarnessNFQueueScriptStats,
	[]TcpHarnessNFQueueScriptTraceEntry, error) {
...
func (s *TcpHarnessSuite) WaitForServerNFQueueScriptStats(timeout time.Duration,
	...
	var (
		current TcpHarnessNFQueueScriptStats
		trace   []TcpHarnessNFQueueScriptTraceEntry
		err     error
	)
