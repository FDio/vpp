...
func EchoBuiltinTest(s *EchoSuite) {
	...
	serverVpp.Vppctl("test vperf server " +
		" uri tcp://" + s.Interfaces.Server.Ip4AddressString() + "/" + s.Ports.Port1)

	clientVpp := s.Containers.ClientVpp.VppInstance

	o := clientVpp.Vppctl("test vperf client nclients 100 bytes 1 verbose" +
...
func EchoBuiltinUdpTest(s *EchoSuite) {
	...
	o := clientVpp.Vppctl("test vperf client " +
		" uri udp://" + s.Interfaces.Server.Ip4AddressString() + ":" + s.Ports.Port1)
	Log(o)
	AssertNotContains(o, "failed:")
}
...
func EchoBuiltinBandwidthTest(s *EchoSuite) {
	...
	o := clientVpp.Vppctl("test vperf client nclients 4 bytes 2m throughput 32m" +
		" uri tcp://" + s.Interfaces.Server.Ip4AddressString() + "/" + s.Ports.Port1)
	Log(o)
...
func EchoBuiltinPeriodicReportTotalTest(s *EchoSuite) {
	...
	o := clientVpp.Vppctl("test vperf client bytes 7900k throughput 16m report-interval-total 1" +
		" uri tcp://" + s.Interfaces.Server.Ip4AddressString() + "/" + s.Ports.Port1)
	Log(o)
	if regex.MatchString(o) {
...
func EchoBuiltinPeriodicReportUDPTest(s *EchoSuite) {
	...
	o := clientVpp.Vppctl("test vperf client bytes 6000k throughput 12m report-interval 1 echo-bytes" +
		" uri udp://" + s.Interfaces.Server.Ip4AddressString() + "/" + s.Ports.Port1)
	Log(o)
	if regex.MatchString(o) {
		matches := regex.FindAllStringSubmatch(o, -1)
...
func EchoBuiltinPeriodicReportTest(s *EchoSuite) {
	...
	o := clientVpp.Vppctl("test vperf client bytes 7900k throughput 16m report-interval 1" +
		" uri tcp://" + s.Interfaces.Server.Ip4AddressString() + "/" + s.Ports.Port1)
	Log(o)
	if regex.MatchString(o) {
		matches := regex.FindAllStringSubmatch(o, -1)
...
func EchoBuiltinRoundtripTest(s *EchoSuite) {
	...
	o := clientVpp.Vppctl("test vperf client bytes 8m" +
		" uri tcp://" + s.Interfaces.Server.Ip4AddressString() + "/" + s.Ports.Port1)
	Log(o)
	if regex.MatchString(o) {
		matches := regex.FindStringSubmatch(o)
...
func EchoBuiltinEchoBytesTest(s *EchoSuite) {
	...
	o := clientVpp.Vppctl("test vperf client echo-bytes verbose uri" +
		" udp://" + s.Interfaces.Server.Ip4AddressString() + "/" + s.Ports.Port1)
	Log(o)
	AssertContains(o, "sent total 6 datagrams, received total 6 datagrams")
	AssertNotContains(o, "test vperf client: failed: timeout with 1 sessions")
}
...
func EchoBuiltinUdpLossTest(s *EchoSuite) {
	...
	o := clientVpp.Vppctl("test vperf client echo-bytes test-bytes verbose bytes 32k test-timeout 1 uri" +
		" udp://" + s.Interfaces.Server.Ip4AddressString() + "/" + s.Ports.Port1)
	Log(o)
	AssertNotContains(o, "failed")
...
func tcpEcho(port string, ip string, clientVpp *VppInstance, serverVpp *VppInstance) string {
	serverVpp.Vppctl("test vperf server fifo-size 64k uri tcp://%s/%s", ip, port)

	// Do echo test from client-vpp container
	output := clientVpp.Vppctl("test vperf client fifo-size 64k uri tcp://%s/%s verbose echo-bytes run-time 10",
		ip, port)
	Log(output)
...
func TlsSingleConnectionTest(s *EchoSuite) {
	...
	o := clientVpp.Vppctl("test vperf client uri tls://%s:%s verbose run-time 5", s.Interfaces.Server.Ip4AddressString(), s.Ports.Port1)
...
func EchoBuiltinHttpTestBytesTest(s *EchoSuite) {
	...
	serverVpp.Vppctl("test vperf server uri https://" + s.Interfaces.Server.Ip4AddressString() + ":" + s.Ports.Port1)

	clientVpp := s.Containers.ClientVpp.VppInstance

	o := clientVpp.Vppctl("test vperf client test-bytes run-time 5 http2 uri https://" +
...
func EchoBuiltinHttpTest(s *EchoSuite) {
	...
	serverVpp.Vppctl("test vperf server uri http://" + s.Interfaces.Server.Ip4AddressString() + ":" + s.Ports.Port1)

	clientVpp := s.Containers.ClientVpp.VppInstance

	o := clientVpp.Vppctl("test vperf client run-time 5 uri http://" +
		s.Interfaces.Server.Ip4AddressString() + ":" + s.Ports.Port1)
	Log(o)
	AssertNotContains(o, "failed:")
	httpVerifyPeriodicStats(o)
...
func EchoBuiltinHttpsTest(s *EchoSuite) {
	...
	o := clientVpp.Vppctl("test vperf client run-time 5 uri https://" +
		s.Interfaces.Server.Ip4AddressString() + ":" + s.Ports.Port1)
	Log(o)
	AssertNotContains(o, "failed:")
	httpVerifyPeriodicStats(o)
...
func EchoBuiltinHttp2Test(s *EchoSuite) {
	...
	o := clientVpp.Vppctl("test vperf client run-time 5 http2 uri https://" +
		s.Interfaces.Server.Ip4AddressString() + ":" + s.Ports.Port1)
	Log(o)
	AssertNotContains(o, "failed:")
	httpVerifyPeriodicStats(o)
...
func EchoBuiltinHttp3Test(s *EchoSuite) {
	...
	o := clientVpp.Vppctl("test vperf client run-time 5 http3 uri https://" +
		s.Interfaces.Server.Ip4AddressString() + ":" + s.Ports.Port1)
	Log(o)
	AssertNotContains(o, "failed:")
	httpVerifyPeriodicStats(o)
...
func echoBuiltinHttp2ConnectUdp(s *EchoSuite, clientExtraArgs, serverExtraArgs string) string {
	serverVpp := s.Containers.ServerVpp.VppInstance
	serverCmd := "test vperf server connect-udp uri https://" + s.Interfaces.Server.Ip4AddressString() + ":" + s.Ports.Port1
	if serverExtraArgs != "" {
	...
	clientVpp := s.Containers.ClientVpp.VppInstance
	clientCmd := "test vperf client run-time 5 echo-bytes http2 connect-udp uri https://" +
		s.Interfaces.Server.Ip4AddressString() + ":" + s.Ports.Port1
	if clientExtraArgs != "" {
...
func EchoBuiltinHttp2ConnectTcpTest(s *EchoSuite) {
	...
	serverVpp.Vppctl("test vperf server connect-tcp uri https://" + s.Interfaces.Server.Ip4AddressString() + ":" + s.Ports.Port1)

	clientVpp := s.Containers.ClientVpp.VppInstance

	o := clientVpp.Vppctl("test vperf client run-time 5 echo-bytes http2 connect-tcp uri https://" +
		s.Interfaces.Server.Ip4AddressString() + ":" + s.Ports.Port1)
	Log(o)
	AssertNotContains(o, "failed:")
...
func EchoBuiltinHttp3ConnectTcpTest(s *EchoSuite) {
	...
	o := clientVpp.Vppctl("test vperf client run-time 5 echo-bytes http3 connect-tcp uri https://" +
		s.Interfaces.Server.Ip4AddressString() + ":" + s.Ports.Port1)
	Log(o)
	AssertNotContains(o, "failed:")
	httpTunnelVerifyPeriodicStats(o)
...
func EchoBuiltinHttp2ConnectUdpTest(s *EchoSuite) {
	...
	serverVpp.Vppctl("test vperf server connect-udp uri https://" + s.Interfaces.Server.Ip4AddressString() + ":" + s.Ports.Port1)

	clientVpp := s.Containers.ClientVpp.VppInstance

	o := clientVpp.Vppctl("test vperf client run-time 5 echo-bytes http2 connect-udp uri https://" +
		s.Interfaces.Server.Ip4AddressString() + ":" + s.Ports.Port1)
	Log(o)
	AssertNotContains(o, "failed:")
	httpTunnelVerifyPeriodicStats(o)
...
func EchoBuiltinHttp3ConnectUdpTest(s *EchoSuite) {
	...
	o := clientVpp.Vppctl("test vperf client run-time 5 echo-bytes http3 connect-udp uri https://" +
		s.Interfaces.Server.Ip4AddressString() + ":" + s.Ports.Port1)
	Log(o)
	AssertNotContains(o, "failed:")
	httpTunnelVerifyPeriodicStats(o)
...
func EchoBuiltinHttp1CpsMWTest(s *EchoSuite) {
	...
	Log(serverVpp.Vppctl("test vperf server " +
		" uri https://" + s.Interfaces.Server.Ip4AddressString() + "/" + s.Ports.Port1))

	o := clientVpp.Vppctl("test vperf client nclients 4000 bytes 64 syn-timeout 40" +
		" uri https://" + s.Interfaces.Server.Ip4AddressString() + "/" + s.Ports.Port1)
	Log(o)
...
func EchoBuiltinHttp2CpsMWTest(s *EchoSuite) {
	...
	o := clientVpp.Vppctl("test vperf client http2 nclients 4000 bytes 64 syn-timeout 40" +
		" uri https://" + s.Interfaces.Server.Ip4AddressString() + "/" + s.Ports.Port1)
	Log(o)
	Log(serverVpp.Vppctl("show http stats"))
	Log(clientVpp.Vppctl("show http stats"))
...
func EchoBuiltinHttp3CpsMWTest(s *EchoSuite) {
	...
	o := clientVpp.Vppctl("test vperf client http3 nclients 1000 bytes 64 syn-timeout 40" +
		" uri https://" + s.Interfaces.Server.Ip4AddressString() + "/" + s.Ports.Port1)
	Log(o)
	Log(serverVpp.Vppctl("show http stats"))
	Log(clientVpp.Vppctl("show http stats"))
