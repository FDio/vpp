...
func init() {
	RegisterEchoTests(EchoBuiltinTest, EchoBuiltinClientSessionDisconnectTest, EchoBuiltinBandwidthTest,
		...
		EchoBuiltinTcpNoTxCsumOffloadTest, EchoBuiltinUdpNoTxCsumOffloadTest, EchoBuiltinHttpTest,
		EchoBuiltinHttpsTest, EchoBuiltinHttp2Test, EchoBuiltinHttp3Test, EchoBuiltinHttpTestBytesTest,
		EchoBuiltinHttp2ConnectTcpTest, EchoBuiltinHttp3ConnectTcpTest,
