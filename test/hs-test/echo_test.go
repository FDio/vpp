...
func init() {
	RegisterEchoTests(EchoBuiltinTest, EchoBuiltinBandwidthTest, EchoBuiltinEchoBytesTest, EchoBuiltinRoundtripTest,
		EchoBuiltinBytesLossTest, EchoBuiltinPeriodicReportTest, EchoBuiltinPeriodicReportTotalTest, TlsSingleConnectionTest,
...
func EchoBuiltinBytesLossTest(s *EchoSuite) {
	serverVpp := s.Containers.ServerVpp.VppInstance
