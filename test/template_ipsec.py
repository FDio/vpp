...
class IpsecTra4(object):
    ...
    def verify_tra_corrupted_esp_footer(self):
        ...
        # Use pad() to get a block-aligned plaintext, then overwrite padlen with
        # 0xFF before encrypting. The ciphertext is still block-aligned so
        # encryption succeeds; VPP reads 0xFF after decryption and fails the
        # footer bound check.
