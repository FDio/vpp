...
class IPSecIPv4Fwd(VppTestCase):
    ...
    # Method verify_Ip_TcpUdp_capture will verify Network and transport layer fields of the packet
    # sa.encrypt() gives interface number garbadge. thus interface validation get failed.
    # Probably scapy bug ?. However our intent is to verify IP layer and above and that is covered
    # in it.
