...
def get_handled_core_path(tempdir):
    return '%s/_core_handled' % tempdir


def get_core_handled(tempdir):
    return os.path.isfile(get_handled_core_path(tempdir))
