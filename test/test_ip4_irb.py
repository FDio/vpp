...
class TestIpIrb(VppTestCase):
    ...
    def setUpClass(cls):
        ...
        half = len(cls.loop0.remote_mac_extend) // 2
        cls.pg0.remote_mac_extend = cls.loop0.remote_mac_extend[:half]
        cls.pg0.remote_ip4_extend = cls.loop0.remote_ip4_extend[:half]
        cls.pg1.remote_mac_extend = cls.loop0.remote_mac_extend[half:]
        cls.pg1.remote_ip4_extend = cls.loop0.remote_ip4_extend[half:]
        ...
        for i in range(0, 257):
            ...
            p = (Ether(dst=src_ip_if.local_mac, src=src_ip_if.remote_mac) /
                 IP(src=src_ip_if.remote_ip4,
                    dst=choice(dst_ip_if.remote_ip4_extend)) /
    ...
    def create_stream_l2_to_ip(self, src_l2_if, src_ip_if, dst_ip_if,
        ...
        for i in range(0, 257):
            ...
            p = (Ether(src=src_l2_if.remote_mac_extend[i],
                       dst = src_ip_if.local_mac) /
                 IP(src=src_l2_if.remote_ip4_extend[i],
    ...
    def verify_capture(self, dst_ip_if, src_ip_if, capture):
        ...
        for packet in capture:
            ...
            self.assertEqual(packet.dst,
                             dst_ip_if._remote_mac_extend[dst_mac_index])
