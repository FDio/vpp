...
class TestSfdpL4LifecycleIp4(TestSfdpL4LifecycleBase):
    ...
    def test_tcp_fsol_non_syn_pkt_block(self):
        """TCP - verify session with first non-SYN pkt are blocked (default)"""
    ...
    def test_tcp_fsol_non_syn_pkt_remove(self):
        """TCP - verify session with first non-SYN pkt is directly removed"""
        ...
        # Reset tcp-check back to default block mode on non-syn fsol
        self.vapi.cli("set sfdp tcp-check fsol-non-syn block")
