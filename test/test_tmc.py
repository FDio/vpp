...
class TestTMC(VppTestCase):
    ...
    def test_tcp_mss_clamping(self):
        ...
        #
        self.vapi.tmc_enable_disable(self.pg1.sw_if_index, 0x300)
        ...
        err = self.statistics.get_counter(
            '/err/tcp-mss-clamping-ip4/clamped')
        self.assertEqual(err, 65)
        err = self.statistics.get_counter(
            '/err/tcp-mss-clamping-ip6/clamped')
        self.assertEqual(err, 65)
        ...
        # they are unchanged
        #
        self.vapi.tmc_enable_disable(self.pg1.sw_if_index, 0, is_enable=0)
