...
class TestWg(VppTestCase):
        ...
        try:
            ...
            for i in self.pg_interfaces:
                i.assert_nothing_captured(
                    timeout=timeout, remark=remark, filter_out_fn=filter_out_misc_and_handshake_init
                )
                timeout = 0.1
        finally:
            pass
    ...
    def _test_wg_send_cookie_tmpl(self, is_resp, is_ip6):
        ...
        if is_resp:
            ...
            rxs = self.send_and_expect(self.pg1, [init], self.pg1, filter_out_fn=filter_out_misc_and_handshake_init)
        else:
    ...
    def test_wg_handshake_ratelimiting_multi_peer(self):
        ...
        rxs = self.send_and_expect(self.pg1, [init_2], self.pg1, filter_out_fn=filter_out_misc_and_handshake_init)
    ...
    def test_wg_peer_v4o4(self):
        ...
        rx = self.send_and_expect(self.pg1, [p], self.pg1, filter_out_fn=filter_out_misc_and_handshake_init)
    ...
    def test_wg_event(self):
        ...
        for i in range(NUM_PEERS):
            ...
            rx = self.send_and_expect(self.pg2, [p], self.pg2, filter_out_fn=filter_out_misc_and_handshake_init)
