...
class TestHttpStaticVapi(VppAsfTestCase):
    ...
    def setUpClass(cls):
        ...
        create_host_interface("vppOut1", cls.ns_name, "10.10.1.1/24", "vppHost1")
    ...
    def tearDownClass(cls):
        delete_namespace(cls.ns_name)
        delete_host_interfaces("vppHost1")
        cls.temp.close()
        cls.temp2.close()
...
class TestHttpStaticCli(VppAsfTestCase):
    ...
    def setUpClass(cls):
        ...
        create_host_interface("vppOut2", cls.ns_name, "10.10.1.1/24", "vppHost2")
