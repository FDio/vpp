...
# copied from vpp_qemu_utils.py and added a parameter;
# this is needed to avoid a conflict when running multiple test jobs
def can_create_namespaces(namespace):
...
class TestHttpStaticVapi(VppTestCase):
    ...
    def setUpClass(cls):
        ...
        if not can_create_namespaces("vpp_chk_4212"):
