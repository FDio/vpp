...
class VppPapiProvider(object):
    ...
    def cli(self, cli):
        ...
        cli += '\n'
        r = self.vpp.cli_inband(length=len(cli), cmd=cli)
    ...
    def pg_create_interface(self, pg_index):
        ...
        """
        return self.api(self.vpp.pg_create_interface,
    ...
    def sw_interface_dump(self, filter=None):
        ...
        if filter is not None:
            ...
            args = {}
        return self.api(self.vpp.sw_interface_dump, args)
    ...
    def sw_interface_set_table(self, sw_if_index, is_ipv6, table_id):
        ...
        """
        return self.api(self.vpp.sw_interface_set_table,
    ...
    def sw_interface_add_del_address(self, sw_if_index, addr, addr_len,
        ...
        """
        return self.api(self.vpp.sw_interface_add_del_address,
    ...
    def sw_interface_enable_disable_mpls(self, sw_if_index,
        ...
        """
        return self.api(self.vpp.sw_interface_set_mpls_enable,
                        {'sw_if_index' : sw_if_index,
                         'enable' : is_enable })

    def sw_interface_ra_suppress(self, sw_if_index):
        return self.api(self.vpp.sw_interface_ip6nd_ra_config,
                        {'sw_if_index' : sw_if_index })
    ...
    def vxlan_add_del_tunnel(
        ...
        """
        return self.api(self.vpp.vxlan_add_del_tunnel,
                        {'is_add' : is_add,
                         'is_ipv6' : is_ipv6,
    ...
    def bridge_domain_add_del(self, bd_id, flood=1, uu_flood=1, forward=1,
        ...
        """
        return self.api(self.vpp.bridge_domain_add_del,
                        { 'bd_id' : bd_id,
                          'flood' : flood,
                          'uu_flood' : uu_flood,
                          'forward' : forward,
    ...
    def l2fib_add_del(self, mac, bd_id, sw_if_index, is_add=1, static_mac=0,
        ...
        """
        return self.api(self.vpp.l2fib_add_del,
    ...
    def sw_interface_set_l2_bridge(self, sw_if_index, bd_id,
        ...
        """
        return self.api(self.vpp.sw_interface_set_l2_bridge,
    ...
    def bridge_flags(self, bd_id, is_set, feature_bitmap):
        ...
        :param int feature_bitmap: Bitmap value of the feature to be set:
            ...
            - arp-term (1 << 4).
        """
        return self.api(self.vpp.bridge_flags,
                        {'bd_id' : bd_id,
                         'is_set' : is_set,
    ...
    def bridge_domain_dump(self, bd_id=0):
        ...
        """
        return self.api(self.vpp.bridge_domain_dump,
                        {'bd_id' : bd_id })
    ...
    def sw_interface_set_l2_xconnect(self, rx_sw_if_index, tx_sw_if_index,
        ...
        """
        return self.api(self.vpp.sw_interface_set_l2_xconnect,
    ...
    def sw_interface_set_l2_tag_rewrite(self, sw_if_index, vtr_oper, push=0, tag1=0, tag2=0):
        ...
        """
        return self.api(self.vpp.l2_interface_vlan_tag_rewrite,
                        { 'sw_if_index' : sw_if_index,
                          'vtr_oper' : vtr_oper,
                          'push' : push,
                          'tag1' : tag1,
    ...
    def sw_interface_set_flags(self, sw_if_index, admin_up_down,
        ...
        """
        return self.api(self.vpp.sw_interface_set_flags,
                        { 'sw_if_index' : sw_if_index,
    ...
    def delete_subif(self, sw_if_index):
        ...
        :param sw_if_index:
        """
        return self.api(self.vpp.delete_subif,
                        { 'sw_if_index' : sw_if_index })
    ...
    def create_vlan_subif(self, sw_if_index, vlan):
        ...
        """
        return self.api(self.vpp.create_vlan_subif,
                        {'sw_if_index' : sw_if_index,
                         'vlan_id' : vlan })
    ...
    def create_loopback(self, mac=''):
        ...
        :param mac: (Optional)
        """
        return self.api(self.vpp.create_loopback,
                        { 'mac_address' : mac })
    ...
    def sw_interface_span_enable_disable(self, sw_if_index_from, sw_if_index_to, enable=1):
        ...
        """
        return self.api(self.vpp.sw_interface_span_enable_disable,
    ...
    def mpls_route_add_del(
        ...
        return self.api(
            self.vpp.mpls_route_add_del,
            { 'mr_label' : label,
              'mr_eos' : eos,
              'mr_table_id' : table_id,
              'mr_classify_table_index' : classify_table_index,
              'mr_create_vrf_if_needed' : create_vrf_if_needed,
              'mr_is_add' : is_add,
              ...
              'mr_next_hop_address' : next_hop_address,
    ...
    def mpls_ip_bind_unbind(
        ...
        """
        return self.api(
            self.vpp.mpls_ip_bind_unbind,
            {'mb_mpls_table_id' : table_id,
             'mb_label' : label,
             'mb_ip_table_id' : ip_table_id,
             'mb_create_vrf_if_needed' : create_vrf_if_needed,
             'mb_is_bind' : is_bind,
             'mb_is_ip4' : is_ip4,
