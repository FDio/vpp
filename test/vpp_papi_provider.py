...
class VppPapiProvider(object):
    ...
    def dhcp6_pd_client_enable_disable(self, sw_if_index, enable=1):
        return self.api(self.papi.dhcp6_pd_client_enable_disable,
                        {'sw_if_index': sw_if_index,
                         'enable': enable})

    def control_plane_ip6_address_add_del(self, sw_if_index, address,
                                          prefix_length, prefix_group=0,
                                          is_add=1):
        return self.api(self.papi.control_plane_ip6_address_add_del,
                        {'sw_if_index': sw_if_index,
