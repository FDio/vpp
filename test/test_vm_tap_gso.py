...
#     sending jumbo frames(9000 Bytes) with GSO on ingress is enabled correctly
#     sending standard frames(1500 Bytes) with GSO on ingress is enabled correctly
#     sending smaller frames(512 Bytes) with GSO on ingress is enabled correctly
#     repeat the above with GSO on egress & GSO on both ingress & egress.
#
...
class TestTapQemuGso(VppTestCase):
    ...
    def test_tap_ingress_gso_9k_mtu_ipv4(self):
        """Enable GSO on ingress tap interface with 9k MTU, IPv4."""
    ...
    # IPv6
    @unittest.skipUnless(config.extended, "part of extended tests")
    def test_tap_ingress_gso_9k_mtu_ipv6(self):
        """Enable GSO on ingress tap interface with 9k MTU, IPv6."""
        self.vapi.sw_interface_set_mtu(
            sw_if_index=self.ingress_tap_if_idx, mtu=[9000, 0, 0, 0]
        )
        self.vapi.feature_gso_enable_disable(
    ...
    # IPv4 packets
    @unittest.skipUnless(config.extended, "part of extended tests")
    def test_tap_egress_gso_9k_mtu_ipv4(self):
        """Enable GSO on egress tap interface with 9k MTU, IPv4."""
        self.vapi.sw_interface_set_mtu(
    ...
    # IPv6
    @unittest.skipUnless(config.extended, "part of extended tests")
    def test_tap_egress_gso_9k_mtu_ipv6(self):
        """Enable GSO on egress tap interface with 9k MTU, IPv6."""
        self.vapi.sw_interface_set_mtu(
            sw_if_index=self.egress_tap_if_idx, mtu=[9000, 0, 0, 0]
        )
        self.vapi.feature_gso_enable_disable(
    ...
    # IPv4 packets
    @unittest.skipUnless(config.extended, "part of extended tests")
    def test_tap_ingress_egress_gso_9k_mtu_ipv4(self):
        """Enable GSO on ingress & egress tap interfaces with 9k MTU, IPv4."""
        self.vapi.sw_interface_set_mtu(
            sw_if_index=self.ingress_tap_if_idx, mtu=[9000, 0, 0, 0]
        )
        self.vapi.sw_interface_set_mtu(
    ...
    # IPv6 packets
    @unittest.skipUnless(config.extended, "part of extended tests")
    def test_tap_ingress_egress_gso_9k_mtu_ipv6(self):
        """Enable GSO on ingress & egress tap interfaces with 9k MTU, IPv6."""
        self.vapi.sw_interface_set_mtu(
            sw_if_index=self.ingress_tap_if_idx, mtu=[9000, 0, 0, 0]
        )
        self.vapi.sw_interface_set_mtu(
