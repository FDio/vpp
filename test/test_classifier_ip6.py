...
class TestClassifierIP6(TestClassifier):
    ...
    def test_iacl_src_ip(self):
        ...
        self.create_classify_session(
            self.acl_tbl_idx.get('ip6_src'),
            self.build_ip6_match(src_ip=self.pg0.remote_ip6))
        self.input_acl_set_interface(self.pg0, self.acl_tbl_idx.get('ip6_src'))
        ...
        self.input_acl_set_interface(
            self.pg0, self.acl_tbl_idx.get('ip6_src'), 0)
    ...
    def test_iacl_dst_ip(self):
        ...
        self.create_classify_session(
            self.acl_tbl_idx.get('ip6_dst'),
            self.build_ip6_match(dst_ip=self.pg1.remote_ip6))
        self.input_acl_set_interface(self.pg0, self.acl_tbl_idx.get('ip6_dst'))
        ...
        self.verify_capture(self.pg1, pkts)
        self.input_acl_set_interface(
            self.pg0, self.acl_tbl_idx.get('ip6_dst'), 0)
        self.pg0.assert_nothing_captured(remark="packets forwarded")
        self.pg2.assert_nothing_captured(remark="packets forwarded")
    ...
    def test_iacl_src_dst_ip(self):
        ...
        self.create_classify_session(
            self.acl_tbl_idx.get('ip6'),
            self.build_ip6_match(src_ip=self.pg0.remote_ip6,
                                 dst_ip=self.pg1.remote_ip6))
        self.input_acl_set_interface(self.pg0, self.acl_tbl_idx.get('ip6'))
        ...
        self.verify_capture(self.pg1, pkts)
        self.input_acl_set_interface(
            self.pg0, self.acl_tbl_idx.get('ip6'), 0)
        self.pg0.assert_nothing_captured(remark="packets forwarded")
        self.pg2.assert_nothing_captured(remark="packets forwarded")
...
class TestClassifierIP6UDP(TestClassifier):
    ...
    def test_iacl_proto_udp(self):
        ...
        self.create_classify_table('nh_udp', self.build_ip6_mask(nh='ff'))
        self.create_classify_session(
            self.acl_tbl_idx.get('nh_udp'),
            self.build_ip6_match(nh=socket.IPPROTO_UDP))
        self.input_acl_set_interface(self.pg0, self.acl_tbl_idx.get('nh_udp'))
        ...
        self.verify_capture(self.pg1, pkts)
        self.input_acl_set_interface(
            self.pg0, self.acl_tbl_idx.get('nh_udp'), 0)
        self.pg0.assert_nothing_captured(remark="packets forwarded")
        self.pg2.assert_nothing_captured(remark="packets forwarded")
    ...
    def test_iacl_proto_udp_sport(self):
        ...
        self.create_classify_table(
            'nh_udp_sport', self.build_ip6_mask(nh='ff', src_port='ffff'))
        self.create_classify_session(
            self.acl_tbl_idx.get('nh_udp_sport'),
            self.build_ip6_match(nh=socket.IPPROTO_UDP, src_port=sport))
        self.input_acl_set_interface(
            self.pg0, self.acl_tbl_idx.get('nh_udp_sport'))
        ...
        self.verify_capture(self.pg1, pkts)
        self.input_acl_set_interface(
            self.pg0, self.acl_tbl_idx.get('nh_udp_sport'), 0)
        self.pg0.assert_nothing_captured(remark="packets forwarded")
        self.pg2.assert_nothing_captured(remark="packets forwarded")
    ...
    def test_iacl_proto_udp_dport(self):
        ...
        self.create_classify_table(
            'nh_udp_dport', self.build_ip6_mask(nh='ff', dst_port='ffff'))
        self.create_classify_session(
            self.acl_tbl_idx.get('nh_udp_dport'),
            self.build_ip6_match(nh=socket.IPPROTO_UDP, dst_port=dport))
        self.input_acl_set_interface(
            self.pg0, self.acl_tbl_idx.get('nh_udp_dport'))
        ...
        self.verify_capture(self.pg1, pkts)
        self.input_acl_set_interface(
            self.pg0, self.acl_tbl_idx.get('nh_udp_dport'), 0)
        self.pg0.assert_nothing_captured(remark="packets forwarded")
        self.pg2.assert_nothing_captured(remark="packets forwarded")
    ...
    def test_iacl_proto_udp_sport_dport(self):
        ...
        self.create_classify_session(
            self.acl_tbl_idx.get('nh_udp_ports'),
            self.build_ip6_match(nh=socket.IPPROTO_UDP, src_port=sport,
                                 dst_port=dport))
        self.input_acl_set_interface(
            self.pg0, self.acl_tbl_idx.get('nh_udp_ports'))
        ...
        self.verify_capture(self.pg1, pkts)
        self.input_acl_set_interface(
            self.pg0, self.acl_tbl_idx.get('nh_udp_ports'), 0)
        self.pg0.assert_nothing_captured(remark="packets forwarded")
        self.pg2.assert_nothing_captured(remark="packets forwarded")
...
class TestClassifierIP6TCP(TestClassifier):
    ...
    def test_iacl_proto_tcp(self):
        ...
        self.create_classify_table('nh_tcp', self.build_ip6_mask(nh='ff'))
        self.create_classify_session(
            self.acl_tbl_idx.get('nh_tcp'),
            self.build_ip6_match(nh=socket.IPPROTO_TCP))
        self.input_acl_set_interface(
            self.pg0, self.acl_tbl_idx.get('nh_tcp'))
        ...
        self.input_acl_set_interface(
            self.pg0, self.acl_tbl_idx.get('nh_tcp'), 0)
        self.pg0.assert_nothing_captured(remark="packets forwarded")
        self.pg2.assert_nothing_captured(remark="packets forwarded")
    ...
    def test_iacl_proto_tcp_sport(self):
        ...
        self.create_classify_table(
            'nh_tcp_sport', self.build_ip6_mask(nh='ff', src_port='ffff'))
        self.create_classify_session(
            self.acl_tbl_idx.get('nh_tcp_sport'),
            self.build_ip6_match(nh=socket.IPPROTO_TCP, src_port=sport))
        self.input_acl_set_interface(
            self.pg0, self.acl_tbl_idx.get('nh_tcp_sport'))
        ...
        self.verify_capture(self.pg1, pkts, TCP)
        self.input_acl_set_interface(
            self.pg0, self.acl_tbl_idx.get('nh_tcp_sport'), 0)
        self.pg0.assert_nothing_captured(remark="packets forwarded")
        self.pg2.assert_nothing_captured(remark="packets forwarded")
    ...
    def test_iacl_proto_tcp_dport(self):
        ...
        self.create_classify_table(
            'nh_tcp_dport', self.build_ip6_mask(nh='ff', dst_port='ffff'))
        self.create_classify_session(
            self.acl_tbl_idx.get('nh_tcp_dport'),
            self.build_ip6_match(nh=socket.IPPROTO_TCP, dst_port=dport))
        self.input_acl_set_interface(
            self.pg0, self.acl_tbl_idx.get('nh_tcp_dport'))
        ...
        self.verify_capture(self.pg1, pkts, TCP)
        self.input_acl_set_interface(
            self.pg0, self.acl_tbl_idx.get('nh_tcp_dport'), 0)
        self.pg0.assert_nothing_captured(remark="packets forwarded")
        self.pg2.assert_nothing_captured(remark="packets forwarded")
    ...
    def test_iacl_proto_tcp_sport_dport(self):
        ...
        self.create_classify_table(
            ...
            self.build_ip6_mask(nh='ff', src_port='ffff', dst_port='ffff'))
        self.create_classify_session(
            self.acl_tbl_idx.get('nh_tcp_ports'),
            self.build_ip6_match(nh=socket.IPPROTO_TCP, src_port=sport,
                                 dst_port=dport))
        self.input_acl_set_interface(
            self.pg0, self.acl_tbl_idx.get('nh_tcp_ports'))
        ...
        self.verify_capture(self.pg1, pkts, TCP)
        self.input_acl_set_interface(
            self.pg0, self.acl_tbl_idx.get('nh_tcp_ports'), 0)
        self.pg0.assert_nothing_captured(remark="packets forwarded")
        self.pg2.assert_nothing_captured(remark="packets forwarded")
...
class TestClassifierIP6Out(TestClassifier):
    ...
    def test_acl_ip_out(self):
        ...
        self.create_classify_table(
            ...
            data_offset=0)
        self.create_classify_session(
            self.acl_tbl_idx.get('ip6_out'),
            self.build_ip6_match(src_ip=self.pg1.remote_ip6))
        self.output_acl_set_interface(
            self.pg0, self.acl_tbl_idx.get('ip6_out'))
        ...
        self.output_acl_set_interface(
            self.pg0, self.acl_tbl_idx.get('ip6_out'), 0)
...
class TestClassifierIP6MAC(TestClassifier):
    ...
    def test_acl_mac(self):
        ...
        self.input_acl_set_interface(
            self.pg0, self.acl_tbl_idx.get('mac'), 0)
        self.pg0.assert_nothing_captured(remark="packets forwarded")
        self.pg1.assert_nothing_captured(remark="packets forwarded")
