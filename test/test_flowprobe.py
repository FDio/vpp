...
@tag_fixme_vpp_workers
@unittest.skipIf(
    "flowprobe" in config.excluded_plugins or "ipfix-export" in config.excluded_plugins,
...
class TestFlowprobeWithoutIpfixExport(VppTestCase):
    """Flowprobe behavior without the IPFIX export plugin"""
    ...
    @classmethod
    def setUpClass(cls):
        super(TestFlowprobeWithoutIpfixExport, cls).setUpClass()
    ...
    def test_enable_without_ipfix_export(self):
        ...
        with self.vapi.assert_negative_api_retval():
            reply = self.vapi.flowprobe_interface_add_del(
                ...
                direction=(VppEnum.vl_api_flowprobe_direction_t.FLOWPROBE_DIRECTION_RX),
