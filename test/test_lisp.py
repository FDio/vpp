...
class TestLisp4o4(VppTestCase):
    ...
    def configure_4o4(self):
        ...
        self.rloc = self.pg1.remote_ip4
        self.seid = '172.16.1.2'
        self.deid = '172.16.3.3'
        self.seid_len = 24
        self.deid_len = 24
        self.seid_pref = self.seid + '/' + str(self.seid_len)
        self.deid_pref = self.deid + '/' + str(self.deid_len)
        ...
        rlocs = [
            {
                ...
                "priority": 1,
                "weight": 1,
                "addr": socket.inet_pton(socket.AF_INET, self.rloc)
            }
        ]
    ...
    def verify_capture(self, src_loc, dst_loc, capture):
        ...
        try:
            ...
            self.assert_equal(ip_hdr.src, src_loc, "IP source address")
            self.assert_equal(ip_hdr.dst, dst_loc,
