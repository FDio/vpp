...
class TestSfdpSessionStats(VppTestCase):
    ...
    def test_session_stats_custom_data_config(self):
        ...
        config = self.vapi.sfdp_session_stats_get_config()
        self.assertFalse(
            config.has_api_custom_data, "No tenant should have API data by default"
        )
        ...
        # Verify get_config shows some tenant has API data
        config = self.vapi.sfdp_session_stats_get_config()
        self.assertTrue(
        ...
        # Verify get_config shows no API data
        config = self.vapi.sfdp_session_stats_get_config()
        self.assertFalse(
            config.has_api_custom_data, "API custom data should be cleared"
        )
