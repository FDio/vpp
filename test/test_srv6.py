...
#            i.admin_down()
    ...
    def test_SRv6_T_encaps(self):
        ...
        packet_header =
        self.create_packet_header_IPv6_SRH_IPv6(dst_in,
                                                sidlist=['a8::', 'a7::',
                                                         'a6::'],
                                                segleft=1)
        # create traffic stream pg0->pg1
    ...
    def test_SRv6_End(self):
        ...
        localsid =
        VppSRv6LocalSID(self, localsid_addr='A3::0',
    ...
    def test_SRv6_End_DX6(self):
        ...
        localsid =
        VppSRv6LocalSID(self, localsid_addr='a3::c4',
        ...
        packet_header =
        self.create_packet_header_IPv6_IPv6(dst_in,
                                            dst_out='a3::c4')
        # add to traffic stream pg0->pg1
        pkts.extend(self.create_stream(self.pg0, self.pg1, packet_header,
                                       self.pg_packet_sizes, count))
    ...
    def create_stream(self, src_if, dst_if, packet_header, packet_sizes,
        ...
        for i in range(0, count-1):
            ...
            self.logger.debug("Creating packet with index %d"
                              % (payload_info.index))
