...
class TestSRv6(VppTestCase):
    ...
    def compare_rx_tx_packet_T_Encaps(self, tx_pkt, rx_pkt):
        ...
        # IPv6:
        # tx: IPv6(A, B2)
        # rx: IPv6(C, S1)SRH(S3, S2, S1; SL=2)IPv6(A, B2)
        # IPv6 + SRH:
        # tx: IPv6(A, B2)SRH(B3, B2, B1; SL=1)
        # rx: IPv6(C, S1)SRH(S3, S2, S1; SL=2)IPv6(a, B2)SRH(B3, B2, B1; SL=1)
    ...
    def compare_rx_tx_packet_T_Encaps_IPv4(self, tx_pkt, rx_pkt):
        ...
        # IPv4:
        # tx: IPv4(A, B2)
        # rx: IPv6(C, S1)SRH(S3, S2, S1; SL=2)IPv4(A, B2)
    ...
    def compare_rx_tx_packet_T_Insert(self, tx_pkt, rx_pkt):
        ...
        # IPv6:
        # tx: IPv6(A, B2)
        # rx: IPv6(A, S1)SRH(B2, S3, S2, S1; SL=3)
        # IPv6 + SRH:
        # tx: IPv6(A, B2)SRH(B3, B2, B1; SL=1)
        # rx: IPv6(A, S1)SRH(B2, S3, S2, S1; SL=3)SRH(B3, B2, B1; SL=1)
    ...
    def compare_rx_tx_packet_End(self, tx_pkt, rx_pkt):
        ...
        # IPv6 + SRH:
        # tx: IPv6(A, S1)SRH(S3, S2, S1; SL=2)
        # rx: IPv6(A, S2)SRH(S3, S2, S1; SL=1)
    ...
    def compare_rx_tx_packet_End_PSP(self, tx_pkt, rx_pkt):
        ...
        # rx: IPv6(A, S2)SRH(S3, S2, S1; SL=1)
        # IPv6 + SRH (SL=1):
        # tx: IPv6(A, S2)SRH(S3, S2, S1; SL=1)
        # rx: IPv6(A, S3)
    ...
    def compare_rx_tx_packet_End_DX6(self, tx_pkt, rx_pkt):
        ...
        # IPv6 + SRH (SL=0):
        # tx: IPv6(A, S3)SRH(S3, S2, S1; SL=0)IPv6(B, D)
        # rx: IPv6(B, D)
        # IPv6:
        # tx: IPv6(A, S3)IPv6(B, D)
        # rx: IPv6(B, D)
    ...
    def compare_rx_tx_packet_End_DX4(self, tx_pkt, rx_pkt):
        ...
        # IPv6 + SRH (SL=0):
        # tx: IPv6(A, S3)SRH(S3, S2, S1; SL=0)IPv4(B, D)
        # rx: IPv4(B, D)
        # IPv6:
        # tx: IPv6(A, S3)IPv4(B, D)
        # rx: IPv4(B, D)
