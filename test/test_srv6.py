...
#            i.admin_down()
    ...
    def test_SRv6_T_encaps(self):
        ...
        sr_policy = VppSRv6Policy(self, bsid=bsid,
            is_encap=1, sr_type=SRv6PolicyType.SR_POLICY_TYPE_DEFAULT,
            weight=1, fib_table=0,
            segments=['a4::', 'a5::', 'a6::c7'], source='a3::')
        ...
        pol_steering = VppSRv6Steering(self,
    ...
    def test_SRv6_End(self):
        ...
        localsid = VppSRv6LocalSID(self, localsid_addr='A3::0',
        ...
        # send packets and verify received packets
        self.send_and_verify(self.pg0, pkts, self.pg1, self.compare_rx_tx_packet_End)
    ...
    def test_SRv6_End_DX6(self):
        ...
        localsid = VppSRv6LocalSID(self, localsid_addr='a3::c4',
        ...
        packet_header = self.create_packet_header_IPv6_IPv6(dst_in,
            dst_out = 'a3::c4')
        # add to traffic stream pg0->pg1
        pkts.extend(self.create_stream(self.pg0, self.pg1, packet_header,
            self.pg_packet_sizes, count))
    ...
    def compare_rx_tx_packet_End_PSP(self, tx_pkt, rx_pkt):
        ...
        if tx_ip.segleft > 1:
            ...
            self.assertEqual(rx_ip.src, tx_ip.src)
            # outer IPv6 header ip.dst should be equal to tx'ed sidlist[segleft-1]
    ...
    def create_stream(self, src_if, dst_if, packet_header, packet_sizes, count):
        ...
        :param packet_header: Layer3 scapy packet headers (excl L2), L2 and Raw(payload) with packet_info are added
        :param list packet_sizes: packet stream packet sizes, sequentially applied
    ...
    def verify_captured_packets(self, dst_if, capture, compare_func):
        ...
        Compare ingress with egress packets using the specified compare function
        """
        ...
        for packet in capture:
            try:
                ...
                # compare received packet with expected packet using compare_func
