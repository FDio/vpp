...
class BridgeDomain(object):
    ...
    def test_decap(self):
        ...
        encapsulated_pkt = self.encapsulate(self.frame_request, self.vni)
    ...
    def test_encap(self):
        ...
        pkt = out[0]
        self.check_encapsulation(pkt, 1)
	...
	for pkt in out:
	    self.check_encapsulation(pkt, 3, True)
            payload = self.decapsulate(pkt)
	    self.assert_eq_pkts(payload, self.frame_reply)
    ...
    def test_mcast_flood(self):
        ...
        out = self.pg0.get_capture(1)
        pkt = out[0]
        self.check_encapsulation(pkt, 2, True)
    ...
    def test_mcast_rcv(self):
        ...
        mcast_stream = [self.encap_mcast(self.frame_request, ip, mac, 2)
