...
class VppInterface(object):
    ...
    def set_table_ip6(self, table_id):
        ...
        """
        # TODO: move configuring to config_ip6 or rename to config_table
    ...
    def querry_vpp_ip4_config_from_dump(self, dump):

        dumped_fib = [(socket.inet_ntop(socket.AF_INET, i.address),
                       i.address_length, i.table_id) for i in dump]
        return (self.local_ip4,
                self.local_ip4_prefix_len,
                self.ip4_table_id, ) in dumped_fib
