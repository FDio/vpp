...
class VppTestCase(VppAsfTestCase):
    ...
    def tearDownClass(cls):
        ...
        cls.reset_packet_infos()
        if hasattr(cls, "pg_interfaces"):
            testcase_dir = os.path.dirname(cls.pg_interfaces[0].out_path)
            cls.pg_interfaces[0].decode_pcap_files(testcase_dir, f"suite{cls.__name__}")
