...
from vpp_pom import StepHook, PollHook, VppPGInterface, VppSubInterface, \
    ...
    VppClient
from vpp_pom.log import RED, GREEN, YELLOW, double_line_delim, \
    single_line_delim, get_logger, colorize
...
class MyVppPGInterface(VppPGInterface):
    ...
    def __init__(self, test, pg_index, gso, gso_size):
        ...
        self._test = test
        super(MyVppPGInterface, self).__init__(
            self._test.vclient, pg_index, gso, gso_size)
...
class KeepAliveReporter(object):
    ...
    def send_keep_alive(self, test, desc=None):
        ...
        self.pipe.send(
            (desc, test.vpp_bin, test.tempdir, test.vpp_process.pid))
...
class VppTestCase(unittest.TestCase):
    ...
    def wait_for_enter(cls):
        ...
        if cls.debug_gdbserver:
            ...
            print("sudo gdb " + cls.vpp_bin + " -ex 'attach %s'" %
                  cls.vpp_process.pid)
            print("Now is the time to attach gdb by running the above "
