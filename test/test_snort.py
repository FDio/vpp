...
class TestSnort(VppTestCase):
    ...
    def test_snort_cli(self):
        ...
        commands_replies = {
            ...
            "snort attach instance snortTest2 interface pg3 inout": "",
            "show snort instances": "snortTest",
            "show snort interfaces": "pg0",
            "show snort clients": "number of clients",
            "snort detach instance snortTest interface pg0 output": "",
            "snort detach instance snortTest2 interface pg1 input": "",
            "snort detach instance snortTest2 interface pg3 inout": "",
