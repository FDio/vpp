...
class TestMAP(VppTestCase):
    ...
    def test_map_e(self):
        ...
        self.vapi.map_if_enable_disable(is_enable=1, sw_if_index=self.pg0.sw_if_index, is_translation=0)
        ...
        # Enable MAP on interface.
        self.vapi.map_if_enable_disable(is_enable=1, sw_if_index=self.pg1.sw_if_index, is_translation=0)
    ...
    def test_map_t(self):
        ...
        self.vapi.map_if_enable_disable(is_enable=1, sw_if_index=self.pg0.sw_if_index, is_translation=1)
        self.vapi.map_if_enable_disable(is_enable=1, sw_if_index=self.pg1.sw_if_index, is_translation=1)
