...
class TestLldpDump(VppTestCase):
    ...
    def test_lldp_dump(self):
        ...
        val_sw_if_ind = self.pg0.sw_if_index
        ...
        #
        details = list(self.vapi.details_iter(self.vapi.lldp_dump))
        ...
        #
        for d in details:
            self.assert_equal(d.active, True)
            ...
            if d.sw_if_index == self.pg0.sw_if_index:
        ...
        #
        # "Sleep" until the TTL has been exceeded.
        #
        ttl = self.TX_HOLD * self.TX_INTERVAL + 10
        self.virtual_sleep(ttl)
