...
class TestClassifier(VppTestCase):
    ...
    def test_iacl_src_ip(self):
        ...
        self.create_classify_table(
            'ip_src', self.build_ip_mask(src_ip='ffffffff'))
        self.create_classify_session(
            self.acl_tbl_idx.get('ip_src'),
            self.build_ip_match(src_ip=self.pg0.remote_ip4))
        self.input_acl_set_interface(self.pg0, self.acl_tbl_idx.get('ip_src'))
        self.acl_active_table = 'ip_src'
    ...
    def test_iacl_dst_ip(self):
        ...
        self.create_classify_table(
            'ip_dst', self.build_ip_mask(dst_ip='ffffffff'))
        self.create_classify_session(
            self.acl_tbl_idx.get('ip_dst'),
            self.build_ip_match(dst_ip=self.pg1.remote_ip4))
        self.input_acl_set_interface(self.pg0, self.acl_tbl_idx.get('ip_dst'))
        self.acl_active_table = 'ip_dst'
    ...
    def test_iacl_src_dst_ip(self):
        ...
        Test scenario for basic IP ACL with source and destination IP
            - Create IPv4 stream for pg0 -> pg1 interface.
            - Create iACL with source and destination IP address.
            - Send and verify received packets on pg1 interface.
        """
        ...
        self.create_classify_table('ip', self.build_ip_mask(
            src_ip='ffffffff', dst_ip='ffffffff'))
        self.create_classify_session(
            self.acl_tbl_idx.get('ip'),
            self.build_ip_match(src_ip=self.pg0.remote_ip4,
                                dst_ip=self.pg1.remote_ip4))
        self.input_acl_set_interface(self.pg0, self.acl_tbl_idx.get('ip'))
        self.acl_active_table = 'ip'
    ...
    def test_iacl_proto_udp(self):
        ...
        self.create_classify_table('proto_udp', self.build_ip_mask(proto='ff'))
        self.create_classify_session(
            self.acl_tbl_idx.get('proto_udp'),
            self.build_ip_match(proto=socket.IPPROTO_UDP))
        self.input_acl_set_interface(
            self.pg0, self.acl_tbl_idx.get('proto_udp'))
        self.acl_active_table = 'proto_udp'
    ...
    def test_iacl_proto_udp_sport(self):
        ...
        self.create_classify_table(
            'proto_udp_sport', self.build_ip_mask(proto='ff', src_port='ffff'))
        self.create_classify_session(
            self.acl_tbl_idx.get('proto_udp_sport'),
            self.build_ip_match(proto=socket.IPPROTO_UDP, src_port=sport))
        self.input_acl_set_interface(
            self.pg0, self.acl_tbl_idx.get('proto_udp_sport'))
        self.acl_active_table = 'proto_udp_sport'
    ...
    def test_iacl_proto_udp_dport(self):
        ...
        self.create_classify_table(
            'proto_udp_dport', self.build_ip_mask(proto='ff', dst_port='ffff'))
        self.create_classify_session(
            self.acl_tbl_idx.get('proto_udp_dport'),
            self.build_ip_match(proto=socket.IPPROTO_UDP, dst_port=dport))
        self.input_acl_set_interface(
            self.pg0, self.acl_tbl_idx.get('proto_udp_dport'))
        self.acl_active_table = 'proto_udp_dport'
    ...
    def test_iacl_proto_udp_sport_dport(self):
        ...
        self.create_classify_table(
            'proto_udp_ports', self.build_ip_mask(proto='ff', src_port='ffff',
                                                  dst_port='ffff'))
        self.create_classify_session(
            self.acl_tbl_idx.get('proto_udp_ports'),
            self.build_ip_match(proto=socket.IPPROTO_UDP, src_port=sport,
                                dst_port=dport))
        self.input_acl_set_interface(
            self.pg0, self.acl_tbl_idx.get('proto_udp_ports'))
        self.acl_active_table = 'proto_udp_ports'
    ...
    def test_iacl_proto_tcp(self):
        ...
        self.create_classify_table(
            'proto_tcp', self.build_ip_mask(proto='ff'))
        self.create_classify_session(
            self.acl_tbl_idx.get('proto_tcp'),
            self.build_ip_match(proto=socket.IPPROTO_TCP))
        self.input_acl_set_interface(
            self.pg0, self.acl_tbl_idx.get('proto_tcp'))
        self.acl_active_table = 'proto_tcp'
    ...
    def test_iacl_proto_tcp_sport(self):
        ...
        self.create_classify_table(
            'proto_tcp_sport', self.build_ip_mask(proto='ff', src_port='ffff'))
        self.create_classify_session(
            self.acl_tbl_idx.get('proto_tcp_sport'),
            self.build_ip_match(proto=socket.IPPROTO_TCP, src_port=sport))
        self.input_acl_set_interface(
            self.pg0, self.acl_tbl_idx.get('proto_tcp_sport'))
        self.acl_active_table = 'proto_tcp_sport'
    ...
    def test_iacl_proto_tcp_dport(self):
        ...
        self.create_classify_table(
            'proto_tcp_dport', self.build_ip_mask(proto='ff', dst_port='ffff'))
        self.create_classify_session(
            self.acl_tbl_idx.get('proto_tcp_dport'),
            self.build_ip_match(proto=socket.IPPROTO_TCP, dst_port=dport))
        self.input_acl_set_interface(
            self.pg0, self.acl_tbl_idx.get('proto_tcp_dport'))
        self.acl_active_table = 'proto_tcp_dport'
    ...
    def test_iacl_proto_tcp_sport_dport(self):
        ...
        self.create_classify_table(
            'proto_tcp_ports', self.build_ip_mask(proto='ff', src_port='ffff',
                                                  dst_port='ffff'))
        self.create_classify_session(
            self.acl_tbl_idx.get('proto_tcp_ports'),
            self.build_ip_match(proto=socket.IPPROTO_TCP, src_port=sport,
                                dst_port=dport))
        self.input_acl_set_interface(
            self.pg0, self.acl_tbl_idx.get('proto_tcp_ports'))
        self.acl_active_table = 'proto_tcp_ports'
    ...
    def test_acl_ip_out(self):
        ...
        self.create_classify_table('ip_out',
                                   self.build_ip_mask(src_ip='ffffffff'),
                                   data_offset=0)
        self.create_classify_session(
            self.acl_tbl_idx.get('ip_out'),
            self.build_ip_match(src_ip=self.pg1.remote_ip4))
        self.output_acl_set_interface(self.pg0, self.acl_tbl_idx.get('ip_out'))
        self.acl_active_table = 'ip_out'
