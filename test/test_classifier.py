...
class TestClassifier(VppTestCase):
    ...
    def create_classify_table(self, key, mask, data_offset=0, is_add=1):
        ...
        if r is not None:
            ...
            raise Exception("No response message for classify_add_del_table")
    ...
    def create_classify_session(self, intf, table_index, match,
        ...
        r = self.vapi.classify_add_del_session(
                ...
                metadata=vrfid)
        if r is None:
            raise Exception("No response message for create_classify_session")
    ...
    def input_acl_set_interface(self, intf, table_index, is_add=1):
        ...
        if r is None:
            raise Exception("No response message for input_acl_set_interface")
