...
class TestClassifier(VppTestCase):
    ...
    def delete_classify_table(self, key):
        """Delete Classify Table
    ...
    def test_iacl_src_dst_ip(self):
        ...
        self.create_classify_table(
            'ip', self.build_ip_mask(src_ip='ffffffff', dst_ip='ffffffff'))
        self.create_classify_session(
    ...
    def test_acl_ip_out(self):
        ...
        self.create_classify_table(
            'ip_out', self.build_ip_mask(src_ip='ffffffff'), data_offset=0)
        self.create_classify_session(
    ...
    def test_acl_pbr(self):
        ...
        self.create_classify_table(
            'pbr', self.build_ip_mask(src_ip='ffffffff'))
        pbr_option = 1
