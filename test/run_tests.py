...
if __name__ == '__main__':
    ...
    compress_core = VppTestCase.get_truthy_envar("CORE_COMPRESS")

    step = VppTestCase.get_truthy_envar("STEP")
    force_foreground = VppTestCase.get_truthy_envar("FORCE_FOREGROUND")
