                ...
                if os.path.isfile(core_path):
                    ...
                    with open("/proc/sys/kernel/core_pattern", "r") as f:
                        ...
                        if corefmt.startswith("|"):
                           global_logger.error("WARNING: redirecting the core dump through a filter may result in truncated dumps.")
                           global_logger.error("   You may want to check the filter settings or uninstall it and edit the /proc/sys/kernel/core_pattern accordingly.")
                           global_logger.error("   current core pattern is: %s" % corefmt)
