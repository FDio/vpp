...
class TestGSO(VppTestCase):
    ...
    def test_gso_ipip(self):
        ...
        self.vapi.sw_interface_set_flags(self.ipip4.sw_if_index, 1)
        self.vapi.sw_interface_set_unnumbered(
                sw_if_index=self.pg0.sw_if_index,
                unnumbered_sw_if_index=self.ipip4.sw_if_index)
        ...
        # Set interface up and enable IP on it
        self.vapi.sw_interface_set_flags(self.ipip6.sw_if_index, 1)
        self.vapi.sw_interface_set_unnumbered(
                sw_if_index=self.pg0.sw_if_index,
                unnumbered_sw_if_index=self.ipip6.sw_if_index)
