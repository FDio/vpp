...
class TestBier(VppTestCase):
    ...
    def test_bier_head(self):
        ...
        #
        bi = VppBierImp(self, bti, 333, scapy.compat.orb(0x3) * 32)
        bi.add_vpp_config()
    ...
    def bier_e2e(self, hdr_len_id, n_bytes, max_bp):
        ...
        lowest = [b'\0'] * (n_bytes)
        lowest[-1] = scapy.compat.orb(1)
        highest = [b'\0'] * (n_bytes)
        highest[0] = scapy.compat.orb(128)
    ...
    def test_bier_head_o_udp(self):
        ...
        #
        bi = VppBierImp(self, bti, 333, scapy.compat.orb(0xff) * 32)
        bi.add_vpp_config()
        bi2 = VppBierImp(self, bti, 334, scapy.compat.orb(0xff) * 32)
        bi2.add_vpp_config()
