...
class TestBier(VppTestCase):
    ...
    def test_bier_midpoint(self):
        ...
        self.logger.error(self.vapi.cli("show bier fib 0"))
    ...
    def test_bier_head(self):
        ...
        self.logger.error(self.vapi.cli("show bier imp"))
        self.logger.error(self.vapi.cli("show bier fib 0"))
    ...
    def test_bier_tail(self):
        ...
        self.logger.error(self.vapi.cli("show bier fib 0"))
        self.logger.error(self.vapi.cli("show bier disp table 0"))
        self.logger.error(self.vapi.cli("show bier disp entry 0"))
    ...
    def test_bier_e2e(self):
        ...
        self.logger.error(self.vapi.cli("show bier fib 0"))
        self.logger.error(self.vapi.cli("show bier fib 3"))
        self.logger.error(self.vapi.cli("show bier disp table 0"))
        self.logger.error(self.vapi.cli("show bier disp entry 0"))
        self.logger.error(self.vapi.cli("show bier imp"))
        self.logger.error(self.vapi.cli("show bier fmask 0"))
        self.logger.error(self.vapi.cli("show ip mfib"))
