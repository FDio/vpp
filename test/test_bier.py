...
class TestBier(VppTestCase):
    ...
    def test_bier_midpoint_4096(self):
        """BIER midpoint BSL:4096"""
        self.bier_midpoint(BIERLength.BIER_LEN_4096, 512, 4096)

    @unittest.skipUnless(running_extended_tests(), "part of extended tests")
    def test_bier_midpoint_2048(self):
        """BIER midpoint BSL:2048"""
        self.bier_midpoint(BIERLength.BIER_LEN_2048, 256, 2048)
    ...
    def bier_e2e(self, hdr_len_id, n_bytes, max_bp):
        ...
        self.logger.error(self.vapi.cli("sh bier fib 0"))
    ...
    @unittest.skipUnless(running_extended_tests(), "part of extended tests")
    def test_bier_e2e_4096(self):
        """ BIER end-to-end BSL:4096"""
        self.bier_e2e(BIERLength.BIER_LEN_4096, 512, 4096)

    @unittest.skipUnless(running_extended_tests(), "part of extended tests")
    def test_bier_e2e_2048(self):
        """ BIER end-to-end BSL:2048"""
        self.bier_e2e(BIERLength.BIER_LEN_2048, 256, 2048)
