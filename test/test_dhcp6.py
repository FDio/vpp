...
class TestDHCPv6PDControlPlane(VppTestCase):
    ...
    def test_prefixes(self):
        ...
        address1 = "0000:0000:0000:0002:0000:0000:0000:0405/60"
        address2 = "0000:0000:0000:0076:0000:0000:0000:0406/62"
        try:
            ...
            if address1 is not None:
                self.vapi.ip6_add_del_address_using_prefix(
                    sw_if_index=self.pg1.sw_if_index, address_with_prefix=address1,
                    prefix_group=self.prefix_group, is_add=0)
            if address2 is not None:
                self.vapi.ip6_add_del_address_using_prefix(
                    sw_if_index=self.pg1.sw_if_index, address_with_prefix=address2,
                    prefix_group=self.prefix_group, is_add=0)
