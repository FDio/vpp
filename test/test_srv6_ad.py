...
class TestSRv6Ad(VppTestCase):
    ...
    def test_srv6_end_ad_usid_end_ipv6(self):
        """ Test SRv6 End.AD uSID behavior end operation for IPv6 traffic. """
        self.run_test(
    ...
    def test_srv6_end_ad_usid_shift_srh_ipv6(self):
        """ Test SRv6 End.AD uSID behavior shift operation with SRH for IPv6 traffic. """
        self.run_test(
          src_addr="5f00:0:10::1",
    ...
    def test_srv6_end_ad_usid_shift_nosrh_ipv6(self):
        """ Test SRv6 End.AD uSID behavior shift operation without SRH for IPv6 traffic. """
        self.run_test(
          src_addr="5f00:0:10::1",
          local_sid="5f00:0:3:ad6::/64",
    ...
    def test_srv6_end_ad_usid_end_ipv4(self):
        """ Test SRv6 End.AD uSID behavior end operation for IPv4 traffic. """
        self.run_test(
          src_addr="5f00:0:10::1",
          local_sid="5f00:0:4:ad6::/64",
          ingress_dst_addr="5f00:0:4:ad6::",
    ...
    def test_srv6_end_ad_usid_shift_srh_ipv4(self):
        """ Test SRv6 End.AD uSID behavior shift operation with SRH for IPv4 traffic. """
        self.run_test(
          src_addr="5f00:0:10::1",
          local_sid="5f00:0:3:ad6::/64",
          ingress_dst_addr="5f00:0:3:ad6:4::",
    ...
    def test_srv6_end_ad_usid_shift_nosrh_ipv4(self):
        """ Test SRv6 End.AD uSID behavior shift operation without SRH for IPv4 traffic. """
        self.run_test(
          src_addr="5f00:0:10::1",
          local_sid="5f00:0:3:ad6::/64",
          ingress_dst_addr="5f00:0:3:ad6:4:5::",
    ...
    def test_srv6_end_ad_usid_end_ether(self):
        """ Test SRv6 End.AD uSID behavior end operation for L2 traffic. """
        self.run_test(
          src_addr="5f00:0:10::1",
          local_sid="5f00:0:4:ad6::/64",
          ingress_dst_addr="5f00:0:4:ad6::",
    ...
    def test_srv6_end_ad_usid_shift_srh_ether(self):
        """ Test SRv6 End.AD uSID behavior shift operation with SRH for L2 traffic. """
        self.run_test(
          src_addr="5f00:0:10::1",
          local_sid="5f00:0:3:ad6::/64",
          ingress_dst_addr="5f00:0:3:ad6:4::",
    ...
    def test_srv6_end_ad_usid_shift_nosrh_ether(self):
        """ Test SRv6 End.AD uSID behavior shift operation without SRH for L2 traffic. """
        self.run_test(
          src_addr="5f00:0:10::1",
          local_sid="5f00:0:3:ad6::/64",
          ingress_dst_addr="5f00:0:3:ad6:4:5::",
    ...
    def run_test(self, src_addr, local_sid, ingress_dst_addr, egress_dst_addr, usid_len=0, srh_sidlist=[], ingress_sl=0, egress_sl=0, inner_type=None):
        ...
        self.logger.debug(self.vapi.cli("show sr localsids behaviors"))
            ...
            if srh_sidlist:
                ingress_hdr = (IPv6(src=src_addr, dst=ingress_dst_addr)
                    / IPv6ExtHdrSegmentRouting(
                        addresses=srh_sidlist, segleft=ingress_sl, nh=143)
                )
            else:
                ingress_hdr = IPv6(src=src_addr, dst=ingress_dst_addr, nh=143)
            ingress_hdr /= inner_hdr
