...
class TestSRv6Ad(VppTestCase):
    ...
    def test_srv6_end_uad_end_ipv6(self):
        """Test SRv6 End.uAD end operation for IPv6 traffic."""
        self.run_test(
    ...
    def test_srv6_end_uad_shift_srh_ipv6(self):
        """Test SRv6 End.uAD shift operation with SRH for IPv6 traffic."""
        self.run_test(
            src_addr="5f00:0:10::1",
    ...
    def test_srv6_end_uad_shift_nosrh_ipv6(self):
        """Test SRv6 End.uAD shift operation without SRH for IPv6 traffic."""
        self.run_test(
            src_addr="5f00:0:10::1",
            local_sid="5f00:0:3:ad6::/64",
    ...
    def test_srv6_end_uad_end_ipv4(self):
        """Test SRv6 End.uAD end operation for IPv4 traffic."""
        self.run_test(
            src_addr="5f00:0:10::1",
            local_sid="5f00:0:4:ad6::/64",
            ingress_dst_addr="5f00:0:4:ad6::",
    ...
    def test_srv6_end_uad_shift_srh_ipv4(self):
        """Test SRv6 End.uAD shift operation with SRH for IPv4 traffic."""
        self.run_test(
            src_addr="5f00:0:10::1",
            local_sid="5f00:0:3:ad6::/64",
            ingress_dst_addr="5f00:0:3:ad6:4::",
    ...
    def test_srv6_end_uad_shift_nosrh_ipv4(self):
        """Test SRv6 End.uAD shift operation without SRH for IPv4 traffic."""
        self.run_test(
            src_addr="5f00:0:10::1",
            local_sid="5f00:0:3:ad6::/64",
            ingress_dst_addr="5f00:0:3:ad6:4:5::",
    ...
    def test_srv6_end_uad_end_ether(self):
        """Test SRv6 End.uAD end operation for L2 traffic."""
        self.run_test(
            src_addr="5f00:0:10::1",
            local_sid="5f00:0:4:ad6::/64",
            ingress_dst_addr="5f00:0:4:ad6::",
    ...
    def test_srv6_end_uad_shift_srh_ether(self):
        """Test SRv6 End.uAD shift operation with SRH for L2 traffic."""
        self.run_test(
            src_addr="5f00:0:10::1",
            local_sid="5f00:0:3:ad6::/64",
            ingress_dst_addr="5f00:0:3:ad6:4::",
    ...
    def test_srv6_end_uad_shift_nosrh_ether(self):
        """Test SRv6 End.uAD shift operation without SRH for L2 traffic."""
        self.run_test(
            src_addr="5f00:0:10::1",
            local_sid="5f00:0:3:ad6::/64",
            ingress_dst_addr="5f00:0:3:ad6:4:5::",
    ...
    def run_test(
        ...
        if usid_len:
            cli_str += " behavior end.uad " + str(usid_len)
        else:
