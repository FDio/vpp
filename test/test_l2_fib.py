...
class TestL2fib(VppTestCase):
    ...
    def test_l2_fib_macs_learn_max(self):
        ...
        self.assertGreater(len(macs), 10)
        self.assertGreater(len(learned_macs), 20)
        self.logger.info(macs)
        self.logger.info(learned_macs)
        self.assertEqual(len(learned_macs), len(macs))
        for e in evs:
