...
class TestSNAT(VppTestCase):
    ...
    def test_inside_overlapping_interfaces(self):
        ...
        sessions = self.vapi.snat_user_session_dump(self.pg5.remote_ip4n,
                                                    0,
                                                    10)
        ...
        # pg4 session dump
        sessions = self.vapi.snat_user_session_dump(self.pg4.remote_ip4n,
                                                    0,
                                                    10)
        ...
        # pg6 session dump
        sessions = self.vapi.snat_user_session_dump(self.pg6.remote_ip4n,
                                                    0,
                                                    20)
