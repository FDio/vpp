...
class TestNAT44(MethodHolder):
    ...
    def test_dynamic(self):
        ...
        icmpn = self.statistics.get_err_counter('/err/nat44-out2in/ICMP packets')
        totaln = self.statistics.get_err_counter(
    ...
    def test_one_armed_nat44(self):
        ...
        err = self.statistics.get_err_counter('/err/nat44-classify/next in2out')
        self.assertEqual(err, 1)
        err = self.statistics.get_err_counter('/err/nat44-classify/next out2in')
        self.assertEqual(err, 1)
...
class TestNAT44EndpointDependent(MethodHolder):
    ...
    def test_dynamic(self):
        ...
        # out2in
        tcpn = self.statistics.get_err_counter('/err/nat44-ed-out2in/TCP packets')
        udpn = self.statistics.get_err_counter('/err/nat44-ed-out2in/UDP packets')
        icmpn = self.statistics.get_err_counter(
        ...
        err = self.statistics.get_err_counter('/err/nat44-ed-out2in/TCP packets')
        self.assertEqual(err - tcpn, 1)
        err = self.statistics.get_err_counter('/err/nat44-ed-out2in/UDP packets')
        self.assertEqual(err - udpn, 1)
        err = self.statistics.get_err_counter(
            '/err/nat44-ed-out2in-slowpath/ICMP packets')
        self.assertEqual(err - icmpn, 1)
...
class TestNAT64(MethodHolder):
    ...
    def test_dynamic(self):
        ...
        icmpn = self.statistics.get_err_counter('/err/nat64-in2out/ICMP packets')
        totaln = self.statistics.get_err_counter(
        ...
        icmpn = self.statistics.get_err_counter('/err/nat64-out2in/ICMP packets')
        totaln = self.statistics.get_err_counter(
