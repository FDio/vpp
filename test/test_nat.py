...
class TestNAT44EndpointDependent(MethodHolder):
    ...
    def test_dynamic_output_feature_vrf(self):
        """ NAT44 dynamic translation test with output feature and change VRF"""

        new_vrf_id = 22 # other then default (0)
        ...
        self.pg0.unconfig_ip4()
        self.pg0.set_table_ip4(new_vrf_id)
        self.pg0.config_ip4()
        self.pg0.resolve_arp()

        self.pg1.unconfig_ip4()
        self.pg1.set_table_ip4(new_vrf_id)
        self.pg1.config_ip4()
        self.pg1.resolve_arp()
