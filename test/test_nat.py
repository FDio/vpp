...
class TestNAT44(MethodHolder):
    ...
    def setUpClass(cls):
        ...
        try:
            ...
            cls.pg4._local_ip4 = VppIpPrefix("172.16.255.1", cls.pg4.local_ip4_prefix.len)
            cls.pg4._remote_hosts[0]._ip4 = "172.16.255.2"
            cls.pg4.set_table_ip4(10)
            cls.pg5._local_ip4 = VppIpPrefix("172.17.255.3", cls.pg5.local_ip4_prefix.len)
            cls.pg5._remote_hosts[0]._ip4 = "172.17.255.4"
            cls.pg5.set_table_ip4(10)
            cls.pg6._local_ip4 = VppIpPrefix("172.16.255.1", cls.pg6.local_ip4_prefix.len)
            ...
            cls.pg9.config_ip4()
            cls.vapi.sw_interface_add_del_address(sw_if_index=cls.pg9.sw_if_index,
...
class TestNAT44EndpointDependent(MethodHolder):
    ...
    def setUpClass(cls):
        ...
        try:
            ...
            cls.pg4.config_ip4()
            cls.vapi.sw_interface_add_del_address(sw_if_index=cls.pg4.sw_if_index,
                                                  prefix=VppIpPrefix("10.0.0.1", 24).encode())
            cls.pg4.admin_up()
            cls.pg4.resolve_arp()
            ...
            cls.pg5._local_ip4 = VppIpPrefix("10.1.1.1", cls.pg5.local_ip4_prefix.len)
            ...
            cls.pg6._local_ip4 = VppIpPrefix("10.1.2.1", cls.pg6.local_ip4_prefix.len)
