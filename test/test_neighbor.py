...
class ARPTestCase(VppTestCase):
    ...
    def test_arp(self):
        ...
        attached_host = VppIpRoute(self.vclient, self.pg2.remote_hosts[3].ip4,
                                   32, [VppRoutePath("0.0.0.0",
...
class NeighborFlush(VppTestCase):
    ...
    def test_flush(self):
        ...
        for s in static:
            ...
            self.vclient.ip_neighbor_flush(
                af.ADDRESS_IP4, self.pg0.sw_if_index)
            ...
            self.vclient.ip_neighbor_flush(
                af.ADDRESS_IP6, self.pg1.sw_if_index)
