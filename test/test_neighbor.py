...
class TestARP(VppTestCase):
    """ ARP Test Case """

    def setUp(self):
        super(TestARP, self).setUp()
    ...
    def test_arp(self):
        ...
        static_p = (Ether(dst=self.pg0.local_mac, src=self.pg0.remote_mac) /
                    ...
                    UDP(sport=1234, dport=1234) /
                    Raw())
        static_pkts = [static_p]

        self.pg0.add_stream(static_pkts)
        self.pg_enable_capture(self.pg_interfaces)
        self.pg_start()
    ...
    def test_proxy_arp(self):
        ...
        arp_req_pg1_hi = (Ether(src=self.pg1.remote_mac,
                          ...
                          ARP(op="who-has",
                              ...
                              psrc=self.pg1.remote_ip4))
        pkts = [arp_req_pg1_hi]
        self.send_and_assert_no_replies(self.pg1, pkts,
