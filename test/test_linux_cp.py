...
class TestLinuxCPLinuxToVPP(TestLinuxCPNetNSBase):
    ...
    def test_linux_to_vpp_route_blackhole(self):
        ...
        add_namespace_route(self.ns_name, "192.168.50.0/24", route_type="blackhole")

        self.verify_paths("192.168.50.1/32", dict(type=FibPathType.FIB_PATH_TYPE_DROP))
    ...
    def test_linux_to_vpp_route_unreachable(self):
        ...
        add_namespace_route(self.ns_name, "192.168.51.0/24", route_type="unreachable")
    ...
    def test_linux_to_vpp_route_prohibit(self):
        ...
        add_namespace_route(self.ns_name, "192.168.52.0/24", route_type="prohibit")
