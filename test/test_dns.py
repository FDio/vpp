...
class TestDns(VppTestCase):
    ...
    def setUpClass(cls):
        ...
        try:
            ...
            cls.vapi.dns_name_server_add_del(
                is_ip6=1,
                is_add=1,
                server_address=IPv6Address("2001:db8::").packed,
            )
    ...
    def create_a_stream(self, src_if):
        ...
        bad_request = (
            ...
            / IP(src=src_if.remote_ip4)
            / UDP(sport=1234, dport=53)
            / DNS(rd=1, qd=DNSQR(qname="noexample.com"))
        )
    ...
    def test_dns_resolve_name(self):
        ...
        self.logger.info(self.vapi.cli("dns cache add example.com 1.2.3.4"))

        # Test the binary API
        rv = self.vapi.dns_resolve_name(name=b"example.com")
        ...
        self.assertIn("[P] noexample.com:", str)
    ...
    def test_dns6_resolve_name(self):
        ...
        # Manually add a static dns cache entry
        self.logger.info(
            self.vapi.cli("dns cache add example.com 2001:4860:4860::1111")
        )
    ...
    def test_request_timeout(self):
        ...
        # Test the binary API for IPv6
        self.vapi.cli("dns resolve name example.com")

        str = self.vapi.cli("show dns cache verbose")
        self.assertIn("example.com", str)
        ...
        str = self.vapi.cli("show dns cache verbose")
        self.assertNotIn("example.com", str)
