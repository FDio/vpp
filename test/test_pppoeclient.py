...
class TestPPPoEClient(VppTestCase):
    ...
    def test_pppoe_backoff_show_and_clear_cli(self):
        ...
        self.vapi.cli("set pppoe backoff jitter 0")
    ...
    def test_pppoe_backoff_jitter_fraction_is_configurable(self):
        """set pppoe backoff jitter updates the plugin-global fraction."""

        output = self.vapi.cli("set pppoe backoff jitter 0.1")
        ...
        try:
            self.vapi.cli("set pppoe backoff jitter 0.9")
