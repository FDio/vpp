        ...
        if gre_key != 0:
            try:
                ...
                self.test.logger.info(
                    f"Deleting GRE tunnel with CLI - src: {self.t_src}, dst: {self.t_dst}, key: {gre_key}"
                )
    ...
    def query_vpp_config(self):
        ...
        try:
            ...
            if gre_key != 0:
                ...
                if (
                    key_pattern in tunnels_info
                    and src_pattern in tunnels_info
                    and dst_pattern in tunnels_info
                ):
                    return True
                return False
            else:
