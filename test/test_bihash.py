...
class TestBihash(VppTestCase):
    ...
    def test_bihash_thread(self):
        ...
        error = self.vapi.cli("test bihash threads 2 nbuckets 64000 careful 0 verbose 0")
    ...
    def test_bihash_coverage(self):
        ...
        error = self.vapi.cli("test bihash nitems 10 ncycles 3 search 2 careful 1 verbose 2 non-random-keys")
