...
class TestVxlanGpe(BridgeDomain, VppTestCase):
    ...
    @classmethod
    def create_gtpu_flood_test_bd(cls, vni, n_ucast_tunnels):
    ...
    def setUpClass(cls):
        ...
        try:
            ...
            # Create VXLAN-GPE VTEP on VPP pg0, and put gtpu_tunnel0 and pg1
            #  into BD.
            ...
            super(TestVxlan_gpe, cls).tearDownClass()
            raise
    ...
    def tearDown(self):
        super(TestVxlan_gpe, self).tearDown()
