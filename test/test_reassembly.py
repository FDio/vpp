...
class TestIPv6Reassembly(VppTestCase):
    ...
    def test_reassembly_cli(self):
        ...
        self.vapi.cli("set ip6-full-reassembly timeout 1234 reset")
        reply = self.vapi.cli("show ip6-full-reassembly details")
        self.assertNotIn("1234", reply)
        self.vapi.cli("set ip6-full-reassembly timeout 1000000 max-reassemblies 1000")
        reply = self.vapi.cli("show ip6-full-reassembly details")
        self.assertIn("1000000", reply)
