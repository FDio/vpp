...
class TestMPLSPIC(VppTestCase):
    ...
    def test_mpls_ibgp_pic(self):
        ...
        rx0 = self.pg0._get_capture(self.NUM_PKTS)
        rx1 = self.pg1._get_capture(self.NUM_PKTS)
        ...
        rx0 = self.pg0.get_capture(self.NUM_PKTS)
    ...
    def test_mpls_ebgp_pic(self):
        ...
        rx0 = self.pg2._get_capture(self.NUM_PKTS)
        rx1 = self.pg3._get_capture(self.NUM_PKTS)
        ...
        rx0 = self.pg3.get_capture(self.NUM_PKTS)
        self.assertEqual(len(pkts), len(rx0),
                         "Expected all (%s) packets across single path. "
                         "rx0: %s." % (len(pkts), len(rx0)))
