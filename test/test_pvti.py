...
class TestPvti(VppTestCase):
    ...
    def create_packets(self, src_ip_if, count=1):
        pkts = []
    ...
    def test_pvti_send_simple_1pkt(self):
        """Simple packet - count 1"""
        local_port = 12312
        peer_addr = "192.0.2.1"
        peer_port = 31234
        peer_port = 12312
        for i in self.pg_interfaces:
           i.test_name = "blah" # self._testMethodName
        pvti0 = VppPvtiInterface(self, self.pg1.local_ip4, local_port, peer_addr, peer_port).add_vpp_config()
        pvti0.admin_up()
        pvti0.config_ip4()

        self.logger.info(self.vapi.cli("ip route add 0.0.0.0/0 via pvti0"))
    ...
    def test_pvti_send_simple_2pkt(self):
        """Simple packet - count 2"""
        local_port = 12312
        peer_addr = "192.0.2.1"
        peer_port = 31234
        peer_port = 12312
