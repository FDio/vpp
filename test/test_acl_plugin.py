...
class TestACLplugin(VppTestCase):
    ...
    def test_0015_tcp_permit_port_v4(self):
        ...
        # Apply rules
        self.apply_rules(rules, b"permit ip4 tcp "+str(port))
    ...
    def test_0019_udp_deny_port(self):
        ...
        # Apply rules
        self.apply_rules(rules, b"deny ip4/ip6 udp "+str(port))
    ...
    def test_0022_zero_length_udp_ipv4(self):
        ...
        # Apply rules
        self.apply_rules(rules, b"permit empty udp ip4 " + str(port))
    ...
    def test_0023_zero_length_udp_ipv6(self):
        ...
        # Apply rules
        self.apply_rules(rules, b"permit empty udp ip6 "+str(port))
