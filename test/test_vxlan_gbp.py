...
class TestVxlanGbp(BridgeDomain, VppTestCase):
    """ VXLAN GBP Test Case """
    ...
    def encap_mcast(self, pkt, src_ip, src_mac, vni):
        ...
        return (Ether(src=src_mac, dst=self.mcast_mac) /
                ...
                UDP(sport=self.dport, dport=self.dport, chksum=0) /
                VXLAN(vni=vni, flags=self.flags, gpid=self.sclass) /
                pkt)
    ...
    def check_encapsulation(self, pkt, vni, local_only=False, mcast_pkt=False):
        ...
        # Verify Source Class
        self.assertEqual(pkt[VXLAN].gpid, type(self).sclass)

    @classmethod
    def create_vxlan_gbp_flood_test_bd(cls, vni, sclass, n_ucast_tunnels):
...
#        cls.add_del_mcast_tunnels_load(is_add=0)
    ...
    def setUpClass(cls):
        ...
        try:
            ...
            cls.create_vxlan_gbp_flood_test_bd(cls.ucast_flood_bd, cls.sclass,
                                           cls.n_ucast_tunnels)
    ...
    def test_encap_big_packet(self):
        ...
        pkt = reassemble(out)
        pkt = ether / pkt
        #self.encapsulate(pkt, self.single_tunnel_bd, 0x0, 16)
