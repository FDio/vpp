...
class TestIPMcast(VppTestCase):
    ...
    def test_ip6_mcast(self):
        ...
        #
        # a stream that matches the route for (*,ff::1)
        #
        self.vapi.cli("clear trace")
        tx = self.create_stream_ip6(self.pg0, "2002::2", "ff00::1")
        self.pg0.add_stream(tx)
        ...
        #
        # a stream that matches the route for (2001::1, ff00::1xs)
        #
        self.vapi.cli("clear trace")
        tx = self.create_stream_ip6(self.pg0, "2001::1", "ff01::1")
        self.pg0.add_stream(tx)
    ...
    def test_ip_mcast_connected(self):
        ...
        route_232_1_1_1.update_entry_flags(MRouteEntryFlags.MFIB_ENTRY_FLAG_CONNECTED);
        ...
        route_232_1_1_2.update_entry_flags(MRouteEntryFlags.MFIB_ENTRY_FLAG_CONNECTED);
    ...
    def test_ip_mcast_signal(self):
        ...
        route_232_1_1_1.update_entry_flags(MRouteEntryFlags.MFIB_ENTRY_FLAG_SIGNAL);
        ...
        #
        route_232_1_1_1.update_entry_flags(MRouteEntryFlags.MFIB_ENTRY_FLAG_NONE);
