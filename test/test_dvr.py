...
class TestDVR(VppTestCase):
    ...
    def test_l2_emulation(self):
        ...
        #
        # set the interfaces as unnumbered to the BVI so that
        # they accept incoming IP
        #
        self.pg0.set_unnumbered(self.loop0.sw_if_index)
        self.pg1.set_unnumbered(self.loop0.sw_if_index)
        sub_if_on_pg2.set_unnumbered(self.loop0.sw_if_index)
        sub_if_on_pg3.set_unnumbered(self.loop0.sw_if_index)

        #
        # Disable flooding and learning. makes this test easier
        # as packets are dropped if not extracted, since we don not
        # learn
        #
        self.vapi.bridge_flags(1, 0, (1 << 2) | (1 << 3))
        ...
        #
        self.vapi.sw_interface_set_l2_l3_extract(self.pg0.sw_if_index)
        self.vapi.sw_interface_set_l2_l3_extract(self.pg1.sw_if_index)
        self.vapi.sw_interface_set_l2_l3_extract(sub_if_on_pg2.sw_if_index)
        self.vapi.sw_interface_set_l2_l3_extract(sub_if_on_pg3.sw_if_index)
        ...
        # cleanup
        #
        self.pg0.unset_unnumbered(self.loop0.sw_if_index)
        self.pg1.unset_unnumbered(self.loop0.sw_if_index)
        sub_if_on_pg2.unset_unnumbered(self.loop0.sw_if_index)
        sub_if_on_pg3.unset_unnumbered(self.loop0.sw_if_index)
