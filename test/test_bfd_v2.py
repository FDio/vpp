...
def set_ipv4_pfx_route_info(cls):
    try:
        ...
        self.vapi.want_bfd_events_v2(enable_disable=0)
        raise
...
def bfd_session_up(test):
    ...
    e = test.vapi.wait_for_event(1, "bfd_udp_session_event_v2")
...
class BFD4TestCase(VppTestCase):
    ...
    def test_session_up_by_ip(self):
        ...
        e = self.vapi.wait_for_event(1, "bfd_udp_session_event_v2")
    ...
    def test_modify_req_min_rx_double(self):
        ...
        time_mark = time.time()
        e = self.vapi.wait_for_event(2 * timeout, "bfd_udp_session_event_v2")
        verify_event(self, e, expected_state=BFDState.down)
    ...
    def test_modify_req_min_rx_halve(self):
        ...
        before = time.time()
        e = self.vapi.wait_for_event(2 * detection_time, "bfd_udp_session_event_v2")
        after = time.time()
        self.assert_in_range(
            after - before,
            0.9 * detection_time,
...
class BFDFIBTestCase(VppTestCase):
    ...
    def tearDown(self):
        if not self.vpp_dead:
            self.vapi.want_bfd_events_v2(enable_disable=False)
