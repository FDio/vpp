...
class JavaRuntimeError(RuntimeError, subprocess.CalledProcessError):
    """Java executable returned an error."""
...
class TestJVpp(VppTestCase):
    ...
    def setUpClass(cls):
        ...
        time.sleep(1)
        cls.java_ver = '(Not tested.)'
        command = ["java", "-version"]
        try:
            cls.java_ver = subprocess.check_output(
                command,
                shell=False,
            ...
            raise RuntimeError('Java returned error code.')

        cls.java_home = os.getenv('JAVA_HOME', '(Not set)')

    def setUp(self):
        self.logger.info("JAVA_HOME : %s", self.__class__.java_home)
        self.logger.info("Java Version :\n%s", self.__class__.java_ver)
    ...
    def test_vpp_core_callback_api(self):
        ...
        self.jvpp_connection_test(api_jar_name="jvpp-core",
    ...
    def test_vpp_acl_callback_api(self):
        ...
        self.jvpp_connection_test(api_jar_name="jvpp-acl",
    ...
    def test_vpp_ioamexport_callback_api(self):
        ...
        self.jvpp_connection_test(api_jar_name="jvpp-ioamexport",
    ...
    def test_vpp_ioampot_callback_api(self):
        ...
        self.jvpp_connection_test(api_jar_name="jvpp-ioampot",
    ...
    def test_vpp_ioamtrace_callback_api(self):
        ...
        self.jvpp_connection_test(api_jar_name="jvpp-ioamtrace",
    ...
    def test_vpp_snat_callback_api(self):
        ...
        self.jvpp_connection_test(api_jar_name="jvpp-nat",
    ...
    def jvpp_connection_test(self, api_jar_name, test_class_name,
        ...
        if self.process.returncode != 0:
            raise JavaRuntimeError(
                ...
                .format(command, self.process.returncode,
                        os.linesep, err))
