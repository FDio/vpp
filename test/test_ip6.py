...
from vpp_pom.vpp_ip_route import VppIpRoute, VppRoutePath, find_route, \
    VppIpMRoute, VppMRoutePath, VppMplsIpBind, \
...
class TestIP6Punt(VppTestCase):
    ...
    def test_ip_punt(self):
        ...
        # add a policer
        #
        policer = VppPolicer(self.vclient, "ip6-punt",
    ...
    def test_replace(self):
        ...
        for ii, t in enumerate(self.tables):
            for jj in range(1, N_ROUTES):
                uni = VppIpRoute(
                    self.vclient, "2001::%d" % jj if jj != 0 else "2001::",
                    128,
    ...
    def test_replace(self):
        ...
        for i in range(len(self.pg_interfaces)):
            ...
            a = VppIpInterfaceAddress(
                self.vclient, intf, addr, 64).add_vpp_config()
...
class TestIP6LinkLocal(VppTestCase):
    ...
    def test_ip6_ll(self):
        ...
        VppIpInterfaceAddress(self.vclient, self.pg0,
                              ll1, 128).add_vpp_config()
