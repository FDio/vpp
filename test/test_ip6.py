...
class TestIP6Input(VppTestCase):
    ...
    def test_ip_input_icmp_reply(self):
        ...
        self.assertEqual(
            self.statistics.get_counter("/err/ip6-input/time_expired")[0], NUM_PKTS
        )
    ...
    def test_ip_input(self):
        ...
        self.assertEqual(
            self.statistics.get_counter("/err/ip6-input/bad_length")[0], NUM_PKTS
        )
        ...
        self.assertEqual(
            self.statistics.get_counter("/err/ip6-input/version")[0], NUM_PKTS
        )
