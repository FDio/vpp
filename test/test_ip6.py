...
class TestIPv6RDControlPlane(TestIPv6ND):
    ...
    def test_all(self):
        ...
        router_address = IPv6Address(unicode(self.pg0.remote_ip6_ll))
        ...
        prefix = IPv6Network(unicode("%s/%d" % (list(new_addresses)[0],  20)),
                             strict=False)
        self.assertEqual(prefix, IPv6Network(unicode('1::/20')))
