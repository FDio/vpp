...
class TestIP6Punt(VppTestCase):
    ...
    def test_ip_punt(self):
        ...
        # add a policer
        #
        policer = self.vapi.policer_add_del("ip6-punt", 4, 0, 5, 0,
                                            rate_type=1)
        self.vapi.ip_punt_police(policer.policer_index, is_ip6=1)
        self.logger.error(self.vapi.cli("sh policer"))
        self.logger.error(self.vapi.cli("sh feature"))
        ...
        self.vapi.policer_add_del("ip6-punt", 4, 0, 5, 0,
