...
class TestIPv6(TestIPv6ND):
    ...
    def test_ns(self):
        ...
        self.assert_equal(self.get_ip6_nd_rx_requests(self.pg0),
                          n_rx_req_pg0 + 1)
        ...
        self.assert_equal(self.get_ip6_nd_rx_requests(self.pg0),
                          n_rx_req_pg0 + 3)
        self.assert_equal(self.get_ip6_nd_tx_replies(self.pg0),
                          n_tx_rep_pg0 + 1)
    ...
    def test_nd_incomplete(self):
        ...
        #
        n_tx_req_pg1 = self.get_ip6_nd_rx_requests(self.pg1)
        rx = self.send_and_expect(self.pg0, [p0], self.pg1)
        self.send_and_expect_ns(self.pg0, self.pg1,
                                p0, self.pg1.remote_hosts[1].ip6)
        self.assert_equal(self.get_ip6_nd_tx_requests(self.pg1),
                          n_tx_req_pg1 + 1)
        ...
        na = (Ether(dst=self.pg1.local_mac,
                    src=self.pg1.remote_mac) /
              IPv6(dst=self.pg1.local_ip6,
                   src=self.pg1.remote_hosts[1].ip6) /
