...
class TestIPv6(TestIPv6ND):
    ...
    def test_rs(self):
        ...
        #
        self.pg0.ip6_ra_prefix(IPv6Network(u'%s/%s' % (self.pg0.local_ip6,
                               self.pg0.local_ip6_prefix_len), strict=False))
        ...
        #
        self.pg0.ip6_ra_prefix(IPv6Network(u'%s/%s' % (self.pg1.local_ip6,
                               self.pg1.local_ip6_prefix_len), strict=False),
                               off_link=1,
                               no_autoconfig=1)
