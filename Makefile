...
ifeq ($(OS_ID),fedora)
	...
	# needed for install-ext-deps
	RPM_DEPENDS += python2-devel python-pip python3-devel
	RPM_DEPENDS += cmake
	RPM_DEPENDS_GROUPS = 'C Development Tools and Libraries'
else
	RPM_DEPENDS += yum-utils
	RPM_DEPENDS += openssl-devel
	RPM_DEPENDS += python-devel python-pip python34-devel python34-pip
...
RPM_SUSE_BUILDTOOLS_DEPS += clang cmake curl indent libtool make ninja
