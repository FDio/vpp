...
ifeq ($(OS_VERSION_ID),26.04)
	DEB_DEPENDS += libssl-dev
	DEB_DEPENDS += llvm clang clang-format-19
	...
	DEB_DEPENDS += virtualenv
	DEB_DEPENDS += clang-14 clang-format-19
