...
test-cov-hs: build-gcov
	@$(MAKE) CC=$(CC) -C test-container/hs-test test-cov \
...
test-checkstyle:
	...
	@$(MAKE) -C test-container/hs-test checkstyle-go
...
.PHONY: cleanup-hst
cleanup-hst:
	$(MAKE) -C test-container/hs-test cleanup-hst
...
.PHONY: fixstyle-go
fixstyle-go:
	@$(MAKE) -C test-container/hs-test fixstyle-go
