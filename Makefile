...
DEB_DEPENDS += cmake ninja-build uuid-dev python3-jsonschema python3-yaml meson
...
RPM_SUSE_BUILDTOOLS_DEPS += clang cmake indent libtool make ninja python3-ply meson
