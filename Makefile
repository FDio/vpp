...
test-asan:
	$(call test,vpp,vpp_asan,test ASAN_OPTIONS=verify_asan_link_order=0:detect_leaks=0:abort_on_error=1)

test-relasan:
	$(call test,vpp,vpp_relasan,test ASAN_OPTIONS=verify_asan_link_order=0:detect_leaks=0:abort_on_error=1)
