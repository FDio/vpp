...
help:
	...
	@echo " test-c-build        - build simple C tests"
	@echo " test-c-build-debug  - build simple C tests (debug)"
...
test-c-build:
	$(call test,vpp,vpp,test-c-build)

test-c-build-debug:
	$(call test,vpp,vpp_debug,test-c-build)
