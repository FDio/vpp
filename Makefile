...
RPM_SUSE_PYTHON_DEPS = python3-devel python3-pip
RPM_SUSE_PYTHON_DEPS += python3-rpm-macros

RPM_SUSE_PLATFORM_DEPS = shadow rpm-build

ifeq ($(OS_ID),opensuse-leap)
	RPM_SUSE_DEVEL_DEPS += xmlto openssl-devel lsb-release
	RPM_SUSE_DEVEL_DEPS += asciidoc git nasm
