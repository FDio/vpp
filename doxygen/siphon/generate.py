...
class Generate(object):
    ...
    def parse(self, filename):
        ...
        with open(filename) as fd:
            ...
            for key in directives.keys():
                ...
                #if 'file' not in self.output[sn]:
                #    self.output[sn]['file'] = "%s/%s.siphon" % (args.output, sn)
                #if 'items' not in self.output[sn]:
                #    self.output[sn]['items'] = []
    ...
    def deliver(self):
        ...
        for siphon in self.output.keys():
            self.log.info("Saving siphon %s." % siphon)
