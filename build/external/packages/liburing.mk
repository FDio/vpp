...
liburing_tarball_sha256sum_2.13 := 618e34dbea408fc9e33d7c4babd746036dbdedf7fce2496b1178ced0f9b5b357
...
define  liburing_config_cmds
	@rm -f $(liburing_build_log)
	@cd ${liburing_src_dir} && ./configure --prefix='$(liburing_install_dir)'
endef

define  liburing_build_cmds
	@cd ${liburing_src_dir} && $(MAKE) > $(liburing_build_log)
endef

define  liburing_install_cmds
	@rm -f $(liburing_install_log)
	@cd ${liburing_src_dir} && \
		$(MAKE) install DESTDIR='$(liburing_install_dir)' >> $(liburing_install_log)
endef
