...
define  rdma-core_config_cmds
	cd $(rdma-core_build_dir) && \
	  cmake -G Ninja $(rdma-core_src_dir) \
	    ...
	    -DCMAKE_INSTALL_RUNDIR:PATH=/dev/null \
	    -DCMAKE_INSTALL_PREFIX:PATH=$(rdma-core_install_dir) -DCMAKE_INSTALL_RPATH:PATH=$(rdma-core_install_dir)/lib -DCMAKE_C_FLAGS=-fPIC > $(rdma-core_config_log)
endef
